...
final class DescribeRepositoriesResponseOps(val self: DescribeRepositoriesResponse) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def repositoriesAsScala: Option[Seq[Repository]] =
    Option(self.repositories).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
