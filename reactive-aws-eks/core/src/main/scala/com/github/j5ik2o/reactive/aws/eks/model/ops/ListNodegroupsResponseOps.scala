...
final class ListNodegroupsResponseOps(val self: ListNodegroupsResponse) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def nodegroupsAsScala: Option[Seq[String]] =
    Option(self.nodegroups).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
