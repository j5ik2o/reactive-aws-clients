...
final case class TransactWriteItemsRequest(transactItems: Option[Seq[TransactWriteItem]] = None,
  ...
  def withTransactItems(value: Option[Seq[TransactWriteItem]]): TransactWriteItemsRequest = copy(transactItems = value)
  ...
  def withClientRequestToken(value: Option[String]): TransactWriteItemsRequest = copy(clientRequestToken = value)
}
