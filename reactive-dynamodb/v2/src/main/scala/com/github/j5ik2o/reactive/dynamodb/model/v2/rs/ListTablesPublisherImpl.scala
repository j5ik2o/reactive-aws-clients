...
import com.github.j5ik2o.reactive.dynamodb.model.{ ListTablesResponse => ScalaListTablesResponse }
...
class ListTablesPublisherImpl(self: software.amazon.awssdk.services.dynamodb.paginators.ListTablesPublisher)
    extends com.github.j5ik2o.reactive.dynamodb.model.rs.ListTablesPublisher {
