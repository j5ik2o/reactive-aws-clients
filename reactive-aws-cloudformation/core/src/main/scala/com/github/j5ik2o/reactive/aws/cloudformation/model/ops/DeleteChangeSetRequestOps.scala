...
implicit def toDeleteChangeSetRequestBuilderOps(v: DeleteChangeSetRequest.Builder): DeleteChangeSetRequestBuilderOps = new DeleteChangeSetRequestBuilderOps(v)

implicit def toDeleteChangeSetRequestOps(v: DeleteChangeSetRequest): DeleteChangeSetRequestOps = new DeleteChangeSetRequestOps(v)
