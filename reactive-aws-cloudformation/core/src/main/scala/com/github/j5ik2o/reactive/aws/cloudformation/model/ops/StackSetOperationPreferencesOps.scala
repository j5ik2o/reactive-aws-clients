...
final class StackSetOperationPreferencesOps(val self: StackSetOperationPreferences) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def regionOrderAsScala: Option[Seq[String]] =
    Option(self.regionOrder).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
