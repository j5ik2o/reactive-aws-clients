...
trait CloudFormationSyncClient extends CloudFormationClient[Either[Throwable, ?]] {
  ...
  ): Either[Throwable, CancelUpdateStackResponse] =
  ...
  ): Either[Throwable, ContinueUpdateRollbackResponse] =
  ...
  ): Either[Throwable, CreateChangeSetResponse] =
  ...
  ): Either[Throwable, CreateStackInstancesResponse] =
  ...
  override def deleteChangeSet(
      deleteChangeSetRequest: DeleteChangeSetRequest
  ): Either[Throwable, DeleteChangeSetResponse] =
  ...
  ): Either[Throwable, DeleteStackInstancesResponse] =
  ...
  ): Either[Throwable, DescribeStackDriftDetectionStatusResponse] =
  ...
  ): Either[Throwable, DescribeStackEventsResponse] =
  ...
  ): Either[Throwable, DescribeStackInstanceResponse] =
  ...
  ): Either[Throwable, DescribeStackResourceResponse] =
  ...
  ): Either[Throwable, DescribeStackResourceDriftsResponse] =
  ...
  ): Either[Throwable, DescribeStackSetOperationResponse] =
  ...
  ): Either[Throwable, EstimateTemplateCostResponse] =
  ...
  ): Either[Throwable, ExecuteChangeSetResponse] =
  ...
  ): Either[Throwable, GetTemplateSummaryResponse] =
  ...
  ): Either[Throwable, StopStackSetOperationResponse] =
  ...
  ): Either[Throwable, UpdateStackInstancesResponse] =
  ...
  ): Either[Throwable, UpdateTerminationProtectionResponse] =
  ...
  ): Either[Throwable, ValidateTemplateResponse] =
