...
implicit def toGetTemplateSummaryRequestBuilderOps(v: GetTemplateSummaryRequest.Builder): GetTemplateSummaryRequestBuilderOps = new GetTemplateSummaryRequestBuilderOps(v)

implicit def toGetTemplateSummaryRequestOps(v: GetTemplateSummaryRequest): GetTemplateSummaryRequestOps = new GetTemplateSummaryRequestOps(v)
