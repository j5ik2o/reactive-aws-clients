...
implicit def toEstimateTemplateCostRequestBuilderOps(v: EstimateTemplateCostRequest.Builder): EstimateTemplateCostRequestBuilderOps = new EstimateTemplateCostRequestBuilderOps(v)

implicit def toEstimateTemplateCostRequestOps(v: EstimateTemplateCostRequest): EstimateTemplateCostRequestOps = new EstimateTemplateCostRequestOps(v)
