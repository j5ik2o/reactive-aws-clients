...
implicit def toStackDriftInformationSummaryBuilderOps(v: StackDriftInformationSummary.Builder): StackDriftInformationSummaryBuilderOps = new StackDriftInformationSummaryBuilderOps(v)

implicit def toStackDriftInformationSummaryOps(v: StackDriftInformationSummary): StackDriftInformationSummaryOps = new StackDriftInformationSummaryOps(v)
