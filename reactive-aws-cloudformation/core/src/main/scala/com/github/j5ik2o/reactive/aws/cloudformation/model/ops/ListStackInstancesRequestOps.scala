...
implicit def toListStackInstancesRequestBuilderOps(v: ListStackInstancesRequest.Builder): ListStackInstancesRequestBuilderOps = new ListStackInstancesRequestBuilderOps(v)

implicit def toListStackInstancesRequestOps(v: ListStackInstancesRequest): ListStackInstancesRequestOps = new ListStackInstancesRequestOps(v)
