...
implicit def toCancelUpdateStackRequestBuilderOps(v: CancelUpdateStackRequest.Builder): CancelUpdateStackRequestBuilderOps = new CancelUpdateStackRequestBuilderOps(v)

implicit def toCancelUpdateStackRequestOps(v: CancelUpdateStackRequest): CancelUpdateStackRequestOps = new CancelUpdateStackRequestOps(v)
