...
trait ToDetectStackSetDriftRequestOps {
  ...
  implicit def toDetectStackSetDriftRequestBuilderOps(
      v: DetectStackSetDriftRequest.Builder
  ): DetectStackSetDriftRequestBuilderOps = new DetectStackSetDriftRequestBuilderOps(v)

  implicit def toDetectStackSetDriftRequestOps(v: DetectStackSetDriftRequest): DetectStackSetDriftRequestOps =
    new DetectStackSetDriftRequestOps(v)
