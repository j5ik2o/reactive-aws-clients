...
implicit def toGetStackPolicyResponseBuilderOps(v: GetStackPolicyResponse.Builder): GetStackPolicyResponseBuilderOps = new GetStackPolicyResponseBuilderOps(v)

implicit def toGetStackPolicyResponseOps(v: GetStackPolicyResponse): GetStackPolicyResponseOps = new GetStackPolicyResponseOps(v)
