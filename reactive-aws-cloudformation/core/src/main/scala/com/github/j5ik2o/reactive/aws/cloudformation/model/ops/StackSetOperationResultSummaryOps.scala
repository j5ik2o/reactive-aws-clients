...
final class StackSetOperationResultSummaryBuilderOps(val self: StackSetOperationResultSummary.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.accountGateResult(v) }
            } 
...
implicit def toStackSetOperationResultSummaryBuilderOps(v: StackSetOperationResultSummary.Builder): StackSetOperationResultSummaryBuilderOps = new StackSetOperationResultSummaryBuilderOps(v)

implicit def toStackSetOperationResultSummaryOps(v: StackSetOperationResultSummary): StackSetOperationResultSummaryOps = new StackSetOperationResultSummaryOps(v)
