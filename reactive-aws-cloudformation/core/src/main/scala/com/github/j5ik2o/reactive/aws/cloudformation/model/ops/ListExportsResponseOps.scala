...
final class ListExportsResponseBuilderOps(val self: ListExportsResponse.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def exportsAsScala(value: Option[Seq[Export]]): ListExportsResponse.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.exports(v.asJava) } 
            }
...
final class ListExportsResponseOps(val self: ListExportsResponse) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def exportsAsScala: Option[Seq[Export]] = Option(self.exports).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toListExportsResponseBuilderOps(v: ListExportsResponse.Builder): ListExportsResponseBuilderOps = new ListExportsResponseBuilderOps(v)
