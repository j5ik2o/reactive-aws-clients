...
final class StackInstanceBuilderOps(val self: StackInstance.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def parameterOverridesAsScala(value: Option[Seq[Parameter]]): StackInstance.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.parameterOverrides(v.asJava) } 
            }
...
final class StackInstanceOps(val self: StackInstance) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def parameterOverridesAsScala: Option[Seq[Parameter]] = Option(self.parameterOverrides).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toStackInstanceBuilderOps(v: StackInstance.Builder): StackInstanceBuilderOps = new StackInstanceBuilderOps(v)
