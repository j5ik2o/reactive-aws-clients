...
implicit def toCreateStackSetResponseBuilderOps(v: CreateStackSetResponse.Builder): CreateStackSetResponseBuilderOps = new CreateStackSetResponseBuilderOps(v)

implicit def toCreateStackSetResponseOps(v: CreateStackSetResponse): CreateStackSetResponseOps = new CreateStackSetResponseOps(v)
