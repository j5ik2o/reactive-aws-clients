...
final class StackSetDriftDetectionDetailsBuilderOps(val self: StackSetDriftDetectionDetails.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def driftDetectionStatusAsScala(value: Option[StackSetDriftDetectionStatus]): StackSetDriftDetectionDetails.Builder = {
            value.fold(self){ v => self.driftDetectionStatus(v) }
            } 
...
implicit def toStackSetDriftDetectionDetailsBuilderOps(v: StackSetDriftDetectionDetails.Builder): StackSetDriftDetectionDetailsBuilderOps = new StackSetDriftDetectionDetailsBuilderOps(v)

implicit def toStackSetDriftDetectionDetailsOps(v: StackSetDriftDetectionDetails): StackSetDriftDetectionDetailsOps = new StackSetDriftDetectionDetailsOps(v)
