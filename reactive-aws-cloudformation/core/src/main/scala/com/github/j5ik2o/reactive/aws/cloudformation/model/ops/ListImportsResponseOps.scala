...
final class ListImportsResponseBuilderOps(val self: ListImportsResponse.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def importsAsScala(value: Option[Seq[String]]): ListImportsResponse.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.imports(v.asJava) } 
            }
...
final class ListImportsResponseOps(val self: ListImportsResponse) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def importsAsScala: Option[Seq[String]] = Option(self.imports).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toListImportsResponseBuilderOps(v: ListImportsResponse.Builder): ListImportsResponseBuilderOps = new ListImportsResponseBuilderOps(v)
