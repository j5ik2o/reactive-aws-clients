...
final class ResourceIdentifierSummaryOps(val self: ResourceIdentifierSummary) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def logicalResourceIdsAsScala: Option[Seq[String]] =
    Option(self.logicalResourceIds).map { v =>
      import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala
    }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def resourceIdentifiersAsScala: Option[Seq[String]] =
    Option(self.resourceIdentifiers).map { v =>
      import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala
    }
