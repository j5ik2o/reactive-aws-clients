...
implicit def toListStackResourcesRequestBuilderOps(v: ListStackResourcesRequest.Builder): ListStackResourcesRequestBuilderOps = new ListStackResourcesRequestBuilderOps(v)

implicit def toListStackResourcesRequestOps(v: ListStackResourcesRequest): ListStackResourcesRequestOps = new ListStackResourcesRequestOps(v)
