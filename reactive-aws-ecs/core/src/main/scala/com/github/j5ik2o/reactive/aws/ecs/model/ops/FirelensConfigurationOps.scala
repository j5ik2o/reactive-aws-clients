...
trait ToFirelensConfigurationOps {
  ...
  implicit def toFirelensConfigurationBuilderOps(v: FirelensConfiguration.Builder): FirelensConfigurationBuilderOps =
    new FirelensConfigurationBuilderOps(v)

  implicit def toFirelensConfigurationOps(v: FirelensConfiguration): FirelensConfigurationOps =
    new FirelensConfigurationOps(v)
