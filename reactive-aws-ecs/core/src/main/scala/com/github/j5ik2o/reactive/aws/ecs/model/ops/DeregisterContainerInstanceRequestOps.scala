...
final class DeregisterContainerInstanceRequestBuilderOps(val self: DeregisterContainerInstanceRequest.Builder) extends AnyVal {
...
implicit def toDeregisterContainerInstanceRequestBuilderOps(v: DeregisterContainerInstanceRequest.Builder): DeregisterContainerInstanceRequestBuilderOps = new DeregisterContainerInstanceRequestBuilderOps(v)

implicit def toDeregisterContainerInstanceRequestOps(v: DeregisterContainerInstanceRequest): DeregisterContainerInstanceRequestOps = new DeregisterContainerInstanceRequestOps(v)
