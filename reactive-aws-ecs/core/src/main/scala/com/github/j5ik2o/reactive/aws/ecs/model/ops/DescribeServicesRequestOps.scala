...
final class DescribeServicesRequestOps(val self: DescribeServicesRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def servicesAsScala: Option[Seq[String]] = Option(self.services).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def includeAsScala: Option[Seq[ServiceField]] = Option(self.include).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toDescribeServicesRequestBuilderOps(v: DescribeServicesRequest.Builder): DescribeServicesRequestBuilderOps = new DescribeServicesRequestBuilderOps(v)

implicit def toDescribeServicesRequestOps(v: DescribeServicesRequest): DescribeServicesRequestOps = new DescribeServicesRequestOps(v)
