...
final class ContainerInstanceBuilderOps(val self: ContainerInstance.Builder) extends AnyVal {
  ...
  final def remainingResourcesAsScala(value: Option[Seq[Resource]]): ContainerInstance.Builder = {
    value.filter(_.nonEmpty).fold(self) { v =>
      import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.remainingResources(v.asJava)
    }
  }
  ...
  final def registeredResourcesAsScala(value: Option[Seq[Resource]]): ContainerInstance.Builder = {
    value.filter(_.nonEmpty).fold(self) { v =>
      import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.registeredResources(v.asJava)
    }
  }
...
final class ContainerInstanceOps(val self: ContainerInstance) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def remainingResourcesAsScala: Option[Seq[Resource]] =
    Option(self.remainingResources).map { v =>
      import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala
    }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def registeredResourcesAsScala: Option[Seq[Resource]] =
    Option(self.registeredResources).map { v =>
      import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala
    }
