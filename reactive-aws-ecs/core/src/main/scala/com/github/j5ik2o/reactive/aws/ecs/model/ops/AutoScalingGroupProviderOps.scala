...
final class AutoScalingGroupProviderBuilderOps(val self: AutoScalingGroupProvider.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def managedTerminationProtectionAsScala(value: Option[ManagedTerminationProtection]): AutoScalingGroupProvider.Builder = {
...
final class AutoScalingGroupProviderOps(val self: AutoScalingGroupProvider) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def managedTerminationProtectionAsScala: Option[ManagedTerminationProtection] = Option(self.managedTerminationProtection) 
...
implicit def toAutoScalingGroupProviderBuilderOps(v: AutoScalingGroupProvider.Builder): AutoScalingGroupProviderBuilderOps = new AutoScalingGroupProviderBuilderOps(v)

implicit def toAutoScalingGroupProviderOps(v: AutoScalingGroupProvider): AutoScalingGroupProviderOps = new AutoScalingGroupProviderOps(v)
