...
implicit def toListAccountSettingsRequestBuilderOps(v: ListAccountSettingsRequest.Builder): ListAccountSettingsRequestBuilderOps = new ListAccountSettingsRequestBuilderOps(v)

implicit def toListAccountSettingsRequestOps(v: ListAccountSettingsRequest): ListAccountSettingsRequestOps = new ListAccountSettingsRequestOps(v)
