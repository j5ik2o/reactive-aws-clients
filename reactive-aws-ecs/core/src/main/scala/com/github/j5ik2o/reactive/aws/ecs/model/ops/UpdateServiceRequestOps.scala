...
final class UpdateServiceRequestBuilderOps(val self: UpdateServiceRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def capacityProviderStrategyAsScala(value: Option[Seq[CapacityProviderStrategyItem]]): UpdateServiceRequest.Builder = {
...
implicit def toUpdateServiceRequestBuilderOps(v: UpdateServiceRequest.Builder): UpdateServiceRequestBuilderOps = new UpdateServiceRequestBuilderOps(v)

implicit def toUpdateServiceRequestOps(v: UpdateServiceRequest): UpdateServiceRequestOps = new UpdateServiceRequestOps(v)
