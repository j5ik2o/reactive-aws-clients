...
final class UpdateServicePrimaryTaskSetRequestBuilderOps(val self: UpdateServicePrimaryTaskSetRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.primaryTaskSet(v) }
            } 
...
implicit def toUpdateServicePrimaryTaskSetRequestBuilderOps(v: UpdateServicePrimaryTaskSetRequest.Builder): UpdateServicePrimaryTaskSetRequestBuilderOps = new UpdateServicePrimaryTaskSetRequestBuilderOps(v)

implicit def toUpdateServicePrimaryTaskSetRequestOps(v: UpdateServicePrimaryTaskSetRequest): UpdateServicePrimaryTaskSetRequestOps = new UpdateServicePrimaryTaskSetRequestOps(v)
