...
final class UpdateContainerInstancesStateRequestBuilderOps(val self: UpdateContainerInstancesStateRequest.Builder) extends AnyVal {
...
implicit def toUpdateContainerInstancesStateRequestBuilderOps(v: UpdateContainerInstancesStateRequest.Builder): UpdateContainerInstancesStateRequestBuilderOps = new UpdateContainerInstancesStateRequestBuilderOps(v)

implicit def toUpdateContainerInstancesStateRequestOps(v: UpdateContainerInstancesStateRequest): UpdateContainerInstancesStateRequestOps = new UpdateContainerInstancesStateRequestOps(v)
