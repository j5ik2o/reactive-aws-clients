...
final class TaskOverrideBuilderOps(val self: TaskOverride.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def containerOverridesAsScala(value: Option[Seq[ContainerOverride]]): TaskOverride.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.containerOverrides(v.asJava) } 
            }
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def inferenceAcceleratorOverridesAsScala(value: Option[Seq[InferenceAcceleratorOverride]]): TaskOverride.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.inferenceAcceleratorOverrides(v.asJava) } 
            }
...
final class TaskOverrideOps(val self: TaskOverride) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def containerOverridesAsScala: Option[Seq[ContainerOverride]] = Option(self.containerOverrides).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def cpuAsScala: Option[String] = Option(self.cpu) 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def inferenceAcceleratorOverridesAsScala: Option[Seq[InferenceAcceleratorOverride]] = Option(self.inferenceAcceleratorOverrides).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
