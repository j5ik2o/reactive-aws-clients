...
implicit def toCapacityProviderStrategyItemBuilderOps(v: CapacityProviderStrategyItem.Builder): CapacityProviderStrategyItemBuilderOps = new CapacityProviderStrategyItemBuilderOps(v)

implicit def toCapacityProviderStrategyItemOps(v: CapacityProviderStrategyItem): CapacityProviderStrategyItemOps = new CapacityProviderStrategyItemOps(v)
