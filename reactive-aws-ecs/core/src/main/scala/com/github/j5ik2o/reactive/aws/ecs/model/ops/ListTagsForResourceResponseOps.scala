...
implicit def toListTagsForResourceResponseBuilderOps(v: ListTagsForResourceResponse.Builder): ListTagsForResourceResponseBuilderOps = new ListTagsForResourceResponseBuilderOps(v)

implicit def toListTagsForResourceResponseOps(v: ListTagsForResourceResponse): ListTagsForResourceResponseOps = new ListTagsForResourceResponseOps(v)
