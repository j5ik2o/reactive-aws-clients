...
final class RegisterTaskDefinitionRequestBuilderOps(val self: RegisterTaskDefinitionRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def containerDefinitionsAsScala(value: Option[Seq[ContainerDefinition]]): RegisterTaskDefinitionRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.containerDefinitions(v.asJava) } 
            }
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def placementConstraintsAsScala(value: Option[Seq[TaskDefinitionPlacementConstraint]]): RegisterTaskDefinitionRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.placementConstraints(v.asJava) } 
            }

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def requiresCompatibilitiesAsScala(value: Option[Seq[Compatibility]]): RegisterTaskDefinitionRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.requiresCompatibilities(v.asJava) } 
            }
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def inferenceAcceleratorsAsScala(value: Option[Seq[InferenceAccelerator]]): RegisterTaskDefinitionRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.inferenceAccelerators(v.asJava) } 
            }
...
final class RegisterTaskDefinitionRequestOps(val self: RegisterTaskDefinitionRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def containerDefinitionsAsScala: Option[Seq[ContainerDefinition]] = Option(self.containerDefinitions).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def placementConstraintsAsScala: Option[Seq[TaskDefinitionPlacementConstraint]] = Option(self.placementConstraints).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def requiresCompatibilitiesAsScala: Option[Seq[Compatibility]] = Option(self.requiresCompatibilities).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def inferenceAcceleratorsAsScala: Option[Seq[InferenceAccelerator]] = Option(self.inferenceAccelerators).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toRegisterTaskDefinitionRequestBuilderOps(v: RegisterTaskDefinitionRequest.Builder): RegisterTaskDefinitionRequestBuilderOps = new RegisterTaskDefinitionRequestBuilderOps(v)

implicit def toRegisterTaskDefinitionRequestOps(v: RegisterTaskDefinitionRequest): RegisterTaskDefinitionRequestOps = new RegisterTaskDefinitionRequestOps(v)
