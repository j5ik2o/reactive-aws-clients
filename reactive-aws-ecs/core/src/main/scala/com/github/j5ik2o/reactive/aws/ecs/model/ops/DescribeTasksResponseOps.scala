...
implicit def toDescribeTasksResponseBuilderOps(v: DescribeTasksResponse.Builder): DescribeTasksResponseBuilderOps = new DescribeTasksResponseBuilderOps(v)

implicit def toDescribeTasksResponseOps(v: DescribeTasksResponse): DescribeTasksResponseOps = new DescribeTasksResponseOps(v)
