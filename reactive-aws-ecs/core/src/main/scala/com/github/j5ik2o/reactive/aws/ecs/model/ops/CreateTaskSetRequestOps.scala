...
final class CreateTaskSetRequestBuilderOps(val self: CreateTaskSetRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def capacityProviderStrategyAsScala(value: Option[Seq[CapacityProviderStrategyItem]]): CreateTaskSetRequest.Builder = {
...
implicit def toCreateTaskSetRequestBuilderOps(v: CreateTaskSetRequest.Builder): CreateTaskSetRequestBuilderOps = new CreateTaskSetRequestBuilderOps(v)

implicit def toCreateTaskSetRequestOps(v: CreateTaskSetRequest): CreateTaskSetRequestOps = new CreateTaskSetRequestOps(v)
