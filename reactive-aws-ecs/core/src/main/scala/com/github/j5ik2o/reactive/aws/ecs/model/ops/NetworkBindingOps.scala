...
final class NetworkBindingBuilderOps(val self: NetworkBinding.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.bindIP(v) }
            } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.hostPort(v) }
            } 
...
implicit def toNetworkBindingBuilderOps(v: NetworkBinding.Builder): NetworkBindingBuilderOps = new NetworkBindingBuilderOps(v)
