...
final class CapacityProviderBuilderOps(val self: CapacityProvider.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.capacityProviderArn(v) }
            } 
...
implicit def toCapacityProviderBuilderOps(v: CapacityProvider.Builder): CapacityProviderBuilderOps = new CapacityProviderBuilderOps(v)
