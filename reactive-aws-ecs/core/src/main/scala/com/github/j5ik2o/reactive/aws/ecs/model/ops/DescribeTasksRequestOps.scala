...
final class DescribeTasksRequestOps(val self: DescribeTasksRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def tasksAsScala: Option[Seq[String]] = Option(self.tasks).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def includeAsScala: Option[Seq[TaskField]] = Option(self.include).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toDescribeTasksRequestBuilderOps(v: DescribeTasksRequest.Builder): DescribeTasksRequestBuilderOps = new DescribeTasksRequestBuilderOps(v)

implicit def toDescribeTasksRequestOps(v: DescribeTasksRequest): DescribeTasksRequestOps = new DescribeTasksRequestOps(v)
