...
implicit def toListTaskDefinitionsRequestBuilderOps(v: ListTaskDefinitionsRequest.Builder): ListTaskDefinitionsRequestBuilderOps = new ListTaskDefinitionsRequestBuilderOps(v)

implicit def toListTaskDefinitionsRequestOps(v: ListTaskDefinitionsRequest): ListTaskDefinitionsRequestOps = new ListTaskDefinitionsRequestOps(v)
