...
final class ContainerDependencyBuilderOps(val self: ContainerDependency.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.condition(v) }
            } 
...
implicit def toContainerDependencyBuilderOps(v: ContainerDependency.Builder): ContainerDependencyBuilderOps = new ContainerDependencyBuilderOps(v)
