...
implicit def toEFSVolumeConfigurationBuilderOps(v: EFSVolumeConfiguration.Builder): EFSVolumeConfigurationBuilderOps = new EFSVolumeConfigurationBuilderOps(v)

implicit def toEFSVolumeConfigurationOps(v: EFSVolumeConfiguration): EFSVolumeConfigurationOps = new EFSVolumeConfigurationOps(v)
