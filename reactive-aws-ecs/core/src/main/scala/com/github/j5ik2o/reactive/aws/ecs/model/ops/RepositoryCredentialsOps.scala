...
final class RepositoryCredentialsBuilderOps(val self: RepositoryCredentials.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.credentialsParameter(v) }
            } 
...
implicit def toRepositoryCredentialsBuilderOps(v: RepositoryCredentials.Builder): RepositoryCredentialsBuilderOps = new RepositoryCredentialsBuilderOps(v)

implicit def toRepositoryCredentialsOps(v: RepositoryCredentials): RepositoryCredentialsOps = new RepositoryCredentialsOps(v)
