...
implicit def toUpdateClusterSettingsResponseBuilderOps(v: UpdateClusterSettingsResponse.Builder): UpdateClusterSettingsResponseBuilderOps = new UpdateClusterSettingsResponseBuilderOps(v)

implicit def toUpdateClusterSettingsResponseOps(v: UpdateClusterSettingsResponse): UpdateClusterSettingsResponseOps = new UpdateClusterSettingsResponseOps(v)
