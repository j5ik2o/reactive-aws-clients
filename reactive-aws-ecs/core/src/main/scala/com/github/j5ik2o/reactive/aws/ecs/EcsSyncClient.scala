...
import EcsSyncClient._
    ...
    override def createCapacityProvider(createCapacityProviderRequest: CreateCapacityProviderRequest): Either[Throwable, CreateCapacityProviderResponse] =
    ...
    override def deleteAccountSetting(deleteAccountSettingRequest: DeleteAccountSettingRequest): Either[Throwable, DeleteAccountSettingResponse] =
        underlying.deleteAccountSetting(deleteAccountSettingRequest).toEither

    override def deleteAttributes(deleteAttributesRequest: DeleteAttributesRequest): Either[Throwable, DeleteAttributesResponse] =
    ...
    override def deregisterContainerInstance(deregisterContainerInstanceRequest: DeregisterContainerInstanceRequest): Either[Throwable, DeregisterContainerInstanceResponse] =
        underlying.deregisterContainerInstance(deregisterContainerInstanceRequest).toEither

    override def deregisterTaskDefinition(deregisterTaskDefinitionRequest: DeregisterTaskDefinitionRequest): Either[Throwable, DeregisterTaskDefinitionResponse] =
        underlying.deregisterTaskDefinition(deregisterTaskDefinitionRequest).toEither

    override def describeCapacityProviders(describeCapacityProvidersRequest: DescribeCapacityProvidersRequest): Either[Throwable, DescribeCapacityProvidersResponse] =
    ...
    override def describeClusters(describeClustersRequest: DescribeClustersRequest): Either[Throwable, DescribeClustersResponse] =
        underlying.describeClusters(describeClustersRequest).toEither

    override def describeContainerInstances(describeContainerInstancesRequest: DescribeContainerInstancesRequest): Either[Throwable, DescribeContainerInstancesResponse] =
        underlying.describeContainerInstances(describeContainerInstancesRequest).toEither

    override def describeServices(describeServicesRequest: DescribeServicesRequest): Either[Throwable, DescribeServicesResponse] =
        underlying.describeServices(describeServicesRequest).toEither

    override def describeTaskDefinition(describeTaskDefinitionRequest: DescribeTaskDefinitionRequest): Either[Throwable, DescribeTaskDefinitionResponse] =
        underlying.describeTaskDefinition(describeTaskDefinitionRequest).toEither

    override def describeTaskSets(describeTaskSetsRequest: DescribeTaskSetsRequest): Either[Throwable, DescribeTaskSetsResponse] =
    ...
    override def discoverPollEndpoint(discoverPollEndpointRequest: DiscoverPollEndpointRequest): Either[Throwable, DiscoverPollEndpointResponse] =
    ...
    override def listAccountSettings(listAccountSettingsRequest: ListAccountSettingsRequest): Either[Throwable, ListAccountSettingsResponse] =
     ...
     def listAccountSettingsPaginator(listAccountSettingsRequest: ListAccountSettingsRequest): ListAccountSettingsIterable =
    ...
    override def listContainerInstances(listContainerInstancesRequest: ListContainerInstancesRequest): Either[Throwable, ListContainerInstancesResponse] =
     ...
     def listContainerInstancesPaginator(listContainerInstancesRequest: ListContainerInstancesRequest): ListContainerInstancesIterable =
    ...
    override def listTagsForResource(listTagsForResourceRequest: ListTagsForResourceRequest): Either[Throwable, ListTagsForResourceResponse] =
    ...
    override def listTaskDefinitionFamilies(listTaskDefinitionFamiliesRequest: ListTaskDefinitionFamiliesRequest): Either[Throwable, ListTaskDefinitionFamiliesResponse] =
     ...
     def listTaskDefinitionFamiliesPaginator(listTaskDefinitionFamiliesRequest: ListTaskDefinitionFamiliesRequest): ListTaskDefinitionFamiliesIterable =
    ...
    override def listTaskDefinitions(listTaskDefinitionsRequest: ListTaskDefinitionsRequest): Either[Throwable, ListTaskDefinitionsResponse] =
     ...
     def listTaskDefinitionsPaginator(listTaskDefinitionsRequest: ListTaskDefinitionsRequest): ListTaskDefinitionsIterable =
    ...
    override def putAccountSetting(putAccountSettingRequest: PutAccountSettingRequest): Either[Throwable, PutAccountSettingResponse] =
        underlying.putAccountSetting(putAccountSettingRequest).toEither

    override def putAccountSettingDefault(putAccountSettingDefaultRequest: PutAccountSettingDefaultRequest): Either[Throwable, PutAccountSettingDefaultResponse] =
    ...
    override def putClusterCapacityProviders(putClusterCapacityProvidersRequest: PutClusterCapacityProvidersRequest): Either[Throwable, PutClusterCapacityProvidersResponse] =
        underlying.putClusterCapacityProviders(putClusterCapacityProvidersRequest).toEither

    override def registerContainerInstance(registerContainerInstanceRequest: RegisterContainerInstanceRequest): Either[Throwable, RegisterContainerInstanceResponse] =
        underlying.registerContainerInstance(registerContainerInstanceRequest).toEither

    override def registerTaskDefinition(registerTaskDefinitionRequest: RegisterTaskDefinitionRequest): Either[Throwable, RegisterTaskDefinitionResponse] =
    ...
    override def submitAttachmentStateChanges(submitAttachmentStateChangesRequest: SubmitAttachmentStateChangesRequest): Either[Throwable, SubmitAttachmentStateChangesResponse] =
        underlying.submitAttachmentStateChanges(submitAttachmentStateChangesRequest).toEither

    override def submitContainerStateChange(submitContainerStateChangeRequest: SubmitContainerStateChangeRequest): Either[Throwable, SubmitContainerStateChangeResponse] =
        underlying.submitContainerStateChange(submitContainerStateChangeRequest).toEither

    override def submitTaskStateChange(submitTaskStateChangeRequest: SubmitTaskStateChangeRequest): Either[Throwable, SubmitTaskStateChangeResponse] =
    ...
    override def updateClusterSettings(updateClusterSettingsRequest: UpdateClusterSettingsRequest): Either[Throwable, UpdateClusterSettingsResponse] =
        underlying.updateClusterSettings(updateClusterSettingsRequest).toEither

    override def updateContainerAgent(updateContainerAgentRequest: UpdateContainerAgentRequest): Either[Throwable, UpdateContainerAgentResponse] =
        underlying.updateContainerAgent(updateContainerAgentRequest).toEither

    override def updateContainerInstancesState(updateContainerInstancesStateRequest: UpdateContainerInstancesStateRequest): Either[Throwable, UpdateContainerInstancesStateResponse] =
    ...
    override def updateServicePrimaryTaskSet(updateServicePrimaryTaskSetRequest: UpdateServicePrimaryTaskSetRequest): Either[Throwable, UpdateServicePrimaryTaskSetResponse] =
