...
trait ToDescribeTaskSetsResponseOps {
  ...
  implicit def toDescribeTaskSetsResponseBuilderOps(
      v: DescribeTaskSetsResponse.Builder
  ): DescribeTaskSetsResponseBuilderOps = new DescribeTaskSetsResponseBuilderOps(v)

  implicit def toDescribeTaskSetsResponseOps(v: DescribeTaskSetsResponse): DescribeTaskSetsResponseOps =
    new DescribeTaskSetsResponseOps(v)
