...
val underlying: JavaEcsAsyncClient
    ...
    override def createCapacityProvider(createCapacityProviderRequest: CreateCapacityProviderRequest): Future[CreateCapacityProviderResponse] =
    ...
    override def deleteAccountSetting(deleteAccountSettingRequest: DeleteAccountSettingRequest): Future[DeleteAccountSettingResponse] =
    ...
    override def deregisterContainerInstance(deregisterContainerInstanceRequest: DeregisterContainerInstanceRequest): Future[DeregisterContainerInstanceResponse] =
            underlying.deregisterContainerInstance(deregisterContainerInstanceRequest).toScala

    override def deregisterTaskDefinition(deregisterTaskDefinitionRequest: DeregisterTaskDefinitionRequest): Future[DeregisterTaskDefinitionResponse] =
            underlying.deregisterTaskDefinition(deregisterTaskDefinitionRequest).toScala

    override def describeCapacityProviders(describeCapacityProvidersRequest: DescribeCapacityProvidersRequest): Future[DescribeCapacityProvidersResponse] =
    ...
    override def describeContainerInstances(describeContainerInstancesRequest: DescribeContainerInstancesRequest): Future[DescribeContainerInstancesResponse] =
    ...
    override def describeTaskDefinition(describeTaskDefinitionRequest: DescribeTaskDefinitionRequest): Future[DescribeTaskDefinitionResponse] =
    ...
    override def discoverPollEndpoint(discoverPollEndpointRequest: DiscoverPollEndpointRequest): Future[DiscoverPollEndpointResponse] =
            underlying.discoverPollEndpoint(discoverPollEndpointRequest).toScala

    override def listAccountSettings(listAccountSettingsRequest: ListAccountSettingsRequest): Future[ListAccountSettingsResponse] =
    ...
    override def listAccountSettings(): Future[ListAccountSettingsResponse] =
     ...
     def listAccountSettingsPaginator(listAccountSettingsRequest: ListAccountSettingsRequest): ListAccountSettingsPublisher =
    ...
    override def listContainerInstances(listContainerInstancesRequest: ListContainerInstancesRequest): Future[ListContainerInstancesResponse] =
    ...
    override def listContainerInstances(): Future[ListContainerInstancesResponse] =
     ...
     def listContainerInstancesPaginator(listContainerInstancesRequest: ListContainerInstancesRequest): ListContainerInstancesPublisher =
    ...
    override def listTagsForResource(listTagsForResourceRequest: ListTagsForResourceRequest): Future[ListTagsForResourceResponse] =
            underlying.listTagsForResource(listTagsForResourceRequest).toScala

    override def listTaskDefinitionFamilies(listTaskDefinitionFamiliesRequest: ListTaskDefinitionFamiliesRequest): Future[ListTaskDefinitionFamiliesResponse] =
    ...
    override def listTaskDefinitionFamilies(): Future[ListTaskDefinitionFamiliesResponse] =
     ...
     def listTaskDefinitionFamiliesPaginator(listTaskDefinitionFamiliesRequest: ListTaskDefinitionFamiliesRequest): ListTaskDefinitionFamiliesPublisher =
        underlying.listTaskDefinitionFamiliesPaginator(listTaskDefinitionFamiliesRequest)

    override def listTaskDefinitions(listTaskDefinitionsRequest: ListTaskDefinitionsRequest): Future[ListTaskDefinitionsResponse] =
    ...
    override def listTaskDefinitions(): Future[ListTaskDefinitionsResponse] =
     ...
     def listTaskDefinitionsPaginator(listTaskDefinitionsRequest: ListTaskDefinitionsRequest): ListTaskDefinitionsPublisher =
    ...
    override def putAccountSetting(putAccountSettingRequest: PutAccountSettingRequest): Future[PutAccountSettingResponse] =
            underlying.putAccountSetting(putAccountSettingRequest).toScala

    override def putAccountSettingDefault(putAccountSettingDefaultRequest: PutAccountSettingDefaultRequest): Future[PutAccountSettingDefaultResponse] =
    ...
    override def putClusterCapacityProviders(putClusterCapacityProvidersRequest: PutClusterCapacityProvidersRequest): Future[PutClusterCapacityProvidersResponse] =
            underlying.putClusterCapacityProviders(putClusterCapacityProvidersRequest).toScala

    override def registerContainerInstance(registerContainerInstanceRequest: RegisterContainerInstanceRequest): Future[RegisterContainerInstanceResponse] =
            underlying.registerContainerInstance(registerContainerInstanceRequest).toScala

    override def registerTaskDefinition(registerTaskDefinitionRequest: RegisterTaskDefinitionRequest): Future[RegisterTaskDefinitionResponse] =
    ...
    override def submitAttachmentStateChanges(submitAttachmentStateChangesRequest: SubmitAttachmentStateChangesRequest): Future[SubmitAttachmentStateChangesResponse] =
            underlying.submitAttachmentStateChanges(submitAttachmentStateChangesRequest).toScala

    override def submitContainerStateChange(submitContainerStateChangeRequest: SubmitContainerStateChangeRequest): Future[SubmitContainerStateChangeResponse] =
            underlying.submitContainerStateChange(submitContainerStateChangeRequest).toScala

    override def submitTaskStateChange(submitTaskStateChangeRequest: SubmitTaskStateChangeRequest): Future[SubmitTaskStateChangeResponse] =
    ...
    override def updateClusterSettings(updateClusterSettingsRequest: UpdateClusterSettingsRequest): Future[UpdateClusterSettingsResponse] =
            underlying.updateClusterSettings(updateClusterSettingsRequest).toScala

    override def updateContainerAgent(updateContainerAgentRequest: UpdateContainerAgentRequest): Future[UpdateContainerAgentResponse] =
            underlying.updateContainerAgent(updateContainerAgentRequest).toScala

    override def updateContainerInstancesState(updateContainerInstancesStateRequest: UpdateContainerInstancesStateRequest): Future[UpdateContainerInstancesStateResponse] =
    ...
    override def updateServicePrimaryTaskSet(updateServicePrimaryTaskSetRequest: UpdateServicePrimaryTaskSetRequest): Future[UpdateServicePrimaryTaskSetResponse] =
