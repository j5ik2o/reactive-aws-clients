...
trait ToCreateTaskSetResponseOps {
  ...
  implicit def toCreateTaskSetResponseBuilderOps(v: CreateTaskSetResponse.Builder): CreateTaskSetResponseBuilderOps =
    new CreateTaskSetResponseBuilderOps(v)

  implicit def toCreateTaskSetResponseOps(v: CreateTaskSetResponse): CreateTaskSetResponseOps =
    new CreateTaskSetResponseOps(v)
