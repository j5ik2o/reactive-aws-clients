...
implicit def toDeleteClusterResponseBuilderOps(v: DeleteClusterResponse.Builder): DeleteClusterResponseBuilderOps = new DeleteClusterResponseBuilderOps(v)

implicit def toDeleteClusterResponseOps(v: DeleteClusterResponse): DeleteClusterResponseOps = new DeleteClusterResponseOps(v)
