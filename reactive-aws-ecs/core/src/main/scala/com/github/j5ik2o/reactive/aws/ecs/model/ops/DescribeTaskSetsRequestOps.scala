...
trait ToDescribeTaskSetsRequestOps {
  ...
  implicit def toDescribeTaskSetsRequestBuilderOps(
      v: DescribeTaskSetsRequest.Builder
  ): DescribeTaskSetsRequestBuilderOps = new DescribeTaskSetsRequestBuilderOps(v)

  implicit def toDescribeTaskSetsRequestOps(v: DescribeTaskSetsRequest): DescribeTaskSetsRequestOps =
    new DescribeTaskSetsRequestOps(v)
