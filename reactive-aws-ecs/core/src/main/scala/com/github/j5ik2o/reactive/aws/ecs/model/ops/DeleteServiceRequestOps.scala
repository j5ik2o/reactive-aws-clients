...
implicit def toDeleteServiceRequestBuilderOps(v: DeleteServiceRequest.Builder): DeleteServiceRequestBuilderOps = new DeleteServiceRequestBuilderOps(v)

implicit def toDeleteServiceRequestOps(v: DeleteServiceRequest): DeleteServiceRequestOps = new DeleteServiceRequestOps(v)
