...
implicit def toDeploymentControllerBuilderOps(v: DeploymentController.Builder): DeploymentControllerBuilderOps = new DeploymentControllerBuilderOps(v)

implicit def toDeploymentControllerOps(v: DeploymentController): DeploymentControllerOps = new DeploymentControllerOps(v)
