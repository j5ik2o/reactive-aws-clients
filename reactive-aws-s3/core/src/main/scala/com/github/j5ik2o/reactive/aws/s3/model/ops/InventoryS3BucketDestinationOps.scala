...
implicit def toInventoryS3BucketDestinationBuilderOps(v: InventoryS3BucketDestination.Builder): InventoryS3BucketDestinationBuilderOps = new InventoryS3BucketDestinationBuilderOps(v)

implicit def toInventoryS3BucketDestinationOps(v: InventoryS3BucketDestination): InventoryS3BucketDestinationOps = new InventoryS3BucketDestinationOps(v)
