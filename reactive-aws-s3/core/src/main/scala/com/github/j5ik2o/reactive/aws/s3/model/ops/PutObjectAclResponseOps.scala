...
implicit def toPutObjectAclResponseBuilderOps(v: PutObjectAclResponse.Builder): PutObjectAclResponseBuilderOps = new PutObjectAclResponseBuilderOps(v)

implicit def toPutObjectAclResponseOps(v: PutObjectAclResponse): PutObjectAclResponseOps = new PutObjectAclResponseOps(v)
