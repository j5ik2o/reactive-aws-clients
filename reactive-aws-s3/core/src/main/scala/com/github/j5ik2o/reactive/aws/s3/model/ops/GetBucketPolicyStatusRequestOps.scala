...
implicit def toGetBucketPolicyStatusRequestBuilderOps(v: GetBucketPolicyStatusRequest.Builder): GetBucketPolicyStatusRequestBuilderOps = new GetBucketPolicyStatusRequestBuilderOps(v)

implicit def toGetBucketPolicyStatusRequestOps(v: GetBucketPolicyStatusRequest): GetBucketPolicyStatusRequestOps = new GetBucketPolicyStatusRequestOps(v)
