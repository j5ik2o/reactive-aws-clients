...
implicit def toAccelerateConfigurationBuilderOps(v: AccelerateConfiguration.Builder): AccelerateConfigurationBuilderOps = new AccelerateConfigurationBuilderOps(v)

implicit def toAccelerateConfigurationOps(v: AccelerateConfiguration): AccelerateConfigurationOps = new AccelerateConfigurationOps(v)
