...
implicit def toPutBucketTaggingRequestBuilderOps(v: PutBucketTaggingRequest.Builder): PutBucketTaggingRequestBuilderOps = new PutBucketTaggingRequestBuilderOps(v)

implicit def toPutBucketTaggingRequestOps(v: PutBucketTaggingRequest): PutBucketTaggingRequestOps = new PutBucketTaggingRequestOps(v)
