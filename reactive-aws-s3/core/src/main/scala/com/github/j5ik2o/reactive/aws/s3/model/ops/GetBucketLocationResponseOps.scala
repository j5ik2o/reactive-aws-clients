...
final class GetBucketLocationResponseBuilderOps(val self: GetBucketLocationResponse.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.locationConstraint(v) }
            } 
...
implicit def toGetBucketLocationResponseBuilderOps(v: GetBucketLocationResponse.Builder): GetBucketLocationResponseBuilderOps = new GetBucketLocationResponseBuilderOps(v)

implicit def toGetBucketLocationResponseOps(v: GetBucketLocationResponse): GetBucketLocationResponseOps = new GetBucketLocationResponseOps(v)
