...
final class LifecycleRuleBuilderOps(val self: LifecycleRule.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def transitionsAsScala(value: Option[Seq[Transition]]): LifecycleRule.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.transitions(v.asJava) } 
            }

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def noncurrentVersionTransitionsAsScala(value: Option[Seq[NoncurrentVersionTransition]]): LifecycleRule.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.noncurrentVersionTransitions(v.asJava) } 
            }
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def abortIncompleteMultipartUploadAsScala(value: Option[AbortIncompleteMultipartUpload]): LifecycleRule.Builder = {
...
final class LifecycleRuleOps(val self: LifecycleRule) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def transitionsAsScala: Option[Seq[Transition]] = Option(self.transitions).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def noncurrentVersionTransitionsAsScala: Option[Seq[NoncurrentVersionTransition]] = Option(self.noncurrentVersionTransitions).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def noncurrentVersionExpirationAsScala: Option[NoncurrentVersionExpiration] = Option(self.noncurrentVersionExpiration) 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def abortIncompleteMultipartUploadAsScala: Option[AbortIncompleteMultipartUpload] = Option(self.abortIncompleteMultipartUpload) 
...
implicit def toLifecycleRuleBuilderOps(v: LifecycleRule.Builder): LifecycleRuleBuilderOps = new LifecycleRuleBuilderOps(v)
