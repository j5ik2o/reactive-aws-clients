...
final class ListObjectVersionsResponseBuilderOps(val self: ListObjectVersionsResponse.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.versionIdMarker(v) }
            } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.nextVersionIdMarker(v) }
            } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def deleteMarkersAsScala(value: Option[Seq[DeleteMarkerEntry]]): ListObjectVersionsResponse.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.deleteMarkers(v.asJava) } 
            }
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def commonPrefixesAsScala(value: Option[Seq[CommonPrefix]]): ListObjectVersionsResponse.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.commonPrefixes(v.asJava) } 
            }
...
final class ListObjectVersionsResponseOps(val self: ListObjectVersionsResponse) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def versionsAsScala: Option[Seq[ObjectVersion]] = Option(self.versions).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def deleteMarkersAsScala: Option[Seq[DeleteMarkerEntry]] = Option(self.deleteMarkers).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def commonPrefixesAsScala: Option[Seq[CommonPrefix]] = Option(self.commonPrefixes).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toListObjectVersionsResponseBuilderOps(v: ListObjectVersionsResponse.Builder): ListObjectVersionsResponseBuilderOps = new ListObjectVersionsResponseBuilderOps(v)

implicit def toListObjectVersionsResponseOps(v: ListObjectVersionsResponse): ListObjectVersionsResponseOps = new ListObjectVersionsResponseOps(v)
