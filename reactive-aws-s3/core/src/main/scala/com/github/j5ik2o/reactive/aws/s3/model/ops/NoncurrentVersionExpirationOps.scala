...
implicit def toNoncurrentVersionExpirationBuilderOps(v: NoncurrentVersionExpiration.Builder): NoncurrentVersionExpirationBuilderOps = new NoncurrentVersionExpirationBuilderOps(v)

implicit def toNoncurrentVersionExpirationOps(v: NoncurrentVersionExpiration): NoncurrentVersionExpirationOps = new NoncurrentVersionExpirationOps(v)
