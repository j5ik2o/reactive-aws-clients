...
val underlying: JavaS3AsyncClient
    ...
    override def abortMultipartUpload(abortMultipartUploadRequest: AbortMultipartUploadRequest): Future[AbortMultipartUploadResponse] =
            underlying.abortMultipartUpload(abortMultipartUploadRequest).toScala

    override def completeMultipartUpload(completeMultipartUploadRequest: CompleteMultipartUploadRequest): Future[CompleteMultipartUploadResponse] =
    ...
    override def createMultipartUpload(createMultipartUploadRequest: CreateMultipartUploadRequest): Future[CreateMultipartUploadResponse] =
    ...
    override def deleteBucketAnalyticsConfiguration(deleteBucketAnalyticsConfigurationRequest: DeleteBucketAnalyticsConfigurationRequest): Future[DeleteBucketAnalyticsConfigurationResponse] =
    ...
    override def deleteBucketEncryption(deleteBucketEncryptionRequest: DeleteBucketEncryptionRequest): Future[DeleteBucketEncryptionResponse] =
            underlying.deleteBucketEncryption(deleteBucketEncryptionRequest).toScala

    override def deleteBucketInventoryConfiguration(deleteBucketInventoryConfigurationRequest: DeleteBucketInventoryConfigurationRequest): Future[DeleteBucketInventoryConfigurationResponse] =
            underlying.deleteBucketInventoryConfiguration(deleteBucketInventoryConfigurationRequest).toScala

    override def deleteBucketLifecycle(deleteBucketLifecycleRequest: DeleteBucketLifecycleRequest): Future[DeleteBucketLifecycleResponse] =
            underlying.deleteBucketLifecycle(deleteBucketLifecycleRequest).toScala

    override def deleteBucketMetricsConfiguration(deleteBucketMetricsConfigurationRequest: DeleteBucketMetricsConfigurationRequest): Future[DeleteBucketMetricsConfigurationResponse] =
            underlying.deleteBucketMetricsConfiguration(deleteBucketMetricsConfigurationRequest).toScala

    override def deleteBucketPolicy(deleteBucketPolicyRequest: DeleteBucketPolicyRequest): Future[DeleteBucketPolicyResponse] =
            underlying.deleteBucketPolicy(deleteBucketPolicyRequest).toScala

    override def deleteBucketReplication(deleteBucketReplicationRequest: DeleteBucketReplicationRequest): Future[DeleteBucketReplicationResponse] =
            underlying.deleteBucketReplication(deleteBucketReplicationRequest).toScala

    override def deleteBucketTagging(deleteBucketTaggingRequest: DeleteBucketTaggingRequest): Future[DeleteBucketTaggingResponse] =
            underlying.deleteBucketTagging(deleteBucketTaggingRequest).toScala

    override def deleteBucketWebsite(deleteBucketWebsiteRequest: DeleteBucketWebsiteRequest): Future[DeleteBucketWebsiteResponse] =
    ...
    override def deleteObjectTagging(deleteObjectTaggingRequest: DeleteObjectTaggingRequest): Future[DeleteObjectTaggingResponse] =
    ...
    override def deletePublicAccessBlock(deletePublicAccessBlockRequest: DeletePublicAccessBlockRequest): Future[DeletePublicAccessBlockResponse] =
            underlying.deletePublicAccessBlock(deletePublicAccessBlockRequest).toScala

    override def getBucketAccelerateConfiguration(getBucketAccelerateConfigurationRequest: GetBucketAccelerateConfigurationRequest): Future[GetBucketAccelerateConfigurationResponse] =
    ...
    override def getBucketAnalyticsConfiguration(getBucketAnalyticsConfigurationRequest: GetBucketAnalyticsConfigurationRequest): Future[GetBucketAnalyticsConfigurationResponse] =
    ...
    override def getBucketEncryption(getBucketEncryptionRequest: GetBucketEncryptionRequest): Future[GetBucketEncryptionResponse] =
            underlying.getBucketEncryption(getBucketEncryptionRequest).toScala

    override def getBucketInventoryConfiguration(getBucketInventoryConfigurationRequest: GetBucketInventoryConfigurationRequest): Future[GetBucketInventoryConfigurationResponse] =
            underlying.getBucketInventoryConfiguration(getBucketInventoryConfigurationRequest).toScala

    override def getBucketLifecycleConfiguration(getBucketLifecycleConfigurationRequest: GetBucketLifecycleConfigurationRequest): Future[GetBucketLifecycleConfigurationResponse] =
            underlying.getBucketLifecycleConfiguration(getBucketLifecycleConfigurationRequest).toScala

    override def getBucketLocation(getBucketLocationRequest: GetBucketLocationRequest): Future[GetBucketLocationResponse] =
    ...
    override def getBucketMetricsConfiguration(getBucketMetricsConfigurationRequest: GetBucketMetricsConfigurationRequest): Future[GetBucketMetricsConfigurationResponse] =
            underlying.getBucketMetricsConfiguration(getBucketMetricsConfigurationRequest).toScala

    override def getBucketNotificationConfiguration(getBucketNotificationConfigurationRequest: GetBucketNotificationConfigurationRequest): Future[GetBucketNotificationConfigurationResponse] =
    ...
    override def getBucketPolicyStatus(getBucketPolicyStatusRequest: GetBucketPolicyStatusRequest): Future[GetBucketPolicyStatusResponse] =
            underlying.getBucketPolicyStatus(getBucketPolicyStatusRequest).toScala

    override def getBucketReplication(getBucketReplicationRequest: GetBucketReplicationRequest): Future[GetBucketReplicationResponse] =
            underlying.getBucketReplication(getBucketReplicationRequest).toScala

    override def getBucketRequestPayment(getBucketRequestPaymentRequest: GetBucketRequestPaymentRequest): Future[GetBucketRequestPaymentResponse] =
    ...
    override def getBucketVersioning(getBucketVersioningRequest: GetBucketVersioningRequest): Future[GetBucketVersioningResponse] =
    ...
    override def getObjectLegalHold(getObjectLegalHoldRequest: GetObjectLegalHoldRequest): Future[GetObjectLegalHoldResponse] =
            underlying.getObjectLegalHold(getObjectLegalHoldRequest).toScala

    override def getObjectLockConfiguration(getObjectLockConfigurationRequest: GetObjectLockConfigurationRequest): Future[GetObjectLockConfigurationResponse] =
            underlying.getObjectLockConfiguration(getObjectLockConfigurationRequest).toScala

    override def getObjectRetention(getObjectRetentionRequest: GetObjectRetentionRequest): Future[GetObjectRetentionResponse] =
    ...
    override def getPublicAccessBlock(getPublicAccessBlockRequest: GetPublicAccessBlockRequest): Future[GetPublicAccessBlockResponse] =
    ...
    override def listBucketAnalyticsConfigurations(listBucketAnalyticsConfigurationsRequest: ListBucketAnalyticsConfigurationsRequest): Future[ListBucketAnalyticsConfigurationsResponse] =
            underlying.listBucketAnalyticsConfigurations(listBucketAnalyticsConfigurationsRequest).toScala

    override def listBucketInventoryConfigurations(listBucketInventoryConfigurationsRequest: ListBucketInventoryConfigurationsRequest): Future[ListBucketInventoryConfigurationsResponse] =
            underlying.listBucketInventoryConfigurations(listBucketInventoryConfigurationsRequest).toScala

    override def listBucketMetricsConfigurations(listBucketMetricsConfigurationsRequest: ListBucketMetricsConfigurationsRequest): Future[ListBucketMetricsConfigurationsResponse] =
    ...
    override def listMultipartUploads(listMultipartUploadsRequest: ListMultipartUploadsRequest): Future[ListMultipartUploadsResponse] =
            underlying.listMultipartUploads(listMultipartUploadsRequest).toScala

     def listMultipartUploadsPaginator(listMultipartUploadsRequest: ListMultipartUploadsRequest): ListMultipartUploadsPublisher =
        underlying.listMultipartUploadsPaginator(listMultipartUploadsRequest)

    override def listObjectVersions(listObjectVersionsRequest: ListObjectVersionsRequest): Future[ListObjectVersionsResponse] =
    ...
    override def putBucketAccelerateConfiguration(putBucketAccelerateConfigurationRequest: PutBucketAccelerateConfigurationRequest): Future[PutBucketAccelerateConfigurationResponse] =
    ...
    override def putBucketAnalyticsConfiguration(putBucketAnalyticsConfigurationRequest: PutBucketAnalyticsConfigurationRequest): Future[PutBucketAnalyticsConfigurationResponse] =
    ...
    override def putBucketEncryption(putBucketEncryptionRequest: PutBucketEncryptionRequest): Future[PutBucketEncryptionResponse] =
            underlying.putBucketEncryption(putBucketEncryptionRequest).toScala

    override def putBucketInventoryConfiguration(putBucketInventoryConfigurationRequest: PutBucketInventoryConfigurationRequest): Future[PutBucketInventoryConfigurationResponse] =
            underlying.putBucketInventoryConfiguration(putBucketInventoryConfigurationRequest).toScala

    override def putBucketLifecycleConfiguration(putBucketLifecycleConfigurationRequest: PutBucketLifecycleConfigurationRequest): Future[PutBucketLifecycleConfigurationResponse] =
    ...
    override def putBucketMetricsConfiguration(putBucketMetricsConfigurationRequest: PutBucketMetricsConfigurationRequest): Future[PutBucketMetricsConfigurationResponse] =
            underlying.putBucketMetricsConfiguration(putBucketMetricsConfigurationRequest).toScala

    override def putBucketNotificationConfiguration(putBucketNotificationConfigurationRequest: PutBucketNotificationConfigurationRequest): Future[PutBucketNotificationConfigurationResponse] =
    ...
    override def putBucketReplication(putBucketReplicationRequest: PutBucketReplicationRequest): Future[PutBucketReplicationResponse] =
            underlying.putBucketReplication(putBucketReplicationRequest).toScala

    override def putBucketRequestPayment(putBucketRequestPaymentRequest: PutBucketRequestPaymentRequest): Future[PutBucketRequestPaymentResponse] =
    ...
    override def putBucketVersioning(putBucketVersioningRequest: PutBucketVersioningRequest): Future[PutBucketVersioningResponse] =
    ...
    override def putObjectLegalHold(putObjectLegalHoldRequest: PutObjectLegalHoldRequest): Future[PutObjectLegalHoldResponse] =
            underlying.putObjectLegalHold(putObjectLegalHoldRequest).toScala

    override def putObjectLockConfiguration(putObjectLockConfigurationRequest: PutObjectLockConfigurationRequest): Future[PutObjectLockConfigurationResponse] =
            underlying.putObjectLockConfiguration(putObjectLockConfigurationRequest).toScala

    override def putObjectRetention(putObjectRetentionRequest: PutObjectRetentionRequest): Future[PutObjectRetentionResponse] =
    ...
    override def putPublicAccessBlock(putPublicAccessBlockRequest: PutPublicAccessBlockRequest): Future[PutPublicAccessBlockResponse] =
