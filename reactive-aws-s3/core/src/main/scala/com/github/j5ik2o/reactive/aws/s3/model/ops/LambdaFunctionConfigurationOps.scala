...
implicit def toLambdaFunctionConfigurationBuilderOps(v: LambdaFunctionConfiguration.Builder): LambdaFunctionConfigurationBuilderOps = new LambdaFunctionConfigurationBuilderOps(v)

implicit def toLambdaFunctionConfigurationOps(v: LambdaFunctionConfiguration): LambdaFunctionConfigurationOps = new LambdaFunctionConfigurationOps(v)
