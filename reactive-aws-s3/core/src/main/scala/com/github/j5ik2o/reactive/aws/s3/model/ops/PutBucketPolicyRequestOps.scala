...
final class PutBucketPolicyRequestBuilderOps(val self: PutBucketPolicyRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.confirmRemoveSelfBucketAccess(v) }
            } 
...
implicit def toPutBucketPolicyRequestBuilderOps(v: PutBucketPolicyRequest.Builder): PutBucketPolicyRequestBuilderOps = new PutBucketPolicyRequestBuilderOps(v)

implicit def toPutBucketPolicyRequestOps(v: PutBucketPolicyRequest): PutBucketPolicyRequestOps = new PutBucketPolicyRequestOps(v)
