...
final class LoggingEnabledOps(val self: LoggingEnabled) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def targetGrantsAsScala: Option[Seq[TargetGrant]] =
    Option(self.targetGrants).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
