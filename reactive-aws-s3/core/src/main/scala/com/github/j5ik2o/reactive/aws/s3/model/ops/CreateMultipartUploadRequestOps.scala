...
final class CreateMultipartUploadRequestBuilderOps(val self: CreateMultipartUploadRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def objectLockLegalHoldStatusAsScala(value: Option[ObjectLockLegalHoldStatus]): CreateMultipartUploadRequest.Builder = {
...
implicit def toCreateMultipartUploadRequestBuilderOps(v: CreateMultipartUploadRequest.Builder): CreateMultipartUploadRequestBuilderOps = new CreateMultipartUploadRequestBuilderOps(v)

implicit def toCreateMultipartUploadRequestOps(v: CreateMultipartUploadRequest): CreateMultipartUploadRequestOps = new CreateMultipartUploadRequestOps(v)
