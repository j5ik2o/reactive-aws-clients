...
implicit def toDeleteBucketTaggingRequestBuilderOps(v: DeleteBucketTaggingRequest.Builder): DeleteBucketTaggingRequestBuilderOps = new DeleteBucketTaggingRequestBuilderOps(v)

implicit def toDeleteBucketTaggingRequestOps(v: DeleteBucketTaggingRequest): DeleteBucketTaggingRequestOps = new DeleteBucketTaggingRequestOps(v)
