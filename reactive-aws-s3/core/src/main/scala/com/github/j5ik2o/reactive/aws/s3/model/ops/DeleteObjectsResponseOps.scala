...
final class DeleteObjectsResponseBuilderOps(val self: DeleteObjectsResponse.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def deletedAsScala(value: Option[Seq[DeletedObject]]): DeleteObjectsResponse.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.deleted(v.asJava) } 
            }
...
final class DeleteObjectsResponseOps(val self: DeleteObjectsResponse) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def deletedAsScala: Option[Seq[DeletedObject]] = Option(self.deleted).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def requestChargedAsScala: Option[RequestCharged] = Option(self.requestCharged) 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def errorsAsScala: Option[Seq[S3Error]] = Option(self.errors).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toDeleteObjectsResponseBuilderOps(v: DeleteObjectsResponse.Builder): DeleteObjectsResponseBuilderOps = new DeleteObjectsResponseBuilderOps(v)

implicit def toDeleteObjectsResponseOps(v: DeleteObjectsResponse): DeleteObjectsResponseOps = new DeleteObjectsResponseOps(v)
