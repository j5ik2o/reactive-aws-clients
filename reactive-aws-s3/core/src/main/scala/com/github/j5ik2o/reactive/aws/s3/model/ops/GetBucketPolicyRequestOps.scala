...
implicit def toGetBucketPolicyRequestBuilderOps(v: GetBucketPolicyRequest.Builder): GetBucketPolicyRequestBuilderOps = new GetBucketPolicyRequestBuilderOps(v)

implicit def toGetBucketPolicyRequestOps(v: GetBucketPolicyRequest): GetBucketPolicyRequestOps = new GetBucketPolicyRequestOps(v)
