...
implicit def toDeleteBucketWebsiteRequestBuilderOps(v: DeleteBucketWebsiteRequest.Builder): DeleteBucketWebsiteRequestBuilderOps = new DeleteBucketWebsiteRequestBuilderOps(v)

implicit def toDeleteBucketWebsiteRequestOps(v: DeleteBucketWebsiteRequest): DeleteBucketWebsiteRequestOps = new DeleteBucketWebsiteRequestOps(v)
