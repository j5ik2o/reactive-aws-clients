...
final class CopyObjectRequestBuilderOps(val self: CopyObjectRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.destinationBucket(v) }
            } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.destinationKey(v) }
            } 
...
implicit def toCopyObjectRequestBuilderOps(v: CopyObjectRequest.Builder): CopyObjectRequestBuilderOps = new CopyObjectRequestBuilderOps(v)
