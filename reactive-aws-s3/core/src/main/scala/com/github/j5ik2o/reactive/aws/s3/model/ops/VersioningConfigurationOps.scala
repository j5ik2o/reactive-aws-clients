...
implicit def toVersioningConfigurationBuilderOps(v: VersioningConfiguration.Builder): VersioningConfigurationBuilderOps = new VersioningConfigurationBuilderOps(v)

implicit def toVersioningConfigurationOps(v: VersioningConfiguration): VersioningConfigurationOps = new VersioningConfigurationOps(v)
