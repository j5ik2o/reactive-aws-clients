...
implicit def toDeleteBucketLifecycleRequestBuilderOps(v: DeleteBucketLifecycleRequest.Builder): DeleteBucketLifecycleRequestBuilderOps = new DeleteBucketLifecycleRequestBuilderOps(v)

implicit def toDeleteBucketLifecycleRequestOps(v: DeleteBucketLifecycleRequest): DeleteBucketLifecycleRequestOps = new DeleteBucketLifecycleRequestOps(v)
