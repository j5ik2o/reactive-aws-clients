...
implicit def toPublicAccessBlockConfigurationBuilderOps(v: PublicAccessBlockConfiguration.Builder): PublicAccessBlockConfigurationBuilderOps = new PublicAccessBlockConfigurationBuilderOps(v)

implicit def toPublicAccessBlockConfigurationOps(v: PublicAccessBlockConfiguration): PublicAccessBlockConfigurationOps = new PublicAccessBlockConfigurationOps(v)
