...
trait ToGetObjectTorrentResponseOps {
  ...
  implicit def toGetObjectTorrentResponseBuilderOps(
      v: GetObjectTorrentResponse.Builder
  ): GetObjectTorrentResponseBuilderOps = new GetObjectTorrentResponseBuilderOps(v)

  implicit def toGetObjectTorrentResponseOps(v: GetObjectTorrentResponse): GetObjectTorrentResponseOps =
    new GetObjectTorrentResponseOps(v)
