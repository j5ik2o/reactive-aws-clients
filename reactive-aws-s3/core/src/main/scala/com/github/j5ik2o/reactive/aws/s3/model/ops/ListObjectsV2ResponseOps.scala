...
final class ListObjectsV2ResponseBuilderOps(val self: ListObjectsV2Response.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def contentsAsScala(value: Option[Seq[S3Object]]): ListObjectsV2Response.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.contents(v.asJava) } 
            }
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.keyCount(v) }
            } 
...
final class ListObjectsV2ResponseOps(val self: ListObjectsV2Response) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def contentsAsScala: Option[Seq[S3Object]] = Option(self.contents).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toListObjectsV2ResponseBuilderOps(v: ListObjectsV2Response.Builder): ListObjectsV2ResponseBuilderOps = new ListObjectsV2ResponseBuilderOps(v)

implicit def toListObjectsV2ResponseOps(v: ListObjectsV2Response): ListObjectsV2ResponseOps = new ListObjectsV2ResponseOps(v)
