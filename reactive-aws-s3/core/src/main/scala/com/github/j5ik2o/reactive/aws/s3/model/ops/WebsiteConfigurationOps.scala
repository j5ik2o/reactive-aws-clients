...
implicit def toWebsiteConfigurationBuilderOps(v: WebsiteConfiguration.Builder): WebsiteConfigurationBuilderOps = new WebsiteConfigurationBuilderOps(v)

implicit def toWebsiteConfigurationOps(v: WebsiteConfiguration): WebsiteConfigurationOps = new WebsiteConfigurationOps(v)
