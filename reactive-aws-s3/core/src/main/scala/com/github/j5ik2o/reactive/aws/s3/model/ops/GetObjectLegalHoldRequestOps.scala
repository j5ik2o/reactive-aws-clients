...
implicit def toGetObjectLegalHoldRequestBuilderOps(v: GetObjectLegalHoldRequest.Builder): GetObjectLegalHoldRequestBuilderOps = new GetObjectLegalHoldRequestBuilderOps(v)

implicit def toGetObjectLegalHoldRequestOps(v: GetObjectLegalHoldRequest): GetObjectLegalHoldRequestOps = new GetObjectLegalHoldRequestOps(v)
