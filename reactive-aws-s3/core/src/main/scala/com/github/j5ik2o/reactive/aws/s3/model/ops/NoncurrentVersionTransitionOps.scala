...
implicit def toNoncurrentVersionTransitionBuilderOps(v: NoncurrentVersionTransition.Builder): NoncurrentVersionTransitionBuilderOps = new NoncurrentVersionTransitionBuilderOps(v)

implicit def toNoncurrentVersionTransitionOps(v: NoncurrentVersionTransition): NoncurrentVersionTransitionOps = new NoncurrentVersionTransitionOps(v)
