...
implicit def toGlacierJobParametersBuilderOps(v: GlacierJobParameters.Builder): GlacierJobParametersBuilderOps = new GlacierJobParametersBuilderOps(v)

implicit def toGlacierJobParametersOps(v: GlacierJobParameters): GlacierJobParametersOps = new GlacierJobParametersOps(v)
