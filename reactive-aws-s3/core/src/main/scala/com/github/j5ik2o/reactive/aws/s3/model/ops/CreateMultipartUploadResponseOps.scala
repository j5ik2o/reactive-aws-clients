...
implicit def toCreateMultipartUploadResponseBuilderOps(v: CreateMultipartUploadResponse.Builder): CreateMultipartUploadResponseBuilderOps = new CreateMultipartUploadResponseBuilderOps(v)

implicit def toCreateMultipartUploadResponseOps(v: CreateMultipartUploadResponse): CreateMultipartUploadResponseOps = new CreateMultipartUploadResponseOps(v)
