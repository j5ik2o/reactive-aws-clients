...
implicit def toAbortMultipartUploadResponseBuilderOps(v: AbortMultipartUploadResponse.Builder): AbortMultipartUploadResponseBuilderOps = new AbortMultipartUploadResponseBuilderOps(v)

implicit def toAbortMultipartUploadResponseOps(v: AbortMultipartUploadResponse): AbortMultipartUploadResponseOps = new AbortMultipartUploadResponseOps(v)
