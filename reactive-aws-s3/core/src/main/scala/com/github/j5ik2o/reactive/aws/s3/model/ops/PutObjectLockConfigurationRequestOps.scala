...
final class PutObjectLockConfigurationRequestBuilderOps(val self: PutObjectLockConfigurationRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def objectLockConfigurationAsScala(value: Option[ObjectLockConfiguration]): PutObjectLockConfigurationRequest.Builder = {
            value.fold(self){ v => self.objectLockConfiguration(v) }
            } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.token(v) }
            } 
...
implicit def toPutObjectLockConfigurationRequestBuilderOps(v: PutObjectLockConfigurationRequest.Builder): PutObjectLockConfigurationRequestBuilderOps = new PutObjectLockConfigurationRequestBuilderOps(v)

implicit def toPutObjectLockConfigurationRequestOps(v: PutObjectLockConfigurationRequest): PutObjectLockConfigurationRequestOps = new PutObjectLockConfigurationRequestOps(v)
