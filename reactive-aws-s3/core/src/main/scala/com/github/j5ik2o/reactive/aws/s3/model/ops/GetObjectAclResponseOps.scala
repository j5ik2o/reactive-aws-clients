...
final class GetObjectAclResponseBuilderOps(val self: GetObjectAclResponse.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def grantsAsScala(value: Option[Seq[Grant]]): GetObjectAclResponse.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.grants(v.asJava) } 
            }
...
final class GetObjectAclResponseOps(val self: GetObjectAclResponse) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def grantsAsScala: Option[Seq[Grant]] = Option(self.grants).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toGetObjectAclResponseBuilderOps(v: GetObjectAclResponse.Builder): GetObjectAclResponseBuilderOps = new GetObjectAclResponseBuilderOps(v)

implicit def toGetObjectAclResponseOps(v: GetObjectAclResponse): GetObjectAclResponseOps = new GetObjectAclResponseOps(v)
