...
final class AnalyticsConfigurationBuilderOps(val self: AnalyticsConfiguration.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.storageClassAnalysis(v) }
            } 
...
implicit def toAnalyticsConfigurationBuilderOps(v: AnalyticsConfiguration.Builder): AnalyticsConfigurationBuilderOps = new AnalyticsConfigurationBuilderOps(v)

implicit def toAnalyticsConfigurationOps(v: AnalyticsConfiguration): AnalyticsConfigurationOps = new AnalyticsConfigurationOps(v)
