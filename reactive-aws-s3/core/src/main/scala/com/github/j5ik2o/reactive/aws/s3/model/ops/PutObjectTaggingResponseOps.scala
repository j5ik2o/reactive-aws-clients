...
implicit def toPutObjectTaggingResponseBuilderOps(v: PutObjectTaggingResponse.Builder): PutObjectTaggingResponseBuilderOps = new PutObjectTaggingResponseBuilderOps(v)

implicit def toPutObjectTaggingResponseOps(v: PutObjectTaggingResponse): PutObjectTaggingResponseOps = new PutObjectTaggingResponseOps(v)
