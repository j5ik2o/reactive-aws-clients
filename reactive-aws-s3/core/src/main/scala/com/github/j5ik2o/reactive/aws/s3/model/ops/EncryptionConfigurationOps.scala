...
implicit def toEncryptionConfigurationBuilderOps(v: EncryptionConfiguration.Builder): EncryptionConfigurationBuilderOps = new EncryptionConfigurationBuilderOps(v)

implicit def toEncryptionConfigurationOps(v: EncryptionConfiguration): EncryptionConfigurationOps = new EncryptionConfigurationOps(v)
