...
implicit def toCreateBucketConfigurationBuilderOps(v: CreateBucketConfiguration.Builder): CreateBucketConfigurationBuilderOps = new CreateBucketConfigurationBuilderOps(v)

implicit def toCreateBucketConfigurationOps(v: CreateBucketConfiguration): CreateBucketConfigurationOps = new CreateBucketConfigurationOps(v)
