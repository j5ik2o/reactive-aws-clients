...
implicit def toInventoryDestinationBuilderOps(v: InventoryDestination.Builder): InventoryDestinationBuilderOps = new InventoryDestinationBuilderOps(v)

implicit def toInventoryDestinationOps(v: InventoryDestination): InventoryDestinationOps = new InventoryDestinationOps(v)
