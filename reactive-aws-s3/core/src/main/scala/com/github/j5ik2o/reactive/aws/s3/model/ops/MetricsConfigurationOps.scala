...
implicit def toMetricsConfigurationBuilderOps(v: MetricsConfiguration.Builder): MetricsConfigurationBuilderOps = new MetricsConfigurationBuilderOps(v)

implicit def toMetricsConfigurationOps(v: MetricsConfiguration): MetricsConfigurationOps = new MetricsConfigurationOps(v)
