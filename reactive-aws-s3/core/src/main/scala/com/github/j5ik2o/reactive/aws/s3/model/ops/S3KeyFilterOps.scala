...
final class S3KeyFilterBuilderOps(val self: S3KeyFilter.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def filterRulesAsScala(value: Option[Seq[FilterRule]]): S3KeyFilter.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.filterRules(v.asJava) } 
            }
...
final class S3KeyFilterOps(val self: S3KeyFilter) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def filterRulesAsScala: Option[Seq[FilterRule]] = Option(self.filterRules).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
