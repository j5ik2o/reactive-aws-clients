...
implicit def toPutObjectTaggingRequestBuilderOps(v: PutObjectTaggingRequest.Builder): PutObjectTaggingRequestBuilderOps = new PutObjectTaggingRequestBuilderOps(v)

implicit def toPutObjectTaggingRequestOps(v: PutObjectTaggingRequest): PutObjectTaggingRequestOps = new PutObjectTaggingRequestOps(v)
