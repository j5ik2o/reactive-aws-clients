...
implicit def toGetObjectTorrentRequestBuilderOps(v: GetObjectTorrentRequest.Builder): GetObjectTorrentRequestBuilderOps = new GetObjectTorrentRequestBuilderOps(v)

implicit def toGetObjectTorrentRequestOps(v: GetObjectTorrentRequest): GetObjectTorrentRequestOps = new GetObjectTorrentRequestOps(v)
