...
implicit def toUploadPartCopyRequestBuilderOps(v: UploadPartCopyRequest.Builder): UploadPartCopyRequestBuilderOps = new UploadPartCopyRequestBuilderOps(v)

implicit def toUploadPartCopyRequestOps(v: UploadPartCopyRequest): UploadPartCopyRequestOps = new UploadPartCopyRequestOps(v)
