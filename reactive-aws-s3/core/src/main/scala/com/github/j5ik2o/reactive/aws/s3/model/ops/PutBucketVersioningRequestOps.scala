...
final class PutBucketVersioningRequestBuilderOps(val self: PutBucketVersioningRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def versioningConfigurationAsScala(value: Option[VersioningConfiguration]): PutBucketVersioningRequest.Builder = {
...
implicit def toPutBucketVersioningRequestBuilderOps(v: PutBucketVersioningRequest.Builder): PutBucketVersioningRequestBuilderOps = new PutBucketVersioningRequestBuilderOps(v)

implicit def toPutBucketVersioningRequestOps(v: PutBucketVersioningRequest): PutBucketVersioningRequestOps = new PutBucketVersioningRequestOps(v)
