...
implicit def toDeleteObjectTaggingRequestBuilderOps(v: DeleteObjectTaggingRequest.Builder): DeleteObjectTaggingRequestBuilderOps = new DeleteObjectTaggingRequestBuilderOps(v)

implicit def toDeleteObjectTaggingRequestOps(v: DeleteObjectTaggingRequest): DeleteObjectTaggingRequestOps = new DeleteObjectTaggingRequestOps(v)
