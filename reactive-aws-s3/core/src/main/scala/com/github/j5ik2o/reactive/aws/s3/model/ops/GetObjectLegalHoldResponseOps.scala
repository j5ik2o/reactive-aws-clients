...
implicit def toGetObjectLegalHoldResponseBuilderOps(v: GetObjectLegalHoldResponse.Builder): GetObjectLegalHoldResponseBuilderOps = new GetObjectLegalHoldResponseBuilderOps(v)

implicit def toGetObjectLegalHoldResponseOps(v: GetObjectLegalHoldResponse): GetObjectLegalHoldResponseOps = new GetObjectLegalHoldResponseOps(v)
