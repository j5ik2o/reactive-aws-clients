...
implicit def toServerSideEncryptionByDefaultBuilderOps(v: ServerSideEncryptionByDefault.Builder): ServerSideEncryptionByDefaultBuilderOps = new ServerSideEncryptionByDefaultBuilderOps(v)

implicit def toServerSideEncryptionByDefaultOps(v: ServerSideEncryptionByDefault): ServerSideEncryptionByDefaultOps = new ServerSideEncryptionByDefaultOps(v)
