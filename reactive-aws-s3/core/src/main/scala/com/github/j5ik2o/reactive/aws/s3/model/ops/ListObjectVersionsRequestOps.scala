...
implicit def toListObjectVersionsRequestBuilderOps(v: ListObjectVersionsRequest.Builder): ListObjectVersionsRequestBuilderOps = new ListObjectVersionsRequestBuilderOps(v)

implicit def toListObjectVersionsRequestOps(v: ListObjectVersionsRequest): ListObjectVersionsRequestOps = new ListObjectVersionsRequestOps(v)
