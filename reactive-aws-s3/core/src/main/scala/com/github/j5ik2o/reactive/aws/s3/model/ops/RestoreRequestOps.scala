...
final class RestoreRequestBuilderOps(val self: RestoreRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.glacierJobParameters(v) }
            } 
...
implicit def toRestoreRequestBuilderOps(v: RestoreRequest.Builder): RestoreRequestBuilderOps = new RestoreRequestBuilderOps(v)
