...
final class DeleteOps(val self: Delete) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def objectsAsScala: Option[Seq[ObjectIdentifier]] =
    Option(self.objects).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
