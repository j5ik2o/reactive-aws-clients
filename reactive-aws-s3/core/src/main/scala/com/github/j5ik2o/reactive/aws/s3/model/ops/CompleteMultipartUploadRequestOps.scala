...
final class CompleteMultipartUploadRequestBuilderOps(val self: CompleteMultipartUploadRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.multipartUpload(v) }
            } 
...
implicit def toCompleteMultipartUploadRequestBuilderOps(v: CompleteMultipartUploadRequest.Builder): CompleteMultipartUploadRequestBuilderOps = new CompleteMultipartUploadRequestBuilderOps(v)

implicit def toCompleteMultipartUploadRequestOps(v: CompleteMultipartUploadRequest): CompleteMultipartUploadRequestOps = new CompleteMultipartUploadRequestOps(v)
