...
implicit def toDeleteBucketCorsRequestBuilderOps(v: DeleteBucketCorsRequest.Builder): DeleteBucketCorsRequestBuilderOps = new DeleteBucketCorsRequestBuilderOps(v)

implicit def toDeleteBucketCorsRequestOps(v: DeleteBucketCorsRequest): DeleteBucketCorsRequestOps = new DeleteBucketCorsRequestOps(v)
