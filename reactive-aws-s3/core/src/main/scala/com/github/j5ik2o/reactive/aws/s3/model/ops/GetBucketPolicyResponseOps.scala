...
implicit def toGetBucketPolicyResponseBuilderOps(v: GetBucketPolicyResponse.Builder): GetBucketPolicyResponseBuilderOps = new GetBucketPolicyResponseBuilderOps(v)

implicit def toGetBucketPolicyResponseOps(v: GetBucketPolicyResponse): GetBucketPolicyResponseOps = new GetBucketPolicyResponseOps(v)
