...
implicit def toPutObjectRetentionResponseBuilderOps(v: PutObjectRetentionResponse.Builder): PutObjectRetentionResponseBuilderOps = new PutObjectRetentionResponseBuilderOps(v)

implicit def toPutObjectRetentionResponseOps(v: PutObjectRetentionResponse): PutObjectRetentionResponseOps = new PutObjectRetentionResponseOps(v)
