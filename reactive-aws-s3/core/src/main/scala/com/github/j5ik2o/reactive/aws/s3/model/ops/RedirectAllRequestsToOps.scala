...
implicit def toRedirectAllRequestsToBuilderOps(v: RedirectAllRequestsTo.Builder): RedirectAllRequestsToBuilderOps = new RedirectAllRequestsToBuilderOps(v)

implicit def toRedirectAllRequestsToOps(v: RedirectAllRequestsTo): RedirectAllRequestsToOps = new RedirectAllRequestsToOps(v)
