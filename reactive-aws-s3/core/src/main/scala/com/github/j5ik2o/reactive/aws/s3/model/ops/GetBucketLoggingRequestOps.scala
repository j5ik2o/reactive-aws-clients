...
implicit def toGetBucketLoggingRequestBuilderOps(v: GetBucketLoggingRequest.Builder): GetBucketLoggingRequestBuilderOps = new GetBucketLoggingRequestBuilderOps(v)

implicit def toGetBucketLoggingRequestOps(v: GetBucketLoggingRequest): GetBucketLoggingRequestOps = new GetBucketLoggingRequestOps(v)
