...
final class S3LocationOps(val self: S3Location) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def accessControlListAsScala: Option[Seq[Grant]] =
    Option(self.accessControlList).map { v =>
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def userMetadataAsScala: Option[Seq[MetadataEntry]] =
    Option(self.userMetadata).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
