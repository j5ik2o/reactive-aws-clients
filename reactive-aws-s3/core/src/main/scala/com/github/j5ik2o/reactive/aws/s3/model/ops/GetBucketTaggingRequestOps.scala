...
implicit def toGetBucketTaggingRequestBuilderOps(v: GetBucketTaggingRequest.Builder): GetBucketTaggingRequestBuilderOps = new GetBucketTaggingRequestBuilderOps(v)

implicit def toGetBucketTaggingRequestOps(v: GetBucketTaggingRequest): GetBucketTaggingRequestOps = new GetBucketTaggingRequestOps(v)
