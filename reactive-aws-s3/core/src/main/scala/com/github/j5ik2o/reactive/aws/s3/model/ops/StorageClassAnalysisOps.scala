...
implicit def toStorageClassAnalysisBuilderOps(v: StorageClassAnalysis.Builder): StorageClassAnalysisBuilderOps = new StorageClassAnalysisBuilderOps(v)

implicit def toStorageClassAnalysisOps(v: StorageClassAnalysis): StorageClassAnalysisOps = new StorageClassAnalysisOps(v)
