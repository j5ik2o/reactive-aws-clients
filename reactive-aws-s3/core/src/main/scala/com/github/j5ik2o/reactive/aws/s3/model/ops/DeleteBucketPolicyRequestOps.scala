...
implicit def toDeleteBucketPolicyRequestBuilderOps(v: DeleteBucketPolicyRequest.Builder): DeleteBucketPolicyRequestBuilderOps = new DeleteBucketPolicyRequestBuilderOps(v)

implicit def toDeleteBucketPolicyRequestOps(v: DeleteBucketPolicyRequest): DeleteBucketPolicyRequestOps = new DeleteBucketPolicyRequestOps(v)
