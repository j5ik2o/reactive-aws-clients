...
implicit def toGetBucketReplicationRequestBuilderOps(v: GetBucketReplicationRequest.Builder): GetBucketReplicationRequestBuilderOps = new GetBucketReplicationRequestBuilderOps(v)

implicit def toGetBucketReplicationRequestOps(v: GetBucketReplicationRequest): GetBucketReplicationRequestOps = new GetBucketReplicationRequestOps(v)
