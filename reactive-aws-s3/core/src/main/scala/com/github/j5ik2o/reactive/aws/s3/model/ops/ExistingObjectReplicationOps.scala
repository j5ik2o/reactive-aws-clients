...
implicit def toExistingObjectReplicationBuilderOps(v: ExistingObjectReplication.Builder): ExistingObjectReplicationBuilderOps = new ExistingObjectReplicationBuilderOps(v)

implicit def toExistingObjectReplicationOps(v: ExistingObjectReplication): ExistingObjectReplicationOps = new ExistingObjectReplicationOps(v)
