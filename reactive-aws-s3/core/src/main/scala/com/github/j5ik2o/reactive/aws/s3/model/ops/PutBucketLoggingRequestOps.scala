...
final class PutBucketLoggingRequestBuilderOps(val self: PutBucketLoggingRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.bucketLoggingStatus(v) }
            } 
...
implicit def toPutBucketLoggingRequestBuilderOps(v: PutBucketLoggingRequest.Builder): PutBucketLoggingRequestBuilderOps = new PutBucketLoggingRequestBuilderOps(v)

implicit def toPutBucketLoggingRequestOps(v: PutBucketLoggingRequest): PutBucketLoggingRequestOps = new PutBucketLoggingRequestOps(v)
