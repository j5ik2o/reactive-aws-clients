...
implicit def toGetObjectRetentionRequestBuilderOps(v: GetObjectRetentionRequest.Builder): GetObjectRetentionRequestBuilderOps = new GetObjectRetentionRequestBuilderOps(v)

implicit def toGetObjectRetentionRequestOps(v: GetObjectRetentionRequest): GetObjectRetentionRequestOps = new GetObjectRetentionRequestOps(v)
