...
object S3CatsIOClient {
  ...
  def apply(asyncClient: S3AsyncClient)(implicit ec: ExecutionContext): S3CatsIOClient =
    new S3CatsIOClient {
...
trait S3CatsIOClient extends S3Client[IO] with S3CatsIOClientSupoprt {
  ...
  override def copyObject(copyObjectRequest: CopyObjectRequest): IO[CopyObjectResponse] =
    IO.fromFuture {
      IO(underlying.copyObject(copyObjectRequest))
    }

  override def createBucket(createBucketRequest: CreateBucketRequest): IO[CreateBucketResponse] =
    IO.fromFuture {
  ...
  override def deleteBucket(deleteBucketRequest: DeleteBucketRequest): IO[DeleteBucketResponse] =
    IO.fromFuture {
  ...
  override def deleteObject(deleteObjectRequest: DeleteObjectRequest): IO[DeleteObjectResponse] =
    IO.fromFuture {
  ...
  override def deleteObjects(deleteObjectsRequest: DeleteObjectsRequest): IO[DeleteObjectsResponse] =
    IO.fromFuture {
  ...
  override def getBucketAcl(getBucketAclRequest: GetBucketAclRequest): IO[GetBucketAclResponse] =
    IO.fromFuture {
  ...
  override def getBucketCors(getBucketCorsRequest: GetBucketCorsRequest): IO[GetBucketCorsResponse] =
    IO.fromFuture {
  ...
  override def getObjectAcl(getObjectAclRequest: GetObjectAclRequest): IO[GetObjectAclResponse] =
    IO.fromFuture {
  ...
  override def headBucket(headBucketRequest: HeadBucketRequest): IO[HeadBucketResponse] =
    IO.fromFuture {
  ...
  override def listBuckets(listBucketsRequest: ListBucketsRequest): IO[ListBucketsResponse] =
    IO.fromFuture {
  ...
  override def listObjects(listObjectsRequest: ListObjectsRequest): IO[ListObjectsResponse] =
    IO.fromFuture {
  ...
  override def listParts(listPartsRequest: ListPartsRequest): IO[ListPartsResponse] =
    IO.fromFuture {
  ...
  override def putBucketAcl(putBucketAclRequest: PutBucketAclRequest): IO[PutBucketAclResponse] =
    IO.fromFuture {
  ...
  override def putBucketCors(putBucketCorsRequest: PutBucketCorsRequest): IO[PutBucketCorsResponse] =
    IO.fromFuture {
  ...
  override def putObjectAcl(putObjectAclRequest: PutObjectAclRequest): IO[PutObjectAclResponse] =
    IO.fromFuture {
  ...
  override def restoreObject(restoreObjectRequest: RestoreObjectRequest): IO[RestoreObjectResponse] =
    IO.fromFuture {
