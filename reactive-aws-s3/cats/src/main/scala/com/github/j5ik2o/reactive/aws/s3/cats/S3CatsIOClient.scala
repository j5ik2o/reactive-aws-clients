...
trait S3CatsIOClient extends S3Client[IO] {
  ...
  ): IO[AbortMultipartUploadResponse] = IO.fromFuture {
    IO(underlying.abortMultipartUpload(abortMultipartUploadRequest))
  }

  override def completeMultipartUpload(
      completeMultipartUploadRequest: CompleteMultipartUploadRequest
  ): IO[CompleteMultipartUploadResponse] = IO.fromFuture {
    IO(underlying.completeMultipartUpload(completeMultipartUploadRequest))
  }

  override def copyObject(copyObjectRequest: CopyObjectRequest): IO[CopyObjectResponse] = IO.fromFuture {
    IO(underlying.copyObject(copyObjectRequest))
  }

  override def createBucket(createBucketRequest: CreateBucketRequest): IO[CreateBucketResponse] = IO.fromFuture {
    IO(underlying.createBucket(createBucketRequest))
  }

  override def createMultipartUpload(
      createMultipartUploadRequest: CreateMultipartUploadRequest
  ): IO[CreateMultipartUploadResponse] = IO.fromFuture {
    IO(underlying.createMultipartUpload(createMultipartUploadRequest))
  }

  override def deleteBucket(deleteBucketRequest: DeleteBucketRequest): IO[DeleteBucketResponse] = IO.fromFuture {
    IO(underlying.deleteBucket(deleteBucketRequest))
  }

  override def deleteBucketAnalyticsConfiguration(
      deleteBucketAnalyticsConfigurationRequest: DeleteBucketAnalyticsConfigurationRequest
  ): IO[DeleteBucketAnalyticsConfigurationResponse] = IO.fromFuture {
    IO(underlying.deleteBucketAnalyticsConfiguration(deleteBucketAnalyticsConfigurationRequest))
  }

  override def deleteBucketCors(deleteBucketCorsRequest: DeleteBucketCorsRequest): IO[DeleteBucketCorsResponse] =
    IO.fromFuture {
  ...
  ): IO[DeleteBucketEncryptionResponse] = IO.fromFuture {
  ...
  ): IO[DeleteBucketInventoryConfigurationResponse] = IO.fromFuture {
  ...
  ): IO[DeleteBucketLifecycleResponse] = IO.fromFuture {
  ...
  ): IO[DeleteBucketMetricsConfigurationResponse] = IO.fromFuture {
  ...
  ): IO[GetBucketLifecycleConfigurationResponse] = IO.fromFuture {
    IO(underlying.getBucketLifecycleConfiguration(getBucketLifecycleConfigurationRequest))
  }

  override def getBucketLocation(getBucketLocationRequest: GetBucketLocationRequest): IO[GetBucketLocationResponse] =
    IO.fromFuture {
      IO(underlying.getBucketLocation(getBucketLocationRequest))
    }

  override def getBucketLogging(getBucketLoggingRequest: GetBucketLoggingRequest): IO[GetBucketLoggingResponse] =
    IO.fromFuture {
  ...
  ): IO[GetBucketMetricsConfigurationResponse] = IO.fromFuture {
  ...
  ): IO[GetBucketNotificationConfigurationResponse] = IO.fromFuture {
    IO(underlying.getBucketNotificationConfiguration(getBucketNotificationConfigurationRequest))
  }

  override def getBucketPolicy(getBucketPolicyRequest: GetBucketPolicyRequest): IO[GetBucketPolicyResponse] =
    IO.fromFuture {
  ...
  ): IO[GetBucketVersioningResponse] = IO.fromFuture {
    IO(underlying.getBucketVersioning(getBucketVersioningRequest))
  }

  override def getBucketWebsite(getBucketWebsiteRequest: GetBucketWebsiteRequest): IO[GetBucketWebsiteResponse] =
    IO.fromFuture {
      IO(underlying.getBucketWebsite(getBucketWebsiteRequest))
    }

  override def getObjectAcl(getObjectAclRequest: GetObjectAclRequest): IO[GetObjectAclResponse] = IO.fromFuture {
  ...
  ): IO[GetObjectRetentionResponse] = IO.fromFuture {
    IO(underlying.getObjectRetention(getObjectRetentionRequest))
  }

  override def getObjectTagging(getObjectTaggingRequest: GetObjectTaggingRequest): IO[GetObjectTaggingResponse] =
    IO.fromFuture {
  ...
  ): IO[GetPublicAccessBlockResponse] = IO.fromFuture {
    IO(underlying.getPublicAccessBlock(getPublicAccessBlockRequest))
  }

  override def headBucket(headBucketRequest: HeadBucketRequest): IO[HeadBucketResponse] = IO.fromFuture {
    IO(underlying.headBucket(headBucketRequest))
  }

  override def headObject(headObjectRequest: HeadObjectRequest): IO[HeadObjectResponse] = IO.fromFuture {
    IO(underlying.headObject(headObjectRequest))
  }

  override def listBucketAnalyticsConfigurations(
      listBucketAnalyticsConfigurationsRequest: ListBucketAnalyticsConfigurationsRequest
  ): IO[ListBucketAnalyticsConfigurationsResponse] = IO.fromFuture {
  ...
  ): IO[ListBucketInventoryConfigurationsResponse] = IO.fromFuture {
  ...
  ): IO[ListBucketMetricsConfigurationsResponse] = IO.fromFuture {
    IO(underlying.listBucketMetricsConfigurations(listBucketMetricsConfigurationsRequest))
  }

  override def listBuckets(listBucketsRequest: ListBucketsRequest): IO[ListBucketsResponse] = IO.fromFuture {
    IO(underlying.listBuckets(listBucketsRequest))
  }

  override def listMultipartUploads(
      listMultipartUploadsRequest: ListMultipartUploadsRequest
  ): IO[ListMultipartUploadsResponse] = IO.fromFuture {
  ...
  ): IO[ListObjectVersionsResponse] = IO.fromFuture {
  ...
  override def listObjects(listObjectsRequest: ListObjectsRequest): IO[ListObjectsResponse] = IO.fromFuture {
    IO(underlying.listObjects(listObjectsRequest))
  }

  override def listObjectsV2(listObjectsV2Request: ListObjectsV2Request): IO[ListObjectsV2Response] = IO.fromFuture {
  ...
  override def listParts(listPartsRequest: ListPartsRequest): IO[ListPartsResponse] = IO.fromFuture {
  ...
  ): IO[PutBucketLifecycleConfigurationResponse] = IO.fromFuture {
    IO(underlying.putBucketLifecycleConfiguration(putBucketLifecycleConfigurationRequest))
  }

  override def putBucketLogging(putBucketLoggingRequest: PutBucketLoggingRequest): IO[PutBucketLoggingResponse] =
    IO.fromFuture {
  ...
  ): IO[PutBucketMetricsConfigurationResponse] = IO.fromFuture {
  ...
  ): IO[PutBucketNotificationConfigurationResponse] = IO.fromFuture {
    IO(underlying.putBucketNotificationConfiguration(putBucketNotificationConfigurationRequest))
  }

  override def putBucketPolicy(putBucketPolicyRequest: PutBucketPolicyRequest): IO[PutBucketPolicyResponse] =
    IO.fromFuture {
  ...
  ): IO[PutBucketReplicationResponse] = IO.fromFuture {
    IO(underlying.putBucketReplication(putBucketReplicationRequest))
  }

  override def putBucketRequestPayment(
      putBucketRequestPaymentRequest: PutBucketRequestPaymentRequest
  ): IO[PutBucketRequestPaymentResponse] = IO.fromFuture {
    IO(underlying.putBucketRequestPayment(putBucketRequestPaymentRequest))
  }

  override def putBucketTagging(putBucketTaggingRequest: PutBucketTaggingRequest): IO[PutBucketTaggingResponse] =
    IO.fromFuture {
  ...
  ): IO[PutBucketVersioningResponse] = IO.fromFuture {
    IO(underlying.putBucketVersioning(putBucketVersioningRequest))
  }

  override def putBucketWebsite(putBucketWebsiteRequest: PutBucketWebsiteRequest): IO[PutBucketWebsiteResponse] =
    IO.fromFuture {
      IO(underlying.putBucketWebsite(putBucketWebsiteRequest))
    }

  override def putObjectAcl(putObjectAclRequest: PutObjectAclRequest): IO[PutObjectAclResponse] = IO.fromFuture {
  ...
  ): IO[PutPublicAccessBlockResponse] = IO.fromFuture {
    IO(underlying.putPublicAccessBlock(putPublicAccessBlockRequest))
  }

  override def restoreObject(restoreObjectRequest: RestoreObjectRequest): IO[RestoreObjectResponse] = IO.fromFuture {
    IO(underlying.restoreObject(restoreObjectRequest))
  }

  override def uploadPartCopy(uploadPartCopyRequest: UploadPartCopyRequest): IO[UploadPartCopyResponse] =
    IO.fromFuture {
