...
import com.github.j5ik2o.reactive.aws.s3.model.{ CopyObjectRequest => ScalaCopyObjectRequest, _ }
import software.amazon.awssdk.services.s3.model.{ CopyObjectRequest => JavaCopyObjectRequest }

@SuppressWarnings(Array("org.wartremover.warts.Recursion"))
object CopyObjectRequestOps {

  implicit class ScalaCopyObjectRequestOps(val self: ScalaCopyObjectRequest) extends AnyVal {

    def toJava: JavaCopyObjectRequest = {
      val result = JavaCopyObjectRequest.builder()
      self.acl.foreach { v =>
      ...
      self.metadataDirective.foreach { v =>
        import MetadataDirectiveOps._; result.metadataDirective(v.toJava)
      } // String
      self.taggingDirective.foreach { v =>
        import TaggingDirectiveOps._; result.taggingDirective(v.toJava)
      } // String
