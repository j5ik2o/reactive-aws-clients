...
import com.github.j5ik2o.reactive.aws.s3.model.{ GetObjectResponse => ScalaGetObjectResponse, _ }
import software.amazon.awssdk.services.s3.model.{ GetObjectResponse => JavaGetObjectResponse }

import scala.compat.java8.OptionConverters._
import scala.collection.JavaConverters._

@SuppressWarnings(Array("org.wartremover.warts.Recursion"))
object GetObjectResponseOps {

  implicit class JavaGetObjectResponseOps(val self: JavaGetObjectResponse) extends AnyVal {

    def toScala: ScalaGetObjectResponse = {
      ScalaGetObjectResponse()
        ...
        .withContentRange(Option(self.contentRange)) // String
        ...
        .withTagCount(Option(self.tagCount).map(_.intValue)) // Int
