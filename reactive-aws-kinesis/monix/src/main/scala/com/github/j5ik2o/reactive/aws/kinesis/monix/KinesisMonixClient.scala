...
trait KinesisMonixClient extends KinesisClient[Task] {
  ...
  override def addTagsToStream(addTagsToStreamRequest: AddTagsToStreamRequest): Task[AddTagsToStreamResponse] =
    Task.deferFuture {
      underlying.addTagsToStream(addTagsToStreamRequest)
    }

  override def createStream(createStreamRequest: CreateStreamRequest): Task[CreateStreamResponse] =
    Task.deferFuture {
  ...
  ): Task[DecreaseStreamRetentionPeriodResponse] =
    Task.deferFuture {
      underlying.decreaseStreamRetentionPeriod(decreaseStreamRetentionPeriodRequest)
    }

  override def deleteStream(deleteStreamRequest: DeleteStreamRequest): Task[DeleteStreamResponse] =
    Task.deferFuture {
  ...
  ): Task[DeregisterStreamConsumerResponse] =
    Task.deferFuture {
  ...
  ): Task[DescribeStreamConsumerResponse] =
    Task.deferFuture {
  ...
  ): Task[DescribeStreamSummaryResponse] =
    Task.deferFuture {
  ...
  ): Task[DisableEnhancedMonitoringResponse] =
    Task.deferFuture {
  ...
  ): Task[EnableEnhancedMonitoringResponse] =
    Task.deferFuture {
  ...
  ): Task[IncreaseStreamRetentionPeriodResponse] =
    Task.deferFuture {
      underlying.increaseStreamRetentionPeriod(increaseStreamRetentionPeriodRequest)
    }

  override def listShards(listShardsRequest: ListShardsRequest): Task[ListShardsResponse] =
    Task.deferFuture {
  ...
  ): Task[ListStreamConsumersResponse] =
    Task.deferFuture {
  ...
  override def listTagsForStream(listTagsForStreamRequest: ListTagsForStreamRequest): Task[ListTagsForStreamResponse] =
    Task.deferFuture {
      underlying.listTagsForStream(listTagsForStreamRequest)
    }

  override def mergeShards(mergeShardsRequest: MergeShardsRequest): Task[MergeShardsResponse] =
    Task.deferFuture {
      underlying.mergeShards(mergeShardsRequest)
    }

  override def putRecord(putRecordRequest: PutRecordRequest): Task[PutRecordResponse] =
    Task.deferFuture {
      underlying.putRecord(putRecordRequest)
    }

  override def putRecords(putRecordsRequest: PutRecordsRequest): Task[PutRecordsResponse] =
    Task.deferFuture {
  ...
  ): Task[RegisterStreamConsumerResponse] =
    Task.deferFuture {
  ...
  ): Task[RemoveTagsFromStreamResponse] =
    Task.deferFuture {
      underlying.removeTagsFromStream(removeTagsFromStreamRequest)
    }

  override def splitShard(splitShardRequest: SplitShardRequest): Task[SplitShardResponse] =
    Task.deferFuture {
  ...
  ): Task[StartStreamEncryptionResponse] =
    Task.deferFuture {
  ...
  ): Task[StopStreamEncryptionResponse] =
    Task.deferFuture {
      underlying.stopStreamEncryption(stopStreamEncryptionRequest)
    }

  override def updateShardCount(updateShardCountRequest: UpdateShardCountRequest): Task[UpdateShardCountResponse] =
    Task.deferFuture {
