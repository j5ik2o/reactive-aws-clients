...
final class RegisterStreamConsumerResponseBuilderOps(val self: RegisterStreamConsumerResponse.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.consumer(v) }
            } 
...
implicit def toRegisterStreamConsumerResponseBuilderOps(v: RegisterStreamConsumerResponse.Builder): RegisterStreamConsumerResponseBuilderOps = new RegisterStreamConsumerResponseBuilderOps(v)

implicit def toRegisterStreamConsumerResponseOps(v: RegisterStreamConsumerResponse): RegisterStreamConsumerResponseOps = new RegisterStreamConsumerResponseOps(v)
