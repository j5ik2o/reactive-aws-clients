...
final class ListShardsResponseBuilderOps(val self: ListShardsResponse.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def shardsAsScala(value: Option[Seq[Shard]]): ListShardsResponse.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.shards(v.asJava) } 
            }
...
final class ListShardsResponseOps(val self: ListShardsResponse) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def shardsAsScala: Option[Seq[Shard]] = Option(self.shards).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toListShardsResponseBuilderOps(v: ListShardsResponse.Builder): ListShardsResponseBuilderOps = new ListShardsResponseBuilderOps(v)
