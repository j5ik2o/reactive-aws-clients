...
implicit def toDescribeStreamConsumerRequestBuilderOps(v: DescribeStreamConsumerRequest.Builder): DescribeStreamConsumerRequestBuilderOps = new DescribeStreamConsumerRequestBuilderOps(v)

implicit def toDescribeStreamConsumerRequestOps(v: DescribeStreamConsumerRequest): DescribeStreamConsumerRequestOps = new DescribeStreamConsumerRequestOps(v)
