...
final class PutRecordsRequestOps(val self: PutRecordsRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def recordsAsScala: Option[Seq[PutRecordsRequestEntry]] = Option(self.records).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toPutRecordsRequestBuilderOps(v: PutRecordsRequest.Builder): PutRecordsRequestBuilderOps = new PutRecordsRequestBuilderOps(v)
