...
final class ListTagsForStreamRequestBuilderOps(val self: ListTagsForStreamRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.exclusiveStartTagKey(v) }
            } 
...
implicit def toListTagsForStreamRequestBuilderOps(v: ListTagsForStreamRequest.Builder): ListTagsForStreamRequestBuilderOps = new ListTagsForStreamRequestBuilderOps(v)

implicit def toListTagsForStreamRequestOps(v: ListTagsForStreamRequest): ListTagsForStreamRequestOps = new ListTagsForStreamRequestOps(v)
