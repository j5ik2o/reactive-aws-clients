...
import KinesisSyncClient._
    ...
    override def addTagsToStream(addTagsToStreamRequest: AddTagsToStreamRequest): Either[Throwable, AddTagsToStreamResponse] =
    ...
    override def decreaseStreamRetentionPeriod(decreaseStreamRetentionPeriodRequest: DecreaseStreamRetentionPeriodRequest): Either[Throwable, DecreaseStreamRetentionPeriodResponse] =
    ...
    override def deregisterStreamConsumer(deregisterStreamConsumerRequest: DeregisterStreamConsumerRequest): Either[Throwable, DeregisterStreamConsumerResponse] =
    ...
    override def describeStreamConsumer(describeStreamConsumerRequest: DescribeStreamConsumerRequest): Either[Throwable, DescribeStreamConsumerResponse] =
        underlying.describeStreamConsumer(describeStreamConsumerRequest).toEither

    override def describeStreamSummary(describeStreamSummaryRequest: DescribeStreamSummaryRequest): Either[Throwable, DescribeStreamSummaryResponse] =
        underlying.describeStreamSummary(describeStreamSummaryRequest).toEither

    override def disableEnhancedMonitoring(disableEnhancedMonitoringRequest: DisableEnhancedMonitoringRequest): Either[Throwable, DisableEnhancedMonitoringResponse] =
        underlying.disableEnhancedMonitoring(disableEnhancedMonitoringRequest).toEither

    override def enableEnhancedMonitoring(enableEnhancedMonitoringRequest: EnableEnhancedMonitoringRequest): Either[Throwable, EnableEnhancedMonitoringResponse] =
    ...
    override def getShardIterator(getShardIteratorRequest: GetShardIteratorRequest): Either[Throwable, GetShardIteratorResponse] =
        underlying.getShardIterator(getShardIteratorRequest).toEither

    override def increaseStreamRetentionPeriod(increaseStreamRetentionPeriodRequest: IncreaseStreamRetentionPeriodRequest): Either[Throwable, IncreaseStreamRetentionPeriodResponse] =
    ...
    override def listStreamConsumers(listStreamConsumersRequest: ListStreamConsumersRequest): Either[Throwable, ListStreamConsumersResponse] =
    ...
    override def listTagsForStream(listTagsForStreamRequest: ListTagsForStreamRequest): Either[Throwable, ListTagsForStreamResponse] =
    ...
    override def registerStreamConsumer(registerStreamConsumerRequest: RegisterStreamConsumerRequest): Either[Throwable, RegisterStreamConsumerResponse] =
        underlying.registerStreamConsumer(registerStreamConsumerRequest).toEither

    override def removeTagsFromStream(removeTagsFromStreamRequest: RemoveTagsFromStreamRequest): Either[Throwable, RemoveTagsFromStreamResponse] =
    ...
    override def startStreamEncryption(startStreamEncryptionRequest: StartStreamEncryptionRequest): Either[Throwable, StartStreamEncryptionResponse] =
        underlying.startStreamEncryption(startStreamEncryptionRequest).toEither

    override def stopStreamEncryption(stopStreamEncryptionRequest: StopStreamEncryptionRequest): Either[Throwable, StopStreamEncryptionResponse] =
        underlying.stopStreamEncryption(stopStreamEncryptionRequest).toEither

    override def updateShardCount(updateShardCountRequest: UpdateShardCountRequest): Either[Throwable, UpdateShardCountResponse] =
