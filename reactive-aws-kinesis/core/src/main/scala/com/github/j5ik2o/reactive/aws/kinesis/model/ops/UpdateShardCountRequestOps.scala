...
implicit def toUpdateShardCountRequestBuilderOps(v: UpdateShardCountRequest.Builder): UpdateShardCountRequestBuilderOps = new UpdateShardCountRequestBuilderOps(v)

implicit def toUpdateShardCountRequestOps(v: UpdateShardCountRequest): UpdateShardCountRequestOps = new UpdateShardCountRequestOps(v)
