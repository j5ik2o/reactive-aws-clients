...
implicit def toRegisterStreamConsumerRequestBuilderOps(v: RegisterStreamConsumerRequest.Builder): RegisterStreamConsumerRequestBuilderOps = new RegisterStreamConsumerRequestBuilderOps(v)

implicit def toRegisterStreamConsumerRequestOps(v: RegisterStreamConsumerRequest): RegisterStreamConsumerRequestOps = new RegisterStreamConsumerRequestOps(v)
