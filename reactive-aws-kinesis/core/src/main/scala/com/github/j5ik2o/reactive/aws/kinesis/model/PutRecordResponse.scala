...
final case class PutRecordResponse(
  ...
  override def withHttpHeaders(value: Option[Map[String, Seq[String]]]): PutRecordResponse =
    copy(httpHeaders = value)
  def withShardId(value: Option[String]): PutRecordResponse =
    copy(shardId = value)
  def withSequenceNumber(value: Option[String]): PutRecordResponse =
    copy(sequenceNumber = value)
  def withEncryptionType(value: Option[EncryptionType]): PutRecordResponse =
