...
implicit def toDescribeStreamSummaryRequestBuilderOps(v: DescribeStreamSummaryRequest.Builder): DescribeStreamSummaryRequestBuilderOps = new DescribeStreamSummaryRequestBuilderOps(v)

implicit def toDescribeStreamSummaryRequestOps(v: DescribeStreamSummaryRequest): DescribeStreamSummaryRequestOps = new DescribeStreamSummaryRequestOps(v)
