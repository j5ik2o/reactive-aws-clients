...
implicit def toListStreamConsumersRequestBuilderOps(v: ListStreamConsumersRequest.Builder): ListStreamConsumersRequestBuilderOps = new ListStreamConsumersRequestBuilderOps(v)

implicit def toListStreamConsumersRequestOps(v: ListStreamConsumersRequest): ListStreamConsumersRequestOps = new ListStreamConsumersRequestOps(v)
