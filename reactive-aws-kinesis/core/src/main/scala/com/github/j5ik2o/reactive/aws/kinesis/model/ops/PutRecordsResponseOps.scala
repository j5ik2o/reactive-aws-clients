...
final class PutRecordsResponseBuilderOps(val self: PutRecordsResponse.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.failedRecordCount(v) }
            } 
...
final class PutRecordsResponseOps(val self: PutRecordsResponse) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def recordsAsScala: Option[Seq[PutRecordsResultEntry]] = Option(self.records).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toPutRecordsResponseBuilderOps(v: PutRecordsResponse.Builder): PutRecordsResponseBuilderOps = new PutRecordsResponseBuilderOps(v)
