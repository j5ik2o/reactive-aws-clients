...
final class ListStreamsResponseOps(val self: ListStreamsResponse) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def streamNamesAsScala: Option[Seq[String]] =
    Option(self.streamNames).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
