...
final case class ListStreamConsumersResponse(
  ...
  def withConsumers(value: Option[Seq[Consumer]]): ListStreamConsumersResponse =
    copy(consumers = value)
  def withNextToken(value: Option[String]): ListStreamConsumersResponse =
