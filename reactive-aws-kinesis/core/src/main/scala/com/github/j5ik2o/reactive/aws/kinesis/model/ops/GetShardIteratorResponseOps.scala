...
implicit def toGetShardIteratorResponseBuilderOps(v: GetShardIteratorResponse.Builder): GetShardIteratorResponseBuilderOps = new GetShardIteratorResponseBuilderOps(v)

implicit def toGetShardIteratorResponseOps(v: GetShardIteratorResponse): GetShardIteratorResponseOps = new GetShardIteratorResponseOps(v)
