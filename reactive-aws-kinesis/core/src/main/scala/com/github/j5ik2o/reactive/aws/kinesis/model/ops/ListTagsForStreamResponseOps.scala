...
implicit def toListTagsForStreamResponseBuilderOps(v: ListTagsForStreamResponse.Builder): ListTagsForStreamResponseBuilderOps = new ListTagsForStreamResponseBuilderOps(v)

implicit def toListTagsForStreamResponseOps(v: ListTagsForStreamResponse): ListTagsForStreamResponseOps = new ListTagsForStreamResponseOps(v)
