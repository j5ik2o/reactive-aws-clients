...
final class CreateStreamRequestBuilderOps(val self: CreateStreamRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.shardCount(v) }
            } 
...
implicit def toCreateStreamRequestBuilderOps(v: CreateStreamRequest.Builder): CreateStreamRequestBuilderOps = new CreateStreamRequestBuilderOps(v)
