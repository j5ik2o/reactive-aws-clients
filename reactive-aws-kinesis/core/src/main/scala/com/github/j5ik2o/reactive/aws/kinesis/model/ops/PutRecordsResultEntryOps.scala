...
implicit def toPutRecordsResultEntryBuilderOps(v: PutRecordsResultEntry.Builder): PutRecordsResultEntryBuilderOps = new PutRecordsResultEntryBuilderOps(v)

implicit def toPutRecordsResultEntryOps(v: PutRecordsResultEntry): PutRecordsResultEntryOps = new PutRecordsResultEntryOps(v)
