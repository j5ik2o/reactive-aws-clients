...
implicit def toDescribeStreamConsumerResponseBuilderOps(v: DescribeStreamConsumerResponse.Builder): DescribeStreamConsumerResponseBuilderOps = new DescribeStreamConsumerResponseBuilderOps(v)

implicit def toDescribeStreamConsumerResponseOps(v: DescribeStreamConsumerResponse): DescribeStreamConsumerResponseOps = new DescribeStreamConsumerResponseOps(v)
