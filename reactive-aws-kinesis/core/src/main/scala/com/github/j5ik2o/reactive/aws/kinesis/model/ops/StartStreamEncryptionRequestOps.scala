...
implicit def toStartStreamEncryptionRequestBuilderOps(v: StartStreamEncryptionRequest.Builder): StartStreamEncryptionRequestBuilderOps = new StartStreamEncryptionRequestBuilderOps(v)

implicit def toStartStreamEncryptionRequestOps(v: StartStreamEncryptionRequest): StartStreamEncryptionRequestOps = new StartStreamEncryptionRequestOps(v)
