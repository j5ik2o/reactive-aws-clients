...
final class ListLayersResponseBuilderOps(val self: ListLayersResponse.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def layersAsScala(value: Option[Seq[LayersListItem]]): ListLayersResponse.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.layers(v.asJava) } 
            }
...
final class ListLayersResponseOps(val self: ListLayersResponse) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def layersAsScala: Option[Seq[LayersListItem]] = Option(self.layers).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toListLayersResponseBuilderOps(v: ListLayersResponse.Builder): ListLayersResponseBuilderOps = new ListLayersResponseBuilderOps(v)
