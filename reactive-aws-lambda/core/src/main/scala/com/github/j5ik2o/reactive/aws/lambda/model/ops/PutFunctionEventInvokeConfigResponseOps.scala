...
final class PutFunctionEventInvokeConfigResponseBuilderOps(val self: PutFunctionEventInvokeConfigResponse.Builder) extends AnyVal {
...
implicit def toPutFunctionEventInvokeConfigResponseBuilderOps(v: PutFunctionEventInvokeConfigResponse.Builder): PutFunctionEventInvokeConfigResponseBuilderOps = new PutFunctionEventInvokeConfigResponseBuilderOps(v)

implicit def toPutFunctionEventInvokeConfigResponseOps(v: PutFunctionEventInvokeConfigResponse): PutFunctionEventInvokeConfigResponseOps = new PutFunctionEventInvokeConfigResponseOps(v)
