...
final class FunctionConfigurationBuilderOps(val self: FunctionConfiguration.Builder) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def stateAsScala(value: Option[State]): FunctionConfiguration.Builder = {
    value.fold(self) { v => self.state(v) }
  }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def stateReasonAsScala(value: Option[String]): FunctionConfiguration.Builder = {
    value.fold(self) { v => self.stateReason(v) }
  }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def stateReasonCodeAsScala(value: Option[StateReasonCode]): FunctionConfiguration.Builder = {
    value.fold(self) { v => self.stateReasonCode(v) }
  }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def lastUpdateStatusAsScala(value: Option[LastUpdateStatus]): FunctionConfiguration.Builder = {
    value.fold(self) { v => self.lastUpdateStatus(v) }
  }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def lastUpdateStatusReasonAsScala(value: Option[String]): FunctionConfiguration.Builder = {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def fileSystemConfigsAsScala(value: Option[Seq[FileSystemConfig]]): FunctionConfiguration.Builder = {
    value.filter(_.nonEmpty).fold(self) { v =>
