...
final class PublishVersionResponseBuilderOps(val self: PublishVersionResponse.Builder) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def stateAsScala(value: Option[State]): PublishVersionResponse.Builder = {
    value.fold(self) { v => self.state(v) }
  }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def stateReasonAsScala(value: Option[String]): PublishVersionResponse.Builder = {
    value.fold(self) { v => self.stateReason(v) }
  }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def stateReasonCodeAsScala(value: Option[StateReasonCode]): PublishVersionResponse.Builder = {
    value.fold(self) { v => self.stateReasonCode(v) }
  }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def lastUpdateStatusAsScala(value: Option[LastUpdateStatus]): PublishVersionResponse.Builder = {
    value.fold(self) { v => self.lastUpdateStatus(v) }
  }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def lastUpdateStatusReasonAsScala(value: Option[String]): PublishVersionResponse.Builder = {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def fileSystemConfigsAsScala(value: Option[Seq[FileSystemConfig]]): PublishVersionResponse.Builder = {
    value.filter(_.nonEmpty).fold(self) { v =>
