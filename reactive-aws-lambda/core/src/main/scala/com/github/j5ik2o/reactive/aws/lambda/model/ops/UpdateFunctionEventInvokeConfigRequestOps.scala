...
final class UpdateFunctionEventInvokeConfigRequestBuilderOps(val self: UpdateFunctionEventInvokeConfigRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def destinationConfigAsScala(value: Option[DestinationConfig]): UpdateFunctionEventInvokeConfigRequest.Builder = {
...
implicit def toUpdateFunctionEventInvokeConfigRequestBuilderOps(v: UpdateFunctionEventInvokeConfigRequest.Builder): UpdateFunctionEventInvokeConfigRequestBuilderOps = new UpdateFunctionEventInvokeConfigRequestBuilderOps(v)

implicit def toUpdateFunctionEventInvokeConfigRequestOps(v: UpdateFunctionEventInvokeConfigRequest): UpdateFunctionEventInvokeConfigRequestOps = new UpdateFunctionEventInvokeConfigRequestOps(v)
