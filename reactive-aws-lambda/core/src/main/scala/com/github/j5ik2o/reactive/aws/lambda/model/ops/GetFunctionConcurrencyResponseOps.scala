...
implicit def toGetFunctionConcurrencyResponseBuilderOps(v: GetFunctionConcurrencyResponse.Builder): GetFunctionConcurrencyResponseBuilderOps = new GetFunctionConcurrencyResponseBuilderOps(v)

implicit def toGetFunctionConcurrencyResponseOps(v: GetFunctionConcurrencyResponse): GetFunctionConcurrencyResponseOps = new GetFunctionConcurrencyResponseOps(v)
