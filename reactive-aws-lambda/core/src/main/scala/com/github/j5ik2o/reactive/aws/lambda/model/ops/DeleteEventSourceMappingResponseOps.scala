...
final class DeleteEventSourceMappingResponseBuilderOps(val self: DeleteEventSourceMappingResponse.Builder)
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def parallelizationFactorAsScala(value: Option[Int]): DeleteEventSourceMappingResponse.Builder = {
    value.fold(self) { v =>
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def destinationConfigAsScala(value: Option[DestinationConfig]): DeleteEventSourceMappingResponse.Builder = {
    value.fold(self) { v =>
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def maximumRecordAgeInSecondsAsScala(value: Option[Int]): DeleteEventSourceMappingResponse.Builder = {
    value.fold(self) { v =>
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def bisectBatchOnFunctionErrorAsScala(value: Option[Boolean]): DeleteEventSourceMappingResponse.Builder = {
    value.fold(self) { v =>
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def maximumRetryAttemptsAsScala(value: Option[Int]): DeleteEventSourceMappingResponse.Builder = {
    value.fold(self) { v =>
