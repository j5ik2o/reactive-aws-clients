...
final class DetectFacesResponseOps(val self: DetectFacesResponse) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def faceDetailsAsScala: Option[Seq[FaceDetail]] =
    Option(self.faceDetails).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
