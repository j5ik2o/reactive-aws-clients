...
final class UpdateResolverRequestBuilderOps(val self: UpdateResolverRequest.Builder) extends AnyVal {
  ...
  final def withApiIdAsScala(value: Option[String]): UpdateResolverRequest.Builder = {
    value.fold(self) { v =>
      self.apiId(v)
    }
  } // String

  final def withTypeNameAsScala(value: Option[String]): UpdateResolverRequest.Builder = {
    value.fold(self) { v =>
      self.typeName(v)
    }
  } // String

  final def withFieldNameAsScala(value: Option[String]): UpdateResolverRequest.Builder = {
    value.fold(self) { v =>
      self.fieldName(v)
    }
  } // String

  final def withDataSourceNameAsScala(value: Option[String]): UpdateResolverRequest.Builder = {
    value.fold(self) { v =>
      self.dataSourceName(v)
    }
  } // String

  final def withRequestMappingTemplateAsScala(value: Option[String]): UpdateResolverRequest.Builder = {
    value.fold(self) { v =>
      self.requestMappingTemplate(v)
    }
  } // String

  final def withResponseMappingTemplateAsScala(value: Option[String]): UpdateResolverRequest.Builder = {
    value.fold(self) { v =>
      self.responseMappingTemplate(v)
    }
  } // String

  final def withKindAsScala(value: Option[ResolverKind]): UpdateResolverRequest.Builder = {
    value.fold(self) { v =>
      self.kind(v)
    }
  } // String

  final def withPipelineConfigAsScala(value: Option[PipelineConfig]): UpdateResolverRequest.Builder = {
    value.fold(self) { v =>
