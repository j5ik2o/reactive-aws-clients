...
def apply(asyncClient: ElasticBeanstalkAsyncClient): ElasticBeanstalkMonixClient = new ElasticBeanstalkMonixClient {
...
val underlying: ElasticBeanstalkAsyncClient
        ...
        override def  abortEnvironmentUpdate(abortEnvironmentUpdateRequest: AbortEnvironmentUpdateRequest): Task[AbortEnvironmentUpdateResponse] =
        Task.deferFuture {
        underlying.abortEnvironmentUpdate(abortEnvironmentUpdateRequest)
        }

        override def  applyEnvironmentManagedAction(applyEnvironmentManagedActionRequest: ApplyEnvironmentManagedActionRequest): Task[ApplyEnvironmentManagedActionResponse] =
        Task.deferFuture {
        underlying.applyEnvironmentManagedAction(applyEnvironmentManagedActionRequest)
        }

        override def  checkDNSAvailability(checkDnsAvailabilityRequest: CheckDnsAvailabilityRequest): Task[CheckDnsAvailabilityResponse] =
        Task.deferFuture {
        underlying.checkDNSAvailability(checkDnsAvailabilityRequest)
        }

        override def  composeEnvironments(composeEnvironmentsRequest: ComposeEnvironmentsRequest): Task[ComposeEnvironmentsResponse] =
        Task.deferFuture {
        ...
        override def  createApplicationVersion(createApplicationVersionRequest: CreateApplicationVersionRequest): Task[CreateApplicationVersionResponse] =
        Task.deferFuture {
        underlying.createApplicationVersion(createApplicationVersionRequest)
        }

        override def  createConfigurationTemplate(createConfigurationTemplateRequest: CreateConfigurationTemplateRequest): Task[CreateConfigurationTemplateResponse] =
        Task.deferFuture {
        ...
        override def  createPlatformVersion(createPlatformVersionRequest: CreatePlatformVersionRequest): Task[CreatePlatformVersionResponse] =
        Task.deferFuture {
        underlying.createPlatformVersion(createPlatformVersionRequest)
        }

        override def  createStorageLocation(createStorageLocationRequest: CreateStorageLocationRequest): Task[CreateStorageLocationResponse] =
        Task.deferFuture {
        ...
        override def  deleteApplicationVersion(deleteApplicationVersionRequest: DeleteApplicationVersionRequest): Task[DeleteApplicationVersionResponse] =
        Task.deferFuture {
        underlying.deleteApplicationVersion(deleteApplicationVersionRequest)
        }

        override def  deleteConfigurationTemplate(deleteConfigurationTemplateRequest: DeleteConfigurationTemplateRequest): Task[DeleteConfigurationTemplateResponse] =
        Task.deferFuture {
        underlying.deleteConfigurationTemplate(deleteConfigurationTemplateRequest)
        }

        override def  deleteEnvironmentConfiguration(deleteEnvironmentConfigurationRequest: DeleteEnvironmentConfigurationRequest): Task[DeleteEnvironmentConfigurationResponse] =
        Task.deferFuture {
        underlying.deleteEnvironmentConfiguration(deleteEnvironmentConfigurationRequest)
        }

        override def  deletePlatformVersion(deletePlatformVersionRequest: DeletePlatformVersionRequest): Task[DeletePlatformVersionResponse] =
        Task.deferFuture {
        ...
        override def  describeApplicationVersions(describeApplicationVersionsRequest: DescribeApplicationVersionsRequest): Task[DescribeApplicationVersionsResponse] =
        Task.deferFuture {
        ...
        override def  describeApplications(describeApplicationsRequest: DescribeApplicationsRequest): Task[DescribeApplicationsResponse] =
        Task.deferFuture {
        ...
        override def  describeConfigurationOptions(describeConfigurationOptionsRequest: DescribeConfigurationOptionsRequest): Task[DescribeConfigurationOptionsResponse] =
        Task.deferFuture {
        underlying.describeConfigurationOptions(describeConfigurationOptionsRequest)
        }

        override def  describeConfigurationSettings(describeConfigurationSettingsRequest: DescribeConfigurationSettingsRequest): Task[DescribeConfigurationSettingsResponse] =
        Task.deferFuture {
        underlying.describeConfigurationSettings(describeConfigurationSettingsRequest)
        }

        override def  describeEnvironmentHealth(describeEnvironmentHealthRequest: DescribeEnvironmentHealthRequest): Task[DescribeEnvironmentHealthResponse] =
        Task.deferFuture {
        underlying.describeEnvironmentHealth(describeEnvironmentHealthRequest)
        }

        override def  describeEnvironmentManagedActionHistory(describeEnvironmentManagedActionHistoryRequest: DescribeEnvironmentManagedActionHistoryRequest): Task[DescribeEnvironmentManagedActionHistoryResponse] =
        Task.deferFuture {
        underlying.describeEnvironmentManagedActionHistory(describeEnvironmentManagedActionHistoryRequest)
        }

        override def  describeEnvironmentManagedActions(describeEnvironmentManagedActionsRequest: DescribeEnvironmentManagedActionsRequest): Task[DescribeEnvironmentManagedActionsResponse] =
        Task.deferFuture {
        underlying.describeEnvironmentManagedActions(describeEnvironmentManagedActionsRequest)
        }

        override def  describeEnvironmentResources(describeEnvironmentResourcesRequest: DescribeEnvironmentResourcesRequest): Task[DescribeEnvironmentResourcesResponse] =
        Task.deferFuture {
        underlying.describeEnvironmentResources(describeEnvironmentResourcesRequest)
        }

        override def  describeEnvironments(describeEnvironmentsRequest: DescribeEnvironmentsRequest): Task[DescribeEnvironmentsResponse] =
        Task.deferFuture {
        ...
        override def  describeInstancesHealth(describeInstancesHealthRequest: DescribeInstancesHealthRequest): Task[DescribeInstancesHealthResponse] =
        Task.deferFuture {
        underlying.describeInstancesHealth(describeInstancesHealthRequest)
        }

        override def  describePlatformVersion(describePlatformVersionRequest: DescribePlatformVersionRequest): Task[DescribePlatformVersionResponse] =
        Task.deferFuture {
        underlying.describePlatformVersion(describePlatformVersionRequest)
        }

        override def  listAvailableSolutionStacks(listAvailableSolutionStacksRequest: ListAvailableSolutionStacksRequest): Task[ListAvailableSolutionStacksResponse] =
        Task.deferFuture {
        ...
        override def  listPlatformBranches(listPlatformBranchesRequest: ListPlatformBranchesRequest): Task[ListPlatformBranchesResponse] =
        Task.deferFuture {
        underlying.listPlatformBranches(listPlatformBranchesRequest)
        }

        def listPlatformBranchesPaginator(listPlatformBranchesRequest: ListPlatformBranchesRequest): Observable[ListPlatformBranchesResponse] =
        Observable.fromReactivePublisher(underlying.listPlatformBranchesPaginator(listPlatformBranchesRequest))

        override def  listPlatformVersions(listPlatformVersionsRequest: ListPlatformVersionsRequest): Task[ListPlatformVersionsResponse] =
        Task.deferFuture {
        ...
        override def  listTagsForResource(listTagsForResourceRequest: ListTagsForResourceRequest): Task[ListTagsForResourceResponse] =
        Task.deferFuture {
        underlying.listTagsForResource(listTagsForResourceRequest)
        }

        override def  rebuildEnvironment(rebuildEnvironmentRequest: RebuildEnvironmentRequest): Task[RebuildEnvironmentResponse] =
        Task.deferFuture {
        underlying.rebuildEnvironment(rebuildEnvironmentRequest)
        }

        override def  requestEnvironmentInfo(requestEnvironmentInfoRequest: RequestEnvironmentInfoRequest): Task[RequestEnvironmentInfoResponse] =
        Task.deferFuture {
        ...
        override def  retrieveEnvironmentInfo(retrieveEnvironmentInfoRequest: RetrieveEnvironmentInfoRequest): Task[RetrieveEnvironmentInfoResponse] =
        Task.deferFuture {
        underlying.retrieveEnvironmentInfo(retrieveEnvironmentInfoRequest)
        }

        override def  swapEnvironmentCNAMEs(swapEnvironmentCnamEsRequest: SwapEnvironmentCnamEsRequest): Task[SwapEnvironmentCNAMEsResponse] =
        Task.deferFuture {
        underlying.swapEnvironmentCNAMEs(swapEnvironmentCnamEsRequest)
        }

        override def  terminateEnvironment(terminateEnvironmentRequest: TerminateEnvironmentRequest): Task[TerminateEnvironmentResponse] =
        Task.deferFuture {
        ...
        override def  updateApplicationResourceLifecycle(updateApplicationResourceLifecycleRequest: UpdateApplicationResourceLifecycleRequest): Task[UpdateApplicationResourceLifecycleResponse] =
        Task.deferFuture {
        underlying.updateApplicationResourceLifecycle(updateApplicationResourceLifecycleRequest)
        }

        override def  updateApplicationVersion(updateApplicationVersionRequest: UpdateApplicationVersionRequest): Task[UpdateApplicationVersionResponse] =
        Task.deferFuture {
        underlying.updateApplicationVersion(updateApplicationVersionRequest)
        }

        override def  updateConfigurationTemplate(updateConfigurationTemplateRequest: UpdateConfigurationTemplateRequest): Task[UpdateConfigurationTemplateResponse] =
        Task.deferFuture {
        ...
        override def  updateTagsForResource(updateTagsForResourceRequest: UpdateTagsForResourceRequest): Task[UpdateTagsForResourceResponse] =
        Task.deferFuture {
        underlying.updateTagsForResource(updateTagsForResourceRequest)
        }

        override def  validateConfigurationSettings(validateConfigurationSettingsRequest: ValidateConfigurationSettingsRequest): Task[ValidateConfigurationSettingsResponse] =
        Task.deferFuture {
