...
object ElasticBeanstalkCatsIOClient {
  ...
  def apply(asyncClient: ElasticBeanstalkAsyncClient)(implicit ec: ExecutionContext): ElasticBeanstalkCatsIOClient = new ElasticBeanstalkCatsIOClient {
...
implicit def cs: ContextShift[IO] = IO.contextShift(executionContext)
        ...
        override def abortEnvironmentUpdate(abortEnvironmentUpdateRequest: AbortEnvironmentUpdateRequest): IO[AbortEnvironmentUpdateResponse] =
        IO.fromFuture {
        IO(underlying.abortEnvironmentUpdate(abortEnvironmentUpdateRequest))
        }

        override def applyEnvironmentManagedAction(applyEnvironmentManagedActionRequest: ApplyEnvironmentManagedActionRequest): IO[ApplyEnvironmentManagedActionResponse] =
        IO.fromFuture {
        IO(underlying.applyEnvironmentManagedAction(applyEnvironmentManagedActionRequest))
        }

        override def checkDNSAvailability(checkDnsAvailabilityRequest: CheckDnsAvailabilityRequest): IO[CheckDnsAvailabilityResponse] =
        IO.fromFuture {
        IO(underlying.checkDNSAvailability(checkDnsAvailabilityRequest))
        }

        override def composeEnvironments(composeEnvironmentsRequest: ComposeEnvironmentsRequest): IO[ComposeEnvironmentsResponse] =
        IO.fromFuture {
        ...
        override def createApplicationVersion(createApplicationVersionRequest: CreateApplicationVersionRequest): IO[CreateApplicationVersionResponse] =
        IO.fromFuture {
        IO(underlying.createApplicationVersion(createApplicationVersionRequest))
        }

        override def createConfigurationTemplate(createConfigurationTemplateRequest: CreateConfigurationTemplateRequest): IO[CreateConfigurationTemplateResponse] =
        IO.fromFuture {
        ...
        override def createPlatformVersion(createPlatformVersionRequest: CreatePlatformVersionRequest): IO[CreatePlatformVersionResponse] =
        IO.fromFuture {
        IO(underlying.createPlatformVersion(createPlatformVersionRequest))
        }

        override def createStorageLocation(createStorageLocationRequest: CreateStorageLocationRequest): IO[CreateStorageLocationResponse] =
        IO.fromFuture {
        ...
        override def deleteApplicationVersion(deleteApplicationVersionRequest: DeleteApplicationVersionRequest): IO[DeleteApplicationVersionResponse] =
        IO.fromFuture {
        IO(underlying.deleteApplicationVersion(deleteApplicationVersionRequest))
        }

        override def deleteConfigurationTemplate(deleteConfigurationTemplateRequest: DeleteConfigurationTemplateRequest): IO[DeleteConfigurationTemplateResponse] =
        IO.fromFuture {
        IO(underlying.deleteConfigurationTemplate(deleteConfigurationTemplateRequest))
        }

        override def deleteEnvironmentConfiguration(deleteEnvironmentConfigurationRequest: DeleteEnvironmentConfigurationRequest): IO[DeleteEnvironmentConfigurationResponse] =
        IO.fromFuture {
        IO(underlying.deleteEnvironmentConfiguration(deleteEnvironmentConfigurationRequest))
        }

        override def deletePlatformVersion(deletePlatformVersionRequest: DeletePlatformVersionRequest): IO[DeletePlatformVersionResponse] =
        IO.fromFuture {
        ...
        override def describeApplicationVersions(describeApplicationVersionsRequest: DescribeApplicationVersionsRequest): IO[DescribeApplicationVersionsResponse] =
        IO.fromFuture {
        ...
        override def describeApplications(describeApplicationsRequest: DescribeApplicationsRequest): IO[DescribeApplicationsResponse] =
        IO.fromFuture {
        ...
        override def describeConfigurationOptions(describeConfigurationOptionsRequest: DescribeConfigurationOptionsRequest): IO[DescribeConfigurationOptionsResponse] =
        IO.fromFuture {
        IO(underlying.describeConfigurationOptions(describeConfigurationOptionsRequest))
        }

        override def describeConfigurationSettings(describeConfigurationSettingsRequest: DescribeConfigurationSettingsRequest): IO[DescribeConfigurationSettingsResponse] =
        IO.fromFuture {
        IO(underlying.describeConfigurationSettings(describeConfigurationSettingsRequest))
        }

        override def describeEnvironmentHealth(describeEnvironmentHealthRequest: DescribeEnvironmentHealthRequest): IO[DescribeEnvironmentHealthResponse] =
        IO.fromFuture {
        IO(underlying.describeEnvironmentHealth(describeEnvironmentHealthRequest))
        }

        override def describeEnvironmentManagedActionHistory(describeEnvironmentManagedActionHistoryRequest: DescribeEnvironmentManagedActionHistoryRequest): IO[DescribeEnvironmentManagedActionHistoryResponse] =
        IO.fromFuture {
        IO(underlying.describeEnvironmentManagedActionHistory(describeEnvironmentManagedActionHistoryRequest))
        }

        override def describeEnvironmentManagedActions(describeEnvironmentManagedActionsRequest: DescribeEnvironmentManagedActionsRequest): IO[DescribeEnvironmentManagedActionsResponse] =
        IO.fromFuture {
        IO(underlying.describeEnvironmentManagedActions(describeEnvironmentManagedActionsRequest))
        }

        override def describeEnvironmentResources(describeEnvironmentResourcesRequest: DescribeEnvironmentResourcesRequest): IO[DescribeEnvironmentResourcesResponse] =
        IO.fromFuture {
        IO(underlying.describeEnvironmentResources(describeEnvironmentResourcesRequest))
        }

        override def describeEnvironments(describeEnvironmentsRequest: DescribeEnvironmentsRequest): IO[DescribeEnvironmentsResponse] =
        IO.fromFuture {
        ...
        override def describeInstancesHealth(describeInstancesHealthRequest: DescribeInstancesHealthRequest): IO[DescribeInstancesHealthResponse] =
        IO.fromFuture {
        IO(underlying.describeInstancesHealth(describeInstancesHealthRequest))
        }

        override def describePlatformVersion(describePlatformVersionRequest: DescribePlatformVersionRequest): IO[DescribePlatformVersionResponse] =
        IO.fromFuture {
        IO(underlying.describePlatformVersion(describePlatformVersionRequest))
        }

        override def listAvailableSolutionStacks(listAvailableSolutionStacksRequest: ListAvailableSolutionStacksRequest): IO[ListAvailableSolutionStacksResponse] =
        IO.fromFuture {
        ...
        override def listPlatformBranches(listPlatformBranchesRequest: ListPlatformBranchesRequest): IO[ListPlatformBranchesResponse] =
        IO.fromFuture {
        IO(underlying.listPlatformBranches(listPlatformBranchesRequest))
        }

        def listPlatformBranchesPaginator(listPlatformBranchesRequest: ListPlatformBranchesRequest): ListPlatformBranchesPublisher =
        underlying.listPlatformBranchesPaginator(listPlatformBranchesRequest)

        override def listPlatformVersions(listPlatformVersionsRequest: ListPlatformVersionsRequest): IO[ListPlatformVersionsResponse] =
        IO.fromFuture {
        ...
        override def rebuildEnvironment(rebuildEnvironmentRequest: RebuildEnvironmentRequest): IO[RebuildEnvironmentResponse] =
        IO.fromFuture {
        IO(underlying.rebuildEnvironment(rebuildEnvironmentRequest))
        }

        override def requestEnvironmentInfo(requestEnvironmentInfoRequest: RequestEnvironmentInfoRequest): IO[RequestEnvironmentInfoResponse] =
        IO.fromFuture {
        ...
        override def retrieveEnvironmentInfo(retrieveEnvironmentInfoRequest: RetrieveEnvironmentInfoRequest): IO[RetrieveEnvironmentInfoResponse] =
        IO.fromFuture {
        IO(underlying.retrieveEnvironmentInfo(retrieveEnvironmentInfoRequest))
        }

        override def swapEnvironmentCNAMEs(swapEnvironmentCnamEsRequest: SwapEnvironmentCnamEsRequest): IO[SwapEnvironmentCNAMEsResponse] =
        IO.fromFuture {
        IO(underlying.swapEnvironmentCNAMEs(swapEnvironmentCnamEsRequest))
        }

        override def terminateEnvironment(terminateEnvironmentRequest: TerminateEnvironmentRequest): IO[TerminateEnvironmentResponse] =
        IO.fromFuture {
        ...
        override def updateApplicationResourceLifecycle(updateApplicationResourceLifecycleRequest: UpdateApplicationResourceLifecycleRequest): IO[UpdateApplicationResourceLifecycleResponse] =
        IO.fromFuture {
        IO(underlying.updateApplicationResourceLifecycle(updateApplicationResourceLifecycleRequest))
        }

        override def updateApplicationVersion(updateApplicationVersionRequest: UpdateApplicationVersionRequest): IO[UpdateApplicationVersionResponse] =
        IO.fromFuture {
        IO(underlying.updateApplicationVersion(updateApplicationVersionRequest))
        }

        override def updateConfigurationTemplate(updateConfigurationTemplateRequest: UpdateConfigurationTemplateRequest): IO[UpdateConfigurationTemplateResponse] =
        IO.fromFuture {
        ...
        override def updateTagsForResource(updateTagsForResourceRequest: UpdateTagsForResourceRequest): IO[UpdateTagsForResourceResponse] =
        IO.fromFuture {
        IO(underlying.updateTagsForResource(updateTagsForResourceRequest))
        }

        override def validateConfigurationSettings(validateConfigurationSettingsRequest: ValidateConfigurationSettingsRequest): IO[ValidateConfigurationSettingsResponse] =
        IO.fromFuture {
