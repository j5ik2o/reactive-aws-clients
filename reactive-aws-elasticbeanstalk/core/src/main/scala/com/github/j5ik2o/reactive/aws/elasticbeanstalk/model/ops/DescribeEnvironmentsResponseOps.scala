...
final class DescribeEnvironmentsResponseOps(val self: DescribeEnvironmentsResponse) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def environmentsAsScala: Option[Seq[EnvironmentDescription]] =
    Option(self.environments).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
