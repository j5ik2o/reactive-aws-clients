...
import com.github.j5ik2o.reactive.aws.dynamodb.v2.{ DynamoDBAsyncClient, JavaAsyncClientDecoratorV2 }
...
class DynamoDBAsyncClientSpec extends FreeSpec with Matchers with ScalaFutures with DynamoDBContainerSpecSupport {
