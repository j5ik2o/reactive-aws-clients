...
import com.github.j5ik2o.reactive.aws.dynamodb.v2.metrics.JavaSyncClientMetricsInterceptor
import com.github.j5ik2o.reactive.aws.metrics.MetricsReporter
import software.amazon.awssdk.services.dynamodb.DynamoDbClient
import software.amazon.awssdk.services.dynamodb.model._

object JavaSyncClientDecoratorV2 {

  def ofMetricsCollector(underlying: DynamoDbClient, _reporter: MetricsReporter): JavaSyncClientDecoratorV2 =
    new JavaSyncClientDecoratorV2Impl(underlying) with JavaSyncClientMetricsInterceptor {
...
class JavaSyncClientDecoratorV2Impl(override val underlying: DynamoDbClient) extends JavaSyncClientDecoratorV2
