...
class ScanPublisherImpl(self: software.amazon.awssdk.services.dynamodb.paginators.ScanPublisher)
    extends com.github.j5ik2o.reactive.dynamodb.model.rs.ScanPublisher {
