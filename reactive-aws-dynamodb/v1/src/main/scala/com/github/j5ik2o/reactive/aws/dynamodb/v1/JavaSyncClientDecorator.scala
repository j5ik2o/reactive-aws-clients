...
trait JavaSyncClientDecorator extends AmazonDynamoDB {
...
class JavaSyncClientDecoratorImpl(override val underlying: AmazonDynamoDB) extends JavaSyncClientDecorator
