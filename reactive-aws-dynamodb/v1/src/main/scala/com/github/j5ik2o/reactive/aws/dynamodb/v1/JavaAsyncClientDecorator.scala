...
trait JavaAsyncClientDecorator extends AmazonDynamoDBAsync with JavaSyncClientDecorator {
...
class JavaAsyncClientDecoratorImpl(override val underlying: AmazonDynamoDBAsync) extends JavaAsyncClientDecorator
