...
final case class DeleteItemRequest(tableName: Option[String] = None,
  ...
  def withTableName(value: Option[String]): DeleteItemRequest                             = copy(tableName = value)
  def withKey(value: Option[Map[String, AttributeValue]]): DeleteItemRequest              = copy(key = value)
  def withExpected(value: Option[Map[String, ExpectedAttributeValue]]): DeleteItemRequest = copy(expected = value)
  def withConditionalOperator(value: Option[ConditionalOperator]): DeleteItemRequest      = copy(conditionalOperator = value)
  def withReturnValues(value: Option[ReturnValue]): DeleteItemRequest                     = copy(returnValues = value)
  def withReturnConsumedCapacity(value: Option[ReturnConsumedCapacity]): DeleteItemRequest =
    copy(returnConsumedCapacity = value)
  def withReturnItemCollectionMetrics(value: Option[String]): DeleteItemRequest =
    copy(returnItemCollectionMetrics = value)
  def withConditionExpression(value: Option[String]): DeleteItemRequest = copy(conditionExpression = value)
