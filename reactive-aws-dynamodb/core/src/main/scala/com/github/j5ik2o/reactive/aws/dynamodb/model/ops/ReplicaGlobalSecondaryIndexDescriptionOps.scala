...
final class ReplicaGlobalSecondaryIndexDescriptionBuilderOps(val self: ReplicaGlobalSecondaryIndexDescription.Builder)
    extends AnyVal {
...
trait ToReplicaGlobalSecondaryIndexDescriptionOps {
  ...
  implicit def toReplicaGlobalSecondaryIndexDescriptionBuilderOps(
      v: ReplicaGlobalSecondaryIndexDescription.Builder
  ): ReplicaGlobalSecondaryIndexDescriptionBuilderOps = new ReplicaGlobalSecondaryIndexDescriptionBuilderOps(v)

  implicit def toReplicaGlobalSecondaryIndexDescriptionOps(
      v: ReplicaGlobalSecondaryIndexDescription
  ): ReplicaGlobalSecondaryIndexDescriptionOps = new ReplicaGlobalSecondaryIndexDescriptionOps(v)
