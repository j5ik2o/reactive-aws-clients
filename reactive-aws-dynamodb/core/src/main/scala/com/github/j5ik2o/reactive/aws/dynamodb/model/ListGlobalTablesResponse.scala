...
final case class ListGlobalTablesResponse(override val statusCode: Option[Int] = None,
  ...
  def withGlobalTables(value: Option[Seq[GlobalTable]]): ListGlobalTablesResponse = copy(globalTables = value)
