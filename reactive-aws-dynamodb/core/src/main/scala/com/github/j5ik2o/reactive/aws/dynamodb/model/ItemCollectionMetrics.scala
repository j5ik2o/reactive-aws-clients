...
final case class ItemCollectionMetrics(
    itemCollectionKey: Option[Map[String, AttributeValue]] = None,
  ...
  def withSizeEstimateRangeGB(value: Option[Seq[Double]]): ItemCollectionMetrics =
    copy(sizeEstimateRangeGB = value)
}
