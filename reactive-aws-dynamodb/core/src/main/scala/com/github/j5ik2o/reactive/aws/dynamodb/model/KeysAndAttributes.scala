...
final case class KeysAndAttributes(
    keys: Option[Seq[Map[String, AttributeValue]]] = None,
  ...
  def withKeys(value: Option[Seq[Map[String, AttributeValue]]]): KeysAndAttributes =
    copy(keys = value)
  def withAttributesToGet(value: Option[Seq[String]]): KeysAndAttributes =
    copy(attributesToGet = value)
  def withConsistentRead(value: Option[Boolean]): KeysAndAttributes =
    copy(consistentRead = value)
  def withProjectionExpression(value: Option[String]): KeysAndAttributes =
