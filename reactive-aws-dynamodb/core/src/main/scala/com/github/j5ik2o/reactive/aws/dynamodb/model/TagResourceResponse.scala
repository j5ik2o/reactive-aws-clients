...
final case class TagResourceResponse(override val statusCode: Option[Int] = None,
  ...
  override def withHttpHeaders(value: Option[Map[String, Seq[String]]]): TagResourceResponse = copy(httpHeaders = value)
