...
final case class Delete(
  ...
  def withKey(value: Option[Map[String, AttributeValue]]): Delete =
    copy(key = value)
  def withTableName(value: Option[String]): Delete =
    copy(tableName = value)
  def withConditionExpression(value: Option[String]): Delete =
    copy(conditionExpression = value)
  def withExpressionAttributeNames(value: Option[Map[String, String]]): Delete =
