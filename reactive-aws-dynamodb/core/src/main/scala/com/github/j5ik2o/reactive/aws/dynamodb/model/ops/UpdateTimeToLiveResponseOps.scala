...
implicit def toUpdateTimeToLiveResponseBuilderOps(v: UpdateTimeToLiveResponse.Builder): UpdateTimeToLiveResponseBuilderOps = new UpdateTimeToLiveResponseBuilderOps(v)

implicit def toUpdateTimeToLiveResponseOps(v: UpdateTimeToLiveResponse): UpdateTimeToLiveResponseOps = new UpdateTimeToLiveResponseOps(v)
