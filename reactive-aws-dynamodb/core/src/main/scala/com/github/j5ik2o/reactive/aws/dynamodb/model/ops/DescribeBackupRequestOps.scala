...
implicit def toDescribeBackupRequestBuilderOps(v: DescribeBackupRequest.Builder): DescribeBackupRequestBuilderOps = new DescribeBackupRequestBuilderOps(v)

implicit def toDescribeBackupRequestOps(v: DescribeBackupRequest): DescribeBackupRequestOps = new DescribeBackupRequestOps(v)
