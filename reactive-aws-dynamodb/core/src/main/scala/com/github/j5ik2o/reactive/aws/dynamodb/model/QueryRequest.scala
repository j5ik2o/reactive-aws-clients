...
final case class QueryRequest(
  ...
  def withTableName(value: Option[String]): QueryRequest =
    copy(tableName = value)
  def withIndexName(value: Option[String]): QueryRequest =
    copy(indexName = value)
  def withSelect(value: Option[Select]): QueryRequest =
    copy(select = value)
  def withAttributesToGet(value: Option[Seq[String]]): QueryRequest =
    copy(attributesToGet = value)
  def withLimit(value: Option[Int]): QueryRequest =
    copy(limit = value)
  def withConsistentRead(value: Option[Boolean]): QueryRequest =
    copy(consistentRead = value)
  def withKeyConditions(value: Option[Map[String, Condition]]): QueryRequest =
    copy(keyConditions = value)
  def withQueryFilter(value: Option[Map[String, Condition]]): QueryRequest =
    copy(queryFilter = value)
  def withConditionalOperator(value: Option[ConditionalOperator]): QueryRequest =
    copy(conditionalOperator = value)
  def withScanIndexForward(value: Option[Boolean]): QueryRequest =
    copy(scanIndexForward = value)
  def withExclusiveStartKey(value: Option[Map[String, AttributeValue]]): QueryRequest =
    copy(exclusiveStartKey = value)
  def withReturnConsumedCapacity(value: Option[ReturnConsumedCapacity]): QueryRequest =
    copy(returnConsumedCapacity = value)
  def withProjectionExpression(value: Option[String]): QueryRequest =
    copy(projectionExpression = value)
  def withFilterExpression(value: Option[String]): QueryRequest =
    copy(filterExpression = value)
  def withKeyConditionExpression(value: Option[String]): QueryRequest =
    copy(keyConditionExpression = value)
