...
trait ToListContributorInsightsRequestOps {
  ...
  implicit def toListContributorInsightsRequestBuilderOps(
      v: ListContributorInsightsRequest.Builder
  ): ListContributorInsightsRequestBuilderOps = new ListContributorInsightsRequestBuilderOps(v)

  implicit def toListContributorInsightsRequestOps(
      v: ListContributorInsightsRequest
  ): ListContributorInsightsRequestOps = new ListContributorInsightsRequestOps(v)
