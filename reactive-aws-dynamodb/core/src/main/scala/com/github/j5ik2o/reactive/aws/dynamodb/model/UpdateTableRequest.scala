...
final case class UpdateTableRequest(
  ...
  def withTableName(value: Option[String]): UpdateTableRequest =
    copy(tableName = value)
  def withBillingMode(value: Option[BillingMode]): UpdateTableRequest =
  ...
  def withSseSpecification(value: Option[SSESpecification]): UpdateTableRequest =
