...
implicit def toDescribeBackupResponseBuilderOps(v: DescribeBackupResponse.Builder): DescribeBackupResponseBuilderOps = new DescribeBackupResponseBuilderOps(v)

implicit def toDescribeBackupResponseOps(v: DescribeBackupResponse): DescribeBackupResponseOps = new DescribeBackupResponseOps(v)
