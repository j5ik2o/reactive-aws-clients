...
final case class CreateTableRequest(
  ...
  def withTableName(value: Option[String]): CreateTableRequest =
    copy(tableName = value)
  def withKeySchema(value: Option[Seq[KeySchemaElement]]): CreateTableRequest =
  ...
  def withBillingMode(value: Option[BillingMode]): CreateTableRequest =
  ...
  def withSseSpecification(value: Option[SSESpecification]): CreateTableRequest =
    copy(sseSpecification = value)
}
