...
final case class GetItemResponse(
  ...
  override def withHttpHeaders(value: Option[Map[String, Seq[String]]]): GetItemResponse =
    copy(httpHeaders = value)
  def withItem(value: Option[Map[String, AttributeValue]]): GetItemResponse =
    copy(item = value)
  def withConsumedCapacity(value: Option[ConsumedCapacity]): GetItemResponse =
