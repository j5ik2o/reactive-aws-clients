...
final class CreateTableRequestOps(val self: CreateTableRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def localSecondaryIndexesAsScala: Option[Seq[LocalSecondaryIndex]] = Option(self.localSecondaryIndexes).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def globalSecondaryIndexesAsScala: Option[Seq[GlobalSecondaryIndex]] = Option(self.globalSecondaryIndexes).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toCreateTableRequestBuilderOps(v: CreateTableRequest.Builder): CreateTableRequestBuilderOps = new CreateTableRequestBuilderOps(v)
