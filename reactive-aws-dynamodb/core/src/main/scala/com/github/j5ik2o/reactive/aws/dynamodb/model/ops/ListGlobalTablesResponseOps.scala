...
final class ListGlobalTablesResponseOps(val self: ListGlobalTablesResponse) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def globalTablesAsScala: Option[Seq[GlobalTable]] =
    Option(self.globalTables).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
