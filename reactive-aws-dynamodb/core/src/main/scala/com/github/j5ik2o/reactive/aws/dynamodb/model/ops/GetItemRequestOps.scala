...
final class GetItemRequestBuilderOps(val self: GetItemRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def attributesToGetAsScala(value: Option[Seq[String]]): GetItemRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.attributesToGet(v.asJava) } 
            }
...
final class GetItemRequestOps(val self: GetItemRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def attributesToGetAsScala: Option[Seq[String]] = Option(self.attributesToGet).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toGetItemRequestBuilderOps(v: GetItemRequest.Builder): GetItemRequestBuilderOps = new GetItemRequestBuilderOps(v)
