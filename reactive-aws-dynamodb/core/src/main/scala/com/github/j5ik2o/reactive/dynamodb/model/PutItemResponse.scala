...
final case class PutItemResponse(override val statusCode: Option[Int] = None,
  ...
  override def withHttpHeaders(value: Option[Map[String, Seq[String]]]): PutItemResponse = copy(httpHeaders = value)
  def withAttributes(value: Option[Map[String, AttributeValue]]): PutItemResponse        = copy(attributes = value)
  def withConsumedCapacity(value: Option[ConsumedCapacity]): PutItemResponse             = copy(consumedCapacity = value)
