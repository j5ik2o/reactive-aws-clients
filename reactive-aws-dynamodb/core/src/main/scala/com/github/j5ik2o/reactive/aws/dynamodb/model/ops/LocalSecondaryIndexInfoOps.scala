...
implicit def toLocalSecondaryIndexInfoBuilderOps(v: LocalSecondaryIndexInfo.Builder): LocalSecondaryIndexInfoBuilderOps = new LocalSecondaryIndexInfoBuilderOps(v)

implicit def toLocalSecondaryIndexInfoOps(v: LocalSecondaryIndexInfo): LocalSecondaryIndexInfoOps = new LocalSecondaryIndexInfoOps(v)
