...
final class AutoScalingSettingsUpdateBuilderOps(val self: AutoScalingSettingsUpdate.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.scalingPolicyUpdate(v) }
            } 
...
implicit def toAutoScalingSettingsUpdateBuilderOps(v: AutoScalingSettingsUpdate.Builder): AutoScalingSettingsUpdateBuilderOps = new AutoScalingSettingsUpdateBuilderOps(v)

implicit def toAutoScalingSettingsUpdateOps(v: AutoScalingSettingsUpdate): AutoScalingSettingsUpdateOps = new AutoScalingSettingsUpdateOps(v)
