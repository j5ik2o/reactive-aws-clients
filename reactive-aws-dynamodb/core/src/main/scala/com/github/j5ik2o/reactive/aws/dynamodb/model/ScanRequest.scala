...
final case class ScanRequest(
  ...
  def withTableName(value: Option[String]): ScanRequest =
    copy(tableName = value)
  def withIndexName(value: Option[String]): ScanRequest =
    copy(indexName = value)
  def withAttributesToGet(value: Option[Seq[String]]): ScanRequest =
    copy(attributesToGet = value)
  def withLimit(value: Option[Int]): ScanRequest =
    copy(limit = value)
  def withSelect(value: Option[Select]): ScanRequest =
    copy(select = value)
  def withScanFilter(value: Option[Map[String, Condition]]): ScanRequest =
    copy(scanFilter = value)
  def withConditionalOperator(value: Option[ConditionalOperator]): ScanRequest =
    copy(conditionalOperator = value)
  def withExclusiveStartKey(value: Option[Map[String, AttributeValue]]): ScanRequest =
  ...
  def withTotalSegments(value: Option[Int]): ScanRequest =
    copy(totalSegments = value)
  def withSegment(value: Option[Int]): ScanRequest =
    copy(segment = value)
  def withProjectionExpression(value: Option[String]): ScanRequest =
    copy(projectionExpression = value)
  def withFilterExpression(value: Option[String]): ScanRequest =
  ...
  def withConsistentRead(value: Option[Boolean]): ScanRequest =
