...
final case class Update(
  ...
  def withKey(value: Option[Map[String, AttributeValue]]): Update =
    copy(key = value)
  def withUpdateExpression(value: Option[String]): Update =
    copy(updateExpression = value)
  def withTableName(value: Option[String]): Update =
    copy(tableName = value)
  def withConditionExpression(value: Option[String]): Update =
    copy(conditionExpression = value)
  def withExpressionAttributeNames(value: Option[Map[String, String]]): Update =
