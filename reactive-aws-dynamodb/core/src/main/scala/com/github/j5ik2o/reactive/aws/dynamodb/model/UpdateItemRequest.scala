...
final case class UpdateItemRequest(
  ...
  def withTableName(value: Option[String]): UpdateItemRequest =
    copy(tableName = value)
  def withKey(value: Option[Map[String, AttributeValue]]): UpdateItemRequest =
    copy(key = value)
  def withAttributeUpdates(value: Option[Map[String, AttributeValueUpdate]]): UpdateItemRequest =
    copy(attributeUpdates = value)
  def withExpected(value: Option[Map[String, ExpectedAttributeValue]]): UpdateItemRequest =
    copy(expected = value)
  def withConditionalOperator(value: Option[ConditionalOperator]): UpdateItemRequest =
    copy(conditionalOperator = value)
  def withReturnValues(value: Option[ReturnValue]): UpdateItemRequest =
  ...
  def withUpdateExpression(value: Option[String]): UpdateItemRequest =
    copy(updateExpression = value)
  def withConditionExpression(value: Option[String]): UpdateItemRequest =
