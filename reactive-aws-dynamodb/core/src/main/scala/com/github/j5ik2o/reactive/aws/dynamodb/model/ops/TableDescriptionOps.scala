...
final class TableDescriptionOps(val self: TableDescription) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def attributeDefinitionsAsScala: Option[Seq[AttributeDefinition]] =
    Option(self.attributeDefinitions).map { v =>
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def replicasAsScala: Option[Seq[ReplicaDescription]] =
