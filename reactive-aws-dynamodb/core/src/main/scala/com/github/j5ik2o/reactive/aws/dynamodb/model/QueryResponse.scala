...
final case class QueryResponse(
  ...
  override def withHttpHeaders(value: Option[Map[String, Seq[String]]]): QueryResponse =
    copy(httpHeaders = value)
  def withItems(value: Option[Seq[Map[String, AttributeValue]]]): QueryResponse =
    copy(items = value)
  def withCount(value: Option[Int]): QueryResponse =
    copy(count = value)
  def withScannedCount(value: Option[Int]): QueryResponse =
    copy(scannedCount = value)
  def withLastEvaluatedKey(value: Option[Map[String, AttributeValue]]): QueryResponse =
    copy(lastEvaluatedKey = value)
  def withConsumedCapacity(value: Option[ConsumedCapacity]): QueryResponse =
