...
final class ContributorInsightsSummaryBuilderOps(val self: ContributorInsightsSummary.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def contributorInsightsStatusAsScala(value: Option[ContributorInsightsStatus]): ContributorInsightsSummary.Builder = {
...
implicit def toContributorInsightsSummaryBuilderOps(v: ContributorInsightsSummary.Builder): ContributorInsightsSummaryBuilderOps = new ContributorInsightsSummaryBuilderOps(v)

implicit def toContributorInsightsSummaryOps(v: ContributorInsightsSummary): ContributorInsightsSummaryOps = new ContributorInsightsSummaryOps(v)
