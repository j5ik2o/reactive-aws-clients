...
final case class UpdateTableResponse(override val statusCode: Option[Int] = None,
  ...
  def withTableDescription(value: Option[TableDescription]): UpdateTableResponse = copy(tableDescription = value)
