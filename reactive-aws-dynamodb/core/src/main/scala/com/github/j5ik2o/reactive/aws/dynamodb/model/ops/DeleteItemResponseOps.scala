...
final class DeleteItemResponseOps(val self: DeleteItemResponse) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def attributesAsScala: Option[Map[String, AttributeValue]]  = Option(self.attributes).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala.toMap } 
...
implicit def toDeleteItemResponseBuilderOps(v: DeleteItemResponse.Builder): DeleteItemResponseBuilderOps = new DeleteItemResponseBuilderOps(v)
