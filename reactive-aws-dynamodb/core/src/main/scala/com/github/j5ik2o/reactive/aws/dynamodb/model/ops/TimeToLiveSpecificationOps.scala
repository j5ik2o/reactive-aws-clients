...
implicit def toTimeToLiveSpecificationBuilderOps(v: TimeToLiveSpecification.Builder): TimeToLiveSpecificationBuilderOps = new TimeToLiveSpecificationBuilderOps(v)

implicit def toTimeToLiveSpecificationOps(v: TimeToLiveSpecification): TimeToLiveSpecificationOps = new TimeToLiveSpecificationOps(v)
