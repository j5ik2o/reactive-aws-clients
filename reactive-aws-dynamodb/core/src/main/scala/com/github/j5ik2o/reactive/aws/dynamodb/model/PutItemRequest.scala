...
final case class PutItemRequest(
  ...
  def withTableName(value: Option[String]): PutItemRequest =
    copy(tableName = value)
  def withItem(value: Option[Map[String, AttributeValue]]): PutItemRequest =
    copy(item = value)
  def withExpected(value: Option[Map[String, ExpectedAttributeValue]]): PutItemRequest =
    copy(expected = value)
  def withReturnValues(value: Option[ReturnValue]): PutItemRequest =
  ...
  def withConditionalOperator(value: Option[ConditionalOperator]): PutItemRequest =
    copy(conditionalOperator = value)
  def withConditionExpression(value: Option[String]): PutItemRequest =
