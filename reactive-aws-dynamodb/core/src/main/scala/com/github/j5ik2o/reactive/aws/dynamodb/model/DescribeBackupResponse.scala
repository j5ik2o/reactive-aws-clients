...
final case class DescribeBackupResponse(override val statusCode: Option[Int] = None,
  ...
  def withBackupDescription(value: Option[BackupDescription]): DescribeBackupResponse = copy(backupDescription = value)
