...
final case class AutoScalingSettingsDescription(
  ...
  def withMinimumUnits(value: Option[Long]): AutoScalingSettingsDescription =
    copy(minimumUnits = value)
  def withMaximumUnits(value: Option[Long]): AutoScalingSettingsDescription =
  ...
  def withAutoScalingRoleArn(value: Option[String]): AutoScalingSettingsDescription =
