...
trait JavaAsyncClientMetricsInterceptor extends DynamoDbAsyncClient with JavaClientMetricsInterceptor {
  ...
  abstract override def createTable(
  ...
  abstract override def deleteBackup(
    ...
    collectCompletableFuture("deleteBackup", deleteBackupRequest)(super.deleteBackup)

  abstract override def deleteItem(
      deleteItemRequest: DeleteItemRequest
  ): CompletableFuture[DeleteItemResponse] =
    collectCompletableFuture("deleteItem", deleteItemRequest)(super.deleteItem)

  abstract override def deleteTable(
      deleteTableRequest: DeleteTableRequest
  ): CompletableFuture[DeleteTableResponse] =
  ...
  abstract override def getItem(
      getItemRequest: GetItemRequest
  ): CompletableFuture[GetItemResponse] =
    collectCompletableFuture("getItem", getItemRequest)(super.getItem)

  abstract override def listBackups(
      listBackupsRequest: ListBackupsRequest
  ): CompletableFuture[ListBackupsResponse] =
  ...
  abstract override def listTables(
      listTablesRequest: ListTablesRequest
  ): CompletableFuture[ListTablesResponse] =
  ...
  abstract override def scan(
      scanRequest: ScanRequest
  ): CompletableFuture[ScanResponse] =
    collectCompletableFuture("scan", scanRequest)(super.scan)

  abstract override def tagResource(
      tagResourceRequest: TagResourceRequest
  ): CompletableFuture[TagResourceResponse] =
  ...
  abstract override def updateItem(
      updateItemRequest: UpdateItemRequest
  ): CompletableFuture[UpdateItemResponse] =
    collectCompletableFuture("updateItem", updateItemRequest)(super.updateItem)

  abstract override def updateTable(
      updateTableRequest: UpdateTableRequest
  ): CompletableFuture[UpdateTableResponse] =
