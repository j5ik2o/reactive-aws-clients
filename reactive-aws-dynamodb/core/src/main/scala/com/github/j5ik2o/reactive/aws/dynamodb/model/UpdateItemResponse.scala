...
final case class UpdateItemResponse(
  ...
  override def withHttpHeaders(value: Option[Map[String, Seq[String]]]): UpdateItemResponse =
    copy(httpHeaders = value)
  def withAttributes(value: Option[Map[String, AttributeValue]]): UpdateItemResponse =
    copy(attributes = value)
  def withConsumedCapacity(value: Option[ConsumedCapacity]): UpdateItemResponse =
