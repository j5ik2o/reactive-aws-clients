...
final class ListTablesResponseOps(val self: ListTablesResponse) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def tableNamesAsScala: Option[Seq[String]] =
    Option(self.tableNames).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
