...
final case class DeleteItemResponse(override val statusCode: Option[Int] = None,
  ...
  def withAttributes(value: Option[Map[String, AttributeValue]]): DeleteItemResponse = copy(attributes = value)
  def withConsumedCapacity(value: Option[ConsumedCapacity]): DeleteItemResponse      = copy(consumedCapacity = value)
