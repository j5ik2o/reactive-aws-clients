...
import DynamoDbSyncClient._
    ...
    override def createGlobalTable(createGlobalTableRequest: CreateGlobalTableRequest): Either[Throwable, CreateGlobalTableResponse] =
    ...
    override def describeContinuousBackups(describeContinuousBackupsRequest: DescribeContinuousBackupsRequest): Either[Throwable, DescribeContinuousBackupsResponse] =
        underlying.describeContinuousBackups(describeContinuousBackupsRequest).toEither

    override def describeContributorInsights(describeContributorInsightsRequest: DescribeContributorInsightsRequest): Either[Throwable, DescribeContributorInsightsResponse] =
    ...
    override def describeEndpoints(describeEndpointsRequest: DescribeEndpointsRequest): Either[Throwable, DescribeEndpointsResponse] =
        underlying.describeEndpoints(describeEndpointsRequest).toEither

    override def describeGlobalTable(describeGlobalTableRequest: DescribeGlobalTableRequest): Either[Throwable, DescribeGlobalTableResponse] =
        underlying.describeGlobalTable(describeGlobalTableRequest).toEither

    override def describeGlobalTableSettings(describeGlobalTableSettingsRequest: DescribeGlobalTableSettingsRequest): Either[Throwable, DescribeGlobalTableSettingsResponse] =
    ...
    override def describeTableReplicaAutoScaling(describeTableReplicaAutoScalingRequest: DescribeTableReplicaAutoScalingRequest): Either[Throwable, DescribeTableReplicaAutoScalingResponse] =
        underlying.describeTableReplicaAutoScaling(describeTableReplicaAutoScalingRequest).toEither

    override def describeTimeToLive(describeTimeToLiveRequest: DescribeTimeToLiveRequest): Either[Throwable, DescribeTimeToLiveResponse] =
    ...
    override def listContributorInsights(listContributorInsightsRequest: ListContributorInsightsRequest): Either[Throwable, ListContributorInsightsResponse] =
        underlying.listContributorInsights(listContributorInsightsRequest).toEither

     def listContributorInsightsPaginator(listContributorInsightsRequest: ListContributorInsightsRequest): ListContributorInsightsIterable =
    ...
    override def listGlobalTables(listGlobalTablesRequest: ListGlobalTablesRequest): Either[Throwable, ListGlobalTablesResponse] =
    ...
    override def listTagsOfResource(listTagsOfResourceRequest: ListTagsOfResourceRequest): Either[Throwable, ListTagsOfResourceResponse] =
    ...
    override def restoreTableFromBackup(restoreTableFromBackupRequest: RestoreTableFromBackupRequest): Either[Throwable, RestoreTableFromBackupResponse] =
        underlying.restoreTableFromBackup(restoreTableFromBackupRequest).toEither

    override def restoreTableToPointInTime(restoreTableToPointInTimeRequest: RestoreTableToPointInTimeRequest): Either[Throwable, RestoreTableToPointInTimeResponse] =
    ...
    override def transactGetItems(transactGetItemsRequest: TransactGetItemsRequest): Either[Throwable, TransactGetItemsResponse] =
        underlying.transactGetItems(transactGetItemsRequest).toEither

    override def transactWriteItems(transactWriteItemsRequest: TransactWriteItemsRequest): Either[Throwable, TransactWriteItemsResponse] =
    ...
    override def updateContinuousBackups(updateContinuousBackupsRequest: UpdateContinuousBackupsRequest): Either[Throwable, UpdateContinuousBackupsResponse] =
        underlying.updateContinuousBackups(updateContinuousBackupsRequest).toEither

    override def updateContributorInsights(updateContributorInsightsRequest: UpdateContributorInsightsRequest): Either[Throwable, UpdateContributorInsightsResponse] =
        underlying.updateContributorInsights(updateContributorInsightsRequest).toEither

    override def updateGlobalTable(updateGlobalTableRequest: UpdateGlobalTableRequest): Either[Throwable, UpdateGlobalTableResponse] =
        underlying.updateGlobalTable(updateGlobalTableRequest).toEither

    override def updateGlobalTableSettings(updateGlobalTableSettingsRequest: UpdateGlobalTableSettingsRequest): Either[Throwable, UpdateGlobalTableSettingsResponse] =
    ...
    override def updateTableReplicaAutoScaling(updateTableReplicaAutoScalingRequest: UpdateTableReplicaAutoScalingRequest): Either[Throwable, UpdateTableReplicaAutoScalingResponse] =
        underlying.updateTableReplicaAutoScaling(updateTableReplicaAutoScalingRequest).toEither

    override def updateTimeToLive(updateTimeToLiveRequest: UpdateTimeToLiveRequest): Either[Throwable, UpdateTimeToLiveResponse] =
