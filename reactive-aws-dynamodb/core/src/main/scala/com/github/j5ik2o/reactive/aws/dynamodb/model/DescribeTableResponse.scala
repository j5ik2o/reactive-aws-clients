...
final case class DescribeTableResponse(override val statusCode: Option[Int] = None,
  ...
  def withTable(value: Option[TableDescription]): DescribeTableResponse = copy(table = value)
}
