...
final case class DeleteTableResponse(
  ...
  override def withHttpHeaders(value: Option[Map[String, Seq[String]]]): DeleteTableResponse =
    copy(httpHeaders = value)
  def withTableDescription(value: Option[TableDescription]): DeleteTableResponse =
