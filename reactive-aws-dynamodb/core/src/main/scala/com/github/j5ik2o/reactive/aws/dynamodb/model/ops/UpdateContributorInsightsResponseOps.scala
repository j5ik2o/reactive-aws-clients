...
final class UpdateContributorInsightsResponseBuilderOps(val self: UpdateContributorInsightsResponse.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def contributorInsightsStatusAsScala(value: Option[ContributorInsightsStatus]): UpdateContributorInsightsResponse.Builder = {
...
implicit def toUpdateContributorInsightsResponseBuilderOps(v: UpdateContributorInsightsResponse.Builder): UpdateContributorInsightsResponseBuilderOps = new UpdateContributorInsightsResponseBuilderOps(v)

implicit def toUpdateContributorInsightsResponseOps(v: UpdateContributorInsightsResponse): UpdateContributorInsightsResponseOps = new UpdateContributorInsightsResponseOps(v)
