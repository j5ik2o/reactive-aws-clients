...
final case class Put(
  ...
  def withItem(value: Option[Map[String, AttributeValue]]): Put =
    copy(item = value)
  def withTableName(value: Option[String]): Put =
    copy(tableName = value)
  def withConditionExpression(value: Option[String]): Put =
    copy(conditionExpression = value)
  def withExpressionAttributeNames(value: Option[Map[String, String]]): Put =
