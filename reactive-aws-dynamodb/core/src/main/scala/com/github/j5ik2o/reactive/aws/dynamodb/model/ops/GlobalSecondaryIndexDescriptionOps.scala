...
final class GlobalSecondaryIndexDescriptionBuilderOps(val self: GlobalSecondaryIndexDescription.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def provisionedThroughputAsScala(value: Option[ProvisionedThroughputDescription]): GlobalSecondaryIndexDescription.Builder = {
...
implicit def toGlobalSecondaryIndexDescriptionBuilderOps(v: GlobalSecondaryIndexDescription.Builder): GlobalSecondaryIndexDescriptionBuilderOps = new GlobalSecondaryIndexDescriptionBuilderOps(v)

implicit def toGlobalSecondaryIndexDescriptionOps(v: GlobalSecondaryIndexDescription): GlobalSecondaryIndexDescriptionOps = new GlobalSecondaryIndexDescriptionOps(v)
