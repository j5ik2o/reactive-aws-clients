...
trait Ec2CatsIOClient extends Ec2Client[IO] {
  ...
  implicit def cs: ContextShift[IO] = IO.contextShift(executionContext)
        ...
        override def acceptReservedInstancesExchangeQuote(acceptReservedInstancesExchangeQuoteRequest: AcceptReservedInstancesExchangeQuoteRequest): IO[AcceptReservedInstancesExchangeQuoteResponse] =
        IO.fromFuture {
        IO(underlying.acceptReservedInstancesExchangeQuote(acceptReservedInstancesExchangeQuoteRequest))
        }

        override def acceptTransitGatewayPeeringAttachment(acceptTransitGatewayPeeringAttachmentRequest: AcceptTransitGatewayPeeringAttachmentRequest): IO[AcceptTransitGatewayPeeringAttachmentResponse] =
        IO.fromFuture {
        IO(underlying.acceptTransitGatewayPeeringAttachment(acceptTransitGatewayPeeringAttachmentRequest))
        }

        override def acceptTransitGatewayVpcAttachment(acceptTransitGatewayVpcAttachmentRequest: AcceptTransitGatewayVpcAttachmentRequest): IO[AcceptTransitGatewayVpcAttachmentResponse] =
        IO.fromFuture {
        IO(underlying.acceptTransitGatewayVpcAttachment(acceptTransitGatewayVpcAttachmentRequest))
        }

        override def acceptVpcEndpointConnections(acceptVpcEndpointConnectionsRequest: AcceptVpcEndpointConnectionsRequest): IO[AcceptVpcEndpointConnectionsResponse] =
        IO.fromFuture {
        IO(underlying.acceptVpcEndpointConnections(acceptVpcEndpointConnectionsRequest))
        }

        override def acceptVpcPeeringConnection(acceptVpcPeeringConnectionRequest: AcceptVpcPeeringConnectionRequest): IO[AcceptVpcPeeringConnectionResponse] =
        IO.fromFuture {
        IO(underlying.acceptVpcPeeringConnection(acceptVpcPeeringConnectionRequest))
        }

        override def advertiseByoipCidr(advertiseByoipCidrRequest: AdvertiseByoipCidrRequest): IO[AdvertiseByoipCidrResponse] =
        IO.fromFuture {
        ...
        override def applySecurityGroupsToClientVpnTargetNetwork(applySecurityGroupsToClientVpnTargetNetworkRequest: ApplySecurityGroupsToClientVpnTargetNetworkRequest): IO[ApplySecurityGroupsToClientVpnTargetNetworkResponse] =
        IO.fromFuture {
        IO(underlying.applySecurityGroupsToClientVpnTargetNetwork(applySecurityGroupsToClientVpnTargetNetworkRequest))
        }

        override def assignIpv6Addresses(assignIpv6AddressesRequest: AssignIpv6AddressesRequest): IO[AssignIpv6AddressesResponse] =
        IO.fromFuture {
        IO(underlying.assignIpv6Addresses(assignIpv6AddressesRequest))
        }

        override def assignPrivateIpAddresses(assignPrivateIpAddressesRequest: AssignPrivateIpAddressesRequest): IO[AssignPrivateIpAddressesResponse] =
        IO.fromFuture {
        ...
        override def associateClientVpnTargetNetwork(associateClientVpnTargetNetworkRequest: AssociateClientVpnTargetNetworkRequest): IO[AssociateClientVpnTargetNetworkResponse] =
        IO.fromFuture {
        IO(underlying.associateClientVpnTargetNetwork(associateClientVpnTargetNetworkRequest))
        }

        override def associateDhcpOptions(associateDhcpOptionsRequest: AssociateDhcpOptionsRequest): IO[AssociateDhcpOptionsResponse] =
        IO.fromFuture {
        IO(underlying.associateDhcpOptions(associateDhcpOptionsRequest))
        }

        override def associateIamInstanceProfile(associateIamInstanceProfileRequest: AssociateIamInstanceProfileRequest): IO[AssociateIamInstanceProfileResponse] =
        IO.fromFuture {
        IO(underlying.associateIamInstanceProfile(associateIamInstanceProfileRequest))
        }

        override def associateRouteTable(associateRouteTableRequest: AssociateRouteTableRequest): IO[AssociateRouteTableResponse] =
        IO.fromFuture {
        IO(underlying.associateRouteTable(associateRouteTableRequest))
        }

        override def associateSubnetCidrBlock(associateSubnetCidrBlockRequest: AssociateSubnetCidrBlockRequest): IO[AssociateSubnetCidrBlockResponse] =
        IO.fromFuture {
        IO(underlying.associateSubnetCidrBlock(associateSubnetCidrBlockRequest))
        }

        override def associateTransitGatewayMulticastDomain(associateTransitGatewayMulticastDomainRequest: AssociateTransitGatewayMulticastDomainRequest): IO[AssociateTransitGatewayMulticastDomainResponse] =
        IO.fromFuture {
        IO(underlying.associateTransitGatewayMulticastDomain(associateTransitGatewayMulticastDomainRequest))
        }

        override def associateTransitGatewayRouteTable(associateTransitGatewayRouteTableRequest: AssociateTransitGatewayRouteTableRequest): IO[AssociateTransitGatewayRouteTableResponse] =
        IO.fromFuture {
        IO(underlying.associateTransitGatewayRouteTable(associateTransitGatewayRouteTableRequest))
        }

        override def associateVpcCidrBlock(associateVpcCidrBlockRequest: AssociateVpcCidrBlockRequest): IO[AssociateVpcCidrBlockResponse] =
        IO.fromFuture {
        IO(underlying.associateVpcCidrBlock(associateVpcCidrBlockRequest))
        }

        override def attachClassicLinkVpc(attachClassicLinkVpcRequest: AttachClassicLinkVpcRequest): IO[AttachClassicLinkVpcResponse] =
        IO.fromFuture {
        IO(underlying.attachClassicLinkVpc(attachClassicLinkVpcRequest))
        }

        override def attachInternetGateway(attachInternetGatewayRequest: AttachInternetGatewayRequest): IO[AttachInternetGatewayResponse] =
        IO.fromFuture {
        IO(underlying.attachInternetGateway(attachInternetGatewayRequest))
        }

        override def attachNetworkInterface(attachNetworkInterfaceRequest: AttachNetworkInterfaceRequest): IO[AttachNetworkInterfaceResponse] =
        IO.fromFuture {
        ...
        override def authorizeClientVpnIngress(authorizeClientVpnIngressRequest: AuthorizeClientVpnIngressRequest): IO[AuthorizeClientVpnIngressResponse] =
        IO.fromFuture {
        IO(underlying.authorizeClientVpnIngress(authorizeClientVpnIngressRequest))
        }

        override def authorizeSecurityGroupEgress(authorizeSecurityGroupEgressRequest: AuthorizeSecurityGroupEgressRequest): IO[AuthorizeSecurityGroupEgressResponse] =
        IO.fromFuture {
        IO(underlying.authorizeSecurityGroupEgress(authorizeSecurityGroupEgressRequest))
        }

        override def authorizeSecurityGroupIngress(authorizeSecurityGroupIngressRequest: AuthorizeSecurityGroupIngressRequest): IO[AuthorizeSecurityGroupIngressResponse] =
        IO.fromFuture {
        ...
        override def cancelCapacityReservation(cancelCapacityReservationRequest: CancelCapacityReservationRequest): IO[CancelCapacityReservationResponse] =
        IO.fromFuture {
        IO(underlying.cancelCapacityReservation(cancelCapacityReservationRequest))
        }

        override def cancelConversionTask(cancelConversionTaskRequest: CancelConversionTaskRequest): IO[CancelConversionTaskResponse] =
        IO.fromFuture {
        ...
        override def cancelReservedInstancesListing(cancelReservedInstancesListingRequest: CancelReservedInstancesListingRequest): IO[CancelReservedInstancesListingResponse] =
        IO.fromFuture {
        IO(underlying.cancelReservedInstancesListing(cancelReservedInstancesListingRequest))
        }

        override def cancelSpotFleetRequests(cancelSpotFleetRequestsRequest: CancelSpotFleetRequestsRequest): IO[CancelSpotFleetRequestsResponse] =
        IO.fromFuture {
        IO(underlying.cancelSpotFleetRequests(cancelSpotFleetRequestsRequest))
        }

        override def cancelSpotInstanceRequests(cancelSpotInstanceRequestsRequest: CancelSpotInstanceRequestsRequest): IO[CancelSpotInstanceRequestsResponse] =
        IO.fromFuture {
        IO(underlying.cancelSpotInstanceRequests(cancelSpotInstanceRequestsRequest))
        }

        override def confirmProductInstance(confirmProductInstanceRequest: ConfirmProductInstanceRequest): IO[ConfirmProductInstanceResponse] =
        IO.fromFuture {
        ...
        override def createCapacityReservation(createCapacityReservationRequest: CreateCapacityReservationRequest): IO[CreateCapacityReservationResponse] =
        IO.fromFuture {
        IO(underlying.createCapacityReservation(createCapacityReservationRequest))
        }

        override def createClientVpnEndpoint(createClientVpnEndpointRequest: CreateClientVpnEndpointRequest): IO[CreateClientVpnEndpointResponse] =
        IO.fromFuture {
        IO(underlying.createClientVpnEndpoint(createClientVpnEndpointRequest))
        }

        override def createClientVpnRoute(createClientVpnRouteRequest: CreateClientVpnRouteRequest): IO[CreateClientVpnRouteResponse] =
        IO.fromFuture {
        IO(underlying.createClientVpnRoute(createClientVpnRouteRequest))
        }

        override def createCustomerGateway(createCustomerGatewayRequest: CreateCustomerGatewayRequest): IO[CreateCustomerGatewayResponse] =
        IO.fromFuture {
        IO(underlying.createCustomerGateway(createCustomerGatewayRequest))
        }

        override def createDefaultSubnet(createDefaultSubnetRequest: CreateDefaultSubnetRequest): IO[CreateDefaultSubnetResponse] =
        IO.fromFuture {
        ...
        override def createEgressOnlyInternetGateway(createEgressOnlyInternetGatewayRequest: CreateEgressOnlyInternetGatewayRequest): IO[CreateEgressOnlyInternetGatewayResponse] =
        IO.fromFuture {
        ...
        override def createInstanceExportTask(createInstanceExportTaskRequest: CreateInstanceExportTaskRequest): IO[CreateInstanceExportTaskResponse] =
        IO.fromFuture {
        IO(underlying.createInstanceExportTask(createInstanceExportTaskRequest))
        }

        override def createInternetGateway(createInternetGatewayRequest: CreateInternetGatewayRequest): IO[CreateInternetGatewayResponse] =
        IO.fromFuture {
        ...
        override def createLaunchTemplate(createLaunchTemplateRequest: CreateLaunchTemplateRequest): IO[CreateLaunchTemplateResponse] =
        IO.fromFuture {
        IO(underlying.createLaunchTemplate(createLaunchTemplateRequest))
        }

        override def createLaunchTemplateVersion(createLaunchTemplateVersionRequest: CreateLaunchTemplateVersionRequest): IO[CreateLaunchTemplateVersionResponse] =
        IO.fromFuture {
        IO(underlying.createLaunchTemplateVersion(createLaunchTemplateVersionRequest))
        }

        override def createLocalGatewayRoute(createLocalGatewayRouteRequest: CreateLocalGatewayRouteRequest): IO[CreateLocalGatewayRouteResponse] =
        IO.fromFuture {
        IO(underlying.createLocalGatewayRoute(createLocalGatewayRouteRequest))
        }

        override def createLocalGatewayRouteTableVpcAssociation(createLocalGatewayRouteTableVpcAssociationRequest: CreateLocalGatewayRouteTableVpcAssociationRequest): IO[CreateLocalGatewayRouteTableVpcAssociationResponse] =
        IO.fromFuture {
        ...
        override def createNetworkAclEntry(createNetworkAclEntryRequest: CreateNetworkAclEntryRequest): IO[CreateNetworkAclEntryResponse] =
        IO.fromFuture {
        IO(underlying.createNetworkAclEntry(createNetworkAclEntryRequest))
        }

        override def createNetworkInterface(createNetworkInterfaceRequest: CreateNetworkInterfaceRequest): IO[CreateNetworkInterfaceResponse] =
        IO.fromFuture {
        IO(underlying.createNetworkInterface(createNetworkInterfaceRequest))
        }

        override def createNetworkInterfacePermission(createNetworkInterfacePermissionRequest: CreateNetworkInterfacePermissionRequest): IO[CreateNetworkInterfacePermissionResponse] =
        IO.fromFuture {
        IO(underlying.createNetworkInterfacePermission(createNetworkInterfacePermissionRequest))
        }

        override def createPlacementGroup(createPlacementGroupRequest: CreatePlacementGroupRequest): IO[CreatePlacementGroupResponse] =
        IO.fromFuture {
        IO(underlying.createPlacementGroup(createPlacementGroupRequest))
        }

        override def createReservedInstancesListing(createReservedInstancesListingRequest: CreateReservedInstancesListingRequest): IO[CreateReservedInstancesListingResponse] =
        IO.fromFuture {
        ...
        override def createSecurityGroup(createSecurityGroupRequest: CreateSecurityGroupRequest): IO[CreateSecurityGroupResponse] =
        IO.fromFuture {
        ...
        override def createSpotDatafeedSubscription(createSpotDatafeedSubscriptionRequest: CreateSpotDatafeedSubscriptionRequest): IO[CreateSpotDatafeedSubscriptionResponse] =
        IO.fromFuture {
        ...
        override def createTrafficMirrorFilter(createTrafficMirrorFilterRequest: CreateTrafficMirrorFilterRequest): IO[CreateTrafficMirrorFilterResponse] =
        IO.fromFuture {
        IO(underlying.createTrafficMirrorFilter(createTrafficMirrorFilterRequest))
        }

        override def createTrafficMirrorFilterRule(createTrafficMirrorFilterRuleRequest: CreateTrafficMirrorFilterRuleRequest): IO[CreateTrafficMirrorFilterRuleResponse] =
        IO.fromFuture {
        IO(underlying.createTrafficMirrorFilterRule(createTrafficMirrorFilterRuleRequest))
        }

        override def createTrafficMirrorSession(createTrafficMirrorSessionRequest: CreateTrafficMirrorSessionRequest): IO[CreateTrafficMirrorSessionResponse] =
        IO.fromFuture {
        IO(underlying.createTrafficMirrorSession(createTrafficMirrorSessionRequest))
        }

        override def createTrafficMirrorTarget(createTrafficMirrorTargetRequest: CreateTrafficMirrorTargetRequest): IO[CreateTrafficMirrorTargetResponse] =
        IO.fromFuture {
        IO(underlying.createTrafficMirrorTarget(createTrafficMirrorTargetRequest))
        }

        override def createTransitGateway(createTransitGatewayRequest: CreateTransitGatewayRequest): IO[CreateTransitGatewayResponse] =
        IO.fromFuture {
        ...
        override def createTransitGatewayMulticastDomain(createTransitGatewayMulticastDomainRequest: CreateTransitGatewayMulticastDomainRequest): IO[CreateTransitGatewayMulticastDomainResponse] =
        IO.fromFuture {
        IO(underlying.createTransitGatewayMulticastDomain(createTransitGatewayMulticastDomainRequest))
        }

        override def createTransitGatewayPeeringAttachment(createTransitGatewayPeeringAttachmentRequest: CreateTransitGatewayPeeringAttachmentRequest): IO[CreateTransitGatewayPeeringAttachmentResponse] =
        IO.fromFuture {
        IO(underlying.createTransitGatewayPeeringAttachment(createTransitGatewayPeeringAttachmentRequest))
        }

        override def createTransitGatewayRoute(createTransitGatewayRouteRequest: CreateTransitGatewayRouteRequest): IO[CreateTransitGatewayRouteResponse] =
        IO.fromFuture {
        IO(underlying.createTransitGatewayRoute(createTransitGatewayRouteRequest))
        }

        override def createTransitGatewayRouteTable(createTransitGatewayRouteTableRequest: CreateTransitGatewayRouteTableRequest): IO[CreateTransitGatewayRouteTableResponse] =
        IO.fromFuture {
        IO(underlying.createTransitGatewayRouteTable(createTransitGatewayRouteTableRequest))
        }

        override def createTransitGatewayVpcAttachment(createTransitGatewayVpcAttachmentRequest: CreateTransitGatewayVpcAttachmentRequest): IO[CreateTransitGatewayVpcAttachmentResponse] =
        IO.fromFuture {
        ...
        override def createVpcEndpointConnectionNotification(createVpcEndpointConnectionNotificationRequest: CreateVpcEndpointConnectionNotificationRequest): IO[CreateVpcEndpointConnectionNotificationResponse] =
        IO.fromFuture {
        IO(underlying.createVpcEndpointConnectionNotification(createVpcEndpointConnectionNotificationRequest))
        }

        override def createVpcEndpointServiceConfiguration(createVpcEndpointServiceConfigurationRequest: CreateVpcEndpointServiceConfigurationRequest): IO[CreateVpcEndpointServiceConfigurationResponse] =
        IO.fromFuture {
        IO(underlying.createVpcEndpointServiceConfiguration(createVpcEndpointServiceConfigurationRequest))
        }

        override def createVpcPeeringConnection(createVpcPeeringConnectionRequest: CreateVpcPeeringConnectionRequest): IO[CreateVpcPeeringConnectionResponse] =
        IO.fromFuture {
        IO(underlying.createVpcPeeringConnection(createVpcPeeringConnectionRequest))
        }

        override def createVpnConnection(createVpnConnectionRequest: CreateVpnConnectionRequest): IO[CreateVpnConnectionResponse] =
        IO.fromFuture {
        IO(underlying.createVpnConnection(createVpnConnectionRequest))
        }

        override def createVpnConnectionRoute(createVpnConnectionRouteRequest: CreateVpnConnectionRouteRequest): IO[CreateVpnConnectionRouteResponse] =
        IO.fromFuture {
        ...
        override def deleteClientVpnEndpoint(deleteClientVpnEndpointRequest: DeleteClientVpnEndpointRequest): IO[DeleteClientVpnEndpointResponse] =
        IO.fromFuture {
        IO(underlying.deleteClientVpnEndpoint(deleteClientVpnEndpointRequest))
        }

        override def deleteClientVpnRoute(deleteClientVpnRouteRequest: DeleteClientVpnRouteRequest): IO[DeleteClientVpnRouteResponse] =
        IO.fromFuture {
        IO(underlying.deleteClientVpnRoute(deleteClientVpnRouteRequest))
        }

        override def deleteCustomerGateway(deleteCustomerGatewayRequest: DeleteCustomerGatewayRequest): IO[DeleteCustomerGatewayResponse] =
        IO.fromFuture {
        ...
        override def deleteEgressOnlyInternetGateway(deleteEgressOnlyInternetGatewayRequest: DeleteEgressOnlyInternetGatewayRequest): IO[DeleteEgressOnlyInternetGatewayResponse] =
        IO.fromFuture {
        ...
        override def deleteInternetGateway(deleteInternetGatewayRequest: DeleteInternetGatewayRequest): IO[DeleteInternetGatewayResponse] =
        IO.fromFuture {
        ...
        override def deleteLaunchTemplate(deleteLaunchTemplateRequest: DeleteLaunchTemplateRequest): IO[DeleteLaunchTemplateResponse] =
        IO.fromFuture {
        IO(underlying.deleteLaunchTemplate(deleteLaunchTemplateRequest))
        }

        override def deleteLaunchTemplateVersions(deleteLaunchTemplateVersionsRequest: DeleteLaunchTemplateVersionsRequest): IO[DeleteLaunchTemplateVersionsResponse] =
        IO.fromFuture {
        IO(underlying.deleteLaunchTemplateVersions(deleteLaunchTemplateVersionsRequest))
        }

        override def deleteLocalGatewayRoute(deleteLocalGatewayRouteRequest: DeleteLocalGatewayRouteRequest): IO[DeleteLocalGatewayRouteResponse] =
        IO.fromFuture {
        IO(underlying.deleteLocalGatewayRoute(deleteLocalGatewayRouteRequest))
        }

        override def deleteLocalGatewayRouteTableVpcAssociation(deleteLocalGatewayRouteTableVpcAssociationRequest: DeleteLocalGatewayRouteTableVpcAssociationRequest): IO[DeleteLocalGatewayRouteTableVpcAssociationResponse] =
        IO.fromFuture {
        ...
        override def deleteNetworkAclEntry(deleteNetworkAclEntryRequest: DeleteNetworkAclEntryRequest): IO[DeleteNetworkAclEntryResponse] =
        IO.fromFuture {
        IO(underlying.deleteNetworkAclEntry(deleteNetworkAclEntryRequest))
        }

        override def deleteNetworkInterface(deleteNetworkInterfaceRequest: DeleteNetworkInterfaceRequest): IO[DeleteNetworkInterfaceResponse] =
        IO.fromFuture {
        IO(underlying.deleteNetworkInterface(deleteNetworkInterfaceRequest))
        }

        override def deleteNetworkInterfacePermission(deleteNetworkInterfacePermissionRequest: DeleteNetworkInterfacePermissionRequest): IO[DeleteNetworkInterfacePermissionResponse] =
        IO.fromFuture {
        IO(underlying.deleteNetworkInterfacePermission(deleteNetworkInterfacePermissionRequest))
        }

        override def deletePlacementGroup(deletePlacementGroupRequest: DeletePlacementGroupRequest): IO[DeletePlacementGroupResponse] =
        IO.fromFuture {
        IO(underlying.deletePlacementGroup(deletePlacementGroupRequest))
        }

        override def deleteQueuedReservedInstances(deleteQueuedReservedInstancesRequest: DeleteQueuedReservedInstancesRequest): IO[DeleteQueuedReservedInstancesResponse] =
        IO.fromFuture {
        ...
        override def deleteSecurityGroup(deleteSecurityGroupRequest: DeleteSecurityGroupRequest): IO[DeleteSecurityGroupResponse] =
        IO.fromFuture {
        ...
        override def deleteSpotDatafeedSubscription(deleteSpotDatafeedSubscriptionRequest: DeleteSpotDatafeedSubscriptionRequest): IO[DeleteSpotDatafeedSubscriptionResponse] =
        IO.fromFuture {
        ...
        override def deleteTrafficMirrorFilter(deleteTrafficMirrorFilterRequest: DeleteTrafficMirrorFilterRequest): IO[DeleteTrafficMirrorFilterResponse] =
        IO.fromFuture {
        IO(underlying.deleteTrafficMirrorFilter(deleteTrafficMirrorFilterRequest))
        }

        override def deleteTrafficMirrorFilterRule(deleteTrafficMirrorFilterRuleRequest: DeleteTrafficMirrorFilterRuleRequest): IO[DeleteTrafficMirrorFilterRuleResponse] =
        IO.fromFuture {
        IO(underlying.deleteTrafficMirrorFilterRule(deleteTrafficMirrorFilterRuleRequest))
        }

        override def deleteTrafficMirrorSession(deleteTrafficMirrorSessionRequest: DeleteTrafficMirrorSessionRequest): IO[DeleteTrafficMirrorSessionResponse] =
        IO.fromFuture {
        IO(underlying.deleteTrafficMirrorSession(deleteTrafficMirrorSessionRequest))
        }

        override def deleteTrafficMirrorTarget(deleteTrafficMirrorTargetRequest: DeleteTrafficMirrorTargetRequest): IO[DeleteTrafficMirrorTargetResponse] =
        IO.fromFuture {
        IO(underlying.deleteTrafficMirrorTarget(deleteTrafficMirrorTargetRequest))
        }

        override def deleteTransitGateway(deleteTransitGatewayRequest: DeleteTransitGatewayRequest): IO[DeleteTransitGatewayResponse] =
        IO.fromFuture {
        IO(underlying.deleteTransitGateway(deleteTransitGatewayRequest))
        }

        override def deleteTransitGatewayMulticastDomain(deleteTransitGatewayMulticastDomainRequest: DeleteTransitGatewayMulticastDomainRequest): IO[DeleteTransitGatewayMulticastDomainResponse] =
        IO.fromFuture {
        IO(underlying.deleteTransitGatewayMulticastDomain(deleteTransitGatewayMulticastDomainRequest))
        }

        override def deleteTransitGatewayPeeringAttachment(deleteTransitGatewayPeeringAttachmentRequest: DeleteTransitGatewayPeeringAttachmentRequest): IO[DeleteTransitGatewayPeeringAttachmentResponse] =
        IO.fromFuture {
        IO(underlying.deleteTransitGatewayPeeringAttachment(deleteTransitGatewayPeeringAttachmentRequest))
        }

        override def deleteTransitGatewayRoute(deleteTransitGatewayRouteRequest: DeleteTransitGatewayRouteRequest): IO[DeleteTransitGatewayRouteResponse] =
        IO.fromFuture {
        IO(underlying.deleteTransitGatewayRoute(deleteTransitGatewayRouteRequest))
        }

        override def deleteTransitGatewayRouteTable(deleteTransitGatewayRouteTableRequest: DeleteTransitGatewayRouteTableRequest): IO[DeleteTransitGatewayRouteTableResponse] =
        IO.fromFuture {
        IO(underlying.deleteTransitGatewayRouteTable(deleteTransitGatewayRouteTableRequest))
        }

        override def deleteTransitGatewayVpcAttachment(deleteTransitGatewayVpcAttachmentRequest: DeleteTransitGatewayVpcAttachmentRequest): IO[DeleteTransitGatewayVpcAttachmentResponse] =
        IO.fromFuture {
        ...
        override def deleteVpcEndpointConnectionNotifications(deleteVpcEndpointConnectionNotificationsRequest: DeleteVpcEndpointConnectionNotificationsRequest): IO[DeleteVpcEndpointConnectionNotificationsResponse] =
        IO.fromFuture {
        IO(underlying.deleteVpcEndpointConnectionNotifications(deleteVpcEndpointConnectionNotificationsRequest))
        }

        override def deleteVpcEndpointServiceConfigurations(deleteVpcEndpointServiceConfigurationsRequest: DeleteVpcEndpointServiceConfigurationsRequest): IO[DeleteVpcEndpointServiceConfigurationsResponse] =
        IO.fromFuture {
        IO(underlying.deleteVpcEndpointServiceConfigurations(deleteVpcEndpointServiceConfigurationsRequest))
        }

        override def deleteVpcEndpoints(deleteVpcEndpointsRequest: DeleteVpcEndpointsRequest): IO[DeleteVpcEndpointsResponse] =
        IO.fromFuture {
        IO(underlying.deleteVpcEndpoints(deleteVpcEndpointsRequest))
        }

        override def deleteVpcPeeringConnection(deleteVpcPeeringConnectionRequest: DeleteVpcPeeringConnectionRequest): IO[DeleteVpcPeeringConnectionResponse] =
        IO.fromFuture {
        IO(underlying.deleteVpcPeeringConnection(deleteVpcPeeringConnectionRequest))
        }

        override def deleteVpnConnection(deleteVpnConnectionRequest: DeleteVpnConnectionRequest): IO[DeleteVpnConnectionResponse] =
        IO.fromFuture {
        IO(underlying.deleteVpnConnection(deleteVpnConnectionRequest))
        }

        override def deleteVpnConnectionRoute(deleteVpnConnectionRouteRequest: DeleteVpnConnectionRouteRequest): IO[DeleteVpnConnectionRouteResponse] =
        IO.fromFuture {
        ...
        override def deprovisionByoipCidr(deprovisionByoipCidrRequest: DeprovisionByoipCidrRequest): IO[DeprovisionByoipCidrResponse] =
        IO.fromFuture {
        ...
        override def deregisterInstanceEventNotificationAttributes(deregisterInstanceEventNotificationAttributesRequest: DeregisterInstanceEventNotificationAttributesRequest): IO[DeregisterInstanceEventNotificationAttributesResponse] =
        IO.fromFuture {
        IO(underlying.deregisterInstanceEventNotificationAttributes(deregisterInstanceEventNotificationAttributesRequest))
        }

        override def deregisterTransitGatewayMulticastGroupMembers(deregisterTransitGatewayMulticastGroupMembersRequest: DeregisterTransitGatewayMulticastGroupMembersRequest): IO[DeregisterTransitGatewayMulticastGroupMembersResponse] =
        IO.fromFuture {
        IO(underlying.deregisterTransitGatewayMulticastGroupMembers(deregisterTransitGatewayMulticastGroupMembersRequest))
        }

        override def deregisterTransitGatewayMulticastGroupSources(deregisterTransitGatewayMulticastGroupSourcesRequest: DeregisterTransitGatewayMulticastGroupSourcesRequest): IO[DeregisterTransitGatewayMulticastGroupSourcesResponse] =
        IO.fromFuture {
        IO(underlying.deregisterTransitGatewayMulticastGroupSources(deregisterTransitGatewayMulticastGroupSourcesRequest))
        }

        override def describeAccountAttributes(describeAccountAttributesRequest: DescribeAccountAttributesRequest): IO[DescribeAccountAttributesResponse] =
        IO.fromFuture {
        ...
        override def describeAggregateIdFormat(describeAggregateIdFormatRequest: DescribeAggregateIdFormatRequest): IO[DescribeAggregateIdFormatResponse] =
        IO.fromFuture {
        ...
        override def describeAvailabilityZones(describeAvailabilityZonesRequest: DescribeAvailabilityZonesRequest): IO[DescribeAvailabilityZonesResponse] =
        IO.fromFuture {
        ...
        override def describeBundleTasks(describeBundleTasksRequest: DescribeBundleTasksRequest): IO[DescribeBundleTasksResponse] =
        IO.fromFuture {
        ...
        override def describeByoipCidrs(describeByoipCidrsRequest: DescribeByoipCidrsRequest): IO[DescribeByoipCidrsResponse] =
        IO.fromFuture {
        ...
        override def describeCapacityReservations(describeCapacityReservationsRequest: DescribeCapacityReservationsRequest): IO[DescribeCapacityReservationsResponse] =
        IO.fromFuture {
        ...
        override def describeClassicLinkInstances(describeClassicLinkInstancesRequest: DescribeClassicLinkInstancesRequest): IO[DescribeClassicLinkInstancesResponse] =
        IO.fromFuture {
        ...
        override def describeClientVpnAuthorizationRules(describeClientVpnAuthorizationRulesRequest: DescribeClientVpnAuthorizationRulesRequest): IO[DescribeClientVpnAuthorizationRulesResponse] =
        IO.fromFuture {
        ...
        override def describeClientVpnConnections(describeClientVpnConnectionsRequest: DescribeClientVpnConnectionsRequest): IO[DescribeClientVpnConnectionsResponse] =
        IO.fromFuture {
        ...
        override def describeClientVpnEndpoints(describeClientVpnEndpointsRequest: DescribeClientVpnEndpointsRequest): IO[DescribeClientVpnEndpointsResponse] =
        IO.fromFuture {
        ...
        override def describeClientVpnRoutes(describeClientVpnRoutesRequest: DescribeClientVpnRoutesRequest): IO[DescribeClientVpnRoutesResponse] =
        IO.fromFuture {
        ...
        override def describeClientVpnTargetNetworks(describeClientVpnTargetNetworksRequest: DescribeClientVpnTargetNetworksRequest): IO[DescribeClientVpnTargetNetworksResponse] =
        IO.fromFuture {
        ...
        override def describeConversionTasks(describeConversionTasksRequest: DescribeConversionTasksRequest): IO[DescribeConversionTasksResponse] =
        IO.fromFuture {
        ...
        override def describeCustomerGateways(describeCustomerGatewaysRequest: DescribeCustomerGatewaysRequest): IO[DescribeCustomerGatewaysResponse] =
        IO.fromFuture {
        ...
        override def describeDhcpOptions(describeDhcpOptionsRequest: DescribeDhcpOptionsRequest): IO[DescribeDhcpOptionsResponse] =
        IO.fromFuture {
        ...
        override def describeEgressOnlyInternetGateways(describeEgressOnlyInternetGatewaysRequest: DescribeEgressOnlyInternetGatewaysRequest): IO[DescribeEgressOnlyInternetGatewaysResponse] =
        IO.fromFuture {
        ...
        override def describeElasticGpus(describeElasticGpusRequest: DescribeElasticGpusRequest): IO[DescribeElasticGpusResponse] =
        IO.fromFuture {
        ...
        override def describeExportImageTasks(describeExportImageTasksRequest: DescribeExportImageTasksRequest): IO[DescribeExportImageTasksResponse] =
        IO.fromFuture {
        ...
        override def describeExportTasks(describeExportTasksRequest: DescribeExportTasksRequest): IO[DescribeExportTasksResponse] =
        IO.fromFuture {
        ...
        override def describeFastSnapshotRestores(describeFastSnapshotRestoresRequest: DescribeFastSnapshotRestoresRequest): IO[DescribeFastSnapshotRestoresResponse] =
        IO.fromFuture {
        ...
        override def describeFleetHistory(describeFleetHistoryRequest: DescribeFleetHistoryRequest): IO[DescribeFleetHistoryResponse] =
        IO.fromFuture {
        IO(underlying.describeFleetHistory(describeFleetHistoryRequest))
        }

        override def describeFleetInstances(describeFleetInstancesRequest: DescribeFleetInstancesRequest): IO[DescribeFleetInstancesResponse] =
        IO.fromFuture {
        ...
        override def describeFpgaImageAttribute(describeFpgaImageAttributeRequest: DescribeFpgaImageAttributeRequest): IO[DescribeFpgaImageAttributeResponse] =
        IO.fromFuture {
        IO(underlying.describeFpgaImageAttribute(describeFpgaImageAttributeRequest))
        }

        override def describeFpgaImages(describeFpgaImagesRequest: DescribeFpgaImagesRequest): IO[DescribeFpgaImagesResponse] =
        IO.fromFuture {
        ...
        override def describeHostReservationOfferings(describeHostReservationOfferingsRequest: DescribeHostReservationOfferingsRequest): IO[DescribeHostReservationOfferingsResponse] =
        IO.fromFuture {
        ...
        override def describeHostReservations(describeHostReservationsRequest: DescribeHostReservationsRequest): IO[DescribeHostReservationsResponse] =
        IO.fromFuture {
        ...
        override def describeIamInstanceProfileAssociations(describeIamInstanceProfileAssociationsRequest: DescribeIamInstanceProfileAssociationsRequest): IO[DescribeIamInstanceProfileAssociationsResponse] =
        IO.fromFuture {
        ...
        override def describeIdentityIdFormat(describeIdentityIdFormatRequest: DescribeIdentityIdFormatRequest): IO[DescribeIdentityIdFormatResponse] =
        IO.fromFuture {
        IO(underlying.describeIdentityIdFormat(describeIdentityIdFormatRequest))
        }

        override def describeImageAttribute(describeImageAttributeRequest: DescribeImageAttributeRequest): IO[DescribeImageAttributeResponse] =
        IO.fromFuture {
        ...
        override def describeImportImageTasks(describeImportImageTasksRequest: DescribeImportImageTasksRequest): IO[DescribeImportImageTasksResponse] =
        IO.fromFuture {
        ...
        override def describeImportSnapshotTasks(describeImportSnapshotTasksRequest: DescribeImportSnapshotTasksRequest): IO[DescribeImportSnapshotTasksResponse] =
        IO.fromFuture {
        ...
        override def describeInstanceAttribute(describeInstanceAttributeRequest: DescribeInstanceAttributeRequest): IO[DescribeInstanceAttributeResponse] =
        IO.fromFuture {
        IO(underlying.describeInstanceAttribute(describeInstanceAttributeRequest))
        }

        override def describeInstanceCreditSpecifications(describeInstanceCreditSpecificationsRequest: DescribeInstanceCreditSpecificationsRequest): IO[DescribeInstanceCreditSpecificationsResponse] =
        IO.fromFuture {
        ...
        override def describeInstanceEventNotificationAttributes(describeInstanceEventNotificationAttributesRequest: DescribeInstanceEventNotificationAttributesRequest): IO[DescribeInstanceEventNotificationAttributesResponse] =
        IO.fromFuture {
        IO(underlying.describeInstanceEventNotificationAttributes(describeInstanceEventNotificationAttributesRequest))
        }

        override def describeInstanceStatus(describeInstanceStatusRequest: DescribeInstanceStatusRequest): IO[DescribeInstanceStatusResponse] =
        IO.fromFuture {
        ...
        override def describeInstanceTypeOfferings(describeInstanceTypeOfferingsRequest: DescribeInstanceTypeOfferingsRequest): IO[DescribeInstanceTypeOfferingsResponse] =
        IO.fromFuture {
        ...
        override def describeInstanceTypes(describeInstanceTypesRequest: DescribeInstanceTypesRequest): IO[DescribeInstanceTypesResponse] =
        IO.fromFuture {
        ...
        override def describeInternetGateways(describeInternetGatewaysRequest: DescribeInternetGatewaysRequest): IO[DescribeInternetGatewaysResponse] =
        IO.fromFuture {
        ...
        override def describeLaunchTemplateVersions(describeLaunchTemplateVersionsRequest: DescribeLaunchTemplateVersionsRequest): IO[DescribeLaunchTemplateVersionsResponse] =
        IO.fromFuture {
        ...
        override def describeLaunchTemplates(describeLaunchTemplatesRequest: DescribeLaunchTemplatesRequest): IO[DescribeLaunchTemplatesResponse] =
        IO.fromFuture {
        ...
        override def describeLocalGatewayRouteTableVirtualInterfaceGroupAssociations(describeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequest: DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequest): IO[DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsResponse] =
        IO.fromFuture {
        IO(underlying.describeLocalGatewayRouteTableVirtualInterfaceGroupAssociations(describeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequest))
        }
        ...
        override def describeLocalGatewayRouteTableVpcAssociations(describeLocalGatewayRouteTableVpcAssociationsRequest: DescribeLocalGatewayRouteTableVpcAssociationsRequest): IO[DescribeLocalGatewayRouteTableVpcAssociationsResponse] =
        IO.fromFuture {
        ...
        override def describeLocalGatewayRouteTables(describeLocalGatewayRouteTablesRequest: DescribeLocalGatewayRouteTablesRequest): IO[DescribeLocalGatewayRouteTablesResponse] =
        IO.fromFuture {
        ...
        override def describeLocalGatewayVirtualInterfaceGroups(describeLocalGatewayVirtualInterfaceGroupsRequest: DescribeLocalGatewayVirtualInterfaceGroupsRequest): IO[DescribeLocalGatewayVirtualInterfaceGroupsResponse] =
        IO.fromFuture {
        ...
        override def describeLocalGatewayVirtualInterfaces(describeLocalGatewayVirtualInterfacesRequest: DescribeLocalGatewayVirtualInterfacesRequest): IO[DescribeLocalGatewayVirtualInterfacesResponse] =
        IO.fromFuture {
        ...
        override def describeLocalGateways(describeLocalGatewaysRequest: DescribeLocalGatewaysRequest): IO[DescribeLocalGatewaysResponse] =
        IO.fromFuture {
        ...
        override def describeMovingAddresses(describeMovingAddressesRequest: DescribeMovingAddressesRequest): IO[DescribeMovingAddressesResponse] =
        IO.fromFuture {
        ...
        override def describeNatGateways(describeNatGatewaysRequest: DescribeNatGatewaysRequest): IO[DescribeNatGatewaysResponse] =
        IO.fromFuture {
        ...
        override def describeNetworkAcls(describeNetworkAclsRequest: DescribeNetworkAclsRequest): IO[DescribeNetworkAclsResponse] =
        IO.fromFuture {
        ...
        override def describeNetworkInterfaceAttribute(describeNetworkInterfaceAttributeRequest: DescribeNetworkInterfaceAttributeRequest): IO[DescribeNetworkInterfaceAttributeResponse] =
        IO.fromFuture {
        IO(underlying.describeNetworkInterfaceAttribute(describeNetworkInterfaceAttributeRequest))
        }

        override def describeNetworkInterfacePermissions(describeNetworkInterfacePermissionsRequest: DescribeNetworkInterfacePermissionsRequest): IO[DescribeNetworkInterfacePermissionsResponse] =
        IO.fromFuture {
        ...
        override def describeNetworkInterfaces(describeNetworkInterfacesRequest: DescribeNetworkInterfacesRequest): IO[DescribeNetworkInterfacesResponse] =
        IO.fromFuture {
        ...
        override def describePlacementGroups(describePlacementGroupsRequest: DescribePlacementGroupsRequest): IO[DescribePlacementGroupsResponse] =
        IO.fromFuture {
        ...
        override def describePrefixLists(describePrefixListsRequest: DescribePrefixListsRequest): IO[DescribePrefixListsResponse] =
        IO.fromFuture {
        ...
        override def describePrincipalIdFormat(describePrincipalIdFormatRequest: DescribePrincipalIdFormatRequest): IO[DescribePrincipalIdFormatResponse] =
        IO.fromFuture {
        ...
        override def describePublicIpv4Pools(describePublicIpv4PoolsRequest: DescribePublicIpv4PoolsRequest): IO[DescribePublicIpv4PoolsResponse] =
        IO.fromFuture {
        ...
        override def describeReservedInstances(describeReservedInstancesRequest: DescribeReservedInstancesRequest): IO[DescribeReservedInstancesResponse] =
        IO.fromFuture {
        ...
        override def describeReservedInstancesListings(describeReservedInstancesListingsRequest: DescribeReservedInstancesListingsRequest): IO[DescribeReservedInstancesListingsResponse] =
        IO.fromFuture {
        ...
        override def describeReservedInstancesModifications(describeReservedInstancesModificationsRequest: DescribeReservedInstancesModificationsRequest): IO[DescribeReservedInstancesModificationsResponse] =
        IO.fromFuture {
        ...
        override def describeReservedInstancesOfferings(describeReservedInstancesOfferingsRequest: DescribeReservedInstancesOfferingsRequest): IO[DescribeReservedInstancesOfferingsResponse] =
        IO.fromFuture {
        ...
        override def describeRouteTables(describeRouteTablesRequest: DescribeRouteTablesRequest): IO[DescribeRouteTablesResponse] =
        IO.fromFuture {
        ...
        override def describeScheduledInstanceAvailability(describeScheduledInstanceAvailabilityRequest: DescribeScheduledInstanceAvailabilityRequest): IO[DescribeScheduledInstanceAvailabilityResponse] =
        IO.fromFuture {
        ...
        override def describeScheduledInstances(describeScheduledInstancesRequest: DescribeScheduledInstancesRequest): IO[DescribeScheduledInstancesResponse] =
        IO.fromFuture {
        ...
        override def describeSecurityGroupReferences(describeSecurityGroupReferencesRequest: DescribeSecurityGroupReferencesRequest): IO[DescribeSecurityGroupReferencesResponse] =
        IO.fromFuture {
        IO(underlying.describeSecurityGroupReferences(describeSecurityGroupReferencesRequest))
        }

        override def describeSecurityGroups(describeSecurityGroupsRequest: DescribeSecurityGroupsRequest): IO[DescribeSecurityGroupsResponse] =
        IO.fromFuture {
        ...
        override def describeSnapshotAttribute(describeSnapshotAttributeRequest: DescribeSnapshotAttributeRequest): IO[DescribeSnapshotAttributeResponse] =
        IO.fromFuture {
        ...
        override def describeSpotDatafeedSubscription(describeSpotDatafeedSubscriptionRequest: DescribeSpotDatafeedSubscriptionRequest): IO[DescribeSpotDatafeedSubscriptionResponse] =
        IO.fromFuture {
        ...
        override def describeSpotFleetInstances(describeSpotFleetInstancesRequest: DescribeSpotFleetInstancesRequest): IO[DescribeSpotFleetInstancesResponse] =
        IO.fromFuture {
        IO(underlying.describeSpotFleetInstances(describeSpotFleetInstancesRequest))
        }

        override def describeSpotFleetRequestHistory(describeSpotFleetRequestHistoryRequest: DescribeSpotFleetRequestHistoryRequest): IO[DescribeSpotFleetRequestHistoryResponse] =
        IO.fromFuture {
        IO(underlying.describeSpotFleetRequestHistory(describeSpotFleetRequestHistoryRequest))
        }

        override def describeSpotFleetRequests(describeSpotFleetRequestsRequest: DescribeSpotFleetRequestsRequest): IO[DescribeSpotFleetRequestsResponse] =
        IO.fromFuture {
        ...
        override def describeSpotInstanceRequests(describeSpotInstanceRequestsRequest: DescribeSpotInstanceRequestsRequest): IO[DescribeSpotInstanceRequestsResponse] =
        IO.fromFuture {
        ...
        override def describeSpotPriceHistory(describeSpotPriceHistoryRequest: DescribeSpotPriceHistoryRequest): IO[DescribeSpotPriceHistoryResponse] =
        IO.fromFuture {
        ...
        override def describeStaleSecurityGroups(describeStaleSecurityGroupsRequest: DescribeStaleSecurityGroupsRequest): IO[DescribeStaleSecurityGroupsResponse] =
        IO.fromFuture {
        ...
        override def describeTrafficMirrorFilters(describeTrafficMirrorFiltersRequest: DescribeTrafficMirrorFiltersRequest): IO[DescribeTrafficMirrorFiltersResponse] =
        IO.fromFuture {
        ...
        override def describeTrafficMirrorSessions(describeTrafficMirrorSessionsRequest: DescribeTrafficMirrorSessionsRequest): IO[DescribeTrafficMirrorSessionsResponse] =
        IO.fromFuture {
        ...
        override def describeTrafficMirrorTargets(describeTrafficMirrorTargetsRequest: DescribeTrafficMirrorTargetsRequest): IO[DescribeTrafficMirrorTargetsResponse] =
        IO.fromFuture {
        ...
        override def describeTransitGatewayAttachments(describeTransitGatewayAttachmentsRequest: DescribeTransitGatewayAttachmentsRequest): IO[DescribeTransitGatewayAttachmentsResponse] =
        IO.fromFuture {
        ...
        override def describeTransitGatewayMulticastDomains(describeTransitGatewayMulticastDomainsRequest: DescribeTransitGatewayMulticastDomainsRequest): IO[DescribeTransitGatewayMulticastDomainsResponse] =
        IO.fromFuture {
        ...
        override def describeTransitGatewayPeeringAttachments(describeTransitGatewayPeeringAttachmentsRequest: DescribeTransitGatewayPeeringAttachmentsRequest): IO[DescribeTransitGatewayPeeringAttachmentsResponse] =
        IO.fromFuture {
        ...
        override def describeTransitGatewayRouteTables(describeTransitGatewayRouteTablesRequest: DescribeTransitGatewayRouteTablesRequest): IO[DescribeTransitGatewayRouteTablesResponse] =
        IO.fromFuture {
        ...
        override def describeTransitGatewayVpcAttachments(describeTransitGatewayVpcAttachmentsRequest: DescribeTransitGatewayVpcAttachmentsRequest): IO[DescribeTransitGatewayVpcAttachmentsResponse] =
        IO.fromFuture {
        ...
        override def describeTransitGateways(describeTransitGatewaysRequest: DescribeTransitGatewaysRequest): IO[DescribeTransitGatewaysResponse] =
        IO.fromFuture {
        ...
        override def describeVolumeAttribute(describeVolumeAttributeRequest: DescribeVolumeAttributeRequest): IO[DescribeVolumeAttributeResponse] =
        IO.fromFuture {
        IO(underlying.describeVolumeAttribute(describeVolumeAttributeRequest))
        }

        override def describeVolumeStatus(describeVolumeStatusRequest: DescribeVolumeStatusRequest): IO[DescribeVolumeStatusResponse] =
        IO.fromFuture {
        ...
        override def describeVolumesModifications(describeVolumesModificationsRequest: DescribeVolumesModificationsRequest): IO[DescribeVolumesModificationsResponse] =
        IO.fromFuture {
        ...
        override def describeVpcAttribute(describeVpcAttributeRequest: DescribeVpcAttributeRequest): IO[DescribeVpcAttributeResponse] =
        IO.fromFuture {
        IO(underlying.describeVpcAttribute(describeVpcAttributeRequest))
        }

        override def describeVpcClassicLink(describeVpcClassicLinkRequest: DescribeVpcClassicLinkRequest): IO[DescribeVpcClassicLinkResponse] =
        IO.fromFuture {
        ...
        override def describeVpcClassicLinkDnsSupport(describeVpcClassicLinkDnsSupportRequest: DescribeVpcClassicLinkDnsSupportRequest): IO[DescribeVpcClassicLinkDnsSupportResponse] =
        IO.fromFuture {
        ...
        override def describeVpcEndpointConnectionNotifications(describeVpcEndpointConnectionNotificationsRequest: DescribeVpcEndpointConnectionNotificationsRequest): IO[DescribeVpcEndpointConnectionNotificationsResponse] =
        IO.fromFuture {
        ...
        override def describeVpcEndpointConnections(describeVpcEndpointConnectionsRequest: DescribeVpcEndpointConnectionsRequest): IO[DescribeVpcEndpointConnectionsResponse] =
        IO.fromFuture {
        ...
        override def describeVpcEndpointServiceConfigurations(describeVpcEndpointServiceConfigurationsRequest: DescribeVpcEndpointServiceConfigurationsRequest): IO[DescribeVpcEndpointServiceConfigurationsResponse] =
        IO.fromFuture {
        ...
        override def describeVpcEndpointServicePermissions(describeVpcEndpointServicePermissionsRequest: DescribeVpcEndpointServicePermissionsRequest): IO[DescribeVpcEndpointServicePermissionsResponse] =
        IO.fromFuture {
        ...
        override def describeVpcEndpointServices(describeVpcEndpointServicesRequest: DescribeVpcEndpointServicesRequest): IO[DescribeVpcEndpointServicesResponse] =
        IO.fromFuture {
        ...
        override def describeVpcEndpoints(describeVpcEndpointsRequest: DescribeVpcEndpointsRequest): IO[DescribeVpcEndpointsResponse] =
        IO.fromFuture {
        ...
        override def describeVpcPeeringConnections(describeVpcPeeringConnectionsRequest: DescribeVpcPeeringConnectionsRequest): IO[DescribeVpcPeeringConnectionsResponse] =
        IO.fromFuture {
        ...
        override def describeVpnConnections(describeVpnConnectionsRequest: DescribeVpnConnectionsRequest): IO[DescribeVpnConnectionsResponse] =
        IO.fromFuture {
        ...
        override def describeVpnGateways(describeVpnGatewaysRequest: DescribeVpnGatewaysRequest): IO[DescribeVpnGatewaysResponse] =
        IO.fromFuture {
        ...
        override def detachClassicLinkVpc(detachClassicLinkVpcRequest: DetachClassicLinkVpcRequest): IO[DetachClassicLinkVpcResponse] =
        IO.fromFuture {
        IO(underlying.detachClassicLinkVpc(detachClassicLinkVpcRequest))
        }

        override def detachInternetGateway(detachInternetGatewayRequest: DetachInternetGatewayRequest): IO[DetachInternetGatewayResponse] =
        IO.fromFuture {
        IO(underlying.detachInternetGateway(detachInternetGatewayRequest))
        }

        override def detachNetworkInterface(detachNetworkInterfaceRequest: DetachNetworkInterfaceRequest): IO[DetachNetworkInterfaceResponse] =
        IO.fromFuture {
        ...
        override def disableEbsEncryptionByDefault(disableEbsEncryptionByDefaultRequest: DisableEbsEncryptionByDefaultRequest): IO[DisableEbsEncryptionByDefaultResponse] =
        IO.fromFuture {
        IO(underlying.disableEbsEncryptionByDefault(disableEbsEncryptionByDefaultRequest))
        }

        override def disableFastSnapshotRestores(disableFastSnapshotRestoresRequest: DisableFastSnapshotRestoresRequest): IO[DisableFastSnapshotRestoresResponse] =
        IO.fromFuture {
        IO(underlying.disableFastSnapshotRestores(disableFastSnapshotRestoresRequest))
        }

        override def disableTransitGatewayRouteTablePropagation(disableTransitGatewayRouteTablePropagationRequest: DisableTransitGatewayRouteTablePropagationRequest): IO[DisableTransitGatewayRouteTablePropagationResponse] =
        IO.fromFuture {
        IO(underlying.disableTransitGatewayRouteTablePropagation(disableTransitGatewayRouteTablePropagationRequest))
        }

        override def disableVgwRoutePropagation(disableVgwRoutePropagationRequest: DisableVgwRoutePropagationRequest): IO[DisableVgwRoutePropagationResponse] =
        IO.fromFuture {
        IO(underlying.disableVgwRoutePropagation(disableVgwRoutePropagationRequest))
        }

        override def disableVpcClassicLink(disableVpcClassicLinkRequest: DisableVpcClassicLinkRequest): IO[DisableVpcClassicLinkResponse] =
        IO.fromFuture {
        IO(underlying.disableVpcClassicLink(disableVpcClassicLinkRequest))
        }

        override def disableVpcClassicLinkDnsSupport(disableVpcClassicLinkDnsSupportRequest: DisableVpcClassicLinkDnsSupportRequest): IO[DisableVpcClassicLinkDnsSupportResponse] =
        IO.fromFuture {
        IO(underlying.disableVpcClassicLinkDnsSupport(disableVpcClassicLinkDnsSupportRequest))
        }

        override def disassociateAddress(disassociateAddressRequest: DisassociateAddressRequest): IO[DisassociateAddressResponse] =
        IO.fromFuture {
        IO(underlying.disassociateAddress(disassociateAddressRequest))
        }

        override def disassociateClientVpnTargetNetwork(disassociateClientVpnTargetNetworkRequest: DisassociateClientVpnTargetNetworkRequest): IO[DisassociateClientVpnTargetNetworkResponse] =
        IO.fromFuture {
        IO(underlying.disassociateClientVpnTargetNetwork(disassociateClientVpnTargetNetworkRequest))
        }

        override def disassociateIamInstanceProfile(disassociateIamInstanceProfileRequest: DisassociateIamInstanceProfileRequest): IO[DisassociateIamInstanceProfileResponse] =
        IO.fromFuture {
        IO(underlying.disassociateIamInstanceProfile(disassociateIamInstanceProfileRequest))
        }

        override def disassociateRouteTable(disassociateRouteTableRequest: DisassociateRouteTableRequest): IO[DisassociateRouteTableResponse] =
        IO.fromFuture {
        IO(underlying.disassociateRouteTable(disassociateRouteTableRequest))
        }

        override def disassociateSubnetCidrBlock(disassociateSubnetCidrBlockRequest: DisassociateSubnetCidrBlockRequest): IO[DisassociateSubnetCidrBlockResponse] =
        IO.fromFuture {
        IO(underlying.disassociateSubnetCidrBlock(disassociateSubnetCidrBlockRequest))
        }

        override def disassociateTransitGatewayMulticastDomain(disassociateTransitGatewayMulticastDomainRequest: DisassociateTransitGatewayMulticastDomainRequest): IO[DisassociateTransitGatewayMulticastDomainResponse] =
        IO.fromFuture {
        IO(underlying.disassociateTransitGatewayMulticastDomain(disassociateTransitGatewayMulticastDomainRequest))
        }

        override def disassociateTransitGatewayRouteTable(disassociateTransitGatewayRouteTableRequest: DisassociateTransitGatewayRouteTableRequest): IO[DisassociateTransitGatewayRouteTableResponse] =
        IO.fromFuture {
        IO(underlying.disassociateTransitGatewayRouteTable(disassociateTransitGatewayRouteTableRequest))
        }

        override def disassociateVpcCidrBlock(disassociateVpcCidrBlockRequest: DisassociateVpcCidrBlockRequest): IO[DisassociateVpcCidrBlockResponse] =
        IO.fromFuture {
        IO(underlying.disassociateVpcCidrBlock(disassociateVpcCidrBlockRequest))
        }

        override def enableEbsEncryptionByDefault(enableEbsEncryptionByDefaultRequest: EnableEbsEncryptionByDefaultRequest): IO[EnableEbsEncryptionByDefaultResponse] =
        IO.fromFuture {
        IO(underlying.enableEbsEncryptionByDefault(enableEbsEncryptionByDefaultRequest))
        }

        override def enableFastSnapshotRestores(enableFastSnapshotRestoresRequest: EnableFastSnapshotRestoresRequest): IO[EnableFastSnapshotRestoresResponse] =
        IO.fromFuture {
        IO(underlying.enableFastSnapshotRestores(enableFastSnapshotRestoresRequest))
        }

        override def enableTransitGatewayRouteTablePropagation(enableTransitGatewayRouteTablePropagationRequest: EnableTransitGatewayRouteTablePropagationRequest): IO[EnableTransitGatewayRouteTablePropagationResponse] =
        IO.fromFuture {
        IO(underlying.enableTransitGatewayRouteTablePropagation(enableTransitGatewayRouteTablePropagationRequest))
        }

        override def enableVgwRoutePropagation(enableVgwRoutePropagationRequest: EnableVgwRoutePropagationRequest): IO[EnableVgwRoutePropagationResponse] =
        IO.fromFuture {
        ...
        override def enableVpcClassicLink(enableVpcClassicLinkRequest: EnableVpcClassicLinkRequest): IO[EnableVpcClassicLinkResponse] =
        IO.fromFuture {
        IO(underlying.enableVpcClassicLink(enableVpcClassicLinkRequest))
        }

        override def enableVpcClassicLinkDnsSupport(enableVpcClassicLinkDnsSupportRequest: EnableVpcClassicLinkDnsSupportRequest): IO[EnableVpcClassicLinkDnsSupportResponse] =
        IO.fromFuture {
        IO(underlying.enableVpcClassicLinkDnsSupport(enableVpcClassicLinkDnsSupportRequest))
        }

        override def exportClientVpnClientCertificateRevocationList(exportClientVpnClientCertificateRevocationListRequest: ExportClientVpnClientCertificateRevocationListRequest): IO[ExportClientVpnClientCertificateRevocationListResponse] =
        IO.fromFuture {
        IO(underlying.exportClientVpnClientCertificateRevocationList(exportClientVpnClientCertificateRevocationListRequest))
        }

        override def exportClientVpnClientConfiguration(exportClientVpnClientConfigurationRequest: ExportClientVpnClientConfigurationRequest): IO[ExportClientVpnClientConfigurationResponse] =
        IO.fromFuture {
        ...
        override def exportTransitGatewayRoutes(exportTransitGatewayRoutesRequest: ExportTransitGatewayRoutesRequest): IO[ExportTransitGatewayRoutesResponse] =
        IO.fromFuture {
        IO(underlying.exportTransitGatewayRoutes(exportTransitGatewayRoutesRequest))
        }

        override def getAssociatedIpv6PoolCidrs(getAssociatedIpv6PoolCidrsRequest: GetAssociatedIpv6PoolCidrsRequest): IO[GetAssociatedIpv6PoolCidrsResponse] =
        IO.fromFuture {
        ...
        override def getCapacityReservationUsage(getCapacityReservationUsageRequest: GetCapacityReservationUsageRequest): IO[GetCapacityReservationUsageResponse] =
        IO.fromFuture {
        ...
        override def getConsoleScreenshot(getConsoleScreenshotRequest: GetConsoleScreenshotRequest): IO[GetConsoleScreenshotResponse] =
        IO.fromFuture {
        IO(underlying.getConsoleScreenshot(getConsoleScreenshotRequest))
        }

        override def getDefaultCreditSpecification(getDefaultCreditSpecificationRequest: GetDefaultCreditSpecificationRequest): IO[GetDefaultCreditSpecificationResponse] =
        IO.fromFuture {
        IO(underlying.getDefaultCreditSpecification(getDefaultCreditSpecificationRequest))
        }

        override def getEbsDefaultKmsKeyId(getEbsDefaultKmsKeyIdRequest: GetEbsDefaultKmsKeyIdRequest): IO[GetEbsDefaultKmsKeyIdResponse] =
        IO.fromFuture {
        IO(underlying.getEbsDefaultKmsKeyId(getEbsDefaultKmsKeyIdRequest))
        }

        override def getEbsEncryptionByDefault(getEbsEncryptionByDefaultRequest: GetEbsEncryptionByDefaultRequest): IO[GetEbsEncryptionByDefaultResponse] =
        IO.fromFuture {
        IO(underlying.getEbsEncryptionByDefault(getEbsEncryptionByDefaultRequest))
        }

        override def getHostReservationPurchasePreview(getHostReservationPurchasePreviewRequest: GetHostReservationPurchasePreviewRequest): IO[GetHostReservationPurchasePreviewResponse] =
        IO.fromFuture {
        IO(underlying.getHostReservationPurchasePreview(getHostReservationPurchasePreviewRequest))
        }

        override def getLaunchTemplateData(getLaunchTemplateDataRequest: GetLaunchTemplateDataRequest): IO[GetLaunchTemplateDataResponse] =
        IO.fromFuture {
        ...
        override def getReservedInstancesExchangeQuote(getReservedInstancesExchangeQuoteRequest: GetReservedInstancesExchangeQuoteRequest): IO[GetReservedInstancesExchangeQuoteResponse] =
        IO.fromFuture {
        IO(underlying.getReservedInstancesExchangeQuote(getReservedInstancesExchangeQuoteRequest))
        }

        override def getTransitGatewayAttachmentPropagations(getTransitGatewayAttachmentPropagationsRequest: GetTransitGatewayAttachmentPropagationsRequest): IO[GetTransitGatewayAttachmentPropagationsResponse] =
        IO.fromFuture {
        ...
        override def getTransitGatewayMulticastDomainAssociations(getTransitGatewayMulticastDomainAssociationsRequest: GetTransitGatewayMulticastDomainAssociationsRequest): IO[GetTransitGatewayMulticastDomainAssociationsResponse] =
        IO.fromFuture {
        ...
        override def getTransitGatewayRouteTableAssociations(getTransitGatewayRouteTableAssociationsRequest: GetTransitGatewayRouteTableAssociationsRequest): IO[GetTransitGatewayRouteTableAssociationsResponse] =
        IO.fromFuture {
        ...
        override def getTransitGatewayRouteTablePropagations(getTransitGatewayRouteTablePropagationsRequest: GetTransitGatewayRouteTablePropagationsRequest): IO[GetTransitGatewayRouteTablePropagationsResponse] =
        IO.fromFuture {
        ...
        override def importClientVpnClientCertificateRevocationList(importClientVpnClientCertificateRevocationListRequest: ImportClientVpnClientCertificateRevocationListRequest): IO[ImportClientVpnClientCertificateRevocationListResponse] =
        IO.fromFuture {
        IO(underlying.importClientVpnClientCertificateRevocationList(importClientVpnClientCertificateRevocationListRequest))
        }
        ...
        override def modifyAvailabilityZoneGroup(modifyAvailabilityZoneGroupRequest: ModifyAvailabilityZoneGroupRequest): IO[ModifyAvailabilityZoneGroupResponse] =
        IO.fromFuture {
        IO(underlying.modifyAvailabilityZoneGroup(modifyAvailabilityZoneGroupRequest))
        }

        override def modifyCapacityReservation(modifyCapacityReservationRequest: ModifyCapacityReservationRequest): IO[ModifyCapacityReservationResponse] =
        IO.fromFuture {
        IO(underlying.modifyCapacityReservation(modifyCapacityReservationRequest))
        }

        override def modifyClientVpnEndpoint(modifyClientVpnEndpointRequest: ModifyClientVpnEndpointRequest): IO[ModifyClientVpnEndpointResponse] =
        IO.fromFuture {
        IO(underlying.modifyClientVpnEndpoint(modifyClientVpnEndpointRequest))
        }

        override def modifyDefaultCreditSpecification(modifyDefaultCreditSpecificationRequest: ModifyDefaultCreditSpecificationRequest): IO[ModifyDefaultCreditSpecificationResponse] =
        IO.fromFuture {
        IO(underlying.modifyDefaultCreditSpecification(modifyDefaultCreditSpecificationRequest))
        }

        override def modifyEbsDefaultKmsKeyId(modifyEbsDefaultKmsKeyIdRequest: ModifyEbsDefaultKmsKeyIdRequest): IO[ModifyEbsDefaultKmsKeyIdResponse] =
        IO.fromFuture {
        ...
        override def modifyFpgaImageAttribute(modifyFpgaImageAttributeRequest: ModifyFpgaImageAttributeRequest): IO[ModifyFpgaImageAttributeResponse] =
        IO.fromFuture {
        ...
        override def modifyIdentityIdFormat(modifyIdentityIdFormatRequest: ModifyIdentityIdFormatRequest): IO[ModifyIdentityIdFormatResponse] =
        IO.fromFuture {
        IO(underlying.modifyIdentityIdFormat(modifyIdentityIdFormatRequest))
        }

        override def modifyImageAttribute(modifyImageAttributeRequest: ModifyImageAttributeRequest): IO[ModifyImageAttributeResponse] =
        IO.fromFuture {
        IO(underlying.modifyImageAttribute(modifyImageAttributeRequest))
        }

        override def modifyInstanceAttribute(modifyInstanceAttributeRequest: ModifyInstanceAttributeRequest): IO[ModifyInstanceAttributeResponse] =
        IO.fromFuture {
        IO(underlying.modifyInstanceAttribute(modifyInstanceAttributeRequest))
        }

        override def modifyInstanceCapacityReservationAttributes(modifyInstanceCapacityReservationAttributesRequest: ModifyInstanceCapacityReservationAttributesRequest): IO[ModifyInstanceCapacityReservationAttributesResponse] =
        IO.fromFuture {
        IO(underlying.modifyInstanceCapacityReservationAttributes(modifyInstanceCapacityReservationAttributesRequest))
        }

        override def modifyInstanceCreditSpecification(modifyInstanceCreditSpecificationRequest: ModifyInstanceCreditSpecificationRequest): IO[ModifyInstanceCreditSpecificationResponse] =
        IO.fromFuture {
        IO(underlying.modifyInstanceCreditSpecification(modifyInstanceCreditSpecificationRequest))
        }

        override def modifyInstanceEventStartTime(modifyInstanceEventStartTimeRequest: ModifyInstanceEventStartTimeRequest): IO[ModifyInstanceEventStartTimeResponse] =
        IO.fromFuture {
        IO(underlying.modifyInstanceEventStartTime(modifyInstanceEventStartTimeRequest))
        }

        override def modifyInstanceMetadataOptions(modifyInstanceMetadataOptionsRequest: ModifyInstanceMetadataOptionsRequest): IO[ModifyInstanceMetadataOptionsResponse] =
        IO.fromFuture {
        IO(underlying.modifyInstanceMetadataOptions(modifyInstanceMetadataOptionsRequest))
        }

        override def modifyInstancePlacement(modifyInstancePlacementRequest: ModifyInstancePlacementRequest): IO[ModifyInstancePlacementResponse] =
        IO.fromFuture {
        IO(underlying.modifyInstancePlacement(modifyInstancePlacementRequest))
        }

        override def modifyLaunchTemplate(modifyLaunchTemplateRequest: ModifyLaunchTemplateRequest): IO[ModifyLaunchTemplateResponse] =
        IO.fromFuture {
        IO(underlying.modifyLaunchTemplate(modifyLaunchTemplateRequest))
        }

        override def modifyNetworkInterfaceAttribute(modifyNetworkInterfaceAttributeRequest: ModifyNetworkInterfaceAttributeRequest): IO[ModifyNetworkInterfaceAttributeResponse] =
        IO.fromFuture {
        IO(underlying.modifyNetworkInterfaceAttribute(modifyNetworkInterfaceAttributeRequest))
        }

        override def modifyReservedInstances(modifyReservedInstancesRequest: ModifyReservedInstancesRequest): IO[ModifyReservedInstancesResponse] =
        IO.fromFuture {
        IO(underlying.modifyReservedInstances(modifyReservedInstancesRequest))
        }

        override def modifySnapshotAttribute(modifySnapshotAttributeRequest: ModifySnapshotAttributeRequest): IO[ModifySnapshotAttributeResponse] =
        IO.fromFuture {
        IO(underlying.modifySnapshotAttribute(modifySnapshotAttributeRequest))
        }

        override def modifySpotFleetRequest(modifySpotFleetRequestRequest: ModifySpotFleetRequestRequest): IO[ModifySpotFleetRequestResponse] =
        IO.fromFuture {
        IO(underlying.modifySpotFleetRequest(modifySpotFleetRequestRequest))
        }

        override def modifySubnetAttribute(modifySubnetAttributeRequest: ModifySubnetAttributeRequest): IO[ModifySubnetAttributeResponse] =
        IO.fromFuture {
        IO(underlying.modifySubnetAttribute(modifySubnetAttributeRequest))
        }

        override def modifyTrafficMirrorFilterNetworkServices(modifyTrafficMirrorFilterNetworkServicesRequest: ModifyTrafficMirrorFilterNetworkServicesRequest): IO[ModifyTrafficMirrorFilterNetworkServicesResponse] =
        IO.fromFuture {
        IO(underlying.modifyTrafficMirrorFilterNetworkServices(modifyTrafficMirrorFilterNetworkServicesRequest))
        }

        override def modifyTrafficMirrorFilterRule(modifyTrafficMirrorFilterRuleRequest: ModifyTrafficMirrorFilterRuleRequest): IO[ModifyTrafficMirrorFilterRuleResponse] =
        IO.fromFuture {
        IO(underlying.modifyTrafficMirrorFilterRule(modifyTrafficMirrorFilterRuleRequest))
        }

        override def modifyTrafficMirrorSession(modifyTrafficMirrorSessionRequest: ModifyTrafficMirrorSessionRequest): IO[ModifyTrafficMirrorSessionResponse] =
        IO.fromFuture {
        IO(underlying.modifyTrafficMirrorSession(modifyTrafficMirrorSessionRequest))
        }

        override def modifyTransitGatewayVpcAttachment(modifyTransitGatewayVpcAttachmentRequest: ModifyTransitGatewayVpcAttachmentRequest): IO[ModifyTransitGatewayVpcAttachmentResponse] =
        IO.fromFuture {
        ...
        override def modifyVolumeAttribute(modifyVolumeAttributeRequest: ModifyVolumeAttributeRequest): IO[ModifyVolumeAttributeResponse] =
        IO.fromFuture {
        IO(underlying.modifyVolumeAttribute(modifyVolumeAttributeRequest))
        }

        override def modifyVpcAttribute(modifyVpcAttributeRequest: ModifyVpcAttributeRequest): IO[ModifyVpcAttributeResponse] =
        IO.fromFuture {
        ...
        override def modifyVpcEndpointConnectionNotification(modifyVpcEndpointConnectionNotificationRequest: ModifyVpcEndpointConnectionNotificationRequest): IO[ModifyVpcEndpointConnectionNotificationResponse] =
        IO.fromFuture {
        IO(underlying.modifyVpcEndpointConnectionNotification(modifyVpcEndpointConnectionNotificationRequest))
        }

        override def modifyVpcEndpointServiceConfiguration(modifyVpcEndpointServiceConfigurationRequest: ModifyVpcEndpointServiceConfigurationRequest): IO[ModifyVpcEndpointServiceConfigurationResponse] =
        IO.fromFuture {
        IO(underlying.modifyVpcEndpointServiceConfiguration(modifyVpcEndpointServiceConfigurationRequest))
        }

        override def modifyVpcEndpointServicePermissions(modifyVpcEndpointServicePermissionsRequest: ModifyVpcEndpointServicePermissionsRequest): IO[ModifyVpcEndpointServicePermissionsResponse] =
        IO.fromFuture {
        IO(underlying.modifyVpcEndpointServicePermissions(modifyVpcEndpointServicePermissionsRequest))
        }

        override def modifyVpcPeeringConnectionOptions(modifyVpcPeeringConnectionOptionsRequest: ModifyVpcPeeringConnectionOptionsRequest): IO[ModifyVpcPeeringConnectionOptionsResponse] =
        IO.fromFuture {
        ...
        override def modifyVpnConnection(modifyVpnConnectionRequest: ModifyVpnConnectionRequest): IO[ModifyVpnConnectionResponse] =
        IO.fromFuture {
        IO(underlying.modifyVpnConnection(modifyVpnConnectionRequest))
        }

        override def modifyVpnTunnelCertificate(modifyVpnTunnelCertificateRequest: ModifyVpnTunnelCertificateRequest): IO[ModifyVpnTunnelCertificateResponse] =
        IO.fromFuture {
        IO(underlying.modifyVpnTunnelCertificate(modifyVpnTunnelCertificateRequest))
        }

        override def modifyVpnTunnelOptions(modifyVpnTunnelOptionsRequest: ModifyVpnTunnelOptionsRequest): IO[ModifyVpnTunnelOptionsResponse] =
        IO.fromFuture {
        ...
        override def provisionByoipCidr(provisionByoipCidrRequest: ProvisionByoipCidrRequest): IO[ProvisionByoipCidrResponse] =
        IO.fromFuture {
        IO(underlying.provisionByoipCidr(provisionByoipCidrRequest))
        }

        override def purchaseHostReservation(purchaseHostReservationRequest: PurchaseHostReservationRequest): IO[PurchaseHostReservationResponse] =
        IO.fromFuture {
        IO(underlying.purchaseHostReservation(purchaseHostReservationRequest))
        }

        override def purchaseReservedInstancesOffering(purchaseReservedInstancesOfferingRequest: PurchaseReservedInstancesOfferingRequest): IO[PurchaseReservedInstancesOfferingResponse] =
        IO.fromFuture {
        IO(underlying.purchaseReservedInstancesOffering(purchaseReservedInstancesOfferingRequest))
        }

        override def purchaseScheduledInstances(purchaseScheduledInstancesRequest: PurchaseScheduledInstancesRequest): IO[PurchaseScheduledInstancesResponse] =
        IO.fromFuture {
        ...
        override def registerInstanceEventNotificationAttributes(registerInstanceEventNotificationAttributesRequest: RegisterInstanceEventNotificationAttributesRequest): IO[RegisterInstanceEventNotificationAttributesResponse] =
        IO.fromFuture {
        IO(underlying.registerInstanceEventNotificationAttributes(registerInstanceEventNotificationAttributesRequest))
        }

        override def registerTransitGatewayMulticastGroupMembers(registerTransitGatewayMulticastGroupMembersRequest: RegisterTransitGatewayMulticastGroupMembersRequest): IO[RegisterTransitGatewayMulticastGroupMembersResponse] =
        IO.fromFuture {
        IO(underlying.registerTransitGatewayMulticastGroupMembers(registerTransitGatewayMulticastGroupMembersRequest))
        }

        override def registerTransitGatewayMulticastGroupSources(registerTransitGatewayMulticastGroupSourcesRequest: RegisterTransitGatewayMulticastGroupSourcesRequest): IO[RegisterTransitGatewayMulticastGroupSourcesResponse] =
        IO.fromFuture {
        IO(underlying.registerTransitGatewayMulticastGroupSources(registerTransitGatewayMulticastGroupSourcesRequest))
        }

        override def rejectTransitGatewayPeeringAttachment(rejectTransitGatewayPeeringAttachmentRequest: RejectTransitGatewayPeeringAttachmentRequest): IO[RejectTransitGatewayPeeringAttachmentResponse] =
        IO.fromFuture {
        IO(underlying.rejectTransitGatewayPeeringAttachment(rejectTransitGatewayPeeringAttachmentRequest))
        }

        override def rejectTransitGatewayVpcAttachment(rejectTransitGatewayVpcAttachmentRequest: RejectTransitGatewayVpcAttachmentRequest): IO[RejectTransitGatewayVpcAttachmentResponse] =
        IO.fromFuture {
        IO(underlying.rejectTransitGatewayVpcAttachment(rejectTransitGatewayVpcAttachmentRequest))
        }

        override def rejectVpcEndpointConnections(rejectVpcEndpointConnectionsRequest: RejectVpcEndpointConnectionsRequest): IO[RejectVpcEndpointConnectionsResponse] =
        IO.fromFuture {
        IO(underlying.rejectVpcEndpointConnections(rejectVpcEndpointConnectionsRequest))
        }

        override def rejectVpcPeeringConnection(rejectVpcPeeringConnectionRequest: RejectVpcPeeringConnectionRequest): IO[RejectVpcPeeringConnectionResponse] =
        IO.fromFuture {
        ...
        override def replaceIamInstanceProfileAssociation(replaceIamInstanceProfileAssociationRequest: ReplaceIamInstanceProfileAssociationRequest): IO[ReplaceIamInstanceProfileAssociationResponse] =
        IO.fromFuture {
        IO(underlying.replaceIamInstanceProfileAssociation(replaceIamInstanceProfileAssociationRequest))
        }

        override def replaceNetworkAclAssociation(replaceNetworkAclAssociationRequest: ReplaceNetworkAclAssociationRequest): IO[ReplaceNetworkAclAssociationResponse] =
        IO.fromFuture {
        IO(underlying.replaceNetworkAclAssociation(replaceNetworkAclAssociationRequest))
        }

        override def replaceNetworkAclEntry(replaceNetworkAclEntryRequest: ReplaceNetworkAclEntryRequest): IO[ReplaceNetworkAclEntryResponse] =
        IO.fromFuture {
        ...
        override def replaceRouteTableAssociation(replaceRouteTableAssociationRequest: ReplaceRouteTableAssociationRequest): IO[ReplaceRouteTableAssociationResponse] =
        IO.fromFuture {
        IO(underlying.replaceRouteTableAssociation(replaceRouteTableAssociationRequest))
        }

        override def replaceTransitGatewayRoute(replaceTransitGatewayRouteRequest: ReplaceTransitGatewayRouteRequest): IO[ReplaceTransitGatewayRouteResponse] =
        IO.fromFuture {
        IO(underlying.replaceTransitGatewayRoute(replaceTransitGatewayRouteRequest))
        }

        override def reportInstanceStatus(reportInstanceStatusRequest: ReportInstanceStatusRequest): IO[ReportInstanceStatusResponse] =
        IO.fromFuture {
        ...
        override def requestSpotInstances(requestSpotInstancesRequest: RequestSpotInstancesRequest): IO[RequestSpotInstancesResponse] =
        IO.fromFuture {
        IO(underlying.requestSpotInstances(requestSpotInstancesRequest))
        }

        override def resetEbsDefaultKmsKeyId(resetEbsDefaultKmsKeyIdRequest: ResetEbsDefaultKmsKeyIdRequest): IO[ResetEbsDefaultKmsKeyIdResponse] =
        IO.fromFuture {
        IO(underlying.resetEbsDefaultKmsKeyId(resetEbsDefaultKmsKeyIdRequest))
        }

        override def resetFpgaImageAttribute(resetFpgaImageAttributeRequest: ResetFpgaImageAttributeRequest): IO[ResetFpgaImageAttributeResponse] =
        IO.fromFuture {
        IO(underlying.resetFpgaImageAttribute(resetFpgaImageAttributeRequest))
        }

        override def resetImageAttribute(resetImageAttributeRequest: ResetImageAttributeRequest): IO[ResetImageAttributeResponse] =
        IO.fromFuture {
        IO(underlying.resetImageAttribute(resetImageAttributeRequest))
        }

        override def resetInstanceAttribute(resetInstanceAttributeRequest: ResetInstanceAttributeRequest): IO[ResetInstanceAttributeResponse] =
        IO.fromFuture {
        IO(underlying.resetInstanceAttribute(resetInstanceAttributeRequest))
        }

        override def resetNetworkInterfaceAttribute(resetNetworkInterfaceAttributeRequest: ResetNetworkInterfaceAttributeRequest): IO[ResetNetworkInterfaceAttributeResponse] =
        IO.fromFuture {
        IO(underlying.resetNetworkInterfaceAttribute(resetNetworkInterfaceAttributeRequest))
        }

        override def resetSnapshotAttribute(resetSnapshotAttributeRequest: ResetSnapshotAttributeRequest): IO[ResetSnapshotAttributeResponse] =
        IO.fromFuture {
        IO(underlying.resetSnapshotAttribute(resetSnapshotAttributeRequest))
        }

        override def restoreAddressToClassic(restoreAddressToClassicRequest: RestoreAddressToClassicRequest): IO[RestoreAddressToClassicResponse] =
        IO.fromFuture {
        IO(underlying.restoreAddressToClassic(restoreAddressToClassicRequest))
        }

        override def revokeClientVpnIngress(revokeClientVpnIngressRequest: RevokeClientVpnIngressRequest): IO[RevokeClientVpnIngressResponse] =
        IO.fromFuture {
        IO(underlying.revokeClientVpnIngress(revokeClientVpnIngressRequest))
        }

        override def revokeSecurityGroupEgress(revokeSecurityGroupEgressRequest: RevokeSecurityGroupEgressRequest): IO[RevokeSecurityGroupEgressResponse] =
        IO.fromFuture {
        IO(underlying.revokeSecurityGroupEgress(revokeSecurityGroupEgressRequest))
        }

        override def revokeSecurityGroupIngress(revokeSecurityGroupIngressRequest: RevokeSecurityGroupIngressRequest): IO[RevokeSecurityGroupIngressResponse] =
        IO.fromFuture {
        ...
        override def runScheduledInstances(runScheduledInstancesRequest: RunScheduledInstancesRequest): IO[RunScheduledInstancesResponse] =
        IO.fromFuture {
        IO(underlying.runScheduledInstances(runScheduledInstancesRequest))
        }

        override def searchLocalGatewayRoutes(searchLocalGatewayRoutesRequest: SearchLocalGatewayRoutesRequest): IO[SearchLocalGatewayRoutesResponse] =
        IO.fromFuture {
        ...
        override def searchTransitGatewayMulticastGroups(searchTransitGatewayMulticastGroupsRequest: SearchTransitGatewayMulticastGroupsRequest): IO[SearchTransitGatewayMulticastGroupsResponse] =
        IO.fromFuture {
        ...
        override def searchTransitGatewayRoutes(searchTransitGatewayRoutesRequest: SearchTransitGatewayRoutesRequest): IO[SearchTransitGatewayRoutesResponse] =
        IO.fromFuture {
        IO(underlying.searchTransitGatewayRoutes(searchTransitGatewayRoutesRequest))
        }

        override def sendDiagnosticInterrupt(sendDiagnosticInterruptRequest: SendDiagnosticInterruptRequest): IO[SendDiagnosticInterruptResponse] =
        IO.fromFuture {
        ...
        override def startVpcEndpointServicePrivateDnsVerification(startVpcEndpointServicePrivateDnsVerificationRequest: StartVpcEndpointServicePrivateDnsVerificationRequest): IO[StartVpcEndpointServicePrivateDnsVerificationResponse] =
        IO.fromFuture {
        ...
        override def terminateClientVpnConnections(terminateClientVpnConnectionsRequest: TerminateClientVpnConnectionsRequest): IO[TerminateClientVpnConnectionsResponse] =
        IO.fromFuture {
        IO(underlying.terminateClientVpnConnections(terminateClientVpnConnectionsRequest))
        }

        override def terminateInstances(terminateInstancesRequest: TerminateInstancesRequest): IO[TerminateInstancesResponse] =
        IO.fromFuture {
        IO(underlying.terminateInstances(terminateInstancesRequest))
        }

        override def unassignIpv6Addresses(unassignIpv6AddressesRequest: UnassignIpv6AddressesRequest): IO[UnassignIpv6AddressesResponse] =
        IO.fromFuture {
        IO(underlying.unassignIpv6Addresses(unassignIpv6AddressesRequest))
        }

        override def unassignPrivateIpAddresses(unassignPrivateIpAddressesRequest: UnassignPrivateIpAddressesRequest): IO[UnassignPrivateIpAddressesResponse] =
        IO.fromFuture {
        IO(underlying.unassignPrivateIpAddresses(unassignPrivateIpAddressesRequest))
        }

        override def unmonitorInstances(unmonitorInstancesRequest: UnmonitorInstancesRequest): IO[UnmonitorInstancesResponse] =
        IO.fromFuture {
        IO(underlying.unmonitorInstances(unmonitorInstancesRequest))
        }

        override def updateSecurityGroupRuleDescriptionsEgress(updateSecurityGroupRuleDescriptionsEgressRequest: UpdateSecurityGroupRuleDescriptionsEgressRequest): IO[UpdateSecurityGroupRuleDescriptionsEgressResponse] =
        IO.fromFuture {
        IO(underlying.updateSecurityGroupRuleDescriptionsEgress(updateSecurityGroupRuleDescriptionsEgressRequest))
        }

        override def updateSecurityGroupRuleDescriptionsIngress(updateSecurityGroupRuleDescriptionsIngressRequest: UpdateSecurityGroupRuleDescriptionsIngressRequest): IO[UpdateSecurityGroupRuleDescriptionsIngressResponse] =
        IO.fromFuture {
