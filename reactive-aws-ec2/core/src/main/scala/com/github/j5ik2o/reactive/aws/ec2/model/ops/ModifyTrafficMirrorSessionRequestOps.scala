...
final class ModifyTrafficMirrorSessionRequestBuilderOps(val self: ModifyTrafficMirrorSessionRequest.Builder)
    extends AnyVal {
  ...
  final def removeFieldsAsScala(
      value: Option[Seq[TrafficMirrorSessionField]]
...
final class ModifyTrafficMirrorSessionRequestOps(val self: ModifyTrafficMirrorSessionRequest) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def removeFieldsAsScala: Option[Seq[TrafficMirrorSessionField]] =
...
trait ToModifyTrafficMirrorSessionRequestOps {
  ...
  implicit def toModifyTrafficMirrorSessionRequestBuilderOps(
      v: ModifyTrafficMirrorSessionRequest.Builder
  ): ModifyTrafficMirrorSessionRequestBuilderOps = new ModifyTrafficMirrorSessionRequestBuilderOps(v)

  implicit def toModifyTrafficMirrorSessionRequestOps(
      v: ModifyTrafficMirrorSessionRequest
  ): ModifyTrafficMirrorSessionRequestOps = new ModifyTrafficMirrorSessionRequestOps(v)
