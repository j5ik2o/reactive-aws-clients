...
final class TransitGatewayRouteTablePropagationBuilderOps(val self: TransitGatewayRouteTablePropagation.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def resourceTypeAsScala(value: Option[TransitGatewayAttachmentResourceType]): TransitGatewayRouteTablePropagation.Builder = {
...
implicit def toTransitGatewayRouteTablePropagationBuilderOps(v: TransitGatewayRouteTablePropagation.Builder): TransitGatewayRouteTablePropagationBuilderOps = new TransitGatewayRouteTablePropagationBuilderOps(v)

implicit def toTransitGatewayRouteTablePropagationOps(v: TransitGatewayRouteTablePropagation): TransitGatewayRouteTablePropagationOps = new TransitGatewayRouteTablePropagationOps(v)
