...
final class DescribeFastSnapshotRestoreSuccessItemBuilderOps(val self: DescribeFastSnapshotRestoreSuccessItem.Builder)
    extends AnyVal {
  ...
  final def stateAsScala(
      value: Option[FastSnapshotRestoreStateCode]
...
trait ToDescribeFastSnapshotRestoreSuccessItemOps {
  ...
  implicit def toDescribeFastSnapshotRestoreSuccessItemBuilderOps(
      v: DescribeFastSnapshotRestoreSuccessItem.Builder
  ): DescribeFastSnapshotRestoreSuccessItemBuilderOps = new DescribeFastSnapshotRestoreSuccessItemBuilderOps(v)

  implicit def toDescribeFastSnapshotRestoreSuccessItemOps(
      v: DescribeFastSnapshotRestoreSuccessItem
  ): DescribeFastSnapshotRestoreSuccessItemOps = new DescribeFastSnapshotRestoreSuccessItemOps(v)
