...
final class TransitGatewayAttachmentPropagationBuilderOps(val self: TransitGatewayAttachmentPropagation.Builder) extends AnyVal {
...
implicit def toTransitGatewayAttachmentPropagationBuilderOps(v: TransitGatewayAttachmentPropagation.Builder): TransitGatewayAttachmentPropagationBuilderOps = new TransitGatewayAttachmentPropagationBuilderOps(v)

implicit def toTransitGatewayAttachmentPropagationOps(v: TransitGatewayAttachmentPropagation): TransitGatewayAttachmentPropagationOps = new TransitGatewayAttachmentPropagationOps(v)
