...
final class FleetLaunchTemplateSpecificationBuilderOps(val self: FleetLaunchTemplateSpecification.Builder) extends AnyVal {
...
implicit def toFleetLaunchTemplateSpecificationBuilderOps(v: FleetLaunchTemplateSpecification.Builder): FleetLaunchTemplateSpecificationBuilderOps = new FleetLaunchTemplateSpecificationBuilderOps(v)

implicit def toFleetLaunchTemplateSpecificationOps(v: FleetLaunchTemplateSpecification): FleetLaunchTemplateSpecificationOps = new FleetLaunchTemplateSpecificationOps(v)
