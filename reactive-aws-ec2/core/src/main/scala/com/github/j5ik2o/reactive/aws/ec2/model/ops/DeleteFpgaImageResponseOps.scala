...
trait ToDeleteFpgaImageResponseOps {
  ...
  implicit def toDeleteFpgaImageResponseBuilderOps(
      v: DeleteFpgaImageResponse.Builder
  ): DeleteFpgaImageResponseBuilderOps = new DeleteFpgaImageResponseBuilderOps(v)

  implicit def toDeleteFpgaImageResponseOps(v: DeleteFpgaImageResponse): DeleteFpgaImageResponseOps =
    new DeleteFpgaImageResponseOps(v)
