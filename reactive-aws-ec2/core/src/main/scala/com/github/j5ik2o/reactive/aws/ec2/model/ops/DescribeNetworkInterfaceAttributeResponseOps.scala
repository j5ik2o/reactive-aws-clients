...
final class DescribeNetworkInterfaceAttributeResponseBuilderOps(val self: DescribeNetworkInterfaceAttributeResponse.Builder) extends AnyVal {

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def attachmentAsScala(value: Option[NetworkInterfaceAttachment]): DescribeNetworkInterfaceAttributeResponse.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def sourceDestCheckAsScala(value: Option[AttributeBooleanValue]): DescribeNetworkInterfaceAttributeResponse.Builder = {
...
final class DescribeNetworkInterfaceAttributeResponseOps(val self: DescribeNetworkInterfaceAttributeResponse) extends AnyVal {
...
implicit def toDescribeNetworkInterfaceAttributeResponseBuilderOps(v: DescribeNetworkInterfaceAttributeResponse.Builder): DescribeNetworkInterfaceAttributeResponseBuilderOps = new DescribeNetworkInterfaceAttributeResponseBuilderOps(v)

implicit def toDescribeNetworkInterfaceAttributeResponseOps(v: DescribeNetworkInterfaceAttributeResponse): DescribeNetworkInterfaceAttributeResponseOps = new DescribeNetworkInterfaceAttributeResponseOps(v)
