...
final class VpnConnectionBuilderOps(val self: VpnConnection.Builder) extends AnyVal {
  ...
  final def vgwTelemetryAsScala(value: Option[Seq[VgwTelemetry]]): VpnConnection.Builder = {
    value.filter(_.nonEmpty).fold(self) { v =>
      import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.vgwTelemetry(v.asJava)
    }
  }
...
final class VpnConnectionOps(val self: VpnConnection) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def routesAsScala: Option[Seq[VpnStaticRoute]] =
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def vgwTelemetryAsScala: Option[Seq[VgwTelemetry]] =
    Option(self.vgwTelemetry).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
