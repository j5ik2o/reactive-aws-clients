...
final class RequestLaunchTemplateDataBuilderOps(val self: RequestLaunchTemplateData.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def iamInstanceProfileAsScala(value: Option[LaunchTemplateIamInstanceProfileSpecificationRequest]): RequestLaunchTemplateData.Builder = {
            value.fold(self){ v => self.iamInstanceProfile(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def blockDeviceMappingsAsScala(value: Option[Seq[LaunchTemplateBlockDeviceMappingRequest]]): RequestLaunchTemplateData.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def networkInterfacesAsScala(value: Option[Seq[LaunchTemplateInstanceNetworkInterfaceSpecificationRequest]]): RequestLaunchTemplateData.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def instanceInitiatedShutdownBehaviorAsScala(value: Option[ShutdownBehavior]): RequestLaunchTemplateData.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def tagSpecificationsAsScala(value: Option[Seq[LaunchTemplateTagSpecificationRequest]]): RequestLaunchTemplateData.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def elasticGpuSpecificationsAsScala(value: Option[Seq[ElasticGpuSpecification]]): RequestLaunchTemplateData.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def elasticInferenceAcceleratorsAsScala(value: Option[Seq[LaunchTemplateElasticInferenceAccelerator]]): RequestLaunchTemplateData.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def instanceMarketOptionsAsScala(value: Option[LaunchTemplateInstanceMarketOptionsRequest]): RequestLaunchTemplateData.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def capacityReservationSpecificationAsScala(value: Option[LaunchTemplateCapacityReservationSpecificationRequest]): RequestLaunchTemplateData.Builder = {
            value.fold(self){ v => self.capacityReservationSpecification(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def licenseSpecificationsAsScala(value: Option[Seq[LaunchTemplateLicenseConfigurationRequest]]): RequestLaunchTemplateData.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def hibernationOptionsAsScala(value: Option[LaunchTemplateHibernationOptionsRequest]): RequestLaunchTemplateData.Builder = {
            value.fold(self){ v => self.hibernationOptions(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def metadataOptionsAsScala(value: Option[LaunchTemplateInstanceMetadataOptionsRequest]): RequestLaunchTemplateData.Builder = {
...
final class RequestLaunchTemplateDataOps(val self: RequestLaunchTemplateData) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def iamInstanceProfileAsScala: Option[LaunchTemplateIamInstanceProfileSpecificationRequest] = Option(self.iamInstanceProfile) 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def blockDeviceMappingsAsScala: Option[Seq[LaunchTemplateBlockDeviceMappingRequest]] = Option(self.blockDeviceMappings).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def networkInterfacesAsScala: Option[Seq[LaunchTemplateInstanceNetworkInterfaceSpecificationRequest]] = Option(self.networkInterfaces).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def tagSpecificationsAsScala: Option[Seq[LaunchTemplateTagSpecificationRequest]] = Option(self.tagSpecifications).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def elasticGpuSpecificationsAsScala: Option[Seq[ElasticGpuSpecification]] = Option(self.elasticGpuSpecifications).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def elasticInferenceAcceleratorsAsScala: Option[Seq[LaunchTemplateElasticInferenceAccelerator]] = Option(self.elasticInferenceAccelerators).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def instanceMarketOptionsAsScala: Option[LaunchTemplateInstanceMarketOptionsRequest] = Option(self.instanceMarketOptions) 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def capacityReservationSpecificationAsScala: Option[LaunchTemplateCapacityReservationSpecificationRequest] = Option(self.capacityReservationSpecification) 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def licenseSpecificationsAsScala: Option[Seq[LaunchTemplateLicenseConfigurationRequest]] = Option(self.licenseSpecifications).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toRequestLaunchTemplateDataBuilderOps(v: RequestLaunchTemplateData.Builder): RequestLaunchTemplateDataBuilderOps = new RequestLaunchTemplateDataBuilderOps(v)

implicit def toRequestLaunchTemplateDataOps(v: RequestLaunchTemplateData): RequestLaunchTemplateDataOps = new RequestLaunchTemplateDataOps(v)
