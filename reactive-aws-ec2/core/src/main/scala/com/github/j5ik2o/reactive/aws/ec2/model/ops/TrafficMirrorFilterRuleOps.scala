...
implicit def toTrafficMirrorFilterRuleBuilderOps(v: TrafficMirrorFilterRule.Builder): TrafficMirrorFilterRuleBuilderOps = new TrafficMirrorFilterRuleBuilderOps(v)

implicit def toTrafficMirrorFilterRuleOps(v: TrafficMirrorFilterRule): TrafficMirrorFilterRuleOps = new TrafficMirrorFilterRuleOps(v)
