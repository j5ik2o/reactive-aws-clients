...
implicit def toModifyLaunchTemplateResponseBuilderOps(v: ModifyLaunchTemplateResponse.Builder): ModifyLaunchTemplateResponseBuilderOps = new ModifyLaunchTemplateResponseBuilderOps(v)

implicit def toModifyLaunchTemplateResponseOps(v: ModifyLaunchTemplateResponse): ModifyLaunchTemplateResponseOps = new ModifyLaunchTemplateResponseOps(v)
