...
implicit def toAttachInternetGatewayRequestBuilderOps(v: AttachInternetGatewayRequest.Builder): AttachInternetGatewayRequestBuilderOps = new AttachInternetGatewayRequestBuilderOps(v)

implicit def toAttachInternetGatewayRequestOps(v: AttachInternetGatewayRequest): AttachInternetGatewayRequestOps = new AttachInternetGatewayRequestOps(v)
