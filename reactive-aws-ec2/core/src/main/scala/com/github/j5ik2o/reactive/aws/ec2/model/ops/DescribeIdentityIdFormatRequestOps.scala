...
final class DescribeIdentityIdFormatRequestBuilderOps(val self: DescribeIdentityIdFormatRequest.Builder) extends AnyVal {
...
implicit def toDescribeIdentityIdFormatRequestBuilderOps(v: DescribeIdentityIdFormatRequest.Builder): DescribeIdentityIdFormatRequestBuilderOps = new DescribeIdentityIdFormatRequestBuilderOps(v)

implicit def toDescribeIdentityIdFormatRequestOps(v: DescribeIdentityIdFormatRequest): DescribeIdentityIdFormatRequestOps = new DescribeIdentityIdFormatRequestOps(v)
