...
trait ToCancelBundleTaskRequestOps {
  ...
  implicit def toCancelBundleTaskRequestBuilderOps(
      v: CancelBundleTaskRequest.Builder
  ): CancelBundleTaskRequestBuilderOps = new CancelBundleTaskRequestBuilderOps(v)

  implicit def toCancelBundleTaskRequestOps(v: CancelBundleTaskRequest): CancelBundleTaskRequestOps =
    new CancelBundleTaskRequestOps(v)
