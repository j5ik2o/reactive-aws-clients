...
final class DeleteTransitGatewayRouteRequestBuilderOps(val self: DeleteTransitGatewayRouteRequest.Builder) extends AnyVal {
...
implicit def toDeleteTransitGatewayRouteRequestBuilderOps(v: DeleteTransitGatewayRouteRequest.Builder): DeleteTransitGatewayRouteRequestBuilderOps = new DeleteTransitGatewayRouteRequestBuilderOps(v)

implicit def toDeleteTransitGatewayRouteRequestOps(v: DeleteTransitGatewayRouteRequest): DeleteTransitGatewayRouteRequestOps = new DeleteTransitGatewayRouteRequestOps(v)
