...
final class DescribeTransitGatewayPeeringAttachmentsRequestBuilderOps(
    val self: DescribeTransitGatewayPeeringAttachmentsRequest.Builder
) extends AnyVal {
...
final class DescribeTransitGatewayPeeringAttachmentsRequestOps(
    val self: DescribeTransitGatewayPeeringAttachmentsRequest
) extends AnyVal {
...
trait ToDescribeTransitGatewayPeeringAttachmentsRequestOps {
  ...
  implicit def toDescribeTransitGatewayPeeringAttachmentsRequestBuilderOps(
      v: DescribeTransitGatewayPeeringAttachmentsRequest.Builder
  ): DescribeTransitGatewayPeeringAttachmentsRequestBuilderOps =
    new DescribeTransitGatewayPeeringAttachmentsRequestBuilderOps(v)

  implicit def toDescribeTransitGatewayPeeringAttachmentsRequestOps(
      v: DescribeTransitGatewayPeeringAttachmentsRequest
  ): DescribeTransitGatewayPeeringAttachmentsRequestOps = new DescribeTransitGatewayPeeringAttachmentsRequestOps(v)
