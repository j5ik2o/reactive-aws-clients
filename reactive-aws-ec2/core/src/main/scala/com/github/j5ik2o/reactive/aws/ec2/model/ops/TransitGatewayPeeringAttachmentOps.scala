...
final class TransitGatewayPeeringAttachmentBuilderOps(val self: TransitGatewayPeeringAttachment.Builder)
    extends AnyVal {
...
trait ToTransitGatewayPeeringAttachmentOps {
  ...
  implicit def toTransitGatewayPeeringAttachmentBuilderOps(
      v: TransitGatewayPeeringAttachment.Builder
  ): TransitGatewayPeeringAttachmentBuilderOps = new TransitGatewayPeeringAttachmentBuilderOps(v)

  implicit def toTransitGatewayPeeringAttachmentOps(
      v: TransitGatewayPeeringAttachment
  ): TransitGatewayPeeringAttachmentOps = new TransitGatewayPeeringAttachmentOps(v)
