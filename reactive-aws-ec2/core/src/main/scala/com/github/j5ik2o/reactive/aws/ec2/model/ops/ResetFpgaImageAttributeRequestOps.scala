...
implicit def toResetFpgaImageAttributeRequestBuilderOps(v: ResetFpgaImageAttributeRequest.Builder): ResetFpgaImageAttributeRequestBuilderOps = new ResetFpgaImageAttributeRequestBuilderOps(v)

implicit def toResetFpgaImageAttributeRequestOps(v: ResetFpgaImageAttributeRequest): ResetFpgaImageAttributeRequestOps = new ResetFpgaImageAttributeRequestOps(v)
