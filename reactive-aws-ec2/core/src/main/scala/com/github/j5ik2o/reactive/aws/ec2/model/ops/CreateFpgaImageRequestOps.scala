...
implicit def toCreateFpgaImageRequestBuilderOps(v: CreateFpgaImageRequest.Builder): CreateFpgaImageRequestBuilderOps = new CreateFpgaImageRequestBuilderOps(v)

implicit def toCreateFpgaImageRequestOps(v: CreateFpgaImageRequest): CreateFpgaImageRequestOps = new CreateFpgaImageRequestOps(v)
