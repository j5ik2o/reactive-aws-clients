...
implicit def toImportVolumeTaskDetailsBuilderOps(v: ImportVolumeTaskDetails.Builder): ImportVolumeTaskDetailsBuilderOps = new ImportVolumeTaskDetailsBuilderOps(v)

implicit def toImportVolumeTaskDetailsOps(v: ImportVolumeTaskDetails): ImportVolumeTaskDetailsOps = new ImportVolumeTaskDetailsOps(v)
