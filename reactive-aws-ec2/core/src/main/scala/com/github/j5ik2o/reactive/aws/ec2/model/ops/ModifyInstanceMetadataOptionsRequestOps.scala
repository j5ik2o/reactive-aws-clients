...
final class ModifyInstanceMetadataOptionsRequestBuilderOps(val self: ModifyInstanceMetadataOptionsRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def httpEndpointAsScala(value: Option[InstanceMetadataEndpointState]): ModifyInstanceMetadataOptionsRequest.Builder = {
...
implicit def toModifyInstanceMetadataOptionsRequestBuilderOps(v: ModifyInstanceMetadataOptionsRequest.Builder): ModifyInstanceMetadataOptionsRequestBuilderOps = new ModifyInstanceMetadataOptionsRequestBuilderOps(v)

implicit def toModifyInstanceMetadataOptionsRequestOps(v: ModifyInstanceMetadataOptionsRequest): ModifyInstanceMetadataOptionsRequestOps = new ModifyInstanceMetadataOptionsRequestOps(v)
