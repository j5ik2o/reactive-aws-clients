...
implicit def toDescribeInstanceTypesRequestBuilderOps(v: DescribeInstanceTypesRequest.Builder): DescribeInstanceTypesRequestBuilderOps = new DescribeInstanceTypesRequestBuilderOps(v)

implicit def toDescribeInstanceTypesRequestOps(v: DescribeInstanceTypesRequest): DescribeInstanceTypesRequestOps = new DescribeInstanceTypesRequestOps(v)
