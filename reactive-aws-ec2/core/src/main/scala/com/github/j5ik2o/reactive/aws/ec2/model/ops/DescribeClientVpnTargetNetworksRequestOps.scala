...
final class DescribeClientVpnTargetNetworksRequestBuilderOps(val self: DescribeClientVpnTargetNetworksRequest.Builder) extends AnyVal {
...
implicit def toDescribeClientVpnTargetNetworksRequestBuilderOps(v: DescribeClientVpnTargetNetworksRequest.Builder): DescribeClientVpnTargetNetworksRequestBuilderOps = new DescribeClientVpnTargetNetworksRequestBuilderOps(v)

implicit def toDescribeClientVpnTargetNetworksRequestOps(v: DescribeClientVpnTargetNetworksRequest): DescribeClientVpnTargetNetworksRequestOps = new DescribeClientVpnTargetNetworksRequestOps(v)
