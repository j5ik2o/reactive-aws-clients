...
trait ToRegisterImageResponseOps {
  ...
  implicit def toRegisterImageResponseBuilderOps(v: RegisterImageResponse.Builder): RegisterImageResponseBuilderOps =
    new RegisterImageResponseBuilderOps(v)

  implicit def toRegisterImageResponseOps(v: RegisterImageResponse): RegisterImageResponseOps =
    new RegisterImageResponseOps(v)
