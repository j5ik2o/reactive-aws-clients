...
final class DescribeInstanceTypesResponseOps(val self: DescribeInstanceTypesResponse) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def instanceTypesAsScala: Option[Seq[InstanceTypeInfo]] = Option(self.instanceTypes).map { v =>
...
trait ToDescribeInstanceTypesResponseOps {
  ...
  implicit def toDescribeInstanceTypesResponseBuilderOps(
      v: DescribeInstanceTypesResponse.Builder
  ): DescribeInstanceTypesResponseBuilderOps = new DescribeInstanceTypesResponseBuilderOps(v)

  implicit def toDescribeInstanceTypesResponseOps(v: DescribeInstanceTypesResponse): DescribeInstanceTypesResponseOps =
    new DescribeInstanceTypesResponseOps(v)
