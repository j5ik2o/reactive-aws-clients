...
final class SpotFleetRequestConfigBuilderOps(val self: SpotFleetRequestConfig.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.spotFleetRequestState(v) }
            } 
...
implicit def toSpotFleetRequestConfigBuilderOps(v: SpotFleetRequestConfig.Builder): SpotFleetRequestConfigBuilderOps = new SpotFleetRequestConfigBuilderOps(v)

implicit def toSpotFleetRequestConfigOps(v: SpotFleetRequestConfig): SpotFleetRequestConfigOps = new SpotFleetRequestConfigOps(v)
