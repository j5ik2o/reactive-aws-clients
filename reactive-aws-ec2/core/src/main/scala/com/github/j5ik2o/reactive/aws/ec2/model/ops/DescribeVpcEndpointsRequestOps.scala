...
implicit def toDescribeVpcEndpointsRequestBuilderOps(v: DescribeVpcEndpointsRequest.Builder): DescribeVpcEndpointsRequestBuilderOps = new DescribeVpcEndpointsRequestBuilderOps(v)

implicit def toDescribeVpcEndpointsRequestOps(v: DescribeVpcEndpointsRequest): DescribeVpcEndpointsRequestOps = new DescribeVpcEndpointsRequestOps(v)
