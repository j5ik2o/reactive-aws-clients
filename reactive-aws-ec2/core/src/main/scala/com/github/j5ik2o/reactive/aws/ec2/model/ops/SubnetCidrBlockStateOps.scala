...
implicit def toSubnetCidrBlockStateBuilderOps(v: SubnetCidrBlockState.Builder): SubnetCidrBlockStateBuilderOps = new SubnetCidrBlockStateBuilderOps(v)

implicit def toSubnetCidrBlockStateOps(v: SubnetCidrBlockState): SubnetCidrBlockStateOps = new SubnetCidrBlockStateOps(v)
