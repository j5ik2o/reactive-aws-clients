...
implicit def toDeleteFlowLogsResponseBuilderOps(v: DeleteFlowLogsResponse.Builder): DeleteFlowLogsResponseBuilderOps = new DeleteFlowLogsResponseBuilderOps(v)

implicit def toDeleteFlowLogsResponseOps(v: DeleteFlowLogsResponse): DeleteFlowLogsResponseOps = new DeleteFlowLogsResponseOps(v)
