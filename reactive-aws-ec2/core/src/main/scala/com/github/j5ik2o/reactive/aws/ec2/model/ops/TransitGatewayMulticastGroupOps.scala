...
final class TransitGatewayMulticastGroupBuilderOps(val self: TransitGatewayMulticastGroup.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def resourceTypeAsScala(value: Option[TransitGatewayAttachmentResourceType]): TransitGatewayMulticastGroup.Builder = {
...
implicit def toTransitGatewayMulticastGroupBuilderOps(v: TransitGatewayMulticastGroup.Builder): TransitGatewayMulticastGroupBuilderOps = new TransitGatewayMulticastGroupBuilderOps(v)

implicit def toTransitGatewayMulticastGroupOps(v: TransitGatewayMulticastGroup): TransitGatewayMulticastGroupOps = new TransitGatewayMulticastGroupOps(v)
