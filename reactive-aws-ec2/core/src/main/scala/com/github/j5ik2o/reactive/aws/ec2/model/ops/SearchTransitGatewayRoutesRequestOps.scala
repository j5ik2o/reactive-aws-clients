...
final class SearchTransitGatewayRoutesRequestBuilderOps(val self: SearchTransitGatewayRoutesRequest.Builder) extends AnyVal {
...
implicit def toSearchTransitGatewayRoutesRequestBuilderOps(v: SearchTransitGatewayRoutesRequest.Builder): SearchTransitGatewayRoutesRequestBuilderOps = new SearchTransitGatewayRoutesRequestBuilderOps(v)

implicit def toSearchTransitGatewayRoutesRequestOps(v: SearchTransitGatewayRoutesRequest): SearchTransitGatewayRoutesRequestOps = new SearchTransitGatewayRoutesRequestOps(v)
