...
implicit def toGetConsoleScreenshotResponseBuilderOps(v: GetConsoleScreenshotResponse.Builder): GetConsoleScreenshotResponseBuilderOps = new GetConsoleScreenshotResponseBuilderOps(v)

implicit def toGetConsoleScreenshotResponseOps(v: GetConsoleScreenshotResponse): GetConsoleScreenshotResponseOps = new GetConsoleScreenshotResponseOps(v)
