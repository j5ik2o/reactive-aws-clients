...
implicit def toDescribeInstancesRequestBuilderOps(v: DescribeInstancesRequest.Builder): DescribeInstancesRequestBuilderOps = new DescribeInstancesRequestBuilderOps(v)

implicit def toDescribeInstancesRequestOps(v: DescribeInstancesRequest): DescribeInstancesRequestOps = new DescribeInstancesRequestOps(v)
