...
implicit def toInstanceStatusDetailsBuilderOps(v: InstanceStatusDetails.Builder): InstanceStatusDetailsBuilderOps = new InstanceStatusDetailsBuilderOps(v)

implicit def toInstanceStatusDetailsOps(v: InstanceStatusDetails): InstanceStatusDetailsOps = new InstanceStatusDetailsOps(v)
