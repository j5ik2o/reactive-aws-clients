...
trait ToGetEbsDefaultKmsKeyIdResponseOps {
  ...
  implicit def toGetEbsDefaultKmsKeyIdResponseBuilderOps(
      v: GetEbsDefaultKmsKeyIdResponse.Builder
  ): GetEbsDefaultKmsKeyIdResponseBuilderOps = new GetEbsDefaultKmsKeyIdResponseBuilderOps(v)

  implicit def toGetEbsDefaultKmsKeyIdResponseOps(v: GetEbsDefaultKmsKeyIdResponse): GetEbsDefaultKmsKeyIdResponseOps =
    new GetEbsDefaultKmsKeyIdResponseOps(v)
