...
final class ClientVpnEndpointBuilderOps(val self: ClientVpnEndpoint.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.clientCidrBlock(v) }
            } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def associatedTargetNetworksAsScala(value: Option[Seq[AssociatedTargetNetwork]]): ClientVpnEndpoint.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.associatedTargetNetworks(v.asJava) } 
            }
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def authenticationOptionsAsScala(value: Option[Seq[ClientVpnAuthentication]]): ClientVpnEndpoint.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.authenticationOptions(v.asJava) } 
            }
...
final class ClientVpnEndpointOps(val self: ClientVpnEndpoint) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def associatedTargetNetworksAsScala: Option[Seq[AssociatedTargetNetwork]] = Option(self.associatedTargetNetworks).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def serverCertificateArnAsScala: Option[String] = Option(self.serverCertificateArn) 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def authenticationOptionsAsScala: Option[Seq[ClientVpnAuthentication]] = Option(self.authenticationOptions).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toClientVpnEndpointBuilderOps(v: ClientVpnEndpoint.Builder): ClientVpnEndpointBuilderOps = new ClientVpnEndpointBuilderOps(v)
