...
implicit def toMoveAddressToVpcResponseBuilderOps(v: MoveAddressToVpcResponse.Builder): MoveAddressToVpcResponseBuilderOps = new MoveAddressToVpcResponseBuilderOps(v)

implicit def toMoveAddressToVpcResponseOps(v: MoveAddressToVpcResponse): MoveAddressToVpcResponseOps = new MoveAddressToVpcResponseOps(v)
