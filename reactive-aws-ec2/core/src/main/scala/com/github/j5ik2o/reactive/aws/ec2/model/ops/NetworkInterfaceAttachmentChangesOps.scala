...
final class NetworkInterfaceAttachmentChangesBuilderOps(val self: NetworkInterfaceAttachmentChanges.Builder) extends AnyVal {
...
implicit def toNetworkInterfaceAttachmentChangesBuilderOps(v: NetworkInterfaceAttachmentChanges.Builder): NetworkInterfaceAttachmentChangesBuilderOps = new NetworkInterfaceAttachmentChangesBuilderOps(v)

implicit def toNetworkInterfaceAttachmentChangesOps(v: NetworkInterfaceAttachmentChanges): NetworkInterfaceAttachmentChangesOps = new NetworkInterfaceAttachmentChangesOps(v)
