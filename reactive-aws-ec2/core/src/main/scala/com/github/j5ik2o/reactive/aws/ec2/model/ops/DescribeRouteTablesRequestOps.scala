...
implicit def toDescribeRouteTablesRequestBuilderOps(v: DescribeRouteTablesRequest.Builder): DescribeRouteTablesRequestBuilderOps = new DescribeRouteTablesRequestBuilderOps(v)

implicit def toDescribeRouteTablesRequestOps(v: DescribeRouteTablesRequest): DescribeRouteTablesRequestOps = new DescribeRouteTablesRequestOps(v)
