...
final class DescribeRegionsRequestBuilderOps(val self: DescribeRegionsRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def regionNamesAsScala(value: Option[Seq[String]]): DescribeRegionsRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.regionNames(v.asJava) } 
            }
...
final class DescribeRegionsRequestOps(val self: DescribeRegionsRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def regionNamesAsScala: Option[Seq[String]] = Option(self.regionNames).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toDescribeRegionsRequestBuilderOps(v: DescribeRegionsRequest.Builder): DescribeRegionsRequestBuilderOps = new DescribeRegionsRequestBuilderOps(v)

implicit def toDescribeRegionsRequestOps(v: DescribeRegionsRequest): DescribeRegionsRequestOps = new DescribeRegionsRequestOps(v)
