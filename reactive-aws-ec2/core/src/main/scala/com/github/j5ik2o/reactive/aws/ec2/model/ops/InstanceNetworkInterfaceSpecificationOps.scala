...
final class InstanceNetworkInterfaceSpecificationBuilderOps(val self: InstanceNetworkInterfaceSpecification.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def ipv6AddressesAsScala(value: Option[Seq[InstanceIpv6Address]]): InstanceNetworkInterfaceSpecification.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def privateIpAddressesAsScala(value: Option[Seq[PrivateIpAddressSpecification]]): InstanceNetworkInterfaceSpecification.Builder = {
...
implicit def toInstanceNetworkInterfaceSpecificationBuilderOps(v: InstanceNetworkInterfaceSpecification.Builder): InstanceNetworkInterfaceSpecificationBuilderOps = new InstanceNetworkInterfaceSpecificationBuilderOps(v)

implicit def toInstanceNetworkInterfaceSpecificationOps(v: InstanceNetworkInterfaceSpecification): InstanceNetworkInterfaceSpecificationOps = new InstanceNetworkInterfaceSpecificationOps(v)
