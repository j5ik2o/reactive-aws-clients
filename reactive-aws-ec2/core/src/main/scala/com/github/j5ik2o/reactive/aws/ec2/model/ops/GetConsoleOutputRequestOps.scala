...
implicit def toGetConsoleOutputRequestBuilderOps(v: GetConsoleOutputRequest.Builder): GetConsoleOutputRequestBuilderOps = new GetConsoleOutputRequestBuilderOps(v)

implicit def toGetConsoleOutputRequestOps(v: GetConsoleOutputRequest): GetConsoleOutputRequestOps = new GetConsoleOutputRequestOps(v)
