...
final class VpcEndpointBuilderOps(val self: VpcEndpoint.Builder) extends AnyVal {
  ...
  final def lastErrorAsScala(value: Option[LastError]): VpcEndpoint.Builder = {
    value.fold(self) { v => self.lastError(v) }
  }
...
final class VpcEndpointOps(val self: VpcEndpoint) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def routeTableIdsAsScala: Option[Seq[String]] =
    Option(self.routeTableIds).map { v =>
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def groupsAsScala: Option[Seq[SecurityGroupIdentifier]] =
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def dnsEntriesAsScala: Option[Seq[DnsEntry]] =
    Option(self.dnsEntries).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
