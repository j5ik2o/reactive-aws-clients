...
implicit def toDescribeByoipCidrsRequestBuilderOps(v: DescribeByoipCidrsRequest.Builder): DescribeByoipCidrsRequestBuilderOps = new DescribeByoipCidrsRequestBuilderOps(v)

implicit def toDescribeByoipCidrsRequestOps(v: DescribeByoipCidrsRequest): DescribeByoipCidrsRequestOps = new DescribeByoipCidrsRequestOps(v)
