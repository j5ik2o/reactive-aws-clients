...
final class CreateNatGatewayResponseBuilderOps(val self: CreateNatGatewayResponse.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.natGateway(v) }
            } 
...
implicit def toCreateNatGatewayResponseBuilderOps(v: CreateNatGatewayResponse.Builder): CreateNatGatewayResponseBuilderOps = new CreateNatGatewayResponseBuilderOps(v)

implicit def toCreateNatGatewayResponseOps(v: CreateNatGatewayResponse): CreateNatGatewayResponseOps = new CreateNatGatewayResponseOps(v)
