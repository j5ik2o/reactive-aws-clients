...
implicit def toSlotStartTimeRangeRequestBuilderOps(v: SlotStartTimeRangeRequest.Builder): SlotStartTimeRangeRequestBuilderOps = new SlotStartTimeRangeRequestBuilderOps(v)

implicit def toSlotStartTimeRangeRequestOps(v: SlotStartTimeRangeRequest): SlotStartTimeRangeRequestOps = new SlotStartTimeRangeRequestOps(v)
