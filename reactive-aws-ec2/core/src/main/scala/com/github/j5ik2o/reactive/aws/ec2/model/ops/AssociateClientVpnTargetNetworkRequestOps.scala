...
final class AssociateClientVpnTargetNetworkRequestBuilderOps(val self: AssociateClientVpnTargetNetworkRequest.Builder) extends AnyVal {
...
implicit def toAssociateClientVpnTargetNetworkRequestBuilderOps(v: AssociateClientVpnTargetNetworkRequest.Builder): AssociateClientVpnTargetNetworkRequestBuilderOps = new AssociateClientVpnTargetNetworkRequestBuilderOps(v)

implicit def toAssociateClientVpnTargetNetworkRequestOps(v: AssociateClientVpnTargetNetworkRequest): AssociateClientVpnTargetNetworkRequestOps = new AssociateClientVpnTargetNetworkRequestOps(v)
