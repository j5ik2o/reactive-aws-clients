...
final class CreateFlowLogsRequestBuilderOps(val self: CreateFlowLogsRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def resourceIdsAsScala(value: Option[Seq[String]]): CreateFlowLogsRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.resourceIds(v.asJava) } 
            }
...
final class CreateFlowLogsRequestOps(val self: CreateFlowLogsRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def resourceIdsAsScala: Option[Seq[String]] = Option(self.resourceIds).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toCreateFlowLogsRequestBuilderOps(v: CreateFlowLogsRequest.Builder): CreateFlowLogsRequestBuilderOps = new CreateFlowLogsRequestBuilderOps(v)

implicit def toCreateFlowLogsRequestOps(v: CreateFlowLogsRequest): CreateFlowLogsRequestOps = new CreateFlowLogsRequestOps(v)
