...
final class DescribeSnapshotAttributeRequestBuilderOps(val self: DescribeSnapshotAttributeRequest.Builder) extends AnyVal {
...
implicit def toDescribeSnapshotAttributeRequestBuilderOps(v: DescribeSnapshotAttributeRequest.Builder): DescribeSnapshotAttributeRequestBuilderOps = new DescribeSnapshotAttributeRequestBuilderOps(v)

implicit def toDescribeSnapshotAttributeRequestOps(v: DescribeSnapshotAttributeRequest): DescribeSnapshotAttributeRequestOps = new DescribeSnapshotAttributeRequestOps(v)
