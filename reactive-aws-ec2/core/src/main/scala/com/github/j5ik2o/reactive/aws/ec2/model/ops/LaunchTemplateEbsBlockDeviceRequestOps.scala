...
final class LaunchTemplateEbsBlockDeviceRequestBuilderOps(val self: LaunchTemplateEbsBlockDeviceRequest.Builder) extends AnyVal {
...
implicit def toLaunchTemplateEbsBlockDeviceRequestBuilderOps(v: LaunchTemplateEbsBlockDeviceRequest.Builder): LaunchTemplateEbsBlockDeviceRequestBuilderOps = new LaunchTemplateEbsBlockDeviceRequestBuilderOps(v)

implicit def toLaunchTemplateEbsBlockDeviceRequestOps(v: LaunchTemplateEbsBlockDeviceRequest): LaunchTemplateEbsBlockDeviceRequestOps = new LaunchTemplateEbsBlockDeviceRequestOps(v)
