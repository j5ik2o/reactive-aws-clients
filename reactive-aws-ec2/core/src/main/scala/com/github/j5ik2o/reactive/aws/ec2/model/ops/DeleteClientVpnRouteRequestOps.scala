...
trait ToDeleteClientVpnRouteRequestOps {
  ...
  implicit def toDeleteClientVpnRouteRequestBuilderOps(
      v: DeleteClientVpnRouteRequest.Builder
  ): DeleteClientVpnRouteRequestBuilderOps = new DeleteClientVpnRouteRequestBuilderOps(v)

  implicit def toDeleteClientVpnRouteRequestOps(v: DeleteClientVpnRouteRequest): DeleteClientVpnRouteRequestOps =
    new DeleteClientVpnRouteRequestOps(v)
