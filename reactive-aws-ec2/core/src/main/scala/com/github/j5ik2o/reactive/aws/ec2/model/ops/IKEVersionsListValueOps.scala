...
trait ToIKEVersionsListValueOps {
  ...
  implicit def toIKEVersionsListValueBuilderOps(v: IKEVersionsListValue.Builder): IKEVersionsListValueBuilderOps =
    new IKEVersionsListValueBuilderOps(v)

  implicit def toIKEVersionsListValueOps(v: IKEVersionsListValue): IKEVersionsListValueOps =
    new IKEVersionsListValueOps(v)
