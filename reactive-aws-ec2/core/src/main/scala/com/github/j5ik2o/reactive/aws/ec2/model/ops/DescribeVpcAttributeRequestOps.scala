...
implicit def toDescribeVpcAttributeRequestBuilderOps(v: DescribeVpcAttributeRequest.Builder): DescribeVpcAttributeRequestBuilderOps = new DescribeVpcAttributeRequestBuilderOps(v)

implicit def toDescribeVpcAttributeRequestOps(v: DescribeVpcAttributeRequest): DescribeVpcAttributeRequestOps = new DescribeVpcAttributeRequestOps(v)
