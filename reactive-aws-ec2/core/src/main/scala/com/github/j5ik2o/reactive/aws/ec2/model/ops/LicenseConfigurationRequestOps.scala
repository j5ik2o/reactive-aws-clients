...
implicit def toLicenseConfigurationRequestBuilderOps(v: LicenseConfigurationRequest.Builder): LicenseConfigurationRequestBuilderOps = new LicenseConfigurationRequestBuilderOps(v)

implicit def toLicenseConfigurationRequestOps(v: LicenseConfigurationRequest): LicenseConfigurationRequestOps = new LicenseConfigurationRequestOps(v)
