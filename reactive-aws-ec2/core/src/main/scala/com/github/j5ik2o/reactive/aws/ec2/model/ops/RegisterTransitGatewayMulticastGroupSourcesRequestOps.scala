...
final class RegisterTransitGatewayMulticastGroupSourcesRequestBuilderOps(
    val self: RegisterTransitGatewayMulticastGroupSourcesRequest.Builder
) extends AnyVal {
...
final class RegisterTransitGatewayMulticastGroupSourcesRequestOps(
    val self: RegisterTransitGatewayMulticastGroupSourcesRequest
) extends AnyVal {
...
trait ToRegisterTransitGatewayMulticastGroupSourcesRequestOps {
  ...
  implicit def toRegisterTransitGatewayMulticastGroupSourcesRequestBuilderOps(
      v: RegisterTransitGatewayMulticastGroupSourcesRequest.Builder
  ): RegisterTransitGatewayMulticastGroupSourcesRequestBuilderOps =
    new RegisterTransitGatewayMulticastGroupSourcesRequestBuilderOps(v)

  implicit def toRegisterTransitGatewayMulticastGroupSourcesRequestOps(
      v: RegisterTransitGatewayMulticastGroupSourcesRequest
  ): RegisterTransitGatewayMulticastGroupSourcesRequestOps =
    new RegisterTransitGatewayMulticastGroupSourcesRequestOps(v)
