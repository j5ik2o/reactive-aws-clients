...
implicit def toVpcIpv6CidrBlockAssociationBuilderOps(v: VpcIpv6CidrBlockAssociation.Builder): VpcIpv6CidrBlockAssociationBuilderOps = new VpcIpv6CidrBlockAssociationBuilderOps(v)

implicit def toVpcIpv6CidrBlockAssociationOps(v: VpcIpv6CidrBlockAssociation): VpcIpv6CidrBlockAssociationOps = new VpcIpv6CidrBlockAssociationOps(v)
