...
implicit def toAssociateRouteTableResponseBuilderOps(v: AssociateRouteTableResponse.Builder): AssociateRouteTableResponseBuilderOps = new AssociateRouteTableResponseBuilderOps(v)

implicit def toAssociateRouteTableResponseOps(v: AssociateRouteTableResponse): AssociateRouteTableResponseOps = new AssociateRouteTableResponseOps(v)
