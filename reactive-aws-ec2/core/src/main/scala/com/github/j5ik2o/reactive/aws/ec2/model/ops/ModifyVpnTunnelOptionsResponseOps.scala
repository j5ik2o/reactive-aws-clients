...
implicit def toModifyVpnTunnelOptionsResponseBuilderOps(v: ModifyVpnTunnelOptionsResponse.Builder): ModifyVpnTunnelOptionsResponseBuilderOps = new ModifyVpnTunnelOptionsResponseBuilderOps(v)

implicit def toModifyVpnTunnelOptionsResponseOps(v: ModifyVpnTunnelOptionsResponse): ModifyVpnTunnelOptionsResponseOps = new ModifyVpnTunnelOptionsResponseOps(v)
