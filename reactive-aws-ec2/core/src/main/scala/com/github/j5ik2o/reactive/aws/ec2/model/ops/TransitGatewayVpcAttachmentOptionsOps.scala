...
final class TransitGatewayVpcAttachmentOptionsBuilderOps(val self: TransitGatewayVpcAttachmentOptions.Builder) extends AnyVal {
...
implicit def toTransitGatewayVpcAttachmentOptionsBuilderOps(v: TransitGatewayVpcAttachmentOptions.Builder): TransitGatewayVpcAttachmentOptionsBuilderOps = new TransitGatewayVpcAttachmentOptionsBuilderOps(v)

implicit def toTransitGatewayVpcAttachmentOptionsOps(v: TransitGatewayVpcAttachmentOptions): TransitGatewayVpcAttachmentOptionsOps = new TransitGatewayVpcAttachmentOptionsOps(v)
