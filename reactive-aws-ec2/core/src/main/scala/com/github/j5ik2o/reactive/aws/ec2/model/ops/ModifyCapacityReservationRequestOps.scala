...
final class ModifyCapacityReservationRequestBuilderOps(val self: ModifyCapacityReservationRequest.Builder) extends AnyVal {
...
implicit def toModifyCapacityReservationRequestBuilderOps(v: ModifyCapacityReservationRequest.Builder): ModifyCapacityReservationRequestBuilderOps = new ModifyCapacityReservationRequestBuilderOps(v)

implicit def toModifyCapacityReservationRequestOps(v: ModifyCapacityReservationRequest): ModifyCapacityReservationRequestOps = new ModifyCapacityReservationRequestOps(v)
