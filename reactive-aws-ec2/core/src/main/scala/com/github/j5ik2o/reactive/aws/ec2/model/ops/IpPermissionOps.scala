...
final class IpPermissionOps(val self: IpPermission) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def ipRangesAsScala: Option[Seq[IpRange]] =
    Option(self.ipRanges).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def ipv6RangesAsScala: Option[Seq[Ipv6Range]] =
    Option(self.ipv6Ranges).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def prefixListIdsAsScala: Option[Seq[PrefixListId]] =
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def userIdGroupPairsAsScala: Option[Seq[UserIdGroupPair]] =
    Option(self.userIdGroupPairs).map { v =>
      import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala
    }
