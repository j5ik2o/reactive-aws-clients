...
implicit def toUnmonitorInstancesRequestBuilderOps(v: UnmonitorInstancesRequest.Builder): UnmonitorInstancesRequestBuilderOps = new UnmonitorInstancesRequestBuilderOps(v)

implicit def toUnmonitorInstancesRequestOps(v: UnmonitorInstancesRequest): UnmonitorInstancesRequestOps = new UnmonitorInstancesRequestOps(v)
