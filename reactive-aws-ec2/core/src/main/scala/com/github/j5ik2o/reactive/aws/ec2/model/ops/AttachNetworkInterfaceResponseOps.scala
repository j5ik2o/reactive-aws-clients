...
implicit def toAttachNetworkInterfaceResponseBuilderOps(v: AttachNetworkInterfaceResponse.Builder): AttachNetworkInterfaceResponseBuilderOps = new AttachNetworkInterfaceResponseBuilderOps(v)

implicit def toAttachNetworkInterfaceResponseOps(v: AttachNetworkInterfaceResponse): AttachNetworkInterfaceResponseOps = new AttachNetworkInterfaceResponseOps(v)
