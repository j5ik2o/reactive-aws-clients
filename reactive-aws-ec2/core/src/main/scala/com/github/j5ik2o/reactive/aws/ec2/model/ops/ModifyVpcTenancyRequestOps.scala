...
implicit def toModifyVpcTenancyRequestBuilderOps(v: ModifyVpcTenancyRequest.Builder): ModifyVpcTenancyRequestBuilderOps = new ModifyVpcTenancyRequestBuilderOps(v)

implicit def toModifyVpcTenancyRequestOps(v: ModifyVpcTenancyRequest): ModifyVpcTenancyRequestOps = new ModifyVpcTenancyRequestOps(v)
