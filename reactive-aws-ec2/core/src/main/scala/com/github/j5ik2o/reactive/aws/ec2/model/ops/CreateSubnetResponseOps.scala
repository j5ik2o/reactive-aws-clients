...
trait ToCreateSubnetResponseOps {
  ...
  implicit def toCreateSubnetResponseBuilderOps(v: CreateSubnetResponse.Builder): CreateSubnetResponseBuilderOps =
    new CreateSubnetResponseBuilderOps(v)

  implicit def toCreateSubnetResponseOps(v: CreateSubnetResponse): CreateSubnetResponseOps =
    new CreateSubnetResponseOps(v)
