...
implicit def toSnapshotDiskContainerBuilderOps(v: SnapshotDiskContainer.Builder): SnapshotDiskContainerBuilderOps = new SnapshotDiskContainerBuilderOps(v)

implicit def toSnapshotDiskContainerOps(v: SnapshotDiskContainer): SnapshotDiskContainerOps = new SnapshotDiskContainerOps(v)
