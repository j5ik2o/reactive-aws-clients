...
implicit def toLaunchTemplateOverridesBuilderOps(v: LaunchTemplateOverrides.Builder): LaunchTemplateOverridesBuilderOps = new LaunchTemplateOverridesBuilderOps(v)

implicit def toLaunchTemplateOverridesOps(v: LaunchTemplateOverrides): LaunchTemplateOverridesOps = new LaunchTemplateOverridesOps(v)
