...
implicit def toReservedInstanceLimitPriceBuilderOps(v: ReservedInstanceLimitPrice.Builder): ReservedInstanceLimitPriceBuilderOps = new ReservedInstanceLimitPriceBuilderOps(v)

implicit def toReservedInstanceLimitPriceOps(v: ReservedInstanceLimitPrice): ReservedInstanceLimitPriceOps = new ReservedInstanceLimitPriceOps(v)
