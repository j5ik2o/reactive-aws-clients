...
final class DescribeNetworkAclsRequestBuilderOps(val self: DescribeNetworkAclsRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def networkAclIdsAsScala(value: Option[Seq[String]]): DescribeNetworkAclsRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.networkAclIds(v.asJava) } 
            }
...
final class DescribeNetworkAclsRequestOps(val self: DescribeNetworkAclsRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def networkAclIdsAsScala: Option[Seq[String]] = Option(self.networkAclIds).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toDescribeNetworkAclsRequestBuilderOps(v: DescribeNetworkAclsRequest.Builder): DescribeNetworkAclsRequestBuilderOps = new DescribeNetworkAclsRequestBuilderOps(v)

implicit def toDescribeNetworkAclsRequestOps(v: DescribeNetworkAclsRequest): DescribeNetworkAclsRequestOps = new DescribeNetworkAclsRequestOps(v)
