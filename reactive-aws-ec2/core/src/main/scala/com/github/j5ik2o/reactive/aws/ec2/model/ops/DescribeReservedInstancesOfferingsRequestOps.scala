...
final class DescribeReservedInstancesOfferingsRequestBuilderOps(val self: DescribeReservedInstancesOfferingsRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.includeMarketplace(v) }
            } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.maxInstanceCount(v) }
            } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def offeringClassAsScala(value: Option[OfferingClassType]): DescribeReservedInstancesOfferingsRequest.Builder = {
            value.fold(self){ v => self.offeringClass(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def productDescriptionAsScala(value: Option[RIProductDescription]): DescribeReservedInstancesOfferingsRequest.Builder = {
            value.fold(self){ v => self.productDescription(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def reservedInstancesOfferingIdsAsScala(value: Option[Seq[String]]): DescribeReservedInstancesOfferingsRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.reservedInstancesOfferingIds(v.asJava) } 
            }
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def offeringTypeAsScala(value: Option[OfferingTypeValues]): DescribeReservedInstancesOfferingsRequest.Builder = {
...
final class DescribeReservedInstancesOfferingsRequestOps(val self: DescribeReservedInstancesOfferingsRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def reservedInstancesOfferingIdsAsScala: Option[Seq[String]] = Option(self.reservedInstancesOfferingIds).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toDescribeReservedInstancesOfferingsRequestBuilderOps(v: DescribeReservedInstancesOfferingsRequest.Builder): DescribeReservedInstancesOfferingsRequestBuilderOps = new DescribeReservedInstancesOfferingsRequestBuilderOps(v)

implicit def toDescribeReservedInstancesOfferingsRequestOps(v: DescribeReservedInstancesOfferingsRequest): DescribeReservedInstancesOfferingsRequestOps = new DescribeReservedInstancesOfferingsRequestOps(v)
