...
implicit def toImportSnapshotResponseBuilderOps(v: ImportSnapshotResponse.Builder): ImportSnapshotResponseBuilderOps = new ImportSnapshotResponseBuilderOps(v)

implicit def toImportSnapshotResponseOps(v: ImportSnapshotResponse): ImportSnapshotResponseOps = new ImportSnapshotResponseOps(v)
