...
final class LaunchTemplateInstanceNetworkInterfaceSpecificationBuilderOps(val self: LaunchTemplateInstanceNetworkInterfaceSpecification.Builder) extends AnyVal {

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def associatePublicIpAddressAsScala(value: Option[Boolean]): LaunchTemplateInstanceNetworkInterfaceSpecification.Builder = {
            value.fold(self){ v => self.associatePublicIpAddress(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def deleteOnTerminationAsScala(value: Option[Boolean]): LaunchTemplateInstanceNetworkInterfaceSpecification.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def ipv6AddressesAsScala(value: Option[Seq[InstanceIpv6Address]]): LaunchTemplateInstanceNetworkInterfaceSpecification.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def networkInterfaceIdAsScala(value: Option[String]): LaunchTemplateInstanceNetworkInterfaceSpecification.Builder = {
            value.fold(self){ v => self.networkInterfaceId(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def privateIpAddressAsScala(value: Option[String]): LaunchTemplateInstanceNetworkInterfaceSpecification.Builder = {
            value.fold(self){ v => self.privateIpAddress(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def privateIpAddressesAsScala(value: Option[Seq[PrivateIpAddressSpecification]]): LaunchTemplateInstanceNetworkInterfaceSpecification.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def secondaryPrivateIpAddressCountAsScala(value: Option[Int]): LaunchTemplateInstanceNetworkInterfaceSpecification.Builder = {
...
final class LaunchTemplateInstanceNetworkInterfaceSpecificationOps(val self: LaunchTemplateInstanceNetworkInterfaceSpecification) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def ipv6AddressesAsScala: Option[Seq[InstanceIpv6Address]] = Option(self.ipv6Addresses).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toLaunchTemplateInstanceNetworkInterfaceSpecificationBuilderOps(v: LaunchTemplateInstanceNetworkInterfaceSpecification.Builder): LaunchTemplateInstanceNetworkInterfaceSpecificationBuilderOps = new LaunchTemplateInstanceNetworkInterfaceSpecificationBuilderOps(v)

implicit def toLaunchTemplateInstanceNetworkInterfaceSpecificationOps(v: LaunchTemplateInstanceNetworkInterfaceSpecification): LaunchTemplateInstanceNetworkInterfaceSpecificationOps = new LaunchTemplateInstanceNetworkInterfaceSpecificationOps(v)
