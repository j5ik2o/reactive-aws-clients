...
implicit def toLaunchTemplateVersionBuilderOps(v: LaunchTemplateVersion.Builder): LaunchTemplateVersionBuilderOps = new LaunchTemplateVersionBuilderOps(v)

implicit def toLaunchTemplateVersionOps(v: LaunchTemplateVersion): LaunchTemplateVersionOps = new LaunchTemplateVersionOps(v)
