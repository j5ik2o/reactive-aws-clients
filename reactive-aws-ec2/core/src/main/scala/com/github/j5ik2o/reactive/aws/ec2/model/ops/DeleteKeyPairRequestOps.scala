...
implicit def toDeleteKeyPairRequestBuilderOps(v: DeleteKeyPairRequest.Builder): DeleteKeyPairRequestBuilderOps = new DeleteKeyPairRequestBuilderOps(v)

implicit def toDeleteKeyPairRequestOps(v: DeleteKeyPairRequest): DeleteKeyPairRequestOps = new DeleteKeyPairRequestOps(v)
