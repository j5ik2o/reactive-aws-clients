...
implicit def toModifyVolumeAttributeRequestBuilderOps(v: ModifyVolumeAttributeRequest.Builder): ModifyVolumeAttributeRequestBuilderOps = new ModifyVolumeAttributeRequestBuilderOps(v)

implicit def toModifyVolumeAttributeRequestOps(v: ModifyVolumeAttributeRequest): ModifyVolumeAttributeRequestOps = new ModifyVolumeAttributeRequestOps(v)
