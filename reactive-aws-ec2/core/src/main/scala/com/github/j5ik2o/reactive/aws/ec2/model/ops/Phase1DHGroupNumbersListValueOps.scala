...
implicit def toPhase1DHGroupNumbersListValueBuilderOps(v: Phase1DHGroupNumbersListValue.Builder): Phase1DHGroupNumbersListValueBuilderOps = new Phase1DHGroupNumbersListValueBuilderOps(v)

implicit def toPhase1DHGroupNumbersListValueOps(v: Phase1DHGroupNumbersListValue): Phase1DHGroupNumbersListValueOps = new Phase1DHGroupNumbersListValueOps(v)
