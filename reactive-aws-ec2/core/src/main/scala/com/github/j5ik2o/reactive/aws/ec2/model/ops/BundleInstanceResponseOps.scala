...
trait ToBundleInstanceResponseOps {
  ...
  implicit def toBundleInstanceResponseBuilderOps(v: BundleInstanceResponse.Builder): BundleInstanceResponseBuilderOps =
    new BundleInstanceResponseBuilderOps(v)

  implicit def toBundleInstanceResponseOps(v: BundleInstanceResponse): BundleInstanceResponseOps =
    new BundleInstanceResponseOps(v)
