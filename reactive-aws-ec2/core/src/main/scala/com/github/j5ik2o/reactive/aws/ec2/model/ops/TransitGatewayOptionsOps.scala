...
final class TransitGatewayOptionsBuilderOps(val self: TransitGatewayOptions.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def autoAcceptSharedAttachmentsAsScala(value: Option[AutoAcceptSharedAttachmentsValue]): TransitGatewayOptions.Builder = {
            value.fold(self){ v => self.autoAcceptSharedAttachments(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def defaultRouteTableAssociationAsScala(value: Option[DefaultRouteTableAssociationValue]): TransitGatewayOptions.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.associationDefaultRouteTableId(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def defaultRouteTablePropagationAsScala(value: Option[DefaultRouteTablePropagationValue]): TransitGatewayOptions.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.propagationDefaultRouteTableId(v) }
            } 
...
final class TransitGatewayOptionsOps(val self: TransitGatewayOptions) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def autoAcceptSharedAttachmentsAsScala: Option[AutoAcceptSharedAttachmentsValue] = Option(self.autoAcceptSharedAttachments) 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def defaultRouteTableAssociationAsScala: Option[DefaultRouteTableAssociationValue] = Option(self.defaultRouteTableAssociation) 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def associationDefaultRouteTableIdAsScala: Option[String] = Option(self.associationDefaultRouteTableId) 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def defaultRouteTablePropagationAsScala: Option[DefaultRouteTablePropagationValue] = Option(self.defaultRouteTablePropagation) 
...
implicit def toTransitGatewayOptionsBuilderOps(v: TransitGatewayOptions.Builder): TransitGatewayOptionsBuilderOps = new TransitGatewayOptionsBuilderOps(v)

implicit def toTransitGatewayOptionsOps(v: TransitGatewayOptions): TransitGatewayOptionsOps = new TransitGatewayOptionsOps(v)
