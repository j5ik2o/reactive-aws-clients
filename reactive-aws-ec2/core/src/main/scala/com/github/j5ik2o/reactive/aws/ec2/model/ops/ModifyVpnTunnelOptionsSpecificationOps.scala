...
final class ModifyVpnTunnelOptionsSpecificationBuilderOps(val self: ModifyVpnTunnelOptionsSpecification.Builder)
    extends AnyVal {
...
final class ModifyVpnTunnelOptionsSpecificationOps(val self: ModifyVpnTunnelOptionsSpecification) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def ikeVersionsAsScala: Option[Seq[IKEVersionsRequestListValue]] = Option(self.ikeVersions).map { v =>
    import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala
  }
...
trait ToModifyVpnTunnelOptionsSpecificationOps {
  ...
  implicit def toModifyVpnTunnelOptionsSpecificationBuilderOps(
      v: ModifyVpnTunnelOptionsSpecification.Builder
  ): ModifyVpnTunnelOptionsSpecificationBuilderOps = new ModifyVpnTunnelOptionsSpecificationBuilderOps(v)

  implicit def toModifyVpnTunnelOptionsSpecificationOps(
      v: ModifyVpnTunnelOptionsSpecification
  ): ModifyVpnTunnelOptionsSpecificationOps = new ModifyVpnTunnelOptionsSpecificationOps(v)
