...
implicit def toElasticGpuAssociationBuilderOps(v: ElasticGpuAssociation.Builder): ElasticGpuAssociationBuilderOps = new ElasticGpuAssociationBuilderOps(v)

implicit def toElasticGpuAssociationOps(v: ElasticGpuAssociation): ElasticGpuAssociationOps = new ElasticGpuAssociationOps(v)
