...
implicit def toIKEVersionsRequestListValueBuilderOps(v: IKEVersionsRequestListValue.Builder): IKEVersionsRequestListValueBuilderOps = new IKEVersionsRequestListValueBuilderOps(v)

implicit def toIKEVersionsRequestListValueOps(v: IKEVersionsRequestListValue): IKEVersionsRequestListValueOps = new IKEVersionsRequestListValueOps(v)
