...
final class ReservedInstancesModificationBuilderOps(val self: ReservedInstancesModification.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.effectiveDate(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def modificationResultsAsScala(value: Option[Seq[ReservedInstancesModificationResult]]): ReservedInstancesModification.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.modificationResults(v.asJava) } 
            }

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def reservedInstancesIdsAsScala(value: Option[Seq[ReservedInstancesId]]): ReservedInstancesModification.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.reservedInstancesIds(v.asJava) } 
            }

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def reservedInstancesModificationIdAsScala(value: Option[String]): ReservedInstancesModification.Builder = {
            value.fold(self){ v => self.reservedInstancesModificationId(v) }
            } 
...
final class ReservedInstancesModificationOps(val self: ReservedInstancesModification) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def modificationResultsAsScala: Option[Seq[ReservedInstancesModificationResult]] = Option(self.modificationResults).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def reservedInstancesIdsAsScala: Option[Seq[ReservedInstancesId]] = Option(self.reservedInstancesIds).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toReservedInstancesModificationBuilderOps(v: ReservedInstancesModification.Builder): ReservedInstancesModificationBuilderOps = new ReservedInstancesModificationBuilderOps(v)

implicit def toReservedInstancesModificationOps(v: ReservedInstancesModification): ReservedInstancesModificationOps = new ReservedInstancesModificationOps(v)
