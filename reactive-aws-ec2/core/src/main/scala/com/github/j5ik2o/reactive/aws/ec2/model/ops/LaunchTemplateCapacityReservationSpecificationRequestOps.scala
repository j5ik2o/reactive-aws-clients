...
final class LaunchTemplateCapacityReservationSpecificationRequestBuilderOps(
...
final class LaunchTemplateCapacityReservationSpecificationRequestOps(
...
trait ToLaunchTemplateCapacityReservationSpecificationRequestOps {
  ...
  implicit def toLaunchTemplateCapacityReservationSpecificationRequestBuilderOps(
      v: LaunchTemplateCapacityReservationSpecificationRequest.Builder
  ): LaunchTemplateCapacityReservationSpecificationRequestBuilderOps =
    new LaunchTemplateCapacityReservationSpecificationRequestBuilderOps(v)

  implicit def toLaunchTemplateCapacityReservationSpecificationRequestOps(
      v: LaunchTemplateCapacityReservationSpecificationRequest
  ): LaunchTemplateCapacityReservationSpecificationRequestOps =
    new LaunchTemplateCapacityReservationSpecificationRequestOps(v)
