...
implicit def toDeleteLaunchTemplateResponseBuilderOps(v: DeleteLaunchTemplateResponse.Builder): DeleteLaunchTemplateResponseBuilderOps = new DeleteLaunchTemplateResponseBuilderOps(v)

implicit def toDeleteLaunchTemplateResponseOps(v: DeleteLaunchTemplateResponse): DeleteLaunchTemplateResponseOps = new DeleteLaunchTemplateResponseOps(v)
