...
final class TrafficMirrorFilterBuilderOps(val self: TrafficMirrorFilter.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def ingressFilterRulesAsScala(value: Option[Seq[TrafficMirrorFilterRule]]): TrafficMirrorFilter.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.ingressFilterRules(v.asJava) } 
            }

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def egressFilterRulesAsScala(value: Option[Seq[TrafficMirrorFilterRule]]): TrafficMirrorFilter.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.egressFilterRules(v.asJava) } 
            }

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def networkServicesAsScala(value: Option[Seq[TrafficMirrorNetworkService]]): TrafficMirrorFilter.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.networkServices(v.asJava) } 
            }
...
final class TrafficMirrorFilterOps(val self: TrafficMirrorFilter) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def ingressFilterRulesAsScala: Option[Seq[TrafficMirrorFilterRule]] = Option(self.ingressFilterRules).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def egressFilterRulesAsScala: Option[Seq[TrafficMirrorFilterRule]] = Option(self.egressFilterRules).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def networkServicesAsScala: Option[Seq[TrafficMirrorNetworkService]] = Option(self.networkServices).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toTrafficMirrorFilterBuilderOps(v: TrafficMirrorFilter.Builder): TrafficMirrorFilterBuilderOps = new TrafficMirrorFilterBuilderOps(v)
