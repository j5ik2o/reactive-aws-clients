...
final class TrafficMirrorFilterOps(val self: TrafficMirrorFilter) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def ingressFilterRulesAsScala: Option[Seq[TrafficMirrorFilterRule]] =
    Option(self.ingressFilterRules).map { v =>
      import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala
    }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def egressFilterRulesAsScala: Option[Seq[TrafficMirrorFilterRule]] =
    Option(self.egressFilterRules).map { v =>
      import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala
    }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def networkServicesAsScala: Option[Seq[TrafficMirrorNetworkService]] =
    Option(self.networkServices).map { v =>
      import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala
    }
