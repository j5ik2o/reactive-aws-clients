...
implicit def toClientVpnAuthenticationBuilderOps(v: ClientVpnAuthentication.Builder): ClientVpnAuthenticationBuilderOps = new ClientVpnAuthenticationBuilderOps(v)

implicit def toClientVpnAuthenticationOps(v: ClientVpnAuthentication): ClientVpnAuthenticationOps = new ClientVpnAuthenticationOps(v)
