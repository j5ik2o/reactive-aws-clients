...
implicit def toElasticInferenceAcceleratorBuilderOps(v: ElasticInferenceAccelerator.Builder): ElasticInferenceAcceleratorBuilderOps = new ElasticInferenceAcceleratorBuilderOps(v)

implicit def toElasticInferenceAcceleratorOps(v: ElasticInferenceAccelerator): ElasticInferenceAcceleratorOps = new ElasticInferenceAcceleratorOps(v)
