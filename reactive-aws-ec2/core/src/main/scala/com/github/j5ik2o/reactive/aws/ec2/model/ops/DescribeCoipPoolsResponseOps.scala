...
final class DescribeCoipPoolsResponseOps(val self: DescribeCoipPoolsResponse) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def coipPoolsAsScala: Option[Seq[CoipPool]] =
    Option(self.coipPools).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
