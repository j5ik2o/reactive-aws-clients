...
trait ToCancelBundleTaskResponseOps {
  ...
  implicit def toCancelBundleTaskResponseBuilderOps(
      v: CancelBundleTaskResponse.Builder
  ): CancelBundleTaskResponseBuilderOps = new CancelBundleTaskResponseBuilderOps(v)

  implicit def toCancelBundleTaskResponseOps(v: CancelBundleTaskResponse): CancelBundleTaskResponseOps =
    new CancelBundleTaskResponseOps(v)
