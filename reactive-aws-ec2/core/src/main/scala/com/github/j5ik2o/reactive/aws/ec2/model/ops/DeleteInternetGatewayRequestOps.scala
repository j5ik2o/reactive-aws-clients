...
implicit def toDeleteInternetGatewayRequestBuilderOps(v: DeleteInternetGatewayRequest.Builder): DeleteInternetGatewayRequestBuilderOps = new DeleteInternetGatewayRequestBuilderOps(v)

implicit def toDeleteInternetGatewayRequestOps(v: DeleteInternetGatewayRequest): DeleteInternetGatewayRequestOps = new DeleteInternetGatewayRequestOps(v)
