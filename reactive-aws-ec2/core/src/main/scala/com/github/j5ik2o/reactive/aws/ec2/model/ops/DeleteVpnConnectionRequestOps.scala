...
implicit def toDeleteVpnConnectionRequestBuilderOps(v: DeleteVpnConnectionRequest.Builder): DeleteVpnConnectionRequestBuilderOps = new DeleteVpnConnectionRequestBuilderOps(v)

implicit def toDeleteVpnConnectionRequestOps(v: DeleteVpnConnectionRequest): DeleteVpnConnectionRequestOps = new DeleteVpnConnectionRequestOps(v)
