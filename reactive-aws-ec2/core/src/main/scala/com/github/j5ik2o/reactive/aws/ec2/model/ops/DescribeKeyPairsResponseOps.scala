...
final class DescribeKeyPairsResponseOps(val self: DescribeKeyPairsResponse) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def keyPairsAsScala: Option[Seq[KeyPairInfo]] =
    Option(self.keyPairs).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
