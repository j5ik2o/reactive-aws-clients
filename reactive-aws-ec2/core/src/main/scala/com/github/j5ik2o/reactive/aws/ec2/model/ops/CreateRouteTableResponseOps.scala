...
implicit def toCreateRouteTableResponseBuilderOps(v: CreateRouteTableResponse.Builder): CreateRouteTableResponseBuilderOps = new CreateRouteTableResponseBuilderOps(v)

implicit def toCreateRouteTableResponseOps(v: CreateRouteTableResponse): CreateRouteTableResponseOps = new CreateRouteTableResponseOps(v)
