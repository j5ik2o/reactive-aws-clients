...
trait ToDeleteLocalGatewayRouteRequestOps {
  ...
  implicit def toDeleteLocalGatewayRouteRequestBuilderOps(
      v: DeleteLocalGatewayRouteRequest.Builder
  ): DeleteLocalGatewayRouteRequestBuilderOps = new DeleteLocalGatewayRouteRequestBuilderOps(v)

  implicit def toDeleteLocalGatewayRouteRequestOps(
      v: DeleteLocalGatewayRouteRequest
  ): DeleteLocalGatewayRouteRequestOps = new DeleteLocalGatewayRouteRequestOps(v)
