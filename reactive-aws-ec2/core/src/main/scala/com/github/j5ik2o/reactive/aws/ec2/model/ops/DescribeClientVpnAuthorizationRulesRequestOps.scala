...
final class DescribeClientVpnAuthorizationRulesRequestBuilderOps(val self: DescribeClientVpnAuthorizationRulesRequest.Builder) extends AnyVal {
...
final class DescribeClientVpnAuthorizationRulesRequestOps(val self: DescribeClientVpnAuthorizationRulesRequest) extends AnyVal {
...
implicit def toDescribeClientVpnAuthorizationRulesRequestBuilderOps(v: DescribeClientVpnAuthorizationRulesRequest.Builder): DescribeClientVpnAuthorizationRulesRequestBuilderOps = new DescribeClientVpnAuthorizationRulesRequestBuilderOps(v)

implicit def toDescribeClientVpnAuthorizationRulesRequestOps(v: DescribeClientVpnAuthorizationRulesRequest): DescribeClientVpnAuthorizationRulesRequestOps = new DescribeClientVpnAuthorizationRulesRequestOps(v)
