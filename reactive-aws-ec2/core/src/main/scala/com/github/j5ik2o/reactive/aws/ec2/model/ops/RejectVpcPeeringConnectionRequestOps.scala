...
trait ToRejectVpcPeeringConnectionRequestOps {
  ...
  implicit def toRejectVpcPeeringConnectionRequestBuilderOps(
      v: RejectVpcPeeringConnectionRequest.Builder
  ): RejectVpcPeeringConnectionRequestBuilderOps = new RejectVpcPeeringConnectionRequestBuilderOps(v)

  implicit def toRejectVpcPeeringConnectionRequestOps(
      v: RejectVpcPeeringConnectionRequest
  ): RejectVpcPeeringConnectionRequestOps = new RejectVpcPeeringConnectionRequestOps(v)
