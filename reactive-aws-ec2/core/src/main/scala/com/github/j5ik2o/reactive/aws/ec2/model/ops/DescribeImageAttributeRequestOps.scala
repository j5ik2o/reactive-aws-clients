...
trait ToDescribeImageAttributeRequestOps {
  ...
  implicit def toDescribeImageAttributeRequestBuilderOps(
      v: DescribeImageAttributeRequest.Builder
  ): DescribeImageAttributeRequestBuilderOps = new DescribeImageAttributeRequestBuilderOps(v)

  implicit def toDescribeImageAttributeRequestOps(v: DescribeImageAttributeRequest): DescribeImageAttributeRequestOps =
    new DescribeImageAttributeRequestOps(v)
