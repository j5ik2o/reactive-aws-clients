...
trait ToRouteTableAssociationStateOps {
  ...
  implicit def toRouteTableAssociationStateBuilderOps(
      v: RouteTableAssociationState.Builder
  ): RouteTableAssociationStateBuilderOps = new RouteTableAssociationStateBuilderOps(v)

  implicit def toRouteTableAssociationStateOps(v: RouteTableAssociationState): RouteTableAssociationStateOps =
    new RouteTableAssociationStateOps(v)
