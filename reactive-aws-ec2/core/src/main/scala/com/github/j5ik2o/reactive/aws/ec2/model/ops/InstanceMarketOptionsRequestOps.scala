...
trait ToInstanceMarketOptionsRequestOps {
  ...
  implicit def toInstanceMarketOptionsRequestBuilderOps(
      v: InstanceMarketOptionsRequest.Builder
  ): InstanceMarketOptionsRequestBuilderOps = new InstanceMarketOptionsRequestBuilderOps(v)

  implicit def toInstanceMarketOptionsRequestOps(v: InstanceMarketOptionsRequest): InstanceMarketOptionsRequestOps =
    new InstanceMarketOptionsRequestOps(v)
