...
implicit def toCreateVpnConnectionRequestBuilderOps(v: CreateVpnConnectionRequest.Builder): CreateVpnConnectionRequestBuilderOps = new CreateVpnConnectionRequestBuilderOps(v)

implicit def toCreateVpnConnectionRequestOps(v: CreateVpnConnectionRequest): CreateVpnConnectionRequestOps = new CreateVpnConnectionRequestOps(v)
