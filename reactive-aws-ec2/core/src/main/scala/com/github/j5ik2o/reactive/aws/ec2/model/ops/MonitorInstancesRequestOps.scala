...
trait ToMonitorInstancesRequestOps {
  ...
  implicit def toMonitorInstancesRequestBuilderOps(
      v: MonitorInstancesRequest.Builder
  ): MonitorInstancesRequestBuilderOps = new MonitorInstancesRequestBuilderOps(v)

  implicit def toMonitorInstancesRequestOps(v: MonitorInstancesRequest): MonitorInstancesRequestOps =
    new MonitorInstancesRequestOps(v)
