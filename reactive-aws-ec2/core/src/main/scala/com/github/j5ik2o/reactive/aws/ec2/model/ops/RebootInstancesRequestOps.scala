...
implicit def toRebootInstancesRequestBuilderOps(v: RebootInstancesRequest.Builder): RebootInstancesRequestBuilderOps = new RebootInstancesRequestBuilderOps(v)

implicit def toRebootInstancesRequestOps(v: RebootInstancesRequest): RebootInstancesRequestOps = new RebootInstancesRequestOps(v)
