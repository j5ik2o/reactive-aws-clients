...
final class SpotFleetLaunchSpecificationBuilderOps(val self: SpotFleetLaunchSpecification.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def iamInstanceProfileAsScala(value: Option[IamInstanceProfileSpecification]): SpotFleetLaunchSpecification.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def networkInterfacesAsScala(value: Option[Seq[InstanceNetworkInterfaceSpecification]]): SpotFleetLaunchSpecification.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def tagSpecificationsAsScala(value: Option[Seq[SpotFleetTagSpecification]]): SpotFleetLaunchSpecification.Builder = {
...
final class SpotFleetLaunchSpecificationOps(val self: SpotFleetLaunchSpecification) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def tagSpecificationsAsScala: Option[Seq[SpotFleetTagSpecification]] = Option(self.tagSpecifications).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toSpotFleetLaunchSpecificationBuilderOps(v: SpotFleetLaunchSpecification.Builder): SpotFleetLaunchSpecificationBuilderOps = new SpotFleetLaunchSpecificationBuilderOps(v)

implicit def toSpotFleetLaunchSpecificationOps(v: SpotFleetLaunchSpecification): SpotFleetLaunchSpecificationOps = new SpotFleetLaunchSpecificationOps(v)
