...
implicit def toDescribePrefixListsRequestBuilderOps(v: DescribePrefixListsRequest.Builder): DescribePrefixListsRequestBuilderOps = new DescribePrefixListsRequestBuilderOps(v)

implicit def toDescribePrefixListsRequestOps(v: DescribePrefixListsRequest): DescribePrefixListsRequestOps = new DescribePrefixListsRequestOps(v)
