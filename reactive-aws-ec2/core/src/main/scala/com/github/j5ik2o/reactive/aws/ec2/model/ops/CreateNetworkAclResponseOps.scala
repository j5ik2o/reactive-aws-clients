...
final class CreateNetworkAclResponseBuilderOps(val self: CreateNetworkAclResponse.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.networkAcl(v) }
            } 
...
implicit def toCreateNetworkAclResponseBuilderOps(v: CreateNetworkAclResponse.Builder): CreateNetworkAclResponseBuilderOps = new CreateNetworkAclResponseBuilderOps(v)

implicit def toCreateNetworkAclResponseOps(v: CreateNetworkAclResponse): CreateNetworkAclResponseOps = new CreateNetworkAclResponseOps(v)
