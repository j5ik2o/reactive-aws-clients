...
trait ToLaunchTemplatesMonitoringOps {
  ...
  implicit def toLaunchTemplatesMonitoringBuilderOps(
      v: LaunchTemplatesMonitoring.Builder
  ): LaunchTemplatesMonitoringBuilderOps = new LaunchTemplatesMonitoringBuilderOps(v)

  implicit def toLaunchTemplatesMonitoringOps(v: LaunchTemplatesMonitoring): LaunchTemplatesMonitoringOps =
    new LaunchTemplatesMonitoringOps(v)
