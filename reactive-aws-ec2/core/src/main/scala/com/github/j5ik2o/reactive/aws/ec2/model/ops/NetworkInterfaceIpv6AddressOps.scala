...
trait ToNetworkInterfaceIpv6AddressOps {
  ...
  implicit def toNetworkInterfaceIpv6AddressBuilderOps(
      v: NetworkInterfaceIpv6Address.Builder
  ): NetworkInterfaceIpv6AddressBuilderOps = new NetworkInterfaceIpv6AddressBuilderOps(v)

  implicit def toNetworkInterfaceIpv6AddressOps(v: NetworkInterfaceIpv6Address): NetworkInterfaceIpv6AddressOps =
    new NetworkInterfaceIpv6AddressOps(v)
