...
trait ToAttributeBooleanValueOps {
  ...
  implicit def toAttributeBooleanValueBuilderOps(v: AttributeBooleanValue.Builder): AttributeBooleanValueBuilderOps =
    new AttributeBooleanValueBuilderOps(v)

  implicit def toAttributeBooleanValueOps(v: AttributeBooleanValue): AttributeBooleanValueOps =
    new AttributeBooleanValueOps(v)
