...
implicit def toLaunchTemplateTagSpecificationBuilderOps(v: LaunchTemplateTagSpecification.Builder): LaunchTemplateTagSpecificationBuilderOps = new LaunchTemplateTagSpecificationBuilderOps(v)

implicit def toLaunchTemplateTagSpecificationOps(v: LaunchTemplateTagSpecification): LaunchTemplateTagSpecificationOps = new LaunchTemplateTagSpecificationOps(v)
