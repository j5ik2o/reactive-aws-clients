...
trait ToCreateNetworkInterfaceResponseOps {
  ...
  implicit def toCreateNetworkInterfaceResponseBuilderOps(
      v: CreateNetworkInterfaceResponse.Builder
  ): CreateNetworkInterfaceResponseBuilderOps = new CreateNetworkInterfaceResponseBuilderOps(v)

  implicit def toCreateNetworkInterfaceResponseOps(
      v: CreateNetworkInterfaceResponse
  ): CreateNetworkInterfaceResponseOps = new CreateNetworkInterfaceResponseOps(v)
