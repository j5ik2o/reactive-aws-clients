...
final class LaunchTemplatePlacementRequestBuilderOps(val self: LaunchTemplatePlacementRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.affinity(v) }
            } 
...
implicit def toLaunchTemplatePlacementRequestBuilderOps(v: LaunchTemplatePlacementRequest.Builder): LaunchTemplatePlacementRequestBuilderOps = new LaunchTemplatePlacementRequestBuilderOps(v)

implicit def toLaunchTemplatePlacementRequestOps(v: LaunchTemplatePlacementRequest): LaunchTemplatePlacementRequestOps = new LaunchTemplatePlacementRequestOps(v)
