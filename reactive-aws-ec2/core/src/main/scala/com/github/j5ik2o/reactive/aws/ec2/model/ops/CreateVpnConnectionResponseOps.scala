...
trait ToCreateVpnConnectionResponseOps {
  ...
  implicit def toCreateVpnConnectionResponseBuilderOps(
      v: CreateVpnConnectionResponse.Builder
  ): CreateVpnConnectionResponseBuilderOps = new CreateVpnConnectionResponseBuilderOps(v)

  implicit def toCreateVpnConnectionResponseOps(v: CreateVpnConnectionResponse): CreateVpnConnectionResponseOps =
    new CreateVpnConnectionResponseOps(v)
