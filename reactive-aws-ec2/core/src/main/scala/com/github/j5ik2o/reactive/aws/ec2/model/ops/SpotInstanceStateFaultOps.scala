...
implicit def toSpotInstanceStateFaultBuilderOps(v: SpotInstanceStateFault.Builder): SpotInstanceStateFaultBuilderOps = new SpotInstanceStateFaultBuilderOps(v)

implicit def toSpotInstanceStateFaultOps(v: SpotInstanceStateFault): SpotInstanceStateFaultOps = new SpotInstanceStateFaultOps(v)
