...
final class ActiveInstanceBuilderOps(val self: ActiveInstance.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.instanceHealth(v) }
            } 
...
implicit def toActiveInstanceBuilderOps(v: ActiveInstance.Builder): ActiveInstanceBuilderOps = new ActiveInstanceBuilderOps(v)
