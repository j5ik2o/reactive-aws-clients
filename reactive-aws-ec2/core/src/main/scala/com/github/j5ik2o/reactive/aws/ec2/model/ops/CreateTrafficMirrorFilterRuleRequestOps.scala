...
final class CreateTrafficMirrorFilterRuleRequestBuilderOps(val self: CreateTrafficMirrorFilterRuleRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def destinationPortRangeAsScala(value: Option[TrafficMirrorPortRangeRequest]): CreateTrafficMirrorFilterRuleRequest.Builder = {
            value.fold(self){ v => self.destinationPortRange(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def sourcePortRangeAsScala(value: Option[TrafficMirrorPortRangeRequest]): CreateTrafficMirrorFilterRuleRequest.Builder = {
...
implicit def toCreateTrafficMirrorFilterRuleRequestBuilderOps(v: CreateTrafficMirrorFilterRuleRequest.Builder): CreateTrafficMirrorFilterRuleRequestBuilderOps = new CreateTrafficMirrorFilterRuleRequestBuilderOps(v)

implicit def toCreateTrafficMirrorFilterRuleRequestOps(v: CreateTrafficMirrorFilterRuleRequest): CreateTrafficMirrorFilterRuleRequestOps = new CreateTrafficMirrorFilterRuleRequestOps(v)
