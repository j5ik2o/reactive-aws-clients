...
final class ReportInstanceStatusRequestBuilderOps(val self: ReportInstanceStatusRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def reasonCodesAsScala(value: Option[Seq[ReportInstanceReasonCodes]]): ReportInstanceStatusRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.reasonCodes(v.asJava) } 
            }
...
final class ReportInstanceStatusRequestOps(val self: ReportInstanceStatusRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def instancesAsScala: Option[Seq[String]] = Option(self.instances).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def reasonCodesAsScala: Option[Seq[ReportInstanceReasonCodes]] = Option(self.reasonCodes).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toReportInstanceStatusRequestBuilderOps(v: ReportInstanceStatusRequest.Builder): ReportInstanceStatusRequestBuilderOps = new ReportInstanceStatusRequestBuilderOps(v)

implicit def toReportInstanceStatusRequestOps(v: ReportInstanceStatusRequest): ReportInstanceStatusRequestOps = new ReportInstanceStatusRequestOps(v)
