...
final class ImportImageRequestBuilderOps(val self: ImportImageRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def diskContainersAsScala(value: Option[Seq[ImageDiskContainer]]): ImportImageRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.diskContainers(v.asJava) } 
            }
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def licenseSpecificationsAsScala(value: Option[Seq[ImportImageLicenseConfigurationRequest]]): ImportImageRequest.Builder = {
...
final class ImportImageRequestOps(val self: ImportImageRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def diskContainersAsScala: Option[Seq[ImageDiskContainer]] = Option(self.diskContainers).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def licenseSpecificationsAsScala: Option[Seq[ImportImageLicenseConfigurationRequest]] = Option(self.licenseSpecifications).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toImportImageRequestBuilderOps(v: ImportImageRequest.Builder): ImportImageRequestBuilderOps = new ImportImageRequestBuilderOps(v)
