...
implicit def toModifyVolumeResponseBuilderOps(v: ModifyVolumeResponse.Builder): ModifyVolumeResponseBuilderOps = new ModifyVolumeResponseBuilderOps(v)

implicit def toModifyVolumeResponseOps(v: ModifyVolumeResponse): ModifyVolumeResponseOps = new ModifyVolumeResponseOps(v)
