...
final class CreateFleetInstanceBuilderOps(val self: CreateFleetInstance.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def launchTemplateAndOverridesAsScala(value: Option[LaunchTemplateAndOverridesResponse]): CreateFleetInstance.Builder = {
...
implicit def toCreateFleetInstanceBuilderOps(v: CreateFleetInstance.Builder): CreateFleetInstanceBuilderOps = new CreateFleetInstanceBuilderOps(v)
