...
final class ExportTransitGatewayRoutesRequestBuilderOps(val self: ExportTransitGatewayRoutesRequest.Builder) extends AnyVal {
...
implicit def toExportTransitGatewayRoutesRequestBuilderOps(v: ExportTransitGatewayRoutesRequest.Builder): ExportTransitGatewayRoutesRequestBuilderOps = new ExportTransitGatewayRoutesRequestBuilderOps(v)

implicit def toExportTransitGatewayRoutesRequestOps(v: ExportTransitGatewayRoutesRequest): ExportTransitGatewayRoutesRequestOps = new ExportTransitGatewayRoutesRequestOps(v)
