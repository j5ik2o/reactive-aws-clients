...
final class DescribeSpotFleetRequestHistoryRequestBuilderOps(val self: DescribeSpotFleetRequestHistoryRequest.Builder) extends AnyVal {
...
implicit def toDescribeSpotFleetRequestHistoryRequestBuilderOps(v: DescribeSpotFleetRequestHistoryRequest.Builder): DescribeSpotFleetRequestHistoryRequestBuilderOps = new DescribeSpotFleetRequestHistoryRequestBuilderOps(v)

implicit def toDescribeSpotFleetRequestHistoryRequestOps(v: DescribeSpotFleetRequestHistoryRequest): DescribeSpotFleetRequestHistoryRequestOps = new DescribeSpotFleetRequestHistoryRequestOps(v)
