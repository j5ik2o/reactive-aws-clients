...
trait ToAvailabilityZoneMessageOps {
  ...
  implicit def toAvailabilityZoneMessageBuilderOps(
      v: AvailabilityZoneMessage.Builder
  ): AvailabilityZoneMessageBuilderOps = new AvailabilityZoneMessageBuilderOps(v)

  implicit def toAvailabilityZoneMessageOps(v: AvailabilityZoneMessage): AvailabilityZoneMessageOps =
    new AvailabilityZoneMessageOps(v)
