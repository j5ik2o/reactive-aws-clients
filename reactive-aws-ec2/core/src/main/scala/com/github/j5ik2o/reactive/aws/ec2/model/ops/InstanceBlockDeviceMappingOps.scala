...
implicit def toInstanceBlockDeviceMappingBuilderOps(v: InstanceBlockDeviceMapping.Builder): InstanceBlockDeviceMappingBuilderOps = new InstanceBlockDeviceMappingBuilderOps(v)

implicit def toInstanceBlockDeviceMappingOps(v: InstanceBlockDeviceMapping): InstanceBlockDeviceMappingOps = new InstanceBlockDeviceMappingOps(v)
