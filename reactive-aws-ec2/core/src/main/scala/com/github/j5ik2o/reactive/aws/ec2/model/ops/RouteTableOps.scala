...
final class RouteTableOps(val self: RouteTable) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def associationsAsScala: Option[Seq[RouteTableAssociation]] =
    Option(self.associations).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def propagatingVgwsAsScala: Option[Seq[PropagatingVgw]] =
    Option(self.propagatingVgws).map { v =>
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def routesAsScala: Option[Seq[Route]] =
