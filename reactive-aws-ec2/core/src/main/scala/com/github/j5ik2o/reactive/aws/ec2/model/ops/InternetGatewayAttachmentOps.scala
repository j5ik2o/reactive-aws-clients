...
implicit def toInternetGatewayAttachmentBuilderOps(v: InternetGatewayAttachment.Builder): InternetGatewayAttachmentBuilderOps = new InternetGatewayAttachmentBuilderOps(v)

implicit def toInternetGatewayAttachmentOps(v: InternetGatewayAttachment): InternetGatewayAttachmentOps = new InternetGatewayAttachmentOps(v)
