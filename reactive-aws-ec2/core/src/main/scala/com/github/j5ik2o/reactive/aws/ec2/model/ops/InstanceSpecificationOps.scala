...
implicit def toInstanceSpecificationBuilderOps(v: InstanceSpecification.Builder): InstanceSpecificationBuilderOps = new InstanceSpecificationBuilderOps(v)

implicit def toInstanceSpecificationOps(v: InstanceSpecification): InstanceSpecificationOps = new InstanceSpecificationOps(v)
