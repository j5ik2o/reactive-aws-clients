...
implicit def toDeleteVpnGatewayRequestBuilderOps(v: DeleteVpnGatewayRequest.Builder): DeleteVpnGatewayRequestBuilderOps = new DeleteVpnGatewayRequestBuilderOps(v)

implicit def toDeleteVpnGatewayRequestOps(v: DeleteVpnGatewayRequest): DeleteVpnGatewayRequestOps = new DeleteVpnGatewayRequestOps(v)
