...
final class TargetCapacitySpecificationBuilderOps(val self: TargetCapacitySpecification.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def defaultTargetCapacityTypeAsScala(value: Option[DefaultTargetCapacityType]): TargetCapacitySpecification.Builder = {
...
implicit def toTargetCapacitySpecificationBuilderOps(v: TargetCapacitySpecification.Builder): TargetCapacitySpecificationBuilderOps = new TargetCapacitySpecificationBuilderOps(v)

implicit def toTargetCapacitySpecificationOps(v: TargetCapacitySpecification): TargetCapacitySpecificationOps = new TargetCapacitySpecificationOps(v)
