...
implicit def toDescribeIpv6PoolsRequestBuilderOps(v: DescribeIpv6PoolsRequest.Builder): DescribeIpv6PoolsRequestBuilderOps = new DescribeIpv6PoolsRequestBuilderOps(v)

implicit def toDescribeIpv6PoolsRequestOps(v: DescribeIpv6PoolsRequest): DescribeIpv6PoolsRequestOps = new DescribeIpv6PoolsRequestOps(v)
