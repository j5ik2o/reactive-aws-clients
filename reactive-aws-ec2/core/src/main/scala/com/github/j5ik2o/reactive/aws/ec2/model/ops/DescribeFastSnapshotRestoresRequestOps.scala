...
final class DescribeFastSnapshotRestoresRequestBuilderOps(val self: DescribeFastSnapshotRestoresRequest.Builder) extends AnyVal {
...
implicit def toDescribeFastSnapshotRestoresRequestBuilderOps(v: DescribeFastSnapshotRestoresRequest.Builder): DescribeFastSnapshotRestoresRequestBuilderOps = new DescribeFastSnapshotRestoresRequestBuilderOps(v)

implicit def toDescribeFastSnapshotRestoresRequestOps(v: DescribeFastSnapshotRestoresRequest): DescribeFastSnapshotRestoresRequestOps = new DescribeFastSnapshotRestoresRequestOps(v)
