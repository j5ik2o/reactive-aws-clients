...
trait ToCreateSnapshotsRequestOps {
  ...
  implicit def toCreateSnapshotsRequestBuilderOps(v: CreateSnapshotsRequest.Builder): CreateSnapshotsRequestBuilderOps =
    new CreateSnapshotsRequestBuilderOps(v)

  implicit def toCreateSnapshotsRequestOps(v: CreateSnapshotsRequest): CreateSnapshotsRequestOps =
    new CreateSnapshotsRequestOps(v)
