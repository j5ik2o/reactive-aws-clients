...
final class CreateTrafficMirrorTargetRequestBuilderOps(val self: CreateTrafficMirrorTargetRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.networkLoadBalancerArn(v) }
            } 
...
implicit def toCreateTrafficMirrorTargetRequestBuilderOps(v: CreateTrafficMirrorTargetRequest.Builder): CreateTrafficMirrorTargetRequestBuilderOps = new CreateTrafficMirrorTargetRequestBuilderOps(v)

implicit def toCreateTrafficMirrorTargetRequestOps(v: CreateTrafficMirrorTargetRequest): CreateTrafficMirrorTargetRequestOps = new CreateTrafficMirrorTargetRequestOps(v)
