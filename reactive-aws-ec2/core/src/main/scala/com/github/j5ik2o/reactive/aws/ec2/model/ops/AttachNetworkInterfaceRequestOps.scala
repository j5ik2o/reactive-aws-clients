...
implicit def toAttachNetworkInterfaceRequestBuilderOps(v: AttachNetworkInterfaceRequest.Builder): AttachNetworkInterfaceRequestBuilderOps = new AttachNetworkInterfaceRequestBuilderOps(v)

implicit def toAttachNetworkInterfaceRequestOps(v: AttachNetworkInterfaceRequest): AttachNetworkInterfaceRequestOps = new AttachNetworkInterfaceRequestOps(v)
