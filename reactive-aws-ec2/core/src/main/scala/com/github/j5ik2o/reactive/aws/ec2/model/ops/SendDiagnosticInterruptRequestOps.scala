...
implicit def toSendDiagnosticInterruptRequestBuilderOps(v: SendDiagnosticInterruptRequest.Builder): SendDiagnosticInterruptRequestBuilderOps = new SendDiagnosticInterruptRequestBuilderOps(v)

implicit def toSendDiagnosticInterruptRequestOps(v: SendDiagnosticInterruptRequest): SendDiagnosticInterruptRequestOps = new SendDiagnosticInterruptRequestOps(v)
