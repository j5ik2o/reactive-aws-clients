...
trait ToTrafficMirrorPortRangeOps {
  ...
  implicit def toTrafficMirrorPortRangeBuilderOps(v: TrafficMirrorPortRange.Builder): TrafficMirrorPortRangeBuilderOps =
    new TrafficMirrorPortRangeBuilderOps(v)

  implicit def toTrafficMirrorPortRangeOps(v: TrafficMirrorPortRange): TrafficMirrorPortRangeOps =
    new TrafficMirrorPortRangeOps(v)
