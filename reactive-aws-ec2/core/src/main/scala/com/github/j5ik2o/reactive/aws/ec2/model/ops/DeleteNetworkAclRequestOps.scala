...
trait ToDeleteNetworkAclRequestOps {
  ...
  implicit def toDeleteNetworkAclRequestBuilderOps(
      v: DeleteNetworkAclRequest.Builder
  ): DeleteNetworkAclRequestBuilderOps = new DeleteNetworkAclRequestBuilderOps(v)

  implicit def toDeleteNetworkAclRequestOps(v: DeleteNetworkAclRequest): DeleteNetworkAclRequestOps =
    new DeleteNetworkAclRequestOps(v)
