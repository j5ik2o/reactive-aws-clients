...
final class RegisterTransitGatewayMulticastGroupMembersRequestBuilderOps(
    val self: RegisterTransitGatewayMulticastGroupMembersRequest.Builder
) extends AnyVal {
...
final class RegisterTransitGatewayMulticastGroupMembersRequestOps(
    val self: RegisterTransitGatewayMulticastGroupMembersRequest
) extends AnyVal {
...
trait ToRegisterTransitGatewayMulticastGroupMembersRequestOps {
  ...
  implicit def toRegisterTransitGatewayMulticastGroupMembersRequestBuilderOps(
      v: RegisterTransitGatewayMulticastGroupMembersRequest.Builder
  ): RegisterTransitGatewayMulticastGroupMembersRequestBuilderOps =
    new RegisterTransitGatewayMulticastGroupMembersRequestBuilderOps(v)

  implicit def toRegisterTransitGatewayMulticastGroupMembersRequestOps(
      v: RegisterTransitGatewayMulticastGroupMembersRequest
  ): RegisterTransitGatewayMulticastGroupMembersRequestOps =
    new RegisterTransitGatewayMulticastGroupMembersRequestOps(v)
