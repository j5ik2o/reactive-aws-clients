...
final class DescribeSpotFleetRequestsRequestBuilderOps(val self: DescribeSpotFleetRequestsRequest.Builder) extends AnyVal {
...
implicit def toDescribeSpotFleetRequestsRequestBuilderOps(v: DescribeSpotFleetRequestsRequest.Builder): DescribeSpotFleetRequestsRequestBuilderOps = new DescribeSpotFleetRequestsRequestBuilderOps(v)

implicit def toDescribeSpotFleetRequestsRequestOps(v: DescribeSpotFleetRequestsRequest): DescribeSpotFleetRequestsRequestOps = new DescribeSpotFleetRequestsRequestOps(v)
