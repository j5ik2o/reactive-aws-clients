...
final class ModifyTrafficMirrorFilterRuleRequestBuilderOps(val self: ModifyTrafficMirrorFilterRuleRequest.Builder)
    extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def removeFieldsAsScala(
      value: Option[Seq[TrafficMirrorFilterRuleField]]
  ): ModifyTrafficMirrorFilterRuleRequest.Builder = {
    value.filter(_.nonEmpty).fold(self) { v =>
      import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.removeFields(v.asJava)
    }
  }
...
final class ModifyTrafficMirrorFilterRuleRequestOps(val self: ModifyTrafficMirrorFilterRuleRequest) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def removeFieldsAsScala: Option[Seq[TrafficMirrorFilterRuleField]] =
    Option(self.removeFields).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
...
trait ToModifyTrafficMirrorFilterRuleRequestOps {
  ...
  implicit def toModifyTrafficMirrorFilterRuleRequestBuilderOps(
      v: ModifyTrafficMirrorFilterRuleRequest.Builder
  ): ModifyTrafficMirrorFilterRuleRequestBuilderOps = new ModifyTrafficMirrorFilterRuleRequestBuilderOps(v)

  implicit def toModifyTrafficMirrorFilterRuleRequestOps(
      v: ModifyTrafficMirrorFilterRuleRequest
  ): ModifyTrafficMirrorFilterRuleRequestOps = new ModifyTrafficMirrorFilterRuleRequestOps(v)
