...
final class DescribeSpotFleetInstancesRequestBuilderOps(val self: DescribeSpotFleetInstancesRequest.Builder) extends AnyVal {
...
implicit def toDescribeSpotFleetInstancesRequestBuilderOps(v: DescribeSpotFleetInstancesRequest.Builder): DescribeSpotFleetInstancesRequestBuilderOps = new DescribeSpotFleetInstancesRequestBuilderOps(v)

implicit def toDescribeSpotFleetInstancesRequestOps(v: DescribeSpotFleetInstancesRequest): DescribeSpotFleetInstancesRequestOps = new DescribeSpotFleetInstancesRequestOps(v)
