...
final class DescribeNetworkInterfacesRequestBuilderOps(val self: DescribeNetworkInterfacesRequest.Builder) extends AnyVal {
...
implicit def toDescribeNetworkInterfacesRequestBuilderOps(v: DescribeNetworkInterfacesRequest.Builder): DescribeNetworkInterfacesRequestBuilderOps = new DescribeNetworkInterfacesRequestBuilderOps(v)

implicit def toDescribeNetworkInterfacesRequestOps(v: DescribeNetworkInterfacesRequest): DescribeNetworkInterfacesRequestOps = new DescribeNetworkInterfacesRequestOps(v)
