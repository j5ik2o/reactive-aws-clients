...
final class DeleteVpnConnectionRouteRequestBuilderOps(val self: DeleteVpnConnectionRouteRequest.Builder) extends AnyVal {
...
implicit def toDeleteVpnConnectionRouteRequestBuilderOps(v: DeleteVpnConnectionRouteRequest.Builder): DeleteVpnConnectionRouteRequestBuilderOps = new DeleteVpnConnectionRouteRequestBuilderOps(v)

implicit def toDeleteVpnConnectionRouteRequestOps(v: DeleteVpnConnectionRouteRequest): DeleteVpnConnectionRouteRequestOps = new DeleteVpnConnectionRouteRequestOps(v)
