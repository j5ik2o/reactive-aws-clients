...
final class ImportSnapshotTaskBuilderOps(val self: ImportSnapshotTask.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def tagsAsScala(value: Option[Seq[Tag]]): ImportSnapshotTask.Builder = {
...
implicit def toImportSnapshotTaskBuilderOps(v: ImportSnapshotTask.Builder): ImportSnapshotTaskBuilderOps = new ImportSnapshotTaskBuilderOps(v)
