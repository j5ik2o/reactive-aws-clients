...
final class DisassociateTransitGatewayMulticastDomainRequestBuilderOps(
    val self: DisassociateTransitGatewayMulticastDomainRequest.Builder
) extends AnyVal {
...
final class DisassociateTransitGatewayMulticastDomainRequestOps(
    val self: DisassociateTransitGatewayMulticastDomainRequest
) extends AnyVal {
...
trait ToDisassociateTransitGatewayMulticastDomainRequestOps {
  ...
  implicit def toDisassociateTransitGatewayMulticastDomainRequestBuilderOps(
      v: DisassociateTransitGatewayMulticastDomainRequest.Builder
  ): DisassociateTransitGatewayMulticastDomainRequestBuilderOps =
    new DisassociateTransitGatewayMulticastDomainRequestBuilderOps(v)

  implicit def toDisassociateTransitGatewayMulticastDomainRequestOps(
      v: DisassociateTransitGatewayMulticastDomainRequest
  ): DisassociateTransitGatewayMulticastDomainRequestOps = new DisassociateTransitGatewayMulticastDomainRequestOps(v)
