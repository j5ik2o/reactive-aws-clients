...
final class OnDemandOptionsRequestBuilderOps(val self: OnDemandOptionsRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def allocationStrategyAsScala(value: Option[FleetOnDemandAllocationStrategy]): OnDemandOptionsRequest.Builder = {
            value.fold(self){ v => self.allocationStrategy(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def capacityReservationOptionsAsScala(value: Option[CapacityReservationOptionsRequest]): OnDemandOptionsRequest.Builder = {
...
final class OnDemandOptionsRequestOps(val self: OnDemandOptionsRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def capacityReservationOptionsAsScala: Option[CapacityReservationOptionsRequest] = Option(self.capacityReservationOptions) 
...
implicit def toOnDemandOptionsRequestBuilderOps(v: OnDemandOptionsRequest.Builder): OnDemandOptionsRequestBuilderOps = new OnDemandOptionsRequestBuilderOps(v)

implicit def toOnDemandOptionsRequestOps(v: OnDemandOptionsRequest): OnDemandOptionsRequestOps = new OnDemandOptionsRequestOps(v)
