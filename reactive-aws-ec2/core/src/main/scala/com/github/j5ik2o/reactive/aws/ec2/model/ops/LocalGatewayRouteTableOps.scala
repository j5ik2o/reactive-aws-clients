...
implicit def toLocalGatewayRouteTableBuilderOps(v: LocalGatewayRouteTable.Builder): LocalGatewayRouteTableBuilderOps = new LocalGatewayRouteTableBuilderOps(v)

implicit def toLocalGatewayRouteTableOps(v: LocalGatewayRouteTable): LocalGatewayRouteTableOps = new LocalGatewayRouteTableOps(v)
