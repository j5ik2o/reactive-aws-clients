...
final class EnableVgwRoutePropagationRequestBuilderOps(val self: EnableVgwRoutePropagationRequest.Builder) extends AnyVal {
...
implicit def toEnableVgwRoutePropagationRequestBuilderOps(v: EnableVgwRoutePropagationRequest.Builder): EnableVgwRoutePropagationRequestBuilderOps = new EnableVgwRoutePropagationRequestBuilderOps(v)

implicit def toEnableVgwRoutePropagationRequestOps(v: EnableVgwRoutePropagationRequest): EnableVgwRoutePropagationRequestOps = new EnableVgwRoutePropagationRequestOps(v)
