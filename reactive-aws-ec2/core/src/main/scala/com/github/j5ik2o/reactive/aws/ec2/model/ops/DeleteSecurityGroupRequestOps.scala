...
implicit def toDeleteSecurityGroupRequestBuilderOps(v: DeleteSecurityGroupRequest.Builder): DeleteSecurityGroupRequestBuilderOps = new DeleteSecurityGroupRequestBuilderOps(v)

implicit def toDeleteSecurityGroupRequestOps(v: DeleteSecurityGroupRequest): DeleteSecurityGroupRequestOps = new DeleteSecurityGroupRequestOps(v)
