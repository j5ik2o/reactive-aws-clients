...
final class VpcBuilderOps(val self: Vpc.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def ipv6CidrBlockAssociationSetAsScala(value: Option[Seq[VpcIpv6CidrBlockAssociation]]): Vpc.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.ipv6CidrBlockAssociationSet(v.asJava) } 
            }

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def cidrBlockAssociationSetAsScala(value: Option[Seq[VpcCidrBlockAssociation]]): Vpc.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.cidrBlockAssociationSet(v.asJava) } 
            }
...
final class VpcOps(val self: Vpc) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def ipv6CidrBlockAssociationSetAsScala: Option[Seq[VpcIpv6CidrBlockAssociation]] = Option(self.ipv6CidrBlockAssociationSet).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def cidrBlockAssociationSetAsScala: Option[Seq[VpcCidrBlockAssociation]] = Option(self.cidrBlockAssociationSet).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
