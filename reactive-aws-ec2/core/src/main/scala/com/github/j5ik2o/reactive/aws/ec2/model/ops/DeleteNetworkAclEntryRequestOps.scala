...
implicit def toDeleteNetworkAclEntryRequestBuilderOps(v: DeleteNetworkAclEntryRequest.Builder): DeleteNetworkAclEntryRequestBuilderOps = new DeleteNetworkAclEntryRequestBuilderOps(v)

implicit def toDeleteNetworkAclEntryRequestOps(v: DeleteNetworkAclEntryRequest): DeleteNetworkAclEntryRequestOps = new DeleteNetworkAclEntryRequestOps(v)
