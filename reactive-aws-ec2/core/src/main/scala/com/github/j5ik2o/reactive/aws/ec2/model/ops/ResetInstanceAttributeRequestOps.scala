...
implicit def toResetInstanceAttributeRequestBuilderOps(v: ResetInstanceAttributeRequest.Builder): ResetInstanceAttributeRequestBuilderOps = new ResetInstanceAttributeRequestBuilderOps(v)

implicit def toResetInstanceAttributeRequestOps(v: ResetInstanceAttributeRequest): ResetInstanceAttributeRequestOps = new ResetInstanceAttributeRequestOps(v)
