...
implicit def toCreateDefaultVpcResponseBuilderOps(v: CreateDefaultVpcResponse.Builder): CreateDefaultVpcResponseBuilderOps = new CreateDefaultVpcResponseBuilderOps(v)

implicit def toCreateDefaultVpcResponseOps(v: CreateDefaultVpcResponse): CreateDefaultVpcResponseOps = new CreateDefaultVpcResponseOps(v)
