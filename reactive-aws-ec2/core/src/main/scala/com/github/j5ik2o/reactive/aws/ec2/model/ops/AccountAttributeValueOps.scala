...
trait ToAccountAttributeValueOps {
  ...
  implicit def toAccountAttributeValueBuilderOps(v: AccountAttributeValue.Builder): AccountAttributeValueBuilderOps =
    new AccountAttributeValueBuilderOps(v)

  implicit def toAccountAttributeValueOps(v: AccountAttributeValue): AccountAttributeValueOps =
    new AccountAttributeValueOps(v)
