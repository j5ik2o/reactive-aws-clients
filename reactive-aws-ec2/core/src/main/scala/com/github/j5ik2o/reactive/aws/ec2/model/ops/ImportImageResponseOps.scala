...
final class ImportImageResponseBuilderOps(val self: ImportImageResponse.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def snapshotDetailsAsScala(value: Option[Seq[SnapshotDetail]]): ImportImageResponse.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.snapshotDetails(v.asJava) } 
            }
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def licenseSpecificationsAsScala(value: Option[Seq[ImportImageLicenseConfigurationResponse]]): ImportImageResponse.Builder = {
...
final class ImportImageResponseOps(val self: ImportImageResponse) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def snapshotDetailsAsScala: Option[Seq[SnapshotDetail]] = Option(self.snapshotDetails).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def licenseSpecificationsAsScala: Option[Seq[ImportImageLicenseConfigurationResponse]] = Option(self.licenseSpecifications).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toImportImageResponseBuilderOps(v: ImportImageResponse.Builder): ImportImageResponseBuilderOps = new ImportImageResponseBuilderOps(v)
