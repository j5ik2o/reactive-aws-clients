...
implicit def toDeleteCustomerGatewayRequestBuilderOps(v: DeleteCustomerGatewayRequest.Builder): DeleteCustomerGatewayRequestBuilderOps = new DeleteCustomerGatewayRequestBuilderOps(v)

implicit def toDeleteCustomerGatewayRequestOps(v: DeleteCustomerGatewayRequest): DeleteCustomerGatewayRequestOps = new DeleteCustomerGatewayRequestOps(v)
