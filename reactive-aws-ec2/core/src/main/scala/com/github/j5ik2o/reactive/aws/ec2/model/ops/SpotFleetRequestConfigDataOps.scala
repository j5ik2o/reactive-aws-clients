...
final class SpotFleetRequestConfigDataBuilderOps(val self: SpotFleetRequestConfigData.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def onDemandAllocationStrategyAsScala(value: Option[OnDemandAllocationStrategy]): SpotFleetRequestConfigData.Builder = {
            value.fold(self){ v => self.onDemandAllocationStrategy(v) }
            } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def excessCapacityTerminationPolicyAsScala(value: Option[ExcessCapacityTerminationPolicy]): SpotFleetRequestConfigData.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.onDemandFulfilledCapacity(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def iamFleetRoleAsScala(value: Option[String]): SpotFleetRequestConfigData.Builder = {
            value.fold(self){ v => self.iamFleetRole(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def launchSpecificationsAsScala(value: Option[Seq[SpotFleetLaunchSpecification]]): SpotFleetRequestConfigData.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.launchSpecifications(v.asJava) } 
            }

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def launchTemplateConfigsAsScala(value: Option[Seq[LaunchTemplateConfig]]): SpotFleetRequestConfigData.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def instanceInterruptionBehaviorAsScala(value: Option[InstanceInterruptionBehavior]): SpotFleetRequestConfigData.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.loadBalancersConfig(v) }
            } 
...
final class SpotFleetRequestConfigDataOps(val self: SpotFleetRequestConfigData) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def onDemandAllocationStrategyAsScala: Option[OnDemandAllocationStrategy] = Option(self.onDemandAllocationStrategy) 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def clientTokenAsScala: Option[String] = Option(self.clientToken) 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def excessCapacityTerminationPolicyAsScala: Option[ExcessCapacityTerminationPolicy] = Option(self.excessCapacityTerminationPolicy) 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def launchSpecificationsAsScala: Option[Seq[SpotFleetLaunchSpecification]] = Option(self.launchSpecifications).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def launchTemplateConfigsAsScala: Option[Seq[LaunchTemplateConfig]] = Option(self.launchTemplateConfigs).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toSpotFleetRequestConfigDataBuilderOps(v: SpotFleetRequestConfigData.Builder): SpotFleetRequestConfigDataBuilderOps = new SpotFleetRequestConfigDataBuilderOps(v)

implicit def toSpotFleetRequestConfigDataOps(v: SpotFleetRequestConfigData): SpotFleetRequestConfigDataOps = new SpotFleetRequestConfigDataOps(v)
