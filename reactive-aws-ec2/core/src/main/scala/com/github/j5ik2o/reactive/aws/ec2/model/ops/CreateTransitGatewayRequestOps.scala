...
implicit def toCreateTransitGatewayRequestBuilderOps(v: CreateTransitGatewayRequest.Builder): CreateTransitGatewayRequestBuilderOps = new CreateTransitGatewayRequestBuilderOps(v)

implicit def toCreateTransitGatewayRequestOps(v: CreateTransitGatewayRequest): CreateTransitGatewayRequestOps = new CreateTransitGatewayRequestOps(v)
