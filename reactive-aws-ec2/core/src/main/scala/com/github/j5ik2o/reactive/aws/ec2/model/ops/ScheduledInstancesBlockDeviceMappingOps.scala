...
final class ScheduledInstancesBlockDeviceMappingBuilderOps(val self: ScheduledInstancesBlockDeviceMapping.Builder) extends AnyVal {
...
implicit def toScheduledInstancesBlockDeviceMappingBuilderOps(v: ScheduledInstancesBlockDeviceMapping.Builder): ScheduledInstancesBlockDeviceMappingBuilderOps = new ScheduledInstancesBlockDeviceMappingBuilderOps(v)

implicit def toScheduledInstancesBlockDeviceMappingOps(v: ScheduledInstancesBlockDeviceMapping): ScheduledInstancesBlockDeviceMappingOps = new ScheduledInstancesBlockDeviceMappingOps(v)
