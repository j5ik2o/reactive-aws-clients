...
implicit def toDescribePublicIpv4PoolsRequestBuilderOps(v: DescribePublicIpv4PoolsRequest.Builder): DescribePublicIpv4PoolsRequestBuilderOps = new DescribePublicIpv4PoolsRequestBuilderOps(v)

implicit def toDescribePublicIpv4PoolsRequestOps(v: DescribePublicIpv4PoolsRequest): DescribePublicIpv4PoolsRequestOps = new DescribePublicIpv4PoolsRequestOps(v)
