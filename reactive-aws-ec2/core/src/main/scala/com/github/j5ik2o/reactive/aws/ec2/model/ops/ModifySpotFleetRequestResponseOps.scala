...
implicit def toModifySpotFleetRequestResponseBuilderOps(v: ModifySpotFleetRequestResponse.Builder): ModifySpotFleetRequestResponseBuilderOps = new ModifySpotFleetRequestResponseBuilderOps(v)

implicit def toModifySpotFleetRequestResponseOps(v: ModifySpotFleetRequestResponse): ModifySpotFleetRequestResponseOps = new ModifySpotFleetRequestResponseOps(v)
