...
final class LaunchSpecificationBuilderOps(val self: LaunchSpecification.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def networkInterfacesAsScala(value: Option[Seq[InstanceNetworkInterfaceSpecification]]): LaunchSpecification.Builder = {
...
implicit def toLaunchSpecificationBuilderOps(v: LaunchSpecification.Builder): LaunchSpecificationBuilderOps = new LaunchSpecificationBuilderOps(v)
