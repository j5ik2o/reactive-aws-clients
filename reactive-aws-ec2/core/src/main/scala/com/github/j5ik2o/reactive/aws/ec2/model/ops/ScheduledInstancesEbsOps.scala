...
implicit def toScheduledInstancesEbsBuilderOps(v: ScheduledInstancesEbs.Builder): ScheduledInstancesEbsBuilderOps = new ScheduledInstancesEbsBuilderOps(v)

implicit def toScheduledInstancesEbsOps(v: ScheduledInstancesEbs): ScheduledInstancesEbsOps = new ScheduledInstancesEbsOps(v)
