...
implicit def toAssignIpv6AddressesRequestBuilderOps(v: AssignIpv6AddressesRequest.Builder): AssignIpv6AddressesRequestBuilderOps = new AssignIpv6AddressesRequestBuilderOps(v)

implicit def toAssignIpv6AddressesRequestOps(v: AssignIpv6AddressesRequest): AssignIpv6AddressesRequestOps = new AssignIpv6AddressesRequestOps(v)
