...
trait ToDeleteNatGatewayResponseOps {
  ...
  implicit def toDeleteNatGatewayResponseBuilderOps(
      v: DeleteNatGatewayResponse.Builder
  ): DeleteNatGatewayResponseBuilderOps = new DeleteNatGatewayResponseBuilderOps(v)

  implicit def toDeleteNatGatewayResponseOps(v: DeleteNatGatewayResponse): DeleteNatGatewayResponseOps =
    new DeleteNatGatewayResponseOps(v)
