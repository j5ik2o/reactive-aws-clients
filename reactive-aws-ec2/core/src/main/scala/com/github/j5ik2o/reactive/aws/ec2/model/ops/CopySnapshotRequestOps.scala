...
final class CopySnapshotRequestBuilderOps(val self: CopySnapshotRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.destinationRegion(v) }
            } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.presignedUrl(v) }
            } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.sourceSnapshotId(v) }
            } 
...
implicit def toCopySnapshotRequestBuilderOps(v: CopySnapshotRequest.Builder): CopySnapshotRequestBuilderOps = new CopySnapshotRequestBuilderOps(v)
