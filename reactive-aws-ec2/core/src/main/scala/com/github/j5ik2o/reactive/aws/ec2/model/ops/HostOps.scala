...
final class HostBuilderOps(val self: Host.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.allocationTime(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def releaseTimeAsScala(value: Option[java.time.Instant]): Host.Builder = {
            value.fold(self){ v => self.releaseTime(v) }
            } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.allowsMultipleInstanceTypes(v) }
            } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.memberOfServiceLinkedResourceGroup(v) }
            } 
...
final class HostOps(val self: Host) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def instancesAsScala: Option[Seq[HostInstance]] = Option(self.instances).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def allowsMultipleInstanceTypesAsScala: Option[AllowsMultipleInstanceTypes] = Option(self.allowsMultipleInstanceTypes) 
