...
trait ToCreditSpecificationRequestOps {
  ...
  implicit def toCreditSpecificationRequestBuilderOps(
      v: CreditSpecificationRequest.Builder
  ): CreditSpecificationRequestBuilderOps = new CreditSpecificationRequestBuilderOps(v)

  implicit def toCreditSpecificationRequestOps(v: CreditSpecificationRequest): CreditSpecificationRequestOps =
    new CreditSpecificationRequestOps(v)
