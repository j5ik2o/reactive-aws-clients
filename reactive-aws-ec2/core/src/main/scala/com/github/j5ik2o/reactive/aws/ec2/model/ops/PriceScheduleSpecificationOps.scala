...
implicit def toPriceScheduleSpecificationBuilderOps(v: PriceScheduleSpecification.Builder): PriceScheduleSpecificationBuilderOps = new PriceScheduleSpecificationBuilderOps(v)

implicit def toPriceScheduleSpecificationOps(v: PriceScheduleSpecification): PriceScheduleSpecificationOps = new PriceScheduleSpecificationOps(v)
