...
final class DescribeInternetGatewaysRequestBuilderOps(val self: DescribeInternetGatewaysRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def internetGatewayIdsAsScala(value: Option[Seq[String]]): DescribeInternetGatewaysRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.internetGatewayIds(v.asJava) } 
            }
...
final class DescribeInternetGatewaysRequestOps(val self: DescribeInternetGatewaysRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def internetGatewayIdsAsScala: Option[Seq[String]] = Option(self.internetGatewayIds).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toDescribeInternetGatewaysRequestBuilderOps(v: DescribeInternetGatewaysRequest.Builder): DescribeInternetGatewaysRequestBuilderOps = new DescribeInternetGatewaysRequestBuilderOps(v)

implicit def toDescribeInternetGatewaysRequestOps(v: DescribeInternetGatewaysRequest): DescribeInternetGatewaysRequestOps = new DescribeInternetGatewaysRequestOps(v)
