...
implicit def toLicenseConfigurationBuilderOps(v: LicenseConfiguration.Builder): LicenseConfigurationBuilderOps = new LicenseConfigurationBuilderOps(v)

implicit def toLicenseConfigurationOps(v: LicenseConfiguration): LicenseConfigurationOps = new LicenseConfigurationOps(v)
