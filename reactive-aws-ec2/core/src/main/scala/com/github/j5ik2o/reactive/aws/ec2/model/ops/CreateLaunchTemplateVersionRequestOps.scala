...
final class CreateLaunchTemplateVersionRequestBuilderOps(val self: CreateLaunchTemplateVersionRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def launchTemplateDataAsScala(value: Option[RequestLaunchTemplateData]): CreateLaunchTemplateVersionRequest.Builder = {
...
implicit def toCreateLaunchTemplateVersionRequestBuilderOps(v: CreateLaunchTemplateVersionRequest.Builder): CreateLaunchTemplateVersionRequestBuilderOps = new CreateLaunchTemplateVersionRequestBuilderOps(v)

implicit def toCreateLaunchTemplateVersionRequestOps(v: CreateLaunchTemplateVersionRequest): CreateLaunchTemplateVersionRequestOps = new CreateLaunchTemplateVersionRequestOps(v)
