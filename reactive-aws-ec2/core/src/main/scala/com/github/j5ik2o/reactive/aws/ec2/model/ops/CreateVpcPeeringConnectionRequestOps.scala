...
final class CreateVpcPeeringConnectionRequestBuilderOps(val self: CreateVpcPeeringConnectionRequest.Builder) extends AnyVal {
...
implicit def toCreateVpcPeeringConnectionRequestBuilderOps(v: CreateVpcPeeringConnectionRequest.Builder): CreateVpcPeeringConnectionRequestBuilderOps = new CreateVpcPeeringConnectionRequestBuilderOps(v)

implicit def toCreateVpcPeeringConnectionRequestOps(v: CreateVpcPeeringConnectionRequest): CreateVpcPeeringConnectionRequestOps = new CreateVpcPeeringConnectionRequestOps(v)
