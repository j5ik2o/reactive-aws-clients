...
final class CreateTransitGatewayVpcAttachmentRequestBuilderOps(val self: CreateTransitGatewayVpcAttachmentRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def optionsAsScala(value: Option[CreateTransitGatewayVpcAttachmentRequestOptions]): CreateTransitGatewayVpcAttachmentRequest.Builder = {
            value.fold(self){ v => self.options(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def tagSpecificationsAsScala(value: Option[Seq[TagSpecification]]): CreateTransitGatewayVpcAttachmentRequest.Builder = {
...
final class CreateTransitGatewayVpcAttachmentRequestOps(val self: CreateTransitGatewayVpcAttachmentRequest) extends AnyVal {
...
implicit def toCreateTransitGatewayVpcAttachmentRequestBuilderOps(v: CreateTransitGatewayVpcAttachmentRequest.Builder): CreateTransitGatewayVpcAttachmentRequestBuilderOps = new CreateTransitGatewayVpcAttachmentRequestBuilderOps(v)

implicit def toCreateTransitGatewayVpcAttachmentRequestOps(v: CreateTransitGatewayVpcAttachmentRequest): CreateTransitGatewayVpcAttachmentRequestOps = new CreateTransitGatewayVpcAttachmentRequestOps(v)
