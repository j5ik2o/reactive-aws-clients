...
final class AcceptVpcEndpointConnectionsResponseBuilderOps(val self: AcceptVpcEndpointConnectionsResponse.Builder) extends AnyVal {
...
implicit def toAcceptVpcEndpointConnectionsResponseBuilderOps(v: AcceptVpcEndpointConnectionsResponse.Builder): AcceptVpcEndpointConnectionsResponseBuilderOps = new AcceptVpcEndpointConnectionsResponseBuilderOps(v)

implicit def toAcceptVpcEndpointConnectionsResponseOps(v: AcceptVpcEndpointConnectionsResponse): AcceptVpcEndpointConnectionsResponseOps = new AcceptVpcEndpointConnectionsResponseOps(v)
