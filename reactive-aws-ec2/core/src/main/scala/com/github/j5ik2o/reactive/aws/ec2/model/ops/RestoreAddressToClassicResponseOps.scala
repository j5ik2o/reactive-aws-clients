...
trait ToRestoreAddressToClassicResponseOps {
  ...
  implicit def toRestoreAddressToClassicResponseBuilderOps(
      v: RestoreAddressToClassicResponse.Builder
  ): RestoreAddressToClassicResponseBuilderOps = new RestoreAddressToClassicResponseBuilderOps(v)

  implicit def toRestoreAddressToClassicResponseOps(
      v: RestoreAddressToClassicResponse
  ): RestoreAddressToClassicResponseOps = new RestoreAddressToClassicResponseOps(v)
