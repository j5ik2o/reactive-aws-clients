...
implicit def toDeleteVpcEndpointsResponseBuilderOps(v: DeleteVpcEndpointsResponse.Builder): DeleteVpcEndpointsResponseBuilderOps = new DeleteVpcEndpointsResponseBuilderOps(v)

implicit def toDeleteVpcEndpointsResponseOps(v: DeleteVpcEndpointsResponse): DeleteVpcEndpointsResponseOps = new DeleteVpcEndpointsResponseOps(v)
