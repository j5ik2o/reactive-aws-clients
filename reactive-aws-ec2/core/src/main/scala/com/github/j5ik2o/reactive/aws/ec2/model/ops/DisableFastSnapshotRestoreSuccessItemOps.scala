...
final class DisableFastSnapshotRestoreSuccessItemBuilderOps(val self: DisableFastSnapshotRestoreSuccessItem.Builder)
    extends AnyVal {
...
trait ToDisableFastSnapshotRestoreSuccessItemOps {
  ...
  implicit def toDisableFastSnapshotRestoreSuccessItemBuilderOps(
      v: DisableFastSnapshotRestoreSuccessItem.Builder
  ): DisableFastSnapshotRestoreSuccessItemBuilderOps = new DisableFastSnapshotRestoreSuccessItemBuilderOps(v)

  implicit def toDisableFastSnapshotRestoreSuccessItemOps(
      v: DisableFastSnapshotRestoreSuccessItem
  ): DisableFastSnapshotRestoreSuccessItemOps = new DisableFastSnapshotRestoreSuccessItemOps(v)
