...
implicit def toGetConsoleOutputResponseBuilderOps(v: GetConsoleOutputResponse.Builder): GetConsoleOutputResponseBuilderOps = new GetConsoleOutputResponseBuilderOps(v)

implicit def toGetConsoleOutputResponseOps(v: GetConsoleOutputResponse): GetConsoleOutputResponseOps = new GetConsoleOutputResponseOps(v)
