...
final class GetConsoleScreenshotRequestBuilderOps(val self: GetConsoleScreenshotRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.wakeUp(v) }
            } 
...
implicit def toGetConsoleScreenshotRequestBuilderOps(v: GetConsoleScreenshotRequest.Builder): GetConsoleScreenshotRequestBuilderOps = new GetConsoleScreenshotRequestBuilderOps(v)

implicit def toGetConsoleScreenshotRequestOps(v: GetConsoleScreenshotRequest): GetConsoleScreenshotRequestOps = new GetConsoleScreenshotRequestOps(v)
