...
final class InstanceNetworkInterfaceAssociationBuilderOps(val self: InstanceNetworkInterfaceAssociation.Builder) extends AnyVal {
...
implicit def toInstanceNetworkInterfaceAssociationBuilderOps(v: InstanceNetworkInterfaceAssociation.Builder): InstanceNetworkInterfaceAssociationBuilderOps = new InstanceNetworkInterfaceAssociationBuilderOps(v)

implicit def toInstanceNetworkInterfaceAssociationOps(v: InstanceNetworkInterfaceAssociation): InstanceNetworkInterfaceAssociationOps = new InstanceNetworkInterfaceAssociationOps(v)
