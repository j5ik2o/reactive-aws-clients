...
implicit def toCreateLaunchTemplateRequestBuilderOps(v: CreateLaunchTemplateRequest.Builder): CreateLaunchTemplateRequestBuilderOps = new CreateLaunchTemplateRequestBuilderOps(v)

implicit def toCreateLaunchTemplateRequestOps(v: CreateLaunchTemplateRequest): CreateLaunchTemplateRequestOps = new CreateLaunchTemplateRequestOps(v)
