...
final class InstanceBuilderOps(val self: Instance.Builder) extends AnyVal {
  ...
  final def elasticGpuAssociationsAsScala(value: Option[Seq[ElasticGpuAssociation]]): Instance.Builder = {
    value.filter(_.nonEmpty).fold(self) { v =>
      import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.elasticGpuAssociations(v.asJava)
    }
  }
  ...
  final def elasticInferenceAcceleratorAssociationsAsScala(
    ...
    value.filter(_.nonEmpty).fold(self) { v =>
      ...
      self.elasticInferenceAcceleratorAssociations(v.asJava)
    }
  }
...
final class InstanceOps(val self: Instance) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def blockDeviceMappingsAsScala: Option[Seq[InstanceBlockDeviceMapping]] =
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def networkInterfacesAsScala: Option[Seq[InstanceNetworkInterface]] =
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def licensesAsScala: Option[Seq[LicenseConfiguration]] =
    Option(self.licenses).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
