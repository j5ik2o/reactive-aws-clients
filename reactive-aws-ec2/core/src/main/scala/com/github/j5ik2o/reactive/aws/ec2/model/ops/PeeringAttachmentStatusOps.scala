...
implicit def toPeeringAttachmentStatusBuilderOps(v: PeeringAttachmentStatus.Builder): PeeringAttachmentStatusBuilderOps = new PeeringAttachmentStatusBuilderOps(v)

implicit def toPeeringAttachmentStatusOps(v: PeeringAttachmentStatus): PeeringAttachmentStatusOps = new PeeringAttachmentStatusOps(v)
