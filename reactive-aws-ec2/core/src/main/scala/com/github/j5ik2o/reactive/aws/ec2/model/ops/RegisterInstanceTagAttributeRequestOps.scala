...
final class RegisterInstanceTagAttributeRequestBuilderOps(val self: RegisterInstanceTagAttributeRequest.Builder) extends AnyVal {
...
implicit def toRegisterInstanceTagAttributeRequestBuilderOps(v: RegisterInstanceTagAttributeRequest.Builder): RegisterInstanceTagAttributeRequestBuilderOps = new RegisterInstanceTagAttributeRequestBuilderOps(v)

implicit def toRegisterInstanceTagAttributeRequestOps(v: RegisterInstanceTagAttributeRequest): RegisterInstanceTagAttributeRequestOps = new RegisterInstanceTagAttributeRequestOps(v)
