...
implicit def toTerminateConnectionStatusBuilderOps(v: TerminateConnectionStatus.Builder): TerminateConnectionStatusBuilderOps = new TerminateConnectionStatusBuilderOps(v)

implicit def toTerminateConnectionStatusOps(v: TerminateConnectionStatus): TerminateConnectionStatusOps = new TerminateConnectionStatusOps(v)
