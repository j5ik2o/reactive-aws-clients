...
final class DescribeVpcClassicLinkDnsSupportResponseOps(val self: DescribeVpcClassicLinkDnsSupportResponse)
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def vpcsAsScala: Option[Seq[ClassicLinkDnsSupport]] =
    Option(self.vpcs).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
