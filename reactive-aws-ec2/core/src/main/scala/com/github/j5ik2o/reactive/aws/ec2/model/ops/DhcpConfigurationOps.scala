...
final class DhcpConfigurationOps(val self: DhcpConfiguration) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def valuesAsScala: Option[Seq[AttributeValue]] = Option(self.values).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toDhcpConfigurationBuilderOps(v: DhcpConfiguration.Builder): DhcpConfigurationBuilderOps = new DhcpConfigurationBuilderOps(v)
