...
final class InstanceTypeInfoBuilderOps(val self: InstanceTypeInfo.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.currentGeneration(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def freeTierEligibleAsScala(value: Option[Boolean]): InstanceTypeInfo.Builder = {
            value.fold(self){ v => self.freeTierEligible(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def supportedUsageClassesAsScala(value: Option[Seq[UsageClassType]]): InstanceTypeInfo.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.supportedUsageClasses(v.asJava) } 
            }

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def supportedRootDeviceTypesAsScala(value: Option[Seq[RootDeviceType]]): InstanceTypeInfo.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.supportedRootDeviceTypes(v.asJava) } 
            }
...
final class InstanceTypeInfoOps(val self: InstanceTypeInfo) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def supportedUsageClassesAsScala: Option[Seq[UsageClassType]] = Option(self.supportedUsageClasses).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def supportedRootDeviceTypesAsScala: Option[Seq[RootDeviceType]] = Option(self.supportedRootDeviceTypes).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toInstanceTypeInfoBuilderOps(v: InstanceTypeInfo.Builder): InstanceTypeInfoBuilderOps = new InstanceTypeInfoBuilderOps(v)
