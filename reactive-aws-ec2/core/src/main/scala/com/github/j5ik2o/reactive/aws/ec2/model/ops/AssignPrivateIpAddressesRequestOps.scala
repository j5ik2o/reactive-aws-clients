...
final class AssignPrivateIpAddressesRequestBuilderOps(val self: AssignPrivateIpAddressesRequest.Builder) extends AnyVal {

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def allowReassignmentAsScala(value: Option[Boolean]): AssignPrivateIpAddressesRequest.Builder = {
            value.fold(self){ v => self.allowReassignment(v) }
            } 
...
implicit def toAssignPrivateIpAddressesRequestBuilderOps(v: AssignPrivateIpAddressesRequest.Builder): AssignPrivateIpAddressesRequestBuilderOps = new AssignPrivateIpAddressesRequestBuilderOps(v)

implicit def toAssignPrivateIpAddressesRequestOps(v: AssignPrivateIpAddressesRequest): AssignPrivateIpAddressesRequestOps = new AssignPrivateIpAddressesRequestOps(v)
