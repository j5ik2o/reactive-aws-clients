...
final class DescribeImageAttributeResponseBuilderOps(val self: DescribeImageAttributeResponse.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def blockDeviceMappingsAsScala(value: Option[Seq[BlockDeviceMapping]]): DescribeImageAttributeResponse.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def launchPermissionsAsScala(value: Option[Seq[LaunchPermission]]): DescribeImageAttributeResponse.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.launchPermissions(v.asJava) } 
            }
...
final class DescribeImageAttributeResponseOps(val self: DescribeImageAttributeResponse) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def launchPermissionsAsScala: Option[Seq[LaunchPermission]] = Option(self.launchPermissions).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toDescribeImageAttributeResponseBuilderOps(v: DescribeImageAttributeResponse.Builder): DescribeImageAttributeResponseBuilderOps = new DescribeImageAttributeResponseBuilderOps(v)

implicit def toDescribeImageAttributeResponseOps(v: DescribeImageAttributeResponse): DescribeImageAttributeResponseOps = new DescribeImageAttributeResponseOps(v)
