...
final class TransitGatewayRequestOptionsBuilderOps(val self: TransitGatewayRequestOptions.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def autoAcceptSharedAttachmentsAsScala(value: Option[AutoAcceptSharedAttachmentsValue]): TransitGatewayRequestOptions.Builder = {
            value.fold(self){ v => self.autoAcceptSharedAttachments(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def defaultRouteTableAssociationAsScala(value: Option[DefaultRouteTableAssociationValue]): TransitGatewayRequestOptions.Builder = {
            value.fold(self){ v => self.defaultRouteTableAssociation(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def defaultRouteTablePropagationAsScala(value: Option[DefaultRouteTablePropagationValue]): TransitGatewayRequestOptions.Builder = {
...
implicit def toTransitGatewayRequestOptionsBuilderOps(v: TransitGatewayRequestOptions.Builder): TransitGatewayRequestOptionsBuilderOps = new TransitGatewayRequestOptionsBuilderOps(v)

implicit def toTransitGatewayRequestOptionsOps(v: TransitGatewayRequestOptions): TransitGatewayRequestOptionsOps = new TransitGatewayRequestOptionsOps(v)
