...
final class ServiceDetailBuilderOps(val self: ServiceDetail.Builder) extends AnyVal {
  ...
  final def vpcEndpointPolicySupportedAsScala(value: Option[Boolean]): ServiceDetail.Builder = {
    value.fold(self) { v => self.vpcEndpointPolicySupported(v) }
  }
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def privateDnsNameVerificationStateAsScala(value: Option[DnsNameState]): ServiceDetail.Builder = {
    value.fold(self) { v => self.privateDnsNameVerificationState(v) }
  }
...
final class ServiceDetailOps(val self: ServiceDetail) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def serviceTypeAsScala: Option[Seq[ServiceTypeDetail]] =
    Option(self.serviceType).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def baseEndpointDnsNamesAsScala: Option[Seq[String]] =
    Option(self.baseEndpointDnsNames).map { v =>
      import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala
    }
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def privateDnsNameVerificationStateAsScala: Option[DnsNameState] = Option(self.privateDnsNameVerificationState)
