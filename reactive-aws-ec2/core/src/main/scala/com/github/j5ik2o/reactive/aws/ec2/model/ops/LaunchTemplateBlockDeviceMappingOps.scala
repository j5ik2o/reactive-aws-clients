...
final class LaunchTemplateBlockDeviceMappingBuilderOps(val self: LaunchTemplateBlockDeviceMapping.Builder) extends AnyVal {
...
implicit def toLaunchTemplateBlockDeviceMappingBuilderOps(v: LaunchTemplateBlockDeviceMapping.Builder): LaunchTemplateBlockDeviceMappingBuilderOps = new LaunchTemplateBlockDeviceMappingBuilderOps(v)

implicit def toLaunchTemplateBlockDeviceMappingOps(v: LaunchTemplateBlockDeviceMapping): LaunchTemplateBlockDeviceMappingOps = new LaunchTemplateBlockDeviceMappingOps(v)
