...
final class CreateCapacityReservationRequestBuilderOps(val self: CreateCapacityReservationRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def instancePlatformAsScala(value: Option[CapacityReservationInstancePlatform]): CreateCapacityReservationRequest.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def instanceMatchCriteriaAsScala(value: Option[InstanceMatchCriteria]): CreateCapacityReservationRequest.Builder = {
...
implicit def toCreateCapacityReservationRequestBuilderOps(v: CreateCapacityReservationRequest.Builder): CreateCapacityReservationRequestBuilderOps = new CreateCapacityReservationRequestBuilderOps(v)

implicit def toCreateCapacityReservationRequestOps(v: CreateCapacityReservationRequest): CreateCapacityReservationRequestOps = new CreateCapacityReservationRequestOps(v)
