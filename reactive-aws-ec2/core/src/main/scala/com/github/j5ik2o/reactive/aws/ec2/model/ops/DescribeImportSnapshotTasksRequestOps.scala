...
final class DescribeImportSnapshotTasksRequestBuilderOps(val self: DescribeImportSnapshotTasksRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def importTaskIdsAsScala(value: Option[Seq[String]]): DescribeImportSnapshotTasksRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.importTaskIds(v.asJava) } 
            }
...
final class DescribeImportSnapshotTasksRequestOps(val self: DescribeImportSnapshotTasksRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def importTaskIdsAsScala: Option[Seq[String]] = Option(self.importTaskIds).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toDescribeImportSnapshotTasksRequestBuilderOps(v: DescribeImportSnapshotTasksRequest.Builder): DescribeImportSnapshotTasksRequestBuilderOps = new DescribeImportSnapshotTasksRequestBuilderOps(v)

implicit def toDescribeImportSnapshotTasksRequestOps(v: DescribeImportSnapshotTasksRequest): DescribeImportSnapshotTasksRequestOps = new DescribeImportSnapshotTasksRequestOps(v)
