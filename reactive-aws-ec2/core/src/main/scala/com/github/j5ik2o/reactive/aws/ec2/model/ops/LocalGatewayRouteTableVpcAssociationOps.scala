...
final class LocalGatewayRouteTableVpcAssociationBuilderOps(val self: LocalGatewayRouteTableVpcAssociation.Builder) extends AnyVal {

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def localGatewayRouteTableVpcAssociationIdAsScala(value: Option[String]): LocalGatewayRouteTableVpcAssociation.Builder = {
...
implicit def toLocalGatewayRouteTableVpcAssociationBuilderOps(v: LocalGatewayRouteTableVpcAssociation.Builder): LocalGatewayRouteTableVpcAssociationBuilderOps = new LocalGatewayRouteTableVpcAssociationBuilderOps(v)

implicit def toLocalGatewayRouteTableVpcAssociationOps(v: LocalGatewayRouteTableVpcAssociation): LocalGatewayRouteTableVpcAssociationOps = new LocalGatewayRouteTableVpcAssociationOps(v)
