...
final class CreateFleetRequestBuilderOps(val self: CreateFleetRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def excessCapacityTerminationPolicyAsScala(value: Option[FleetExcessCapacityTerminationPolicy]): CreateFleetRequest.Builder = {
            value.fold(self){ v => self.excessCapacityTerminationPolicy(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def launchTemplateConfigsAsScala(value: Option[Seq[FleetLaunchTemplateConfigRequest]]): CreateFleetRequest.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def targetCapacitySpecificationAsScala(value: Option[TargetCapacitySpecificationRequest]): CreateFleetRequest.Builder = {
...
final class CreateFleetRequestOps(val self: CreateFleetRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def launchTemplateConfigsAsScala: Option[Seq[FleetLaunchTemplateConfigRequest]] = Option(self.launchTemplateConfigs).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toCreateFleetRequestBuilderOps(v: CreateFleetRequest.Builder): CreateFleetRequestBuilderOps = new CreateFleetRequestBuilderOps(v)
