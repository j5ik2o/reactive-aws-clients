...
implicit def toCreateFpgaImageResponseBuilderOps(v: CreateFpgaImageResponse.Builder): CreateFpgaImageResponseBuilderOps = new CreateFpgaImageResponseBuilderOps(v)

implicit def toCreateFpgaImageResponseOps(v: CreateFpgaImageResponse): CreateFpgaImageResponseOps = new CreateFpgaImageResponseOps(v)
