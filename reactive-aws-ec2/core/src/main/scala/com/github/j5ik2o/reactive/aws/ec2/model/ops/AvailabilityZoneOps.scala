...
final class AvailabilityZoneBuilderOps(val self: AvailabilityZone.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def messagesAsScala(value: Option[Seq[AvailabilityZoneMessage]]): AvailabilityZone.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.messages(v.asJava) } 
            }
...
final class AvailabilityZoneOps(val self: AvailabilityZone) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def messagesAsScala: Option[Seq[AvailabilityZoneMessage]] = Option(self.messages).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toAvailabilityZoneBuilderOps(v: AvailabilityZone.Builder): AvailabilityZoneBuilderOps = new AvailabilityZoneBuilderOps(v)
