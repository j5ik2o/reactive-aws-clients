...
implicit def toDescribeVolumeStatusRequestBuilderOps(v: DescribeVolumeStatusRequest.Builder): DescribeVolumeStatusRequestBuilderOps = new DescribeVolumeStatusRequestBuilderOps(v)

implicit def toDescribeVolumeStatusRequestOps(v: DescribeVolumeStatusRequest): DescribeVolumeStatusRequestOps = new DescribeVolumeStatusRequestOps(v)
