...
trait ToExportTaskS3LocationOps {
  ...
  implicit def toExportTaskS3LocationBuilderOps(v: ExportTaskS3Location.Builder): ExportTaskS3LocationBuilderOps =
    new ExportTaskS3LocationBuilderOps(v)

  implicit def toExportTaskS3LocationOps(v: ExportTaskS3Location): ExportTaskS3LocationOps =
    new ExportTaskS3LocationOps(v)
