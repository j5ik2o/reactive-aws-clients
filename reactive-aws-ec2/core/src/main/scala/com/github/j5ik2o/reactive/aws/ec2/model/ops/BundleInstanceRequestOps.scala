...
implicit def toBundleInstanceRequestBuilderOps(v: BundleInstanceRequest.Builder): BundleInstanceRequestBuilderOps = new BundleInstanceRequestBuilderOps(v)

implicit def toBundleInstanceRequestOps(v: BundleInstanceRequest): BundleInstanceRequestOps = new BundleInstanceRequestOps(v)
