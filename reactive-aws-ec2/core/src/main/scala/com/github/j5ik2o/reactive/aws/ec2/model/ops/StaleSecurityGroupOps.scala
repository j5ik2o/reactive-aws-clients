...
final class StaleSecurityGroupBuilderOps(val self: StaleSecurityGroup.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def staleIpPermissionsAsScala(value: Option[Seq[StaleIpPermission]]): StaleSecurityGroup.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.staleIpPermissions(v.asJava) } 
            }

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def staleIpPermissionsEgressAsScala(value: Option[Seq[StaleIpPermission]]): StaleSecurityGroup.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.staleIpPermissionsEgress(v.asJava) } 
            }
...
final class StaleSecurityGroupOps(val self: StaleSecurityGroup) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def staleIpPermissionsAsScala: Option[Seq[StaleIpPermission]] = Option(self.staleIpPermissions).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def staleIpPermissionsEgressAsScala: Option[Seq[StaleIpPermission]] = Option(self.staleIpPermissionsEgress).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toStaleSecurityGroupBuilderOps(v: StaleSecurityGroup.Builder): StaleSecurityGroupBuilderOps = new StaleSecurityGroupBuilderOps(v)
