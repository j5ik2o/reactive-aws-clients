...
final class NetworkInterfacePrivateIpAddressBuilderOps(val self: NetworkInterfacePrivateIpAddress.Builder) extends AnyVal {
...
implicit def toNetworkInterfacePrivateIpAddressBuilderOps(v: NetworkInterfacePrivateIpAddress.Builder): NetworkInterfacePrivateIpAddressBuilderOps = new NetworkInterfacePrivateIpAddressBuilderOps(v)

implicit def toNetworkInterfacePrivateIpAddressOps(v: NetworkInterfacePrivateIpAddress): NetworkInterfacePrivateIpAddressOps = new NetworkInterfacePrivateIpAddressOps(v)
