...
final class PrefixListBuilderOps(val self: PrefixList.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def cidrsAsScala(value: Option[Seq[String]]): PrefixList.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.cidrs(v.asJava) } 
            }
...
final class PrefixListOps(val self: PrefixList) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def cidrsAsScala: Option[Seq[String]] = Option(self.cidrs).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
