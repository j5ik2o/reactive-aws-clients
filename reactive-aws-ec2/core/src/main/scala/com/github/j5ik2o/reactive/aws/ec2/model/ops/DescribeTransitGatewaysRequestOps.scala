...
final class DescribeTransitGatewaysRequestBuilderOps(val self: DescribeTransitGatewaysRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def transitGatewayIdsAsScala(value: Option[Seq[String]]): DescribeTransitGatewaysRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.transitGatewayIds(v.asJava) } 
            }
...
final class DescribeTransitGatewaysRequestOps(val self: DescribeTransitGatewaysRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def transitGatewayIdsAsScala: Option[Seq[String]] = Option(self.transitGatewayIds).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toDescribeTransitGatewaysRequestBuilderOps(v: DescribeTransitGatewaysRequest.Builder): DescribeTransitGatewaysRequestBuilderOps = new DescribeTransitGatewaysRequestBuilderOps(v)

implicit def toDescribeTransitGatewaysRequestOps(v: DescribeTransitGatewaysRequest): DescribeTransitGatewaysRequestOps = new DescribeTransitGatewaysRequestOps(v)
