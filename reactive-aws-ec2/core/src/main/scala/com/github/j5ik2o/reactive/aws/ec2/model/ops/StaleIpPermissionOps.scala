...
final class StaleIpPermissionOps(val self: StaleIpPermission) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def ipRangesAsScala: Option[Seq[String]] = Option(self.ipRanges).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def prefixListIdsAsScala: Option[Seq[String]] = Option(self.prefixListIds).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toStaleIpPermissionBuilderOps(v: StaleIpPermission.Builder): StaleIpPermissionBuilderOps = new StaleIpPermissionBuilderOps(v)
