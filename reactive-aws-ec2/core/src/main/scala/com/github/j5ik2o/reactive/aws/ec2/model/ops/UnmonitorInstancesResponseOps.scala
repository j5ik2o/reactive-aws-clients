...
implicit def toUnmonitorInstancesResponseBuilderOps(v: UnmonitorInstancesResponse.Builder): UnmonitorInstancesResponseBuilderOps = new UnmonitorInstancesResponseBuilderOps(v)

implicit def toUnmonitorInstancesResponseOps(v: UnmonitorInstancesResponse): UnmonitorInstancesResponseOps = new UnmonitorInstancesResponseOps(v)
