...
implicit def toAttachVolumeResponseBuilderOps(v: AttachVolumeResponse.Builder): AttachVolumeResponseBuilderOps = new AttachVolumeResponseBuilderOps(v)

implicit def toAttachVolumeResponseOps(v: AttachVolumeResponse): AttachVolumeResponseOps = new AttachVolumeResponseOps(v)
