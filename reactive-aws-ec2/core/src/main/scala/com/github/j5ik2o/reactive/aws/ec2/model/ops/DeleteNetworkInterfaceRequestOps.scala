...
implicit def toDeleteNetworkInterfaceRequestBuilderOps(v: DeleteNetworkInterfaceRequest.Builder): DeleteNetworkInterfaceRequestBuilderOps = new DeleteNetworkInterfaceRequestBuilderOps(v)

implicit def toDeleteNetworkInterfaceRequestOps(v: DeleteNetworkInterfaceRequest): DeleteNetworkInterfaceRequestOps = new DeleteNetworkInterfaceRequestOps(v)
