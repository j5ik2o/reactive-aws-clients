...
final class ModifySpotFleetRequestRequestBuilderOps(val self: ModifySpotFleetRequestRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def excessCapacityTerminationPolicyAsScala(value: Option[ExcessCapacityTerminationPolicy]): ModifySpotFleetRequestRequest.Builder = {
...
implicit def toModifySpotFleetRequestRequestBuilderOps(v: ModifySpotFleetRequestRequest.Builder): ModifySpotFleetRequestRequestBuilderOps = new ModifySpotFleetRequestRequestBuilderOps(v)

implicit def toModifySpotFleetRequestRequestOps(v: ModifySpotFleetRequestRequest): ModifySpotFleetRequestRequestOps = new ModifySpotFleetRequestRequestOps(v)
