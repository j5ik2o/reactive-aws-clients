...
final class RevokeSecurityGroupEgressRequestBuilderOps(val self: RevokeSecurityGroupEgressRequest.Builder) extends AnyVal {
...
implicit def toRevokeSecurityGroupEgressRequestBuilderOps(v: RevokeSecurityGroupEgressRequest.Builder): RevokeSecurityGroupEgressRequestBuilderOps = new RevokeSecurityGroupEgressRequestBuilderOps(v)

implicit def toRevokeSecurityGroupEgressRequestOps(v: RevokeSecurityGroupEgressRequest): RevokeSecurityGroupEgressRequestOps = new RevokeSecurityGroupEgressRequestOps(v)
