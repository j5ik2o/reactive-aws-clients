...
implicit def toGetCoipPoolUsageRequestBuilderOps(v: GetCoipPoolUsageRequest.Builder): GetCoipPoolUsageRequestBuilderOps = new GetCoipPoolUsageRequestBuilderOps(v)

implicit def toGetCoipPoolUsageRequestOps(v: GetCoipPoolUsageRequest): GetCoipPoolUsageRequestOps = new GetCoipPoolUsageRequestOps(v)
