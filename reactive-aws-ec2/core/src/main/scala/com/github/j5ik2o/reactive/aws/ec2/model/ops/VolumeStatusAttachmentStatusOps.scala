...
trait ToVolumeStatusAttachmentStatusOps {
  ...
  implicit def toVolumeStatusAttachmentStatusBuilderOps(
      v: VolumeStatusAttachmentStatus.Builder
  ): VolumeStatusAttachmentStatusBuilderOps = new VolumeStatusAttachmentStatusBuilderOps(v)

  implicit def toVolumeStatusAttachmentStatusOps(v: VolumeStatusAttachmentStatus): VolumeStatusAttachmentStatusOps =
    new VolumeStatusAttachmentStatusOps(v)
