...
final class ImportImageTaskBuilderOps(val self: ImportImageTask.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def licenseSpecificationsAsScala(value: Option[Seq[ImportImageLicenseConfigurationResponse]]): ImportImageTask.Builder = {
...
implicit def toImportImageTaskBuilderOps(v: ImportImageTask.Builder): ImportImageTaskBuilderOps = new ImportImageTaskBuilderOps(v)
