...
implicit def toPhase2DHGroupNumbersListValueBuilderOps(v: Phase2DHGroupNumbersListValue.Builder): Phase2DHGroupNumbersListValueBuilderOps = new Phase2DHGroupNumbersListValueBuilderOps(v)

implicit def toPhase2DHGroupNumbersListValueOps(v: Phase2DHGroupNumbersListValue): Phase2DHGroupNumbersListValueOps = new Phase2DHGroupNumbersListValueOps(v)
