...
implicit def toStopInstancesRequestBuilderOps(v: StopInstancesRequest.Builder): StopInstancesRequestBuilderOps = new StopInstancesRequestBuilderOps(v)

implicit def toStopInstancesRequestOps(v: StopInstancesRequest): StopInstancesRequestOps = new StopInstancesRequestOps(v)
