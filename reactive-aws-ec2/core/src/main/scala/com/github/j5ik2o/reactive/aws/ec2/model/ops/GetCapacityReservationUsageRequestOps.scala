...
final class GetCapacityReservationUsageRequestBuilderOps(val self: GetCapacityReservationUsageRequest.Builder) extends AnyVal {
...
implicit def toGetCapacityReservationUsageRequestBuilderOps(v: GetCapacityReservationUsageRequest.Builder): GetCapacityReservationUsageRequestBuilderOps = new GetCapacityReservationUsageRequestBuilderOps(v)

implicit def toGetCapacityReservationUsageRequestOps(v: GetCapacityReservationUsageRequest): GetCapacityReservationUsageRequestOps = new GetCapacityReservationUsageRequestOps(v)
