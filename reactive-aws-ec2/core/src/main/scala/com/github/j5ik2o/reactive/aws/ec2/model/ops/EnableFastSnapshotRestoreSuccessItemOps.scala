...
final class EnableFastSnapshotRestoreSuccessItemBuilderOps(val self: EnableFastSnapshotRestoreSuccessItem.Builder) extends AnyVal {
...
implicit def toEnableFastSnapshotRestoreSuccessItemBuilderOps(v: EnableFastSnapshotRestoreSuccessItem.Builder): EnableFastSnapshotRestoreSuccessItemBuilderOps = new EnableFastSnapshotRestoreSuccessItemBuilderOps(v)

implicit def toEnableFastSnapshotRestoreSuccessItemOps(v: EnableFastSnapshotRestoreSuccessItem): EnableFastSnapshotRestoreSuccessItemOps = new EnableFastSnapshotRestoreSuccessItemOps(v)
