...
implicit def toTargetReservationValueBuilderOps(v: TargetReservationValue.Builder): TargetReservationValueBuilderOps = new TargetReservationValueBuilderOps(v)

implicit def toTargetReservationValueOps(v: TargetReservationValue): TargetReservationValueOps = new TargetReservationValueOps(v)
