...
implicit def toAssociateDhcpOptionsRequestBuilderOps(v: AssociateDhcpOptionsRequest.Builder): AssociateDhcpOptionsRequestBuilderOps = new AssociateDhcpOptionsRequestBuilderOps(v)

implicit def toAssociateDhcpOptionsRequestOps(v: AssociateDhcpOptionsRequest): AssociateDhcpOptionsRequestOps = new AssociateDhcpOptionsRequestOps(v)
