...
implicit def toStartInstancesRequestBuilderOps(v: StartInstancesRequest.Builder): StartInstancesRequestBuilderOps = new StartInstancesRequestBuilderOps(v)

implicit def toStartInstancesRequestOps(v: StartInstancesRequest): StartInstancesRequestOps = new StartInstancesRequestOps(v)
