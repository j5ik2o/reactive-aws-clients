...
final class InstanceNetworkInterfaceAttachmentBuilderOps(val self: InstanceNetworkInterfaceAttachment.Builder) extends AnyVal {
...
implicit def toInstanceNetworkInterfaceAttachmentBuilderOps(v: InstanceNetworkInterfaceAttachment.Builder): InstanceNetworkInterfaceAttachmentBuilderOps = new InstanceNetworkInterfaceAttachmentBuilderOps(v)

implicit def toInstanceNetworkInterfaceAttachmentOps(v: InstanceNetworkInterfaceAttachment): InstanceNetworkInterfaceAttachmentOps = new InstanceNetworkInterfaceAttachmentOps(v)
