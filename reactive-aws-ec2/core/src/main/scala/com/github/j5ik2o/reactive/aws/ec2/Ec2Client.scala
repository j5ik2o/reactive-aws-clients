...
trait Ec2Client[M[_]] {
  ...
  ): M[AcceptVpcEndpointConnectionsResponse]
  ...
  ): M[ApplySecurityGroupsToClientVpnTargetNetworkResponse]
  ...
  ): M[AssociateClientVpnTargetNetworkResponse]
  ...
  ): M[AssociateIamInstanceProfileResponse]
  ...
  ): M[AuthorizeClientVpnIngressResponse]
  ...
  ): M[CancelCapacityReservationResponse]
  ...
  ): M[CancelSpotFleetRequestsResponse]
  ...
  ): M[CreateEgressOnlyInternetGatewayResponse]
  ...
  ): M[CreateNetworkInterfacePermissionResponse]
  ...
  ): M[CreateVpcEndpointConnectionNotificationResponse]
  ...
  ): M[CreateVpcEndpointServiceConfigurationResponse]
  ...
  ): M[DeleteClientVpnEndpointResponse]
  ...
  ): M[DeleteEgressOnlyInternetGatewayResponse]
  ...
  ): M[DeleteNetworkInterfacePermissionResponse]
  ...
  ): M[DeleteVpcEndpointConnectionNotificationsResponse]
  ...
  ): M[DeleteVpcEndpointServiceConfigurationsResponse]
  ...
  ): M[DescribeAggregateIdFormatResponse]
  ...
  ): M[DescribeCapacityReservationsResponse]
  ...
  ): M[DescribeClassicLinkInstancesResponse]
  ...
  ): M[DescribeClientVpnRoutesResponse]
  ...
  ): M[DescribeEgressOnlyInternetGatewaysResponse]
  ...
  ): M[DescribeFleetInstancesResponse]
  ...
  ): M[DescribeFpgaImageAttributeResponse]
  ...
  ): M[DescribeHostReservationOfferingsResponse]
  ...
  ): M[DescribeHostReservationsResponse]
  ...
  ): M[DescribeIamInstanceProfileAssociationsResponse]
  ...
  ): M[DescribeIdentityIdFormatResponse]
  ...
  ): M[DescribeImportImageTasksResponse]
  ...
  ): M[DescribeImportSnapshotTasksResponse]
  ...
  ): M[DescribeInstanceStatusResponse]
  ...
  ): M[DescribeLaunchTemplateVersionsResponse]
  ...
  ): M[DescribeNetworkInterfacePermissionsResponse]
  ...
  ): M[DescribePrincipalIdFormatResponse]
  ...
  ): M[DescribePublicIpv4PoolsResponse]
  ...
  ): M[DescribeReservedInstancesModificationsResponse]
  ...
  ): M[DescribeReservedInstancesOfferingsResponse]
  ...
  ): M[DescribeSecurityGroupReferencesResponse]
  ...
  ): M[DescribeSpotPriceHistoryResponse]
  ...
  ): M[DescribeStaleSecurityGroupsResponse]
  ...
  ): M[DescribeTransitGatewayVpcAttachmentsResponse]
  ...
  ): M[DescribeTransitGatewaysResponse]
  ...
  ): M[DescribeVolumesModificationsResponse]
  ...
  ): M[DescribeVpcClassicLinkResponse]
  ...
  ): M[DescribeVpcClassicLinkDnsSupportResponse]
  ...
  ): M[DescribeVpcEndpointConnectionNotificationsResponse]
  ...
  ): M[DescribeVpcEndpointConnectionsResponse]
  ...
  ): M[DescribeVpcEndpointServiceConfigurationsResponse]
  ...
  ): M[EnableVpcClassicLinkDnsSupportResponse]
  ...
  ): M[ExportClientVpnClientCertificateRevocationListResponse]
  ...
  ): M[GetHostReservationPurchasePreviewResponse]
  ...
  ): M[GetReservedInstancesExchangeQuoteResponse]
  ...
  ): M[GetTransitGatewayRouteTableAssociationsResponse]
  ...
  ): M[GetTransitGatewayRouteTablePropagationsResponse]
  ...
  ): M[ImportClientVpnClientCertificateRevocationListResponse]
  ...
  ): M[ModifyFpgaImageAttributeResponse]
  ...
  ): M[ModifyIdentityIdFormatResponse]
  ...
  ): M[ModifySpotFleetRequestResponse]
  ...
  ): M[ModifyVpcEndpointConnectionNotificationResponse]
  ...
  ): M[ModifyVpcEndpointServiceConfigurationResponse]
  ...
  ): M[PurchaseHostReservationResponse]
  ...
  ): M[PurchaseScheduledInstancesResponse]
  ...
  ): M[RejectVpcEndpointConnectionsResponse]
  ...
  ): M[ReplaceIamInstanceProfileAssociationResponse]
  ...
  ): M[ReplaceTransitGatewayRouteResponse]
  ...
  ): M[RevokeClientVpnIngressResponse]
  ...
  ): M[TerminateClientVpnConnectionsResponse]
  ...
  ): M[UnassignIpv6AddressesResponse]
  ...
  ): M[UpdateSecurityGroupRuleDescriptionsEgressResponse]
  ...
  ): M[UpdateSecurityGroupRuleDescriptionsIngressResponse]
