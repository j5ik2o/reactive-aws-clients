...
final class CreateImageRequestBuilderOps(val self: CreateImageRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.noReboot(v) }
            } 
...
implicit def toCreateImageRequestBuilderOps(v: CreateImageRequest.Builder): CreateImageRequestBuilderOps = new CreateImageRequestBuilderOps(v)
