...
implicit def toCopySnapshotResponseBuilderOps(v: CopySnapshotResponse.Builder): CopySnapshotResponseBuilderOps = new CopySnapshotResponseBuilderOps(v)

implicit def toCopySnapshotResponseOps(v: CopySnapshotResponse): CopySnapshotResponseOps = new CopySnapshotResponseOps(v)
