...
implicit def toInstanceTypeOfferingBuilderOps(v: InstanceTypeOffering.Builder): InstanceTypeOfferingBuilderOps = new InstanceTypeOfferingBuilderOps(v)

implicit def toInstanceTypeOfferingOps(v: InstanceTypeOffering): InstanceTypeOfferingOps = new InstanceTypeOfferingOps(v)
