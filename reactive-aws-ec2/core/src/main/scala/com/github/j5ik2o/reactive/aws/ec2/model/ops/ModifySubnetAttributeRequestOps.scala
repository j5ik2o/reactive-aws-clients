...
final class ModifySubnetAttributeRequestBuilderOps(val self: ModifySubnetAttributeRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def assignIpv6AddressOnCreationAsScala(value: Option[AttributeBooleanValue]): ModifySubnetAttributeRequest.Builder = {
...
implicit def toModifySubnetAttributeRequestBuilderOps(v: ModifySubnetAttributeRequest.Builder): ModifySubnetAttributeRequestBuilderOps = new ModifySubnetAttributeRequestBuilderOps(v)

implicit def toModifySubnetAttributeRequestOps(v: ModifySubnetAttributeRequest): ModifySubnetAttributeRequestOps = new ModifySubnetAttributeRequestOps(v)
