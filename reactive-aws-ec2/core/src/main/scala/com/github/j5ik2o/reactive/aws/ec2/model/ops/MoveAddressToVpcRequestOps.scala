...
implicit def toMoveAddressToVpcRequestBuilderOps(v: MoveAddressToVpcRequest.Builder): MoveAddressToVpcRequestBuilderOps = new MoveAddressToVpcRequestBuilderOps(v)

implicit def toMoveAddressToVpcRequestOps(v: MoveAddressToVpcRequest): MoveAddressToVpcRequestOps = new MoveAddressToVpcRequestOps(v)
