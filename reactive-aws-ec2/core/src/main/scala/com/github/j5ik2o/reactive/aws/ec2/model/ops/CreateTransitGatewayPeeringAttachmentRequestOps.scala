...
final class CreateTransitGatewayPeeringAttachmentRequestBuilderOps(
    val self: CreateTransitGatewayPeeringAttachmentRequest.Builder
) extends AnyVal {
...
final class CreateTransitGatewayPeeringAttachmentRequestOps(val self: CreateTransitGatewayPeeringAttachmentRequest)
    extends AnyVal {
...
trait ToCreateTransitGatewayPeeringAttachmentRequestOps {
  ...
  implicit def toCreateTransitGatewayPeeringAttachmentRequestBuilderOps(
      v: CreateTransitGatewayPeeringAttachmentRequest.Builder
  ): CreateTransitGatewayPeeringAttachmentRequestBuilderOps =
    new CreateTransitGatewayPeeringAttachmentRequestBuilderOps(v)

  implicit def toCreateTransitGatewayPeeringAttachmentRequestOps(
      v: CreateTransitGatewayPeeringAttachmentRequest
  ): CreateTransitGatewayPeeringAttachmentRequestOps = new CreateTransitGatewayPeeringAttachmentRequestOps(v)
