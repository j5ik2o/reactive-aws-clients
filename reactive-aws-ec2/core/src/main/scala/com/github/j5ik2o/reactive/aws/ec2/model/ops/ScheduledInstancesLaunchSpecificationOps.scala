...
final class ScheduledInstancesLaunchSpecificationBuilderOps(val self: ScheduledInstancesLaunchSpecification.Builder) extends AnyVal {

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def blockDeviceMappingsAsScala(value: Option[Seq[ScheduledInstancesBlockDeviceMapping]]): ScheduledInstancesLaunchSpecification.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def iamInstanceProfileAsScala(value: Option[ScheduledInstancesIamInstanceProfile]): ScheduledInstancesLaunchSpecification.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def monitoringAsScala(value: Option[ScheduledInstancesMonitoring]): ScheduledInstancesLaunchSpecification.Builder = {
            value.fold(self){ v => self.monitoring(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def networkInterfacesAsScala(value: Option[Seq[ScheduledInstancesNetworkInterface]]): ScheduledInstancesLaunchSpecification.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def placementAsScala(value: Option[ScheduledInstancesPlacement]): ScheduledInstancesLaunchSpecification.Builder = {
...
final class ScheduledInstancesLaunchSpecificationOps(val self: ScheduledInstancesLaunchSpecification) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def blockDeviceMappingsAsScala: Option[Seq[ScheduledInstancesBlockDeviceMapping]] = Option(self.blockDeviceMappings).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def networkInterfacesAsScala: Option[Seq[ScheduledInstancesNetworkInterface]] = Option(self.networkInterfaces).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toScheduledInstancesLaunchSpecificationBuilderOps(v: ScheduledInstancesLaunchSpecification.Builder): ScheduledInstancesLaunchSpecificationBuilderOps = new ScheduledInstancesLaunchSpecificationBuilderOps(v)

implicit def toScheduledInstancesLaunchSpecificationOps(v: ScheduledInstancesLaunchSpecification): ScheduledInstancesLaunchSpecificationOps = new ScheduledInstancesLaunchSpecificationOps(v)
