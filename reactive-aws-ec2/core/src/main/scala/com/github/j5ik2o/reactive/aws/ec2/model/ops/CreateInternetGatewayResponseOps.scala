...
final class CreateInternetGatewayResponseBuilderOps(val self: CreateInternetGatewayResponse.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.internetGateway(v) }
            } 
...
implicit def toCreateInternetGatewayResponseBuilderOps(v: CreateInternetGatewayResponse.Builder): CreateInternetGatewayResponseBuilderOps = new CreateInternetGatewayResponseBuilderOps(v)

implicit def toCreateInternetGatewayResponseOps(v: CreateInternetGatewayResponse): CreateInternetGatewayResponseOps = new CreateInternetGatewayResponseOps(v)
