...
trait ToDeleteEgressOnlyInternetGatewayRequestOps {
  ...
  implicit def toDeleteEgressOnlyInternetGatewayRequestBuilderOps(
      v: DeleteEgressOnlyInternetGatewayRequest.Builder
  ): DeleteEgressOnlyInternetGatewayRequestBuilderOps = new DeleteEgressOnlyInternetGatewayRequestBuilderOps(v)

  implicit def toDeleteEgressOnlyInternetGatewayRequestOps(
      v: DeleteEgressOnlyInternetGatewayRequest
  ): DeleteEgressOnlyInternetGatewayRequestOps = new DeleteEgressOnlyInternetGatewayRequestOps(v)
