...
trait ToDescribeIdFormatResponseOps {
  ...
  implicit def toDescribeIdFormatResponseBuilderOps(
      v: DescribeIdFormatResponse.Builder
  ): DescribeIdFormatResponseBuilderOps = new DescribeIdFormatResponseBuilderOps(v)

  implicit def toDescribeIdFormatResponseOps(v: DescribeIdFormatResponse): DescribeIdFormatResponseOps =
    new DescribeIdFormatResponseOps(v)
