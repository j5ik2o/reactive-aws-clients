...
implicit def toReservedInstancesConfigurationBuilderOps(v: ReservedInstancesConfiguration.Builder): ReservedInstancesConfigurationBuilderOps = new ReservedInstancesConfigurationBuilderOps(v)

implicit def toReservedInstancesConfigurationOps(v: ReservedInstancesConfiguration): ReservedInstancesConfigurationOps = new ReservedInstancesConfigurationOps(v)
