...
implicit def toTransitGatewayMulticastDomainBuilderOps(v: TransitGatewayMulticastDomain.Builder): TransitGatewayMulticastDomainBuilderOps = new TransitGatewayMulticastDomainBuilderOps(v)

implicit def toTransitGatewayMulticastDomainOps(v: TransitGatewayMulticastDomain): TransitGatewayMulticastDomainOps = new TransitGatewayMulticastDomainOps(v)
