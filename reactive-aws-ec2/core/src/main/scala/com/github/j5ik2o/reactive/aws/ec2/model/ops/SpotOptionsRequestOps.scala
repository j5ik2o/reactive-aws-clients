...
final class SpotOptionsRequestBuilderOps(val self: SpotOptionsRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def instanceInterruptionBehaviorAsScala(value: Option[SpotInstanceInterruptionBehavior]): SpotOptionsRequest.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def maxTotalPriceAsScala(value: Option[String]): SpotOptionsRequest.Builder = {
...
final class SpotOptionsRequestOps(val self: SpotOptionsRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def instanceInterruptionBehaviorAsScala: Option[SpotInstanceInterruptionBehavior] = Option(self.instanceInterruptionBehavior) 
...
implicit def toSpotOptionsRequestBuilderOps(v: SpotOptionsRequest.Builder): SpotOptionsRequestBuilderOps = new SpotOptionsRequestBuilderOps(v)
