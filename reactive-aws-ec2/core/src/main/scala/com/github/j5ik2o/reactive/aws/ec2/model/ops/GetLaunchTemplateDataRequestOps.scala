...
implicit def toGetLaunchTemplateDataRequestBuilderOps(v: GetLaunchTemplateDataRequest.Builder): GetLaunchTemplateDataRequestBuilderOps = new GetLaunchTemplateDataRequestBuilderOps(v)

implicit def toGetLaunchTemplateDataRequestOps(v: GetLaunchTemplateDataRequest): GetLaunchTemplateDataRequestOps = new GetLaunchTemplateDataRequestOps(v)
