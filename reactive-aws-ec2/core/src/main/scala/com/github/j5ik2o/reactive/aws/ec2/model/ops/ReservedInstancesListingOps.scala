...
final class ReservedInstancesListingBuilderOps(val self: ReservedInstancesListing.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def instanceCountsAsScala(value: Option[Seq[InstanceCount]]): ReservedInstancesListing.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.instanceCounts(v.asJava) } 
            }
...
final class ReservedInstancesListingOps(val self: ReservedInstancesListing) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def instanceCountsAsScala: Option[Seq[InstanceCount]] = Option(self.instanceCounts).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def priceSchedulesAsScala: Option[Seq[PriceSchedule]] = Option(self.priceSchedules).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toReservedInstancesListingBuilderOps(v: ReservedInstancesListing.Builder): ReservedInstancesListingBuilderOps = new ReservedInstancesListingBuilderOps(v)

implicit def toReservedInstancesListingOps(v: ReservedInstancesListing): ReservedInstancesListingOps = new ReservedInstancesListingOps(v)
