...
implicit def toSpotFleetTagSpecificationBuilderOps(v: SpotFleetTagSpecification.Builder): SpotFleetTagSpecificationBuilderOps = new SpotFleetTagSpecificationBuilderOps(v)

implicit def toSpotFleetTagSpecificationOps(v: SpotFleetTagSpecification): SpotFleetTagSpecificationOps = new SpotFleetTagSpecificationOps(v)
