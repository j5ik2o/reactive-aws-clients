...
final class VpcPeeringConnectionStateReasonBuilderOps(val self: VpcPeeringConnectionStateReason.Builder) extends AnyVal {
...
implicit def toVpcPeeringConnectionStateReasonBuilderOps(v: VpcPeeringConnectionStateReason.Builder): VpcPeeringConnectionStateReasonBuilderOps = new VpcPeeringConnectionStateReasonBuilderOps(v)

implicit def toVpcPeeringConnectionStateReasonOps(v: VpcPeeringConnectionStateReason): VpcPeeringConnectionStateReasonOps = new VpcPeeringConnectionStateReasonOps(v)
