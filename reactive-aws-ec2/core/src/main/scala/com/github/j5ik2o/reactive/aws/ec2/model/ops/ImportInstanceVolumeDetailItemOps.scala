...
implicit def toImportInstanceVolumeDetailItemBuilderOps(v: ImportInstanceVolumeDetailItem.Builder): ImportInstanceVolumeDetailItemBuilderOps = new ImportInstanceVolumeDetailItemBuilderOps(v)

implicit def toImportInstanceVolumeDetailItemOps(v: ImportInstanceVolumeDetailItem): ImportInstanceVolumeDetailItemOps = new ImportInstanceVolumeDetailItemOps(v)
