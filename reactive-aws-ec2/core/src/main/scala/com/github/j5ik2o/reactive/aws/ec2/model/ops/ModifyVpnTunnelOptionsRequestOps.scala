...
final class ModifyVpnTunnelOptionsRequestBuilderOps(val self: ModifyVpnTunnelOptionsRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def tunnelOptionsAsScala(value: Option[ModifyVpnTunnelOptionsSpecification]): ModifyVpnTunnelOptionsRequest.Builder = {
...
implicit def toModifyVpnTunnelOptionsRequestBuilderOps(v: ModifyVpnTunnelOptionsRequest.Builder): ModifyVpnTunnelOptionsRequestBuilderOps = new ModifyVpnTunnelOptionsRequestBuilderOps(v)

implicit def toModifyVpnTunnelOptionsRequestOps(v: ModifyVpnTunnelOptionsRequest): ModifyVpnTunnelOptionsRequestOps = new ModifyVpnTunnelOptionsRequestOps(v)
