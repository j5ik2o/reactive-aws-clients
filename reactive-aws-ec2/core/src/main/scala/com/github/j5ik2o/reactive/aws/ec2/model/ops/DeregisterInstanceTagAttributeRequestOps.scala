...
final class DeregisterInstanceTagAttributeRequestBuilderOps(val self: DeregisterInstanceTagAttributeRequest.Builder) extends AnyVal {
...
implicit def toDeregisterInstanceTagAttributeRequestBuilderOps(v: DeregisterInstanceTagAttributeRequest.Builder): DeregisterInstanceTagAttributeRequestBuilderOps = new DeregisterInstanceTagAttributeRequestBuilderOps(v)

implicit def toDeregisterInstanceTagAttributeRequestOps(v: DeregisterInstanceTagAttributeRequest): DeregisterInstanceTagAttributeRequestOps = new DeregisterInstanceTagAttributeRequestOps(v)
