...
implicit def toConfirmProductInstanceResponseBuilderOps(v: ConfirmProductInstanceResponse.Builder): ConfirmProductInstanceResponseBuilderOps = new ConfirmProductInstanceResponseBuilderOps(v)

implicit def toConfirmProductInstanceResponseOps(v: ConfirmProductInstanceResponse): ConfirmProductInstanceResponseOps = new ConfirmProductInstanceResponseOps(v)
