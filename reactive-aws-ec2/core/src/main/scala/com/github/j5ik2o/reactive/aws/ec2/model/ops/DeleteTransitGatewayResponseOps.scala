...
trait ToDeleteTransitGatewayResponseOps {
  ...
  implicit def toDeleteTransitGatewayResponseBuilderOps(
      v: DeleteTransitGatewayResponse.Builder
  ): DeleteTransitGatewayResponseBuilderOps = new DeleteTransitGatewayResponseBuilderOps(v)

  implicit def toDeleteTransitGatewayResponseOps(v: DeleteTransitGatewayResponse): DeleteTransitGatewayResponseOps =
    new DeleteTransitGatewayResponseOps(v)
