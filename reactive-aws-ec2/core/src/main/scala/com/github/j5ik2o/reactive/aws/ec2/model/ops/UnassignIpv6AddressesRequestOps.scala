...
final class UnassignIpv6AddressesRequestOps(val self: UnassignIpv6AddressesRequest) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def ipv6AddressesAsScala: Option[Seq[String]] =
...
trait ToUnassignIpv6AddressesRequestOps {
  ...
  implicit def toUnassignIpv6AddressesRequestBuilderOps(
      v: UnassignIpv6AddressesRequest.Builder
  ): UnassignIpv6AddressesRequestBuilderOps = new UnassignIpv6AddressesRequestBuilderOps(v)

  implicit def toUnassignIpv6AddressesRequestOps(v: UnassignIpv6AddressesRequest): UnassignIpv6AddressesRequestOps =
    new UnassignIpv6AddressesRequestOps(v)
