...
implicit def toCancelSpotFleetRequestsErrorBuilderOps(v: CancelSpotFleetRequestsError.Builder): CancelSpotFleetRequestsErrorBuilderOps = new CancelSpotFleetRequestsErrorBuilderOps(v)

implicit def toCancelSpotFleetRequestsErrorOps(v: CancelSpotFleetRequestsError): CancelSpotFleetRequestsErrorOps = new CancelSpotFleetRequestsErrorOps(v)
