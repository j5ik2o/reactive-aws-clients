...
implicit def toReplaceNetworkAclEntryRequestBuilderOps(v: ReplaceNetworkAclEntryRequest.Builder): ReplaceNetworkAclEntryRequestBuilderOps = new ReplaceNetworkAclEntryRequestBuilderOps(v)

implicit def toReplaceNetworkAclEntryRequestOps(v: ReplaceNetworkAclEntryRequest): ReplaceNetworkAclEntryRequestOps = new ReplaceNetworkAclEntryRequestOps(v)
