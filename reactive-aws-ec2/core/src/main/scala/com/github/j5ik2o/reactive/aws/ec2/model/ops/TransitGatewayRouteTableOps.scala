...
implicit def toTransitGatewayRouteTableBuilderOps(v: TransitGatewayRouteTable.Builder): TransitGatewayRouteTableBuilderOps = new TransitGatewayRouteTableBuilderOps(v)

implicit def toTransitGatewayRouteTableOps(v: TransitGatewayRouteTable): TransitGatewayRouteTableOps = new TransitGatewayRouteTableOps(v)
