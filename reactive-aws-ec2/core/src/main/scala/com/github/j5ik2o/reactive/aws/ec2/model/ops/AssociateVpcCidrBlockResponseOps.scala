...
final class AssociateVpcCidrBlockResponseBuilderOps(val self: AssociateVpcCidrBlockResponse.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def ipv6CidrBlockAssociationAsScala(value: Option[VpcIpv6CidrBlockAssociation]): AssociateVpcCidrBlockResponse.Builder = {
            value.fold(self){ v => self.ipv6CidrBlockAssociation(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def cidrBlockAssociationAsScala(value: Option[VpcCidrBlockAssociation]): AssociateVpcCidrBlockResponse.Builder = {
...
implicit def toAssociateVpcCidrBlockResponseBuilderOps(v: AssociateVpcCidrBlockResponse.Builder): AssociateVpcCidrBlockResponseBuilderOps = new AssociateVpcCidrBlockResponseBuilderOps(v)

implicit def toAssociateVpcCidrBlockResponseOps(v: AssociateVpcCidrBlockResponse): AssociateVpcCidrBlockResponseOps = new AssociateVpcCidrBlockResponseOps(v)
