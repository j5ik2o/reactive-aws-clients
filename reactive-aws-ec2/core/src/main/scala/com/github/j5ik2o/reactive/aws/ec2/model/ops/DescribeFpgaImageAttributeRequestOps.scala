...
final class DescribeFpgaImageAttributeRequestBuilderOps(val self: DescribeFpgaImageAttributeRequest.Builder) extends AnyVal {
...
implicit def toDescribeFpgaImageAttributeRequestBuilderOps(v: DescribeFpgaImageAttributeRequest.Builder): DescribeFpgaImageAttributeRequestBuilderOps = new DescribeFpgaImageAttributeRequestBuilderOps(v)

implicit def toDescribeFpgaImageAttributeRequestOps(v: DescribeFpgaImageAttributeRequest): DescribeFpgaImageAttributeRequestOps = new DescribeFpgaImageAttributeRequestOps(v)
