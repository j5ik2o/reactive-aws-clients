...
implicit def toCapacityReservationTargetBuilderOps(v: CapacityReservationTarget.Builder): CapacityReservationTargetBuilderOps = new CapacityReservationTargetBuilderOps(v)

implicit def toCapacityReservationTargetOps(v: CapacityReservationTarget): CapacityReservationTargetOps = new CapacityReservationTargetOps(v)
