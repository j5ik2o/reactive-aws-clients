...
implicit def toAssociateAddressResponseBuilderOps(v: AssociateAddressResponse.Builder): AssociateAddressResponseBuilderOps = new AssociateAddressResponseBuilderOps(v)

implicit def toAssociateAddressResponseOps(v: AssociateAddressResponse): AssociateAddressResponseOps = new AssociateAddressResponseOps(v)
