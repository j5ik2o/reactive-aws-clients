...
final class GetCoipPoolUsageResponseBuilderOps(val self: GetCoipPoolUsageResponse.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.coipPoolId(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def coipAddressUsagesAsScala(value: Option[Seq[CoipAddressUsage]]): GetCoipPoolUsageResponse.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.coipAddressUsages(v.asJava) } 
            }
...
final class GetCoipPoolUsageResponseOps(val self: GetCoipPoolUsageResponse) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def coipAddressUsagesAsScala: Option[Seq[CoipAddressUsage]] = Option(self.coipAddressUsages).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toGetCoipPoolUsageResponseBuilderOps(v: GetCoipPoolUsageResponse.Builder): GetCoipPoolUsageResponseBuilderOps = new GetCoipPoolUsageResponseBuilderOps(v)

implicit def toGetCoipPoolUsageResponseOps(v: GetCoipPoolUsageResponse): GetCoipPoolUsageResponseOps = new GetCoipPoolUsageResponseOps(v)
