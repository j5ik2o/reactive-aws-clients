...
implicit def toDetachVpnGatewayRequestBuilderOps(v: DetachVpnGatewayRequest.Builder): DetachVpnGatewayRequestBuilderOps = new DetachVpnGatewayRequestBuilderOps(v)

implicit def toDetachVpnGatewayRequestOps(v: DetachVpnGatewayRequest): DetachVpnGatewayRequestOps = new DetachVpnGatewayRequestOps(v)
