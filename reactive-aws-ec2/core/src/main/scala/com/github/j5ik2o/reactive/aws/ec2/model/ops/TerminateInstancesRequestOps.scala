...
implicit def toTerminateInstancesRequestBuilderOps(v: TerminateInstancesRequest.Builder): TerminateInstancesRequestBuilderOps = new TerminateInstancesRequestBuilderOps(v)

implicit def toTerminateInstancesRequestOps(v: TerminateInstancesRequest): TerminateInstancesRequestOps = new TerminateInstancesRequestOps(v)
