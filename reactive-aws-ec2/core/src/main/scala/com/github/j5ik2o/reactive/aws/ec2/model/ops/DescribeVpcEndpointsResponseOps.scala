...
final class DescribeVpcEndpointsResponseOps(val self: DescribeVpcEndpointsResponse) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def vpcEndpointsAsScala: Option[Seq[VpcEndpoint]] =
    Option(self.vpcEndpoints).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
