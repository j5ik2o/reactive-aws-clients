...
final class DescribeTransitGatewayAttachmentsRequestBuilderOps(val self: DescribeTransitGatewayAttachmentsRequest.Builder) extends AnyVal {

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def transitGatewayAttachmentIdsAsScala(value: Option[Seq[String]]): DescribeTransitGatewayAttachmentsRequest.Builder = {
...
final class DescribeTransitGatewayAttachmentsRequestOps(val self: DescribeTransitGatewayAttachmentsRequest) extends AnyVal {
...
implicit def toDescribeTransitGatewayAttachmentsRequestBuilderOps(v: DescribeTransitGatewayAttachmentsRequest.Builder): DescribeTransitGatewayAttachmentsRequestBuilderOps = new DescribeTransitGatewayAttachmentsRequestBuilderOps(v)

implicit def toDescribeTransitGatewayAttachmentsRequestOps(v: DescribeTransitGatewayAttachmentsRequest): DescribeTransitGatewayAttachmentsRequestOps = new DescribeTransitGatewayAttachmentsRequestOps(v)
