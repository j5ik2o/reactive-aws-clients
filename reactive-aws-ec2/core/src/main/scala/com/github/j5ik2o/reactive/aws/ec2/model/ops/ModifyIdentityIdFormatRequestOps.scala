...
final class ModifyIdentityIdFormatRequestBuilderOps(val self: ModifyIdentityIdFormatRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.useLongIds(v) }
            } 
...
implicit def toModifyIdentityIdFormatRequestBuilderOps(v: ModifyIdentityIdFormatRequest.Builder): ModifyIdentityIdFormatRequestBuilderOps = new ModifyIdentityIdFormatRequestBuilderOps(v)

implicit def toModifyIdentityIdFormatRequestOps(v: ModifyIdentityIdFormatRequest): ModifyIdentityIdFormatRequestOps = new ModifyIdentityIdFormatRequestOps(v)
