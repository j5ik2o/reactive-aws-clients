...
final class DescribeRouteTablesResponseOps(val self: DescribeRouteTablesResponse) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def routeTablesAsScala: Option[Seq[RouteTable]] =
    Option(self.routeTables).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
