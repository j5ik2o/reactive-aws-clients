...
final class PurchaseHostReservationResponseBuilderOps(val self: PurchaseHostReservationResponse.Builder) extends AnyVal {
...
implicit def toPurchaseHostReservationResponseBuilderOps(v: PurchaseHostReservationResponse.Builder): PurchaseHostReservationResponseBuilderOps = new PurchaseHostReservationResponseBuilderOps(v)

implicit def toPurchaseHostReservationResponseOps(v: PurchaseHostReservationResponse): PurchaseHostReservationResponseOps = new PurchaseHostReservationResponseOps(v)
