...
final class CreateLocalGatewayRouteRequestBuilderOps(val self: CreateLocalGatewayRouteRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def localGatewayVirtualInterfaceGroupIdAsScala(value: Option[String]): CreateLocalGatewayRouteRequest.Builder = {
...
implicit def toCreateLocalGatewayRouteRequestBuilderOps(v: CreateLocalGatewayRouteRequest.Builder): CreateLocalGatewayRouteRequestBuilderOps = new CreateLocalGatewayRouteRequestBuilderOps(v)

implicit def toCreateLocalGatewayRouteRequestOps(v: CreateLocalGatewayRouteRequest): CreateLocalGatewayRouteRequestOps = new CreateLocalGatewayRouteRequestOps(v)
