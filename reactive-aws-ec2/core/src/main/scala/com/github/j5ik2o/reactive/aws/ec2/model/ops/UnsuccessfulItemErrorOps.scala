...
trait ToUnsuccessfulItemErrorOps {
  ...
  implicit def toUnsuccessfulItemErrorBuilderOps(v: UnsuccessfulItemError.Builder): UnsuccessfulItemErrorBuilderOps =
    new UnsuccessfulItemErrorBuilderOps(v)

  implicit def toUnsuccessfulItemErrorOps(v: UnsuccessfulItemError): UnsuccessfulItemErrorOps =
    new UnsuccessfulItemErrorOps(v)
