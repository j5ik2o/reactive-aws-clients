...
implicit def toResetImageAttributeRequestBuilderOps(v: ResetImageAttributeRequest.Builder): ResetImageAttributeRequestBuilderOps = new ResetImageAttributeRequestBuilderOps(v)

implicit def toResetImageAttributeRequestOps(v: ResetImageAttributeRequest): ResetImageAttributeRequestOps = new ResetImageAttributeRequestOps(v)
