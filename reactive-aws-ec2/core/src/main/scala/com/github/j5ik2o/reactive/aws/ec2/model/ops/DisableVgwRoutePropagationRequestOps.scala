...
trait ToDisableVgwRoutePropagationRequestOps {
  ...
  implicit def toDisableVgwRoutePropagationRequestBuilderOps(
      v: DisableVgwRoutePropagationRequest.Builder
  ): DisableVgwRoutePropagationRequestBuilderOps = new DisableVgwRoutePropagationRequestBuilderOps(v)

  implicit def toDisableVgwRoutePropagationRequestOps(
      v: DisableVgwRoutePropagationRequest
  ): DisableVgwRoutePropagationRequestOps = new DisableVgwRoutePropagationRequestOps(v)
