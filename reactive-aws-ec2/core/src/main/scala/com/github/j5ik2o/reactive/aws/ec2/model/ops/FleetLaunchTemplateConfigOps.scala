...
final class FleetLaunchTemplateConfigBuilderOps(val self: FleetLaunchTemplateConfig.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def launchTemplateSpecificationAsScala(value: Option[FleetLaunchTemplateSpecification]): FleetLaunchTemplateConfig.Builder = {
...
final class FleetLaunchTemplateConfigOps(val self: FleetLaunchTemplateConfig) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def overridesAsScala: Option[Seq[FleetLaunchTemplateOverrides]] = Option(self.overrides).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toFleetLaunchTemplateConfigBuilderOps(v: FleetLaunchTemplateConfig.Builder): FleetLaunchTemplateConfigBuilderOps = new FleetLaunchTemplateConfigBuilderOps(v)

implicit def toFleetLaunchTemplateConfigOps(v: FleetLaunchTemplateConfig): FleetLaunchTemplateConfigOps = new FleetLaunchTemplateConfigOps(v)
