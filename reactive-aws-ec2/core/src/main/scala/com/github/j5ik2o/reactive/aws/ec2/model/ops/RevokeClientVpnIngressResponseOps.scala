...
trait ToRevokeClientVpnIngressResponseOps {
  ...
  implicit def toRevokeClientVpnIngressResponseBuilderOps(
      v: RevokeClientVpnIngressResponse.Builder
  ): RevokeClientVpnIngressResponseBuilderOps = new RevokeClientVpnIngressResponseBuilderOps(v)

  implicit def toRevokeClientVpnIngressResponseOps(
      v: RevokeClientVpnIngressResponse
  ): RevokeClientVpnIngressResponseOps = new RevokeClientVpnIngressResponseOps(v)
