...
final class VpcClassicLinkBuilderOps(val self: VpcClassicLink.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.classicLinkEnabled(v) }
            } 
...
implicit def toVpcClassicLinkBuilderOps(v: VpcClassicLink.Builder): VpcClassicLinkBuilderOps = new VpcClassicLinkBuilderOps(v)
