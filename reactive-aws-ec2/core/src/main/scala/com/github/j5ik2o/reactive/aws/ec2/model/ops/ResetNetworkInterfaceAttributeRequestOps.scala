...
final class ResetNetworkInterfaceAttributeRequestBuilderOps(val self: ResetNetworkInterfaceAttributeRequest.Builder) extends AnyVal {
...
implicit def toResetNetworkInterfaceAttributeRequestBuilderOps(v: ResetNetworkInterfaceAttributeRequest.Builder): ResetNetworkInterfaceAttributeRequestBuilderOps = new ResetNetworkInterfaceAttributeRequestBuilderOps(v)

implicit def toResetNetworkInterfaceAttributeRequestOps(v: ResetNetworkInterfaceAttributeRequest): ResetNetworkInterfaceAttributeRequestOps = new ResetNetworkInterfaceAttributeRequestOps(v)
