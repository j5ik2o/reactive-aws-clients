...
implicit def toClassicLinkDnsSupportBuilderOps(v: ClassicLinkDnsSupport.Builder): ClassicLinkDnsSupportBuilderOps = new ClassicLinkDnsSupportBuilderOps(v)

implicit def toClassicLinkDnsSupportOps(v: ClassicLinkDnsSupport): ClassicLinkDnsSupportOps = new ClassicLinkDnsSupportOps(v)
