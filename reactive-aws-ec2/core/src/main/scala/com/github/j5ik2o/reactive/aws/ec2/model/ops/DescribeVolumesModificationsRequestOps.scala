...
final class DescribeVolumesModificationsRequestBuilderOps(val self: DescribeVolumesModificationsRequest.Builder) extends AnyVal {
...
implicit def toDescribeVolumesModificationsRequestBuilderOps(v: DescribeVolumesModificationsRequest.Builder): DescribeVolumesModificationsRequestBuilderOps = new DescribeVolumesModificationsRequestBuilderOps(v)

implicit def toDescribeVolumesModificationsRequestOps(v: DescribeVolumesModificationsRequest): DescribeVolumesModificationsRequestOps = new DescribeVolumesModificationsRequestOps(v)
