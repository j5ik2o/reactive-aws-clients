...
trait ToDeleteDhcpOptionsRequestOps {
  ...
  implicit def toDeleteDhcpOptionsRequestBuilderOps(
      v: DeleteDhcpOptionsRequest.Builder
  ): DeleteDhcpOptionsRequestBuilderOps = new DeleteDhcpOptionsRequestBuilderOps(v)

  implicit def toDeleteDhcpOptionsRequestOps(v: DeleteDhcpOptionsRequest): DeleteDhcpOptionsRequestOps =
    new DeleteDhcpOptionsRequestOps(v)
