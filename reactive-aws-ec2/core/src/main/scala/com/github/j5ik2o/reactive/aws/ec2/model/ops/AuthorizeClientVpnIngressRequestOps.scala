...
final class AuthorizeClientVpnIngressRequestBuilderOps(val self: AuthorizeClientVpnIngressRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.authorizeAllGroups(v) }
            } 
...
implicit def toAuthorizeClientVpnIngressRequestBuilderOps(v: AuthorizeClientVpnIngressRequest.Builder): AuthorizeClientVpnIngressRequestBuilderOps = new AuthorizeClientVpnIngressRequestBuilderOps(v)

implicit def toAuthorizeClientVpnIngressRequestOps(v: AuthorizeClientVpnIngressRequest): AuthorizeClientVpnIngressRequestOps = new AuthorizeClientVpnIngressRequestOps(v)
