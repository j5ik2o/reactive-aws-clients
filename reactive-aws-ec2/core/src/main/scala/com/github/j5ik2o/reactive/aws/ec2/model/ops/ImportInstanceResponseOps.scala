...
trait ToImportInstanceResponseOps {
  ...
  implicit def toImportInstanceResponseBuilderOps(v: ImportInstanceResponse.Builder): ImportInstanceResponseBuilderOps =
    new ImportInstanceResponseBuilderOps(v)

  implicit def toImportInstanceResponseOps(v: ImportInstanceResponse): ImportInstanceResponseOps =
    new ImportInstanceResponseOps(v)
