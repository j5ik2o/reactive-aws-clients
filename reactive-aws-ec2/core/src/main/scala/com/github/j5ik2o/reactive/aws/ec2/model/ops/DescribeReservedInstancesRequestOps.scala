...
final class DescribeReservedInstancesRequestBuilderOps(val self: DescribeReservedInstancesRequest.Builder) extends AnyVal {
...
implicit def toDescribeReservedInstancesRequestBuilderOps(v: DescribeReservedInstancesRequest.Builder): DescribeReservedInstancesRequestBuilderOps = new DescribeReservedInstancesRequestBuilderOps(v)

implicit def toDescribeReservedInstancesRequestOps(v: DescribeReservedInstancesRequest): DescribeReservedInstancesRequestOps = new DescribeReservedInstancesRequestOps(v)
