...
final class DescribeInstanceAttributeRequestBuilderOps(val self: DescribeInstanceAttributeRequest.Builder) extends AnyVal {
...
implicit def toDescribeInstanceAttributeRequestBuilderOps(v: DescribeInstanceAttributeRequest.Builder): DescribeInstanceAttributeRequestBuilderOps = new DescribeInstanceAttributeRequestBuilderOps(v)

implicit def toDescribeInstanceAttributeRequestOps(v: DescribeInstanceAttributeRequest): DescribeInstanceAttributeRequestOps = new DescribeInstanceAttributeRequestOps(v)
