...
trait ToCreateTransitGatewayResponseOps {
  ...
  implicit def toCreateTransitGatewayResponseBuilderOps(
      v: CreateTransitGatewayResponse.Builder
  ): CreateTransitGatewayResponseBuilderOps = new CreateTransitGatewayResponseBuilderOps(v)

  implicit def toCreateTransitGatewayResponseOps(v: CreateTransitGatewayResponse): CreateTransitGatewayResponseOps =
    new CreateTransitGatewayResponseOps(v)
