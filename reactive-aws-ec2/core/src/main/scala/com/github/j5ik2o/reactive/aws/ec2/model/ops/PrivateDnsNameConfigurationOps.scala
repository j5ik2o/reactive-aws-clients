...
trait ToPrivateDnsNameConfigurationOps {
  ...
  implicit def toPrivateDnsNameConfigurationBuilderOps(
      v: PrivateDnsNameConfiguration.Builder
  ): PrivateDnsNameConfigurationBuilderOps = new PrivateDnsNameConfigurationBuilderOps(v)

  implicit def toPrivateDnsNameConfigurationOps(v: PrivateDnsNameConfiguration): PrivateDnsNameConfigurationOps =
    new PrivateDnsNameConfigurationOps(v)
