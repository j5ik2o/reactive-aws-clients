...
final class CreateVpnConnectionRouteRequestBuilderOps(val self: CreateVpnConnectionRouteRequest.Builder) extends AnyVal {
...
implicit def toCreateVpnConnectionRouteRequestBuilderOps(v: CreateVpnConnectionRouteRequest.Builder): CreateVpnConnectionRouteRequestBuilderOps = new CreateVpnConnectionRouteRequestBuilderOps(v)

implicit def toCreateVpnConnectionRouteRequestOps(v: CreateVpnConnectionRouteRequest): CreateVpnConnectionRouteRequestOps = new CreateVpnConnectionRouteRequestOps(v)
