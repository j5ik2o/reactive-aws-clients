...
implicit def toSpotDatafeedSubscriptionBuilderOps(v: SpotDatafeedSubscription.Builder): SpotDatafeedSubscriptionBuilderOps = new SpotDatafeedSubscriptionBuilderOps(v)

implicit def toSpotDatafeedSubscriptionOps(v: SpotDatafeedSubscription): SpotDatafeedSubscriptionOps = new SpotDatafeedSubscriptionOps(v)
