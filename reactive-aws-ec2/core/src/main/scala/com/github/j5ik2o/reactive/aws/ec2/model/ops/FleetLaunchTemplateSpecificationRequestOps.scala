...
final class FleetLaunchTemplateSpecificationRequestBuilderOps(val self: FleetLaunchTemplateSpecificationRequest.Builder) extends AnyVal {
...
final class FleetLaunchTemplateSpecificationRequestOps(val self: FleetLaunchTemplateSpecificationRequest) extends AnyVal {
...
implicit def toFleetLaunchTemplateSpecificationRequestBuilderOps(v: FleetLaunchTemplateSpecificationRequest.Builder): FleetLaunchTemplateSpecificationRequestBuilderOps = new FleetLaunchTemplateSpecificationRequestBuilderOps(v)

implicit def toFleetLaunchTemplateSpecificationRequestOps(v: FleetLaunchTemplateSpecificationRequest): FleetLaunchTemplateSpecificationRequestOps = new FleetLaunchTemplateSpecificationRequestOps(v)
