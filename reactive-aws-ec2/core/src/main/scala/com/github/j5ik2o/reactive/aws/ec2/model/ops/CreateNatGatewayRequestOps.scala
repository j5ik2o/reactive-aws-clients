...
implicit def toCreateNatGatewayRequestBuilderOps(v: CreateNatGatewayRequest.Builder): CreateNatGatewayRequestBuilderOps = new CreateNatGatewayRequestBuilderOps(v)

implicit def toCreateNatGatewayRequestOps(v: CreateNatGatewayRequest): CreateNatGatewayRequestOps = new CreateNatGatewayRequestOps(v)
