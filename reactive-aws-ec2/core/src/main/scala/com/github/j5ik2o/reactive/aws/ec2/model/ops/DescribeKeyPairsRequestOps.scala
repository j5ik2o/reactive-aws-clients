...
final class DescribeKeyPairsRequestOps(val self: DescribeKeyPairsRequest) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def keyNamesAsScala: Option[Seq[String]] =
    Option(self.keyNames).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def keyPairIdsAsScala: Option[Seq[String]] =
    Option(self.keyPairIds).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
