...
implicit def toDeleteFlowLogsRequestBuilderOps(v: DeleteFlowLogsRequest.Builder): DeleteFlowLogsRequestBuilderOps = new DeleteFlowLogsRequestBuilderOps(v)

implicit def toDeleteFlowLogsRequestOps(v: DeleteFlowLogsRequest): DeleteFlowLogsRequestOps = new DeleteFlowLogsRequestOps(v)
