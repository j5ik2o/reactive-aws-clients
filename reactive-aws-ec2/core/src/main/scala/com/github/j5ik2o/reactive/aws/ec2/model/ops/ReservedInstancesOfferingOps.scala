...
final class ReservedInstancesOfferingBuilderOps(val self: ReservedInstancesOffering.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.marketplace(v) }
            } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def pricingDetailsAsScala(value: Option[Seq[PricingDetail]]): ReservedInstancesOffering.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.pricingDetails(v.asJava) } 
            }

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def recurringChargesAsScala(value: Option[Seq[RecurringCharge]]): ReservedInstancesOffering.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.recurringCharges(v.asJava) } 
            }

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def scopeAsScala(value: Option[Scope]): ReservedInstancesOffering.Builder = {
            value.fold(self){ v => self.scope(v) }
            } 
...
final class ReservedInstancesOfferingOps(val self: ReservedInstancesOffering) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def pricingDetailsAsScala: Option[Seq[PricingDetail]] = Option(self.pricingDetails).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def recurringChargesAsScala: Option[Seq[RecurringCharge]] = Option(self.recurringCharges).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toReservedInstancesOfferingBuilderOps(v: ReservedInstancesOffering.Builder): ReservedInstancesOfferingBuilderOps = new ReservedInstancesOfferingBuilderOps(v)

implicit def toReservedInstancesOfferingOps(v: ReservedInstancesOffering): ReservedInstancesOfferingOps = new ReservedInstancesOfferingOps(v)
