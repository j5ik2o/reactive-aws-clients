...
implicit def toCancelledSpotInstanceRequestBuilderOps(v: CancelledSpotInstanceRequest.Builder): CancelledSpotInstanceRequestBuilderOps = new CancelledSpotInstanceRequestBuilderOps(v)

implicit def toCancelledSpotInstanceRequestOps(v: CancelledSpotInstanceRequest): CancelledSpotInstanceRequestOps = new CancelledSpotInstanceRequestOps(v)
