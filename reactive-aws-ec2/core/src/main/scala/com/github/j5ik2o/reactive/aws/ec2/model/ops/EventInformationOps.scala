...
final class EventInformationBuilderOps(val self: EventInformation.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.eventDescription(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def eventSubTypeAsScala(value: Option[String]): EventInformation.Builder = {
            value.fold(self){ v => self.eventSubType(v) }
            } 
...
implicit def toEventInformationBuilderOps(v: EventInformation.Builder): EventInformationBuilderOps = new EventInformationBuilderOps(v)
