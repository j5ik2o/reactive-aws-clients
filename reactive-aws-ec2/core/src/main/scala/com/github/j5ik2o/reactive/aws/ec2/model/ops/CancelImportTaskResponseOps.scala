...
implicit def toCancelImportTaskResponseBuilderOps(v: CancelImportTaskResponse.Builder): CancelImportTaskResponseBuilderOps = new CancelImportTaskResponseBuilderOps(v)

implicit def toCancelImportTaskResponseOps(v: CancelImportTaskResponse): CancelImportTaskResponseOps = new CancelImportTaskResponseOps(v)
