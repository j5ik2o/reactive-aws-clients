...
final class InstanceMetadataOptionsRequestBuilderOps(val self: InstanceMetadataOptionsRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def httpEndpointAsScala(value: Option[InstanceMetadataEndpointState]): InstanceMetadataOptionsRequest.Builder = {
...
implicit def toInstanceMetadataOptionsRequestBuilderOps(v: InstanceMetadataOptionsRequest.Builder): InstanceMetadataOptionsRequestBuilderOps = new InstanceMetadataOptionsRequestBuilderOps(v)

implicit def toInstanceMetadataOptionsRequestOps(v: InstanceMetadataOptionsRequest): InstanceMetadataOptionsRequestOps = new InstanceMetadataOptionsRequestOps(v)
