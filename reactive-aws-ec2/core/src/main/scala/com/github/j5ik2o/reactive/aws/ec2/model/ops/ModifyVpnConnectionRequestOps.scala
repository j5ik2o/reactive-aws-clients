...
trait ToModifyVpnConnectionRequestOps {
  ...
  implicit def toModifyVpnConnectionRequestBuilderOps(
      v: ModifyVpnConnectionRequest.Builder
  ): ModifyVpnConnectionRequestBuilderOps = new ModifyVpnConnectionRequestBuilderOps(v)

  implicit def toModifyVpnConnectionRequestOps(v: ModifyVpnConnectionRequest): ModifyVpnConnectionRequestOps =
    new ModifyVpnConnectionRequestOps(v)
