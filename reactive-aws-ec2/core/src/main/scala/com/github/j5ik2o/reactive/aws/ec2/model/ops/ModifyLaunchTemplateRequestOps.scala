...
implicit def toModifyLaunchTemplateRequestBuilderOps(v: ModifyLaunchTemplateRequest.Builder): ModifyLaunchTemplateRequestBuilderOps = new ModifyLaunchTemplateRequestBuilderOps(v)

implicit def toModifyLaunchTemplateRequestOps(v: ModifyLaunchTemplateRequest): ModifyLaunchTemplateRequestOps = new ModifyLaunchTemplateRequestOps(v)
