...
implicit def toLaunchTemplatePlacementBuilderOps(v: LaunchTemplatePlacement.Builder): LaunchTemplatePlacementBuilderOps = new LaunchTemplatePlacementBuilderOps(v)

implicit def toLaunchTemplatePlacementOps(v: LaunchTemplatePlacement): LaunchTemplatePlacementOps = new LaunchTemplatePlacementOps(v)
