...
implicit def toLaunchTemplateEbsBlockDeviceBuilderOps(v: LaunchTemplateEbsBlockDevice.Builder): LaunchTemplateEbsBlockDeviceBuilderOps = new LaunchTemplateEbsBlockDeviceBuilderOps(v)

implicit def toLaunchTemplateEbsBlockDeviceOps(v: LaunchTemplateEbsBlockDevice): LaunchTemplateEbsBlockDeviceOps = new LaunchTemplateEbsBlockDeviceOps(v)
