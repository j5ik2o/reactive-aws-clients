...
implicit def toCreateNetworkAclEntryRequestBuilderOps(v: CreateNetworkAclEntryRequest.Builder): CreateNetworkAclEntryRequestBuilderOps = new CreateNetworkAclEntryRequestBuilderOps(v)

implicit def toCreateNetworkAclEntryRequestOps(v: CreateNetworkAclEntryRequest): CreateNetworkAclEntryRequestOps = new CreateNetworkAclEntryRequestOps(v)
