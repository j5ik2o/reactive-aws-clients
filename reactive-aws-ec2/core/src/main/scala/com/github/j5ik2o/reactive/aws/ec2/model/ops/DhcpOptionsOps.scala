...
final class DhcpOptionsOps(val self: DhcpOptions) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def dhcpConfigurationsAsScala: Option[Seq[DhcpConfiguration]] = Option(self.dhcpConfigurations).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
