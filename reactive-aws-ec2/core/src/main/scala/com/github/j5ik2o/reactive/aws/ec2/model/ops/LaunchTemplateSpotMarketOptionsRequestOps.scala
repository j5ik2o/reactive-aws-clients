...
final class LaunchTemplateSpotMarketOptionsRequestBuilderOps(val self: LaunchTemplateSpotMarketOptionsRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def instanceInterruptionBehaviorAsScala(value: Option[InstanceInterruptionBehavior]): LaunchTemplateSpotMarketOptionsRequest.Builder = {
...
implicit def toLaunchTemplateSpotMarketOptionsRequestBuilderOps(v: LaunchTemplateSpotMarketOptionsRequest.Builder): LaunchTemplateSpotMarketOptionsRequestBuilderOps = new LaunchTemplateSpotMarketOptionsRequestBuilderOps(v)

implicit def toLaunchTemplateSpotMarketOptionsRequestOps(v: LaunchTemplateSpotMarketOptionsRequest): LaunchTemplateSpotMarketOptionsRequestOps = new LaunchTemplateSpotMarketOptionsRequestOps(v)
