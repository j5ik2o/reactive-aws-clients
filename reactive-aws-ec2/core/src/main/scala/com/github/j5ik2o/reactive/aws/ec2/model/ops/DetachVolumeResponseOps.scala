...
implicit def toDetachVolumeResponseBuilderOps(v: DetachVolumeResponse.Builder): DetachVolumeResponseBuilderOps = new DetachVolumeResponseBuilderOps(v)

implicit def toDetachVolumeResponseOps(v: DetachVolumeResponse): DetachVolumeResponseOps = new DetachVolumeResponseOps(v)
