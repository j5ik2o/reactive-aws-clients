...
implicit def toDiskImageVolumeDescriptionBuilderOps(v: DiskImageVolumeDescription.Builder): DiskImageVolumeDescriptionBuilderOps = new DiskImageVolumeDescriptionBuilderOps(v)

implicit def toDiskImageVolumeDescriptionOps(v: DiskImageVolumeDescription): DiskImageVolumeDescriptionOps = new DiskImageVolumeDescriptionOps(v)
