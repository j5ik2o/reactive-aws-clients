...
final class HostPropertiesBuilderOps(val self: HostProperties.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.cores(v) }
            } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.sockets(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def totalVCpusAsScala(value: Option[Int]): HostProperties.Builder = {
            value.fold(self){ v => self.totalVCpus(v) }
            } 
...
implicit def toHostPropertiesBuilderOps(v: HostProperties.Builder): HostPropertiesBuilderOps = new HostPropertiesBuilderOps(v)
