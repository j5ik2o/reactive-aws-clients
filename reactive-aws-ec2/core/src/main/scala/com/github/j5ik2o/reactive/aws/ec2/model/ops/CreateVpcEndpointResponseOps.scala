...
implicit def toCreateVpcEndpointResponseBuilderOps(v: CreateVpcEndpointResponse.Builder): CreateVpcEndpointResponseBuilderOps = new CreateVpcEndpointResponseBuilderOps(v)

implicit def toCreateVpcEndpointResponseOps(v: CreateVpcEndpointResponse): CreateVpcEndpointResponseOps = new CreateVpcEndpointResponseOps(v)
