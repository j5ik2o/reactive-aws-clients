...
trait ToDisableVpcClassicLinkRequestOps {
  ...
  implicit def toDisableVpcClassicLinkRequestBuilderOps(
      v: DisableVpcClassicLinkRequest.Builder
  ): DisableVpcClassicLinkRequestBuilderOps = new DisableVpcClassicLinkRequestBuilderOps(v)

  implicit def toDisableVpcClassicLinkRequestOps(v: DisableVpcClassicLinkRequest): DisableVpcClassicLinkRequestOps =
    new DisableVpcClassicLinkRequestOps(v)
