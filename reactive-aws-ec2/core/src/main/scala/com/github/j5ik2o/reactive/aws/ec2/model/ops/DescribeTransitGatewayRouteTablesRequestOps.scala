...
final class DescribeTransitGatewayRouteTablesRequestBuilderOps(
  ...
  final def transitGatewayRouteTableIdsAsScala(
    ...
    value.filter(_.nonEmpty).fold(self) { v =>
      import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.transitGatewayRouteTableIds(v.asJava)
    }
  }
...
final class DescribeTransitGatewayRouteTablesRequestOps(val self: DescribeTransitGatewayRouteTablesRequest)
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def transitGatewayRouteTableIdsAsScala: Option[Seq[String]] =
    Option(self.transitGatewayRouteTableIds).map { v =>
