...
final class ModifyVpnTunnelCertificateRequestBuilderOps(val self: ModifyVpnTunnelCertificateRequest.Builder)
    extends AnyVal {
  ...
  final def vpnTunnelOutsideIpAddressAsScala(value: Option[String]): ModifyVpnTunnelCertificateRequest.Builder = {
    value.fold(self) { v =>
      self.vpnTunnelOutsideIpAddress(v)
    }
  }
...
trait ToModifyVpnTunnelCertificateRequestOps {
  ...
  implicit def toModifyVpnTunnelCertificateRequestBuilderOps(
      v: ModifyVpnTunnelCertificateRequest.Builder
  ): ModifyVpnTunnelCertificateRequestBuilderOps = new ModifyVpnTunnelCertificateRequestBuilderOps(v)

  implicit def toModifyVpnTunnelCertificateRequestOps(
      v: ModifyVpnTunnelCertificateRequest
  ): ModifyVpnTunnelCertificateRequestOps = new ModifyVpnTunnelCertificateRequestOps(v)
