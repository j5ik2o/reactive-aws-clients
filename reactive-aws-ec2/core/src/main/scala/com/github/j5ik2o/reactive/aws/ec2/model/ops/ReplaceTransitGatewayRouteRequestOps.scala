...
final class ReplaceTransitGatewayRouteRequestBuilderOps(val self: ReplaceTransitGatewayRouteRequest.Builder) extends AnyVal {
...
implicit def toReplaceTransitGatewayRouteRequestBuilderOps(v: ReplaceTransitGatewayRouteRequest.Builder): ReplaceTransitGatewayRouteRequestBuilderOps = new ReplaceTransitGatewayRouteRequestBuilderOps(v)

implicit def toReplaceTransitGatewayRouteRequestOps(v: ReplaceTransitGatewayRouteRequest): ReplaceTransitGatewayRouteRequestOps = new ReplaceTransitGatewayRouteRequestOps(v)
