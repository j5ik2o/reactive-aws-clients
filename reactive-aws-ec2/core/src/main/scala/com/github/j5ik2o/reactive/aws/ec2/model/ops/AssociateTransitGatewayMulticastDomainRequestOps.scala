...
final class AssociateTransitGatewayMulticastDomainRequestBuilderOps(
    val self: AssociateTransitGatewayMulticastDomainRequest.Builder
) extends AnyVal {
...
final class AssociateTransitGatewayMulticastDomainRequestOps(val self: AssociateTransitGatewayMulticastDomainRequest)
    extends AnyVal {
...
trait ToAssociateTransitGatewayMulticastDomainRequestOps {
  ...
  implicit def toAssociateTransitGatewayMulticastDomainRequestBuilderOps(
      v: AssociateTransitGatewayMulticastDomainRequest.Builder
  ): AssociateTransitGatewayMulticastDomainRequestBuilderOps =
    new AssociateTransitGatewayMulticastDomainRequestBuilderOps(v)

  implicit def toAssociateTransitGatewayMulticastDomainRequestOps(
      v: AssociateTransitGatewayMulticastDomainRequest
  ): AssociateTransitGatewayMulticastDomainRequestOps = new AssociateTransitGatewayMulticastDomainRequestOps(v)
