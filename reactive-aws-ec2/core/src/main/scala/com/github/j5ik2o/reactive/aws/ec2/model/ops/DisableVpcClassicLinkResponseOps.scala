...
implicit def toDisableVpcClassicLinkResponseBuilderOps(v: DisableVpcClassicLinkResponse.Builder): DisableVpcClassicLinkResponseBuilderOps = new DisableVpcClassicLinkResponseBuilderOps(v)

implicit def toDisableVpcClassicLinkResponseOps(v: DisableVpcClassicLinkResponse): DisableVpcClassicLinkResponseOps = new DisableVpcClassicLinkResponseOps(v)
