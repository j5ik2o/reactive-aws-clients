...
trait ToModifyVpnConnectionResponseOps {
  ...
  implicit def toModifyVpnConnectionResponseBuilderOps(
      v: ModifyVpnConnectionResponse.Builder
  ): ModifyVpnConnectionResponseBuilderOps = new ModifyVpnConnectionResponseBuilderOps(v)

  implicit def toModifyVpnConnectionResponseOps(v: ModifyVpnConnectionResponse): ModifyVpnConnectionResponseOps =
    new ModifyVpnConnectionResponseOps(v)
