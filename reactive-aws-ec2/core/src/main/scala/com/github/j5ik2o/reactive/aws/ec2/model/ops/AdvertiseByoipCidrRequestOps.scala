...
implicit def toAdvertiseByoipCidrRequestBuilderOps(v: AdvertiseByoipCidrRequest.Builder): AdvertiseByoipCidrRequestBuilderOps = new AdvertiseByoipCidrRequestBuilderOps(v)

implicit def toAdvertiseByoipCidrRequestOps(v: AdvertiseByoipCidrRequest): AdvertiseByoipCidrRequestOps = new AdvertiseByoipCidrRequestOps(v)
