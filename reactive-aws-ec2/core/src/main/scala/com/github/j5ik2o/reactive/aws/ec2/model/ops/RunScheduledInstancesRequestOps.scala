...
final class RunScheduledInstancesRequestBuilderOps(val self: RunScheduledInstancesRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def launchSpecificationAsScala(value: Option[ScheduledInstancesLaunchSpecification]): RunScheduledInstancesRequest.Builder = {
...
implicit def toRunScheduledInstancesRequestBuilderOps(v: RunScheduledInstancesRequest.Builder): RunScheduledInstancesRequestBuilderOps = new RunScheduledInstancesRequestBuilderOps(v)

implicit def toRunScheduledInstancesRequestOps(v: RunScheduledInstancesRequest): RunScheduledInstancesRequestOps = new RunScheduledInstancesRequestOps(v)
