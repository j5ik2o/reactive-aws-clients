...
implicit def toCancelImportTaskRequestBuilderOps(v: CancelImportTaskRequest.Builder): CancelImportTaskRequestBuilderOps = new CancelImportTaskRequestBuilderOps(v)

implicit def toCancelImportTaskRequestOps(v: CancelImportTaskRequest): CancelImportTaskRequestOps = new CancelImportTaskRequestOps(v)
