...
implicit def toModifyInstancePlacementRequestBuilderOps(v: ModifyInstancePlacementRequest.Builder): ModifyInstancePlacementRequestBuilderOps = new ModifyInstancePlacementRequestBuilderOps(v)

implicit def toModifyInstancePlacementRequestOps(v: ModifyInstancePlacementRequest): ModifyInstancePlacementRequestOps = new ModifyInstancePlacementRequestOps(v)
