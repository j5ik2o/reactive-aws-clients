...
final class CreateFleetResponseOps(val self: CreateFleetResponse) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def errorsAsScala: Option[Seq[CreateFleetError]] = Option(self.errors).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def instancesAsScala: Option[Seq[CreateFleetInstance]] = Option(self.instances).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toCreateFleetResponseBuilderOps(v: CreateFleetResponse.Builder): CreateFleetResponseBuilderOps = new CreateFleetResponseBuilderOps(v)
