...
implicit def toImportKeyPairResponseBuilderOps(v: ImportKeyPairResponse.Builder): ImportKeyPairResponseBuilderOps = new ImportKeyPairResponseBuilderOps(v)

implicit def toImportKeyPairResponseOps(v: ImportKeyPairResponse): ImportKeyPairResponseOps = new ImportKeyPairResponseOps(v)
