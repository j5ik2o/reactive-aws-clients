...
final class ClientVpnAuthenticationRequestBuilderOps(val self: ClientVpnAuthenticationRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def activeDirectoryAsScala(value: Option[DirectoryServiceAuthenticationRequest]): ClientVpnAuthenticationRequest.Builder = {
            value.fold(self){ v => self.activeDirectory(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def mutualAuthenticationAsScala(value: Option[CertificateAuthenticationRequest]): ClientVpnAuthenticationRequest.Builder = {
...
implicit def toClientVpnAuthenticationRequestBuilderOps(v: ClientVpnAuthenticationRequest.Builder): ClientVpnAuthenticationRequestBuilderOps = new ClientVpnAuthenticationRequestBuilderOps(v)

implicit def toClientVpnAuthenticationRequestOps(v: ClientVpnAuthenticationRequest): ClientVpnAuthenticationRequestOps = new ClientVpnAuthenticationRequestOps(v)
