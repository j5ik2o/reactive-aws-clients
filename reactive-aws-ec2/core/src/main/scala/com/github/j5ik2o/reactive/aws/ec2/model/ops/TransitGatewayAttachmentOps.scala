...
final class TransitGatewayAttachmentBuilderOps(val self: TransitGatewayAttachment.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.transitGatewayOwnerId(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def resourceOwnerIdAsScala(value: Option[String]): TransitGatewayAttachment.Builder = {
            value.fold(self){ v => self.resourceOwnerId(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def resourceTypeAsScala(value: Option[TransitGatewayAttachmentResourceType]): TransitGatewayAttachment.Builder = {
...
implicit def toTransitGatewayAttachmentBuilderOps(v: TransitGatewayAttachment.Builder): TransitGatewayAttachmentBuilderOps = new TransitGatewayAttachmentBuilderOps(v)

implicit def toTransitGatewayAttachmentOps(v: TransitGatewayAttachment): TransitGatewayAttachmentOps = new TransitGatewayAttachmentOps(v)
