...
implicit def toDescribeVolumeAttributeRequestBuilderOps(v: DescribeVolumeAttributeRequest.Builder): DescribeVolumeAttributeRequestBuilderOps = new DescribeVolumeAttributeRequestBuilderOps(v)

implicit def toDescribeVolumeAttributeRequestOps(v: DescribeVolumeAttributeRequest): DescribeVolumeAttributeRequestOps = new DescribeVolumeAttributeRequestOps(v)
