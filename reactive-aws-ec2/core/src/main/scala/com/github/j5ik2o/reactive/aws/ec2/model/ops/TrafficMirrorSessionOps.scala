...
implicit def toTrafficMirrorSessionBuilderOps(v: TrafficMirrorSession.Builder): TrafficMirrorSessionBuilderOps = new TrafficMirrorSessionBuilderOps(v)

implicit def toTrafficMirrorSessionOps(v: TrafficMirrorSession): TrafficMirrorSessionOps = new TrafficMirrorSessionOps(v)
