...
trait ToExportTaskS3LocationRequestOps {
  ...
  implicit def toExportTaskS3LocationRequestBuilderOps(
      v: ExportTaskS3LocationRequest.Builder
  ): ExportTaskS3LocationRequestBuilderOps = new ExportTaskS3LocationRequestBuilderOps(v)

  implicit def toExportTaskS3LocationRequestOps(v: ExportTaskS3LocationRequest): ExportTaskS3LocationRequestOps =
    new ExportTaskS3LocationRequestOps(v)
