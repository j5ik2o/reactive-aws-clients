...
final class DescribeFpgaImagesRequestBuilderOps(val self: DescribeFpgaImagesRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def fpgaImageIdsAsScala(value: Option[Seq[String]]): DescribeFpgaImagesRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.fpgaImageIds(v.asJava) } 
            }
...
final class DescribeFpgaImagesRequestOps(val self: DescribeFpgaImagesRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def fpgaImageIdsAsScala: Option[Seq[String]] = Option(self.fpgaImageIds).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toDescribeFpgaImagesRequestBuilderOps(v: DescribeFpgaImagesRequest.Builder): DescribeFpgaImagesRequestBuilderOps = new DescribeFpgaImagesRequestBuilderOps(v)

implicit def toDescribeFpgaImagesRequestOps(v: DescribeFpgaImagesRequest): DescribeFpgaImagesRequestOps = new DescribeFpgaImagesRequestOps(v)
