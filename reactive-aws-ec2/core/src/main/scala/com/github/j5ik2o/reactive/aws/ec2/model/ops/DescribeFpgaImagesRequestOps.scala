...
final class DescribeFpgaImagesRequestOps(val self: DescribeFpgaImagesRequest) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def fpgaImageIdsAsScala: Option[Seq[String]] =
    Option(self.fpgaImageIds).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def ownersAsScala: Option[Seq[String]] =
    Option(self.owners).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
