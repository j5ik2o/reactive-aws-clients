...
implicit def toDeleteFleetErrorItemBuilderOps(v: DeleteFleetErrorItem.Builder): DeleteFleetErrorItemBuilderOps = new DeleteFleetErrorItemBuilderOps(v)

implicit def toDeleteFleetErrorItemOps(v: DeleteFleetErrorItem): DeleteFleetErrorItemOps = new DeleteFleetErrorItemOps(v)
