...
final class DescribeInstanceAttributeResponseBuilderOps(val self: DescribeInstanceAttributeResponse.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def blockDeviceMappingsAsScala(value: Option[Seq[InstanceBlockDeviceMapping]]): DescribeInstanceAttributeResponse.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def disableApiTerminationAsScala(value: Option[AttributeBooleanValue]): DescribeInstanceAttributeResponse.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def instanceInitiatedShutdownBehaviorAsScala(value: Option[AttributeValue]): DescribeInstanceAttributeResponse.Builder = {
...
implicit def toDescribeInstanceAttributeResponseBuilderOps(v: DescribeInstanceAttributeResponse.Builder): DescribeInstanceAttributeResponseBuilderOps = new DescribeInstanceAttributeResponseBuilderOps(v)

implicit def toDescribeInstanceAttributeResponseOps(v: DescribeInstanceAttributeResponse): DescribeInstanceAttributeResponseOps = new DescribeInstanceAttributeResponseOps(v)
