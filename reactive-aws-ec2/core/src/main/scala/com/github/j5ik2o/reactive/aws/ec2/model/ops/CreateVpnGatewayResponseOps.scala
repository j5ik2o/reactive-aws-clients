...
implicit def toCreateVpnGatewayResponseBuilderOps(v: CreateVpnGatewayResponse.Builder): CreateVpnGatewayResponseBuilderOps = new CreateVpnGatewayResponseBuilderOps(v)

implicit def toCreateVpnGatewayResponseOps(v: CreateVpnGatewayResponse): CreateVpnGatewayResponseOps = new CreateVpnGatewayResponseOps(v)
