...
final class GetAssociatedIpv6PoolCidrsRequestBuilderOps(val self: GetAssociatedIpv6PoolCidrsRequest.Builder)
    extends AnyVal {
...
trait ToGetAssociatedIpv6PoolCidrsRequestOps {
  ...
  implicit def toGetAssociatedIpv6PoolCidrsRequestBuilderOps(
      v: GetAssociatedIpv6PoolCidrsRequest.Builder
  ): GetAssociatedIpv6PoolCidrsRequestBuilderOps = new GetAssociatedIpv6PoolCidrsRequestBuilderOps(v)

  implicit def toGetAssociatedIpv6PoolCidrsRequestOps(
      v: GetAssociatedIpv6PoolCidrsRequest
  ): GetAssociatedIpv6PoolCidrsRequestOps = new GetAssociatedIpv6PoolCidrsRequestOps(v)
