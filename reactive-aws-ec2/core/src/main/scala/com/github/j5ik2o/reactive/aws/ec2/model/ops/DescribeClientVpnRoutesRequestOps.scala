...
implicit def toDescribeClientVpnRoutesRequestBuilderOps(v: DescribeClientVpnRoutesRequest.Builder): DescribeClientVpnRoutesRequestBuilderOps = new DescribeClientVpnRoutesRequestBuilderOps(v)

implicit def toDescribeClientVpnRoutesRequestOps(v: DescribeClientVpnRoutesRequest): DescribeClientVpnRoutesRequestOps = new DescribeClientVpnRoutesRequestOps(v)
