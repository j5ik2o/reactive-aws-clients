...
final class DescribeLaunchTemplatesRequestBuilderOps(val self: DescribeLaunchTemplatesRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def launchTemplateIdsAsScala(value: Option[Seq[String]]): DescribeLaunchTemplatesRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.launchTemplateIds(v.asJava) } 
            }

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def launchTemplateNamesAsScala(value: Option[Seq[String]]): DescribeLaunchTemplatesRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.launchTemplateNames(v.asJava) } 
            }
...
final class DescribeLaunchTemplatesRequestOps(val self: DescribeLaunchTemplatesRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def launchTemplateIdsAsScala: Option[Seq[String]] = Option(self.launchTemplateIds).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def launchTemplateNamesAsScala: Option[Seq[String]] = Option(self.launchTemplateNames).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toDescribeLaunchTemplatesRequestBuilderOps(v: DescribeLaunchTemplatesRequest.Builder): DescribeLaunchTemplatesRequestBuilderOps = new DescribeLaunchTemplatesRequestBuilderOps(v)

implicit def toDescribeLaunchTemplatesRequestOps(v: DescribeLaunchTemplatesRequest): DescribeLaunchTemplatesRequestOps = new DescribeLaunchTemplatesRequestOps(v)
