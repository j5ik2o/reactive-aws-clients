...
final class DescribeLaunchTemplatesRequestOps(val self: DescribeLaunchTemplatesRequest) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def launchTemplateIdsAsScala: Option[Seq[String]] =
    Option(self.launchTemplateIds).map { v =>
      import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala
    }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def launchTemplateNamesAsScala: Option[Seq[String]] =
    Option(self.launchTemplateNames).map { v =>
      import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala
    }
