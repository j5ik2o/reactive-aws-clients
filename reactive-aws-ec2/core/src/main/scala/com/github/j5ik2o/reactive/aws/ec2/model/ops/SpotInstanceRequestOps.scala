...
final class SpotInstanceRequestBuilderOps(val self: SpotInstanceRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.actualBlockHourlyPrice(v) }
            } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.fault(v) }
            } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.launchedAvailabilityZone(v) }
            } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def instanceInterruptionBehaviorAsScala(value: Option[InstanceInterruptionBehavior]): SpotInstanceRequest.Builder = {
...
implicit def toSpotInstanceRequestBuilderOps(v: SpotInstanceRequest.Builder): SpotInstanceRequestBuilderOps = new SpotInstanceRequestBuilderOps(v)
