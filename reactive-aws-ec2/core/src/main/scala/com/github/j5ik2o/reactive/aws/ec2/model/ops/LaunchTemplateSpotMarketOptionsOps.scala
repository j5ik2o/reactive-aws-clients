...
final class LaunchTemplateSpotMarketOptionsBuilderOps(val self: LaunchTemplateSpotMarketOptions.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def instanceInterruptionBehaviorAsScala(value: Option[InstanceInterruptionBehavior]): LaunchTemplateSpotMarketOptions.Builder = {
...
implicit def toLaunchTemplateSpotMarketOptionsBuilderOps(v: LaunchTemplateSpotMarketOptions.Builder): LaunchTemplateSpotMarketOptionsBuilderOps = new LaunchTemplateSpotMarketOptionsBuilderOps(v)

implicit def toLaunchTemplateSpotMarketOptionsOps(v: LaunchTemplateSpotMarketOptions): LaunchTemplateSpotMarketOptionsOps = new LaunchTemplateSpotMarketOptionsOps(v)
