...
final class RunInstancesRequestBuilderOps(val self: RunInstancesRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.minCount(v) }
            } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def networkInterfacesAsScala(value: Option[Seq[InstanceNetworkInterfaceSpecification]]): RunInstancesRequest.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def elasticGpuSpecificationAsScala(value: Option[Seq[ElasticGpuSpecification]]): RunInstancesRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.elasticGpuSpecification(v.asJava) } 
            }

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def elasticInferenceAcceleratorsAsScala(value: Option[Seq[ElasticInferenceAccelerator]]): RunInstancesRequest.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def capacityReservationSpecificationAsScala(value: Option[CapacityReservationSpecification]): RunInstancesRequest.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def licenseSpecificationsAsScala(value: Option[Seq[LicenseConfigurationRequest]]): RunInstancesRequest.Builder = {
...
final class RunInstancesRequestOps(val self: RunInstancesRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def elasticGpuSpecificationAsScala: Option[Seq[ElasticGpuSpecification]] = Option(self.elasticGpuSpecification).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def elasticInferenceAcceleratorsAsScala: Option[Seq[ElasticInferenceAccelerator]] = Option(self.elasticInferenceAccelerators).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def capacityReservationSpecificationAsScala: Option[CapacityReservationSpecification] = Option(self.capacityReservationSpecification) 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def hibernationOptionsAsScala: Option[HibernationOptionsRequest] = Option(self.hibernationOptions) 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def licenseSpecificationsAsScala: Option[Seq[LicenseConfigurationRequest]] = Option(self.licenseSpecifications).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toRunInstancesRequestBuilderOps(v: RunInstancesRequest.Builder): RunInstancesRequestBuilderOps = new RunInstancesRequestBuilderOps(v)
