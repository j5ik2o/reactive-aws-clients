...
final class TransitGatewayAssociationBuilderOps(val self: TransitGatewayAssociation.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def resourceTypeAsScala(value: Option[TransitGatewayAttachmentResourceType]): TransitGatewayAssociation.Builder = {
...
implicit def toTransitGatewayAssociationBuilderOps(v: TransitGatewayAssociation.Builder): TransitGatewayAssociationBuilderOps = new TransitGatewayAssociationBuilderOps(v)

implicit def toTransitGatewayAssociationOps(v: TransitGatewayAssociation): TransitGatewayAssociationOps = new TransitGatewayAssociationOps(v)
