...
final class TransitGatewayPropagationBuilderOps(val self: TransitGatewayPropagation.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def resourceTypeAsScala(value: Option[TransitGatewayAttachmentResourceType]): TransitGatewayPropagation.Builder = {
...
implicit def toTransitGatewayPropagationBuilderOps(v: TransitGatewayPropagation.Builder): TransitGatewayPropagationBuilderOps = new TransitGatewayPropagationBuilderOps(v)

implicit def toTransitGatewayPropagationOps(v: TransitGatewayPropagation): TransitGatewayPropagationOps = new TransitGatewayPropagationOps(v)
