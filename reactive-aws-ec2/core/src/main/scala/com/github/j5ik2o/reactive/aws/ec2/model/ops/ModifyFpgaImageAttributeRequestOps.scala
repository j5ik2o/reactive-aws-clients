...
final class ModifyFpgaImageAttributeRequestBuilderOps(val self: ModifyFpgaImageAttributeRequest.Builder)
  ...
  final def userGroupsAsScala(value: Option[Seq[String]]): ModifyFpgaImageAttributeRequest.Builder = {
    value.filter(_.nonEmpty).fold(self) { v =>
      import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.userGroups(v.asJava)
    }
  }
...
final class ModifyFpgaImageAttributeRequestOps(val self: ModifyFpgaImageAttributeRequest) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def userIdsAsScala: Option[Seq[String]] =
    Option(self.userIds).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def userGroupsAsScala: Option[Seq[String]] =
    Option(self.userGroups).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def productCodesAsScala: Option[Seq[String]] =
