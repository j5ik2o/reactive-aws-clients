...
final class LaunchTemplateCpuOptionsRequestBuilderOps(val self: LaunchTemplateCpuOptionsRequest.Builder) extends AnyVal {
...
implicit def toLaunchTemplateCpuOptionsRequestBuilderOps(v: LaunchTemplateCpuOptionsRequest.Builder): LaunchTemplateCpuOptionsRequestBuilderOps = new LaunchTemplateCpuOptionsRequestBuilderOps(v)

implicit def toLaunchTemplateCpuOptionsRequestOps(v: LaunchTemplateCpuOptionsRequest): LaunchTemplateCpuOptionsRequestOps = new LaunchTemplateCpuOptionsRequestOps(v)
