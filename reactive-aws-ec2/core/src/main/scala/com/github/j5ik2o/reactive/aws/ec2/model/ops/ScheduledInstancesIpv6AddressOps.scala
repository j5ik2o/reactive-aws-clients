...
trait ToScheduledInstancesIpv6AddressOps {
  ...
  implicit def toScheduledInstancesIpv6AddressBuilderOps(
      v: ScheduledInstancesIpv6Address.Builder
  ): ScheduledInstancesIpv6AddressBuilderOps = new ScheduledInstancesIpv6AddressBuilderOps(v)

  implicit def toScheduledInstancesIpv6AddressOps(v: ScheduledInstancesIpv6Address): ScheduledInstancesIpv6AddressOps =
    new ScheduledInstancesIpv6AddressOps(v)
