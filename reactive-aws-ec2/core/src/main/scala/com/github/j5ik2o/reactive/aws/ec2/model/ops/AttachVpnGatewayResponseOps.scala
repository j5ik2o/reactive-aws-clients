...
implicit def toAttachVpnGatewayResponseBuilderOps(v: AttachVpnGatewayResponse.Builder): AttachVpnGatewayResponseBuilderOps = new AttachVpnGatewayResponseBuilderOps(v)

implicit def toAttachVpnGatewayResponseOps(v: AttachVpnGatewayResponse): AttachVpnGatewayResponseOps = new AttachVpnGatewayResponseOps(v)
