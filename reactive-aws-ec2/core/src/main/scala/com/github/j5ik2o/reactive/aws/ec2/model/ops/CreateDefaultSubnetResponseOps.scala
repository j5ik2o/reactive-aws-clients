...
trait ToCreateDefaultSubnetResponseOps {
  ...
  implicit def toCreateDefaultSubnetResponseBuilderOps(
      v: CreateDefaultSubnetResponse.Builder
  ): CreateDefaultSubnetResponseBuilderOps = new CreateDefaultSubnetResponseBuilderOps(v)

  implicit def toCreateDefaultSubnetResponseOps(v: CreateDefaultSubnetResponse): CreateDefaultSubnetResponseOps =
    new CreateDefaultSubnetResponseOps(v)
