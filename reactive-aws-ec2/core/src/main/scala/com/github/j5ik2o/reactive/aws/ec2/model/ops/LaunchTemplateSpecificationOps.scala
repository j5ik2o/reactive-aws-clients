...
implicit def toLaunchTemplateSpecificationBuilderOps(v: LaunchTemplateSpecification.Builder): LaunchTemplateSpecificationBuilderOps = new LaunchTemplateSpecificationBuilderOps(v)

implicit def toLaunchTemplateSpecificationOps(v: LaunchTemplateSpecification): LaunchTemplateSpecificationOps = new LaunchTemplateSpecificationOps(v)
