...
final class DescribeBundleTasksRequestBuilderOps(val self: DescribeBundleTasksRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def bundleIdsAsScala(value: Option[Seq[String]]): DescribeBundleTasksRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.bundleIds(v.asJava) } 
            }
...
final class DescribeBundleTasksRequestOps(val self: DescribeBundleTasksRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def bundleIdsAsScala: Option[Seq[String]] = Option(self.bundleIds).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toDescribeBundleTasksRequestBuilderOps(v: DescribeBundleTasksRequest.Builder): DescribeBundleTasksRequestBuilderOps = new DescribeBundleTasksRequestBuilderOps(v)

implicit def toDescribeBundleTasksRequestOps(v: DescribeBundleTasksRequest): DescribeBundleTasksRequestOps = new DescribeBundleTasksRequestOps(v)
