...
implicit def toCreateNetworkAclRequestBuilderOps(v: CreateNetworkAclRequest.Builder): CreateNetworkAclRequestBuilderOps = new CreateNetworkAclRequestBuilderOps(v)

implicit def toCreateNetworkAclRequestOps(v: CreateNetworkAclRequest): CreateNetworkAclRequestOps = new CreateNetworkAclRequestOps(v)
