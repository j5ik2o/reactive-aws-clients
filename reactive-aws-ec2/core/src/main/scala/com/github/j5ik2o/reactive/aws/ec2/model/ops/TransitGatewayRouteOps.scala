...
final class TransitGatewayRouteBuilderOps(val self: TransitGatewayRoute.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def transitGatewayAttachmentsAsScala(value: Option[Seq[TransitGatewayRouteAttachment]]): TransitGatewayRoute.Builder = {
...
final class TransitGatewayRouteOps(val self: TransitGatewayRoute) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def transitGatewayAttachmentsAsScala: Option[Seq[TransitGatewayRouteAttachment]] = Option(self.transitGatewayAttachments).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toTransitGatewayRouteBuilderOps(v: TransitGatewayRoute.Builder): TransitGatewayRouteBuilderOps = new TransitGatewayRouteBuilderOps(v)
