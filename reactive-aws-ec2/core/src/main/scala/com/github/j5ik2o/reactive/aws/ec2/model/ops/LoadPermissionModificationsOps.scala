...
final class LoadPermissionModificationsOps(val self: LoadPermissionModifications) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def addAsScala: Option[Seq[LoadPermissionRequest]] = Option(self.add).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def removeAsScala: Option[Seq[LoadPermissionRequest]] = Option(self.remove).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toLoadPermissionModificationsBuilderOps(v: LoadPermissionModifications.Builder): LoadPermissionModificationsBuilderOps = new LoadPermissionModificationsBuilderOps(v)

implicit def toLoadPermissionModificationsOps(v: LoadPermissionModifications): LoadPermissionModificationsOps = new LoadPermissionModificationsOps(v)
