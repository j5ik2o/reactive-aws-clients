...
implicit def toDirectoryServiceAuthenticationBuilderOps(v: DirectoryServiceAuthentication.Builder): DirectoryServiceAuthenticationBuilderOps = new DirectoryServiceAuthenticationBuilderOps(v)

implicit def toDirectoryServiceAuthenticationOps(v: DirectoryServiceAuthentication): DirectoryServiceAuthenticationOps = new DirectoryServiceAuthenticationOps(v)
