...
trait ToRequestSpotFleetResponseOps {
  ...
  implicit def toRequestSpotFleetResponseBuilderOps(
      v: RequestSpotFleetResponse.Builder
  ): RequestSpotFleetResponseBuilderOps = new RequestSpotFleetResponseBuilderOps(v)

  implicit def toRequestSpotFleetResponseOps(v: RequestSpotFleetResponse): RequestSpotFleetResponseOps =
    new RequestSpotFleetResponseOps(v)
