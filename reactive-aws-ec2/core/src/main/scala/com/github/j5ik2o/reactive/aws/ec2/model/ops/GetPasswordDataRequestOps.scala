...
implicit def toGetPasswordDataRequestBuilderOps(v: GetPasswordDataRequest.Builder): GetPasswordDataRequestBuilderOps = new GetPasswordDataRequestBuilderOps(v)

implicit def toGetPasswordDataRequestOps(v: GetPasswordDataRequest): GetPasswordDataRequestOps = new GetPasswordDataRequestOps(v)
