...
final class CreateNetworkInterfacePermissionRequestBuilderOps(val self: CreateNetworkInterfacePermissionRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def permissionAsScala(value: Option[InterfacePermissionType]): CreateNetworkInterfacePermissionRequest.Builder = {
...
final class CreateNetworkInterfacePermissionRequestOps(val self: CreateNetworkInterfacePermissionRequest) extends AnyVal {
...
implicit def toCreateNetworkInterfacePermissionRequestBuilderOps(v: CreateNetworkInterfacePermissionRequest.Builder): CreateNetworkInterfacePermissionRequestBuilderOps = new CreateNetworkInterfacePermissionRequestBuilderOps(v)

implicit def toCreateNetworkInterfacePermissionRequestOps(v: CreateNetworkInterfacePermissionRequest): CreateNetworkInterfacePermissionRequestOps = new CreateNetworkInterfacePermissionRequestOps(v)
