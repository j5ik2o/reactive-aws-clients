...
final class ReplaceRouteTableAssociationRequestBuilderOps(val self: ReplaceRouteTableAssociationRequest.Builder) extends AnyVal {
...
implicit def toReplaceRouteTableAssociationRequestBuilderOps(v: ReplaceRouteTableAssociationRequest.Builder): ReplaceRouteTableAssociationRequestBuilderOps = new ReplaceRouteTableAssociationRequestBuilderOps(v)

implicit def toReplaceRouteTableAssociationRequestOps(v: ReplaceRouteTableAssociationRequest): ReplaceRouteTableAssociationRequestOps = new ReplaceRouteTableAssociationRequestOps(v)
