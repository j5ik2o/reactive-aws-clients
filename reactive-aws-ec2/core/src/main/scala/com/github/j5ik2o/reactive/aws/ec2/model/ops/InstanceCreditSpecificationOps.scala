...
implicit def toInstanceCreditSpecificationBuilderOps(v: InstanceCreditSpecification.Builder): InstanceCreditSpecificationBuilderOps = new InstanceCreditSpecificationBuilderOps(v)

implicit def toInstanceCreditSpecificationOps(v: InstanceCreditSpecification): InstanceCreditSpecificationOps = new InstanceCreditSpecificationOps(v)
