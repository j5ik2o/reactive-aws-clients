...
final class ModifyVpcEndpointRequestBuilderOps(val self: ModifyVpcEndpointRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def addRouteTableIdsAsScala(value: Option[Seq[String]]): ModifyVpcEndpointRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.addRouteTableIds(v.asJava) } 
            }

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def removeRouteTableIdsAsScala(value: Option[Seq[String]]): ModifyVpcEndpointRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.removeRouteTableIds(v.asJava) } 
            }
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def addSecurityGroupIdsAsScala(value: Option[Seq[String]]): ModifyVpcEndpointRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.addSecurityGroupIds(v.asJava) } 
            }

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def removeSecurityGroupIdsAsScala(value: Option[Seq[String]]): ModifyVpcEndpointRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.removeSecurityGroupIds(v.asJava) } 
            }
...
final class ModifyVpcEndpointRequestOps(val self: ModifyVpcEndpointRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def addRouteTableIdsAsScala: Option[Seq[String]] = Option(self.addRouteTableIds).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def removeRouteTableIdsAsScala: Option[Seq[String]] = Option(self.removeRouteTableIds).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def addSecurityGroupIdsAsScala: Option[Seq[String]] = Option(self.addSecurityGroupIds).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def removeSecurityGroupIdsAsScala: Option[Seq[String]] = Option(self.removeSecurityGroupIds).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toModifyVpcEndpointRequestBuilderOps(v: ModifyVpcEndpointRequest.Builder): ModifyVpcEndpointRequestBuilderOps = new ModifyVpcEndpointRequestBuilderOps(v)

implicit def toModifyVpcEndpointRequestOps(v: ModifyVpcEndpointRequest): ModifyVpcEndpointRequestOps = new ModifyVpcEndpointRequestOps(v)
