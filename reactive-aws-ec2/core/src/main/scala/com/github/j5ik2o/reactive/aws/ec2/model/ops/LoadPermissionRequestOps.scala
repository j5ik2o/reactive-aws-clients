...
trait ToLoadPermissionRequestOps {
  ...
  implicit def toLoadPermissionRequestBuilderOps(v: LoadPermissionRequest.Builder): LoadPermissionRequestBuilderOps =
    new LoadPermissionRequestBuilderOps(v)

  implicit def toLoadPermissionRequestOps(v: LoadPermissionRequest): LoadPermissionRequestOps =
    new LoadPermissionRequestOps(v)
