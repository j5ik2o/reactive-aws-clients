...
final class ModifySnapshotAttributeRequestBuilderOps(val self: ModifySnapshotAttributeRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def createVolumePermissionAsScala(value: Option[CreateVolumePermissionModifications]): ModifySnapshotAttributeRequest.Builder = {
            value.fold(self){ v => self.createVolumePermission(v) }
            } 
...
final class ModifySnapshotAttributeRequestOps(val self: ModifySnapshotAttributeRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def createVolumePermissionAsScala: Option[CreateVolumePermissionModifications] = Option(self.createVolumePermission) 
...
implicit def toModifySnapshotAttributeRequestBuilderOps(v: ModifySnapshotAttributeRequest.Builder): ModifySnapshotAttributeRequestBuilderOps = new ModifySnapshotAttributeRequestBuilderOps(v)

implicit def toModifySnapshotAttributeRequestOps(v: ModifySnapshotAttributeRequest): ModifySnapshotAttributeRequestOps = new ModifySnapshotAttributeRequestOps(v)
