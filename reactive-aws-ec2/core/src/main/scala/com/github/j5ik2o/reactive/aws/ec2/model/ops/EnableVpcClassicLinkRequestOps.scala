...
implicit def toEnableVpcClassicLinkRequestBuilderOps(v: EnableVpcClassicLinkRequest.Builder): EnableVpcClassicLinkRequestBuilderOps = new EnableVpcClassicLinkRequestBuilderOps(v)

implicit def toEnableVpcClassicLinkRequestOps(v: EnableVpcClassicLinkRequest): EnableVpcClassicLinkRequestOps = new EnableVpcClassicLinkRequestOps(v)
