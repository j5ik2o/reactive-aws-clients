...
final class VpcPeeringConnectionBuilderOps(val self: VpcPeeringConnection.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.accepterVpcInfo(v) }
            } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.requesterVpcInfo(v) }
            } 
...
implicit def toVpcPeeringConnectionBuilderOps(v: VpcPeeringConnection.Builder): VpcPeeringConnectionBuilderOps = new VpcPeeringConnectionBuilderOps(v)

implicit def toVpcPeeringConnectionOps(v: VpcPeeringConnection): VpcPeeringConnectionOps = new VpcPeeringConnectionOps(v)
