...
final class InstanceNetworkInterfaceBuilderOps(val self: InstanceNetworkInterface.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def privateIpAddressesAsScala(value: Option[Seq[InstancePrivateIpAddress]]): InstanceNetworkInterface.Builder = {
...
final class InstanceNetworkInterfaceOps(val self: InstanceNetworkInterface) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def privateIpAddressesAsScala: Option[Seq[InstancePrivateIpAddress]] = Option(self.privateIpAddresses).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toInstanceNetworkInterfaceBuilderOps(v: InstanceNetworkInterface.Builder): InstanceNetworkInterfaceBuilderOps = new InstanceNetworkInterfaceBuilderOps(v)

implicit def toInstanceNetworkInterfaceOps(v: InstanceNetworkInterface): InstanceNetworkInterfaceOps = new InstanceNetworkInterfaceOps(v)
