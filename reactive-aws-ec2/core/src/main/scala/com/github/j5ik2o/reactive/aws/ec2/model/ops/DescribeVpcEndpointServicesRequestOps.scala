...
final class DescribeVpcEndpointServicesRequestBuilderOps(val self: DescribeVpcEndpointServicesRequest.Builder) extends AnyVal {
...
implicit def toDescribeVpcEndpointServicesRequestBuilderOps(v: DescribeVpcEndpointServicesRequest.Builder): DescribeVpcEndpointServicesRequestBuilderOps = new DescribeVpcEndpointServicesRequestBuilderOps(v)

implicit def toDescribeVpcEndpointServicesRequestOps(v: DescribeVpcEndpointServicesRequest): DescribeVpcEndpointServicesRequestOps = new DescribeVpcEndpointServicesRequestOps(v)
