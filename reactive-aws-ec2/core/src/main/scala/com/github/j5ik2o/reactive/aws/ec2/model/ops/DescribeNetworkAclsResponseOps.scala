...
final class DescribeNetworkAclsResponseOps(val self: DescribeNetworkAclsResponse) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def networkAclsAsScala: Option[Seq[NetworkAcl]] =
    Option(self.networkAcls).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
