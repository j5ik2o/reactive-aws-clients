...
final class TransitGatewayAttachmentAssociationBuilderOps(val self: TransitGatewayAttachmentAssociation.Builder) extends AnyVal {
...
implicit def toTransitGatewayAttachmentAssociationBuilderOps(v: TransitGatewayAttachmentAssociation.Builder): TransitGatewayAttachmentAssociationBuilderOps = new TransitGatewayAttachmentAssociationBuilderOps(v)

implicit def toTransitGatewayAttachmentAssociationOps(v: TransitGatewayAttachmentAssociation): TransitGatewayAttachmentAssociationOps = new TransitGatewayAttachmentAssociationOps(v)
