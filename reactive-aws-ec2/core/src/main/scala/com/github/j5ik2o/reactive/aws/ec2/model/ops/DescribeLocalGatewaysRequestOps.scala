...
final class DescribeLocalGatewaysRequestBuilderOps(val self: DescribeLocalGatewaysRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def localGatewayIdsAsScala(value: Option[Seq[String]]): DescribeLocalGatewaysRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.localGatewayIds(v.asJava) } 
            }
...
final class DescribeLocalGatewaysRequestOps(val self: DescribeLocalGatewaysRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def localGatewayIdsAsScala: Option[Seq[String]] = Option(self.localGatewayIds).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toDescribeLocalGatewaysRequestBuilderOps(v: DescribeLocalGatewaysRequest.Builder): DescribeLocalGatewaysRequestBuilderOps = new DescribeLocalGatewaysRequestBuilderOps(v)

implicit def toDescribeLocalGatewaysRequestOps(v: DescribeLocalGatewaysRequest): DescribeLocalGatewaysRequestOps = new DescribeLocalGatewaysRequestOps(v)
