...
implicit def toCreateClientVpnRouteResponseBuilderOps(v: CreateClientVpnRouteResponse.Builder): CreateClientVpnRouteResponseBuilderOps = new CreateClientVpnRouteResponseBuilderOps(v)

implicit def toCreateClientVpnRouteResponseOps(v: CreateClientVpnRouteResponse): CreateClientVpnRouteResponseOps = new CreateClientVpnRouteResponseOps(v)
