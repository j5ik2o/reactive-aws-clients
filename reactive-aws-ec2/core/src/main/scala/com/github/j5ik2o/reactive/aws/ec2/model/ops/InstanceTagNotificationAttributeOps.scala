...
final class InstanceTagNotificationAttributeBuilderOps(val self: InstanceTagNotificationAttribute.Builder)
    extends AnyVal {
  ...
  final def includeAllTagsOfInstanceAsScala(value: Option[Boolean]): InstanceTagNotificationAttribute.Builder = {
    value.fold(self) { v =>
      self.includeAllTagsOfInstance(v)
    }
  }
...
final class InstanceTagNotificationAttributeOps(val self: InstanceTagNotificationAttribute) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def instanceTagKeysAsScala: Option[Seq[String]] = Option(self.instanceTagKeys).map { v =>
...
trait ToInstanceTagNotificationAttributeOps {
  ...
  implicit def toInstanceTagNotificationAttributeBuilderOps(
      v: InstanceTagNotificationAttribute.Builder
  ): InstanceTagNotificationAttributeBuilderOps = new InstanceTagNotificationAttributeBuilderOps(v)

  implicit def toInstanceTagNotificationAttributeOps(
      v: InstanceTagNotificationAttribute
  ): InstanceTagNotificationAttributeOps = new InstanceTagNotificationAttributeOps(v)
