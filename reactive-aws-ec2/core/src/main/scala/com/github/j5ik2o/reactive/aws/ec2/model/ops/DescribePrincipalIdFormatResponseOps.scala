...
final class DescribePrincipalIdFormatResponseOps(val self: DescribePrincipalIdFormatResponse) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def principalsAsScala: Option[Seq[PrincipalIdFormat]] =
    Option(self.principals).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
