...
final class VolumeStatusItemOps(val self: VolumeStatusItem) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def actionsAsScala: Option[Seq[VolumeStatusAction]] =
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def eventsAsScala: Option[Seq[VolumeStatusEvent]] =
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def attachmentStatusesAsScala: Option[Seq[VolumeStatusAttachmentStatus]] =
    Option(self.attachmentStatuses).map { v =>
