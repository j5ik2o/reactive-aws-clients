...
final class VolumeStatusItemBuilderOps(val self: VolumeStatusItem.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def actionsAsScala(value: Option[Seq[VolumeStatusAction]]): VolumeStatusItem.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.actions(v.asJava) } 
            }
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.volumeStatus(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def attachmentStatusesAsScala(value: Option[Seq[VolumeStatusAttachmentStatus]]): VolumeStatusItem.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.attachmentStatuses(v.asJava) } 
            }
...
final class VolumeStatusItemOps(val self: VolumeStatusItem) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def actionsAsScala: Option[Seq[VolumeStatusAction]] = Option(self.actions).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def eventsAsScala: Option[Seq[VolumeStatusEvent]] = Option(self.events).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def attachmentStatusesAsScala: Option[Seq[VolumeStatusAttachmentStatus]] = Option(self.attachmentStatuses).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toVolumeStatusItemBuilderOps(v: VolumeStatusItem.Builder): VolumeStatusItemBuilderOps = new VolumeStatusItemBuilderOps(v)
