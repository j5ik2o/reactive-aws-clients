...
implicit def toConnectionLogResponseOptionsBuilderOps(v: ConnectionLogResponseOptions.Builder): ConnectionLogResponseOptionsBuilderOps = new ConnectionLogResponseOptionsBuilderOps(v)

implicit def toConnectionLogResponseOptionsOps(v: ConnectionLogResponseOptions): ConnectionLogResponseOptionsOps = new ConnectionLogResponseOptionsOps(v)
