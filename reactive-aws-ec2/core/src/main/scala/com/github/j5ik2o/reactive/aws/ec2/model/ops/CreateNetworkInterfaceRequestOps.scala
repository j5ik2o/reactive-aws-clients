...
final class CreateNetworkInterfaceRequestBuilderOps(val self: CreateNetworkInterfaceRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def privateIpAddressesAsScala(value: Option[Seq[PrivateIpAddressSpecification]]): CreateNetworkInterfaceRequest.Builder = {
...
implicit def toCreateNetworkInterfaceRequestBuilderOps(v: CreateNetworkInterfaceRequest.Builder): CreateNetworkInterfaceRequestBuilderOps = new CreateNetworkInterfaceRequestBuilderOps(v)

implicit def toCreateNetworkInterfaceRequestOps(v: CreateNetworkInterfaceRequest): CreateNetworkInterfaceRequestOps = new CreateNetworkInterfaceRequestOps(v)
