...
final class SubnetOps(val self: Subnet) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def ipv6CidrBlockAssociationSetAsScala: Option[Seq[SubnetIpv6CidrBlockAssociation]] = Option(self.ipv6CidrBlockAssociationSet).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
