...
implicit def toInstanceIpv6AddressRequestBuilderOps(v: InstanceIpv6AddressRequest.Builder): InstanceIpv6AddressRequestBuilderOps = new InstanceIpv6AddressRequestBuilderOps(v)

implicit def toInstanceIpv6AddressRequestOps(v: InstanceIpv6AddressRequest): InstanceIpv6AddressRequestOps = new InstanceIpv6AddressRequestOps(v)
