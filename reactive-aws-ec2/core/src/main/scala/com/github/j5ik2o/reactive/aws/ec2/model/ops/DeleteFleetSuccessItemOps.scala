...
implicit def toDeleteFleetSuccessItemBuilderOps(v: DeleteFleetSuccessItem.Builder): DeleteFleetSuccessItemBuilderOps = new DeleteFleetSuccessItemBuilderOps(v)

implicit def toDeleteFleetSuccessItemOps(v: DeleteFleetSuccessItem): DeleteFleetSuccessItemOps = new DeleteFleetSuccessItemOps(v)
