...
trait ToFpgaDeviceMemoryInfoOps {
  ...
  implicit def toFpgaDeviceMemoryInfoBuilderOps(v: FpgaDeviceMemoryInfo.Builder): FpgaDeviceMemoryInfoBuilderOps =
    new FpgaDeviceMemoryInfoBuilderOps(v)

  implicit def toFpgaDeviceMemoryInfoOps(v: FpgaDeviceMemoryInfo): FpgaDeviceMemoryInfoOps =
    new FpgaDeviceMemoryInfoOps(v)
