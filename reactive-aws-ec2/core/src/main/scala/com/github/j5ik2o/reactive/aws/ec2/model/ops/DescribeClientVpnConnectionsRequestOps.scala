...
final class DescribeClientVpnConnectionsRequestBuilderOps(val self: DescribeClientVpnConnectionsRequest.Builder) extends AnyVal {
...
implicit def toDescribeClientVpnConnectionsRequestBuilderOps(v: DescribeClientVpnConnectionsRequest.Builder): DescribeClientVpnConnectionsRequestBuilderOps = new DescribeClientVpnConnectionsRequestBuilderOps(v)

implicit def toDescribeClientVpnConnectionsRequestOps(v: DescribeClientVpnConnectionsRequest): DescribeClientVpnConnectionsRequestOps = new DescribeClientVpnConnectionsRequestOps(v)
