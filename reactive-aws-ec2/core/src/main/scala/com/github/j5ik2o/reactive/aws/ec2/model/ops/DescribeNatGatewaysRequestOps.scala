...
final class DescribeNatGatewaysRequestBuilderOps(val self: DescribeNatGatewaysRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def natGatewayIdsAsScala(value: Option[Seq[String]]): DescribeNatGatewaysRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.natGatewayIds(v.asJava) } 
            }
...
final class DescribeNatGatewaysRequestOps(val self: DescribeNatGatewaysRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def natGatewayIdsAsScala: Option[Seq[String]] = Option(self.natGatewayIds).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toDescribeNatGatewaysRequestBuilderOps(v: DescribeNatGatewaysRequest.Builder): DescribeNatGatewaysRequestBuilderOps = new DescribeNatGatewaysRequestBuilderOps(v)

implicit def toDescribeNatGatewaysRequestOps(v: DescribeNatGatewaysRequest): DescribeNatGatewaysRequestOps = new DescribeNatGatewaysRequestOps(v)
