...
implicit def toCreateSnapshotResponseBuilderOps(v: CreateSnapshotResponse.Builder): CreateSnapshotResponseBuilderOps = new CreateSnapshotResponseBuilderOps(v)

implicit def toCreateSnapshotResponseOps(v: CreateSnapshotResponse): CreateSnapshotResponseOps = new CreateSnapshotResponseOps(v)
