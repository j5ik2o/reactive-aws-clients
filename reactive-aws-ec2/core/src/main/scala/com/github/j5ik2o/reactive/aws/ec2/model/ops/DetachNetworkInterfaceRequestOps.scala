...
implicit def toDetachNetworkInterfaceRequestBuilderOps(v: DetachNetworkInterfaceRequest.Builder): DetachNetworkInterfaceRequestBuilderOps = new DetachNetworkInterfaceRequestBuilderOps(v)

implicit def toDetachNetworkInterfaceRequestOps(v: DetachNetworkInterfaceRequest): DetachNetworkInterfaceRequestOps = new DetachNetworkInterfaceRequestOps(v)
