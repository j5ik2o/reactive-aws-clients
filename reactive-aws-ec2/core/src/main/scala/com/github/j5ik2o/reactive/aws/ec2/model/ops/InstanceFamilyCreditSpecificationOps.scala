...
final class InstanceFamilyCreditSpecificationBuilderOps(val self: InstanceFamilyCreditSpecification.Builder)
    extends AnyVal {
...
trait ToInstanceFamilyCreditSpecificationOps {
  ...
  implicit def toInstanceFamilyCreditSpecificationBuilderOps(
      v: InstanceFamilyCreditSpecification.Builder
  ): InstanceFamilyCreditSpecificationBuilderOps = new InstanceFamilyCreditSpecificationBuilderOps(v)

  implicit def toInstanceFamilyCreditSpecificationOps(
      v: InstanceFamilyCreditSpecification
  ): InstanceFamilyCreditSpecificationOps = new InstanceFamilyCreditSpecificationOps(v)
