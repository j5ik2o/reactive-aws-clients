...
final class LocalGatewayVirtualInterfaceBuilderOps(val self: LocalGatewayVirtualInterface.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.localGatewayVirtualInterfaceId(v) }
            } 
...
implicit def toLocalGatewayVirtualInterfaceBuilderOps(v: LocalGatewayVirtualInterface.Builder): LocalGatewayVirtualInterfaceBuilderOps = new LocalGatewayVirtualInterfaceBuilderOps(v)

implicit def toLocalGatewayVirtualInterfaceOps(v: LocalGatewayVirtualInterface): LocalGatewayVirtualInterfaceOps = new LocalGatewayVirtualInterfaceOps(v)
