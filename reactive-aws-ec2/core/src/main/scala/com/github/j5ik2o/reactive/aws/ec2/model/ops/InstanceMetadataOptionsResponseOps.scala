...
final class InstanceMetadataOptionsResponseBuilderOps(val self: InstanceMetadataOptionsResponse.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def httpEndpointAsScala(value: Option[InstanceMetadataEndpointState]): InstanceMetadataOptionsResponse.Builder = {
...
implicit def toInstanceMetadataOptionsResponseBuilderOps(v: InstanceMetadataOptionsResponse.Builder): InstanceMetadataOptionsResponseBuilderOps = new InstanceMetadataOptionsResponseBuilderOps(v)

implicit def toInstanceMetadataOptionsResponseOps(v: InstanceMetadataOptionsResponse): InstanceMetadataOptionsResponseOps = new InstanceMetadataOptionsResponseOps(v)
