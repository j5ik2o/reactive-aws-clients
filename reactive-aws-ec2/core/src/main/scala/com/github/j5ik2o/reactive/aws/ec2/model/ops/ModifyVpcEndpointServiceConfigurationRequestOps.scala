...
final class ModifyVpcEndpointServiceConfigurationRequestOps(val self: ModifyVpcEndpointServiceConfigurationRequest)
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def addNetworkLoadBalancerArnsAsScala: Option[Seq[String]] =
    Option(self.addNetworkLoadBalancerArns).map { v =>
      import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala
    }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def removeNetworkLoadBalancerArnsAsScala: Option[Seq[String]] =
    Option(self.removeNetworkLoadBalancerArns).map { v =>
      import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala
    }
