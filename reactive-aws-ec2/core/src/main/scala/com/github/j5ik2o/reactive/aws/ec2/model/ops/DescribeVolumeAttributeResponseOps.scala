...
final class DescribeVolumeAttributeResponseBuilderOps(val self: DescribeVolumeAttributeResponse.Builder) extends AnyVal {

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def autoEnableIOAsScala(value: Option[AttributeBooleanValue]): DescribeVolumeAttributeResponse.Builder = {
            value.fold(self){ v => self.autoEnableIO(v) }
            } 
...
implicit def toDescribeVolumeAttributeResponseBuilderOps(v: DescribeVolumeAttributeResponse.Builder): DescribeVolumeAttributeResponseBuilderOps = new DescribeVolumeAttributeResponseBuilderOps(v)

implicit def toDescribeVolumeAttributeResponseOps(v: DescribeVolumeAttributeResponse): DescribeVolumeAttributeResponseOps = new DescribeVolumeAttributeResponseOps(v)
