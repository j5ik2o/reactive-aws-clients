...
final class SubnetIpv6CidrBlockAssociationBuilderOps(val self: SubnetIpv6CidrBlockAssociation.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.ipv6CidrBlockState(v) }
            } 
...
implicit def toSubnetIpv6CidrBlockAssociationBuilderOps(v: SubnetIpv6CidrBlockAssociation.Builder): SubnetIpv6CidrBlockAssociationBuilderOps = new SubnetIpv6CidrBlockAssociationBuilderOps(v)

implicit def toSubnetIpv6CidrBlockAssociationOps(v: SubnetIpv6CidrBlockAssociation): SubnetIpv6CidrBlockAssociationOps = new SubnetIpv6CidrBlockAssociationOps(v)
