...
implicit def toDescribeVpcAttributeResponseBuilderOps(v: DescribeVpcAttributeResponse.Builder): DescribeVpcAttributeResponseBuilderOps = new DescribeVpcAttributeResponseBuilderOps(v)

implicit def toDescribeVpcAttributeResponseOps(v: DescribeVpcAttributeResponse): DescribeVpcAttributeResponseOps = new DescribeVpcAttributeResponseOps(v)
