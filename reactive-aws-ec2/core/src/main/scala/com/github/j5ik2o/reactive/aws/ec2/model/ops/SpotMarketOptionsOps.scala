...
final class SpotMarketOptionsBuilderOps(val self: SpotMarketOptions.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def instanceInterruptionBehaviorAsScala(value: Option[InstanceInterruptionBehavior]): SpotMarketOptions.Builder = {
...
implicit def toSpotMarketOptionsBuilderOps(v: SpotMarketOptions.Builder): SpotMarketOptionsBuilderOps = new SpotMarketOptionsBuilderOps(v)
