...
implicit def toCopyFpgaImageResponseBuilderOps(v: CopyFpgaImageResponse.Builder): CopyFpgaImageResponseBuilderOps = new CopyFpgaImageResponseBuilderOps(v)

implicit def toCopyFpgaImageResponseOps(v: CopyFpgaImageResponse): CopyFpgaImageResponseOps = new CopyFpgaImageResponseOps(v)
