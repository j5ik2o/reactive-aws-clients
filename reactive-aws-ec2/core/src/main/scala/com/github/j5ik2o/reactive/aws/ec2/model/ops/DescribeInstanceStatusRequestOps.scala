...
implicit def toDescribeInstanceStatusRequestBuilderOps(v: DescribeInstanceStatusRequest.Builder): DescribeInstanceStatusRequestBuilderOps = new DescribeInstanceStatusRequestBuilderOps(v)

implicit def toDescribeInstanceStatusRequestOps(v: DescribeInstanceStatusRequest): DescribeInstanceStatusRequestOps = new DescribeInstanceStatusRequestOps(v)
