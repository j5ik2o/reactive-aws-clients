...
implicit def toCreatePlacementGroupResponseBuilderOps(v: CreatePlacementGroupResponse.Builder): CreatePlacementGroupResponseBuilderOps = new CreatePlacementGroupResponseBuilderOps(v)

implicit def toCreatePlacementGroupResponseOps(v: CreatePlacementGroupResponse): CreatePlacementGroupResponseOps = new CreatePlacementGroupResponseOps(v)
