...
implicit def toAssociatedTargetNetworkBuilderOps(v: AssociatedTargetNetwork.Builder): AssociatedTargetNetworkBuilderOps = new AssociatedTargetNetworkBuilderOps(v)

implicit def toAssociatedTargetNetworkOps(v: AssociatedTargetNetwork): AssociatedTargetNetworkOps = new AssociatedTargetNetworkOps(v)
