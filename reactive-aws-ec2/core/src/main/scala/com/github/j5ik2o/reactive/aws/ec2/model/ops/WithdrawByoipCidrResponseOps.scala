...
implicit def toWithdrawByoipCidrResponseBuilderOps(v: WithdrawByoipCidrResponse.Builder): WithdrawByoipCidrResponseBuilderOps = new WithdrawByoipCidrResponseBuilderOps(v)

implicit def toWithdrawByoipCidrResponseOps(v: WithdrawByoipCidrResponse): WithdrawByoipCidrResponseOps = new WithdrawByoipCidrResponseOps(v)
