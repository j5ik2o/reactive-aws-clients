...
final class DescribeInstanceTypeOfferingsRequestBuilderOps(val self: DescribeInstanceTypeOfferingsRequest.Builder)
    extends AnyVal {
...
trait ToDescribeInstanceTypeOfferingsRequestOps {
  ...
  implicit def toDescribeInstanceTypeOfferingsRequestBuilderOps(
      v: DescribeInstanceTypeOfferingsRequest.Builder
  ): DescribeInstanceTypeOfferingsRequestBuilderOps = new DescribeInstanceTypeOfferingsRequestBuilderOps(v)

  implicit def toDescribeInstanceTypeOfferingsRequestOps(
      v: DescribeInstanceTypeOfferingsRequest
  ): DescribeInstanceTypeOfferingsRequestOps = new DescribeInstanceTypeOfferingsRequestOps(v)
