...
implicit def toAssignedPrivateIpAddressBuilderOps(v: AssignedPrivateIpAddress.Builder): AssignedPrivateIpAddressBuilderOps = new AssignedPrivateIpAddressBuilderOps(v)

implicit def toAssignedPrivateIpAddressOps(v: AssignedPrivateIpAddress): AssignedPrivateIpAddressOps = new AssignedPrivateIpAddressOps(v)
