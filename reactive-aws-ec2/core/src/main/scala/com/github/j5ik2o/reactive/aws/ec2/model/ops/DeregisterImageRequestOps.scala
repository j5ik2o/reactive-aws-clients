...
implicit def toDeregisterImageRequestBuilderOps(v: DeregisterImageRequest.Builder): DeregisterImageRequestBuilderOps = new DeregisterImageRequestBuilderOps(v)

implicit def toDeregisterImageRequestOps(v: DeregisterImageRequest): DeregisterImageRequestOps = new DeregisterImageRequestOps(v)
