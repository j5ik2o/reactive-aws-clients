...
final class DescribeLaunchTemplateVersionsRequestBuilderOps(val self: DescribeLaunchTemplateVersionsRequest.Builder) extends AnyVal {
...
implicit def toDescribeLaunchTemplateVersionsRequestBuilderOps(v: DescribeLaunchTemplateVersionsRequest.Builder): DescribeLaunchTemplateVersionsRequestBuilderOps = new DescribeLaunchTemplateVersionsRequestBuilderOps(v)

implicit def toDescribeLaunchTemplateVersionsRequestOps(v: DescribeLaunchTemplateVersionsRequest): DescribeLaunchTemplateVersionsRequestOps = new DescribeLaunchTemplateVersionsRequestOps(v)
