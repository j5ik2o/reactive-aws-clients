...
trait ToEnableVolumeIoRequestOps {
  ...
  implicit def toEnableVolumeIoRequestBuilderOps(v: EnableVolumeIoRequest.Builder): EnableVolumeIoRequestBuilderOps =
    new EnableVolumeIoRequestBuilderOps(v)

  implicit def toEnableVolumeIoRequestOps(v: EnableVolumeIoRequest): EnableVolumeIoRequestOps =
    new EnableVolumeIoRequestOps(v)
