...
final class DescribeVpcEndpointConnectionsRequestBuilderOps(val self: DescribeVpcEndpointConnectionsRequest.Builder) extends AnyVal {
...
implicit def toDescribeVpcEndpointConnectionsRequestBuilderOps(v: DescribeVpcEndpointConnectionsRequest.Builder): DescribeVpcEndpointConnectionsRequestBuilderOps = new DescribeVpcEndpointConnectionsRequestBuilderOps(v)

implicit def toDescribeVpcEndpointConnectionsRequestOps(v: DescribeVpcEndpointConnectionsRequest): DescribeVpcEndpointConnectionsRequestOps = new DescribeVpcEndpointConnectionsRequestOps(v)
