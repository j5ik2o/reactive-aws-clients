...
final class ReplaceRouteRequestBuilderOps(val self: ReplaceRouteRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def localTargetAsScala(value: Option[Boolean]): ReplaceRouteRequest.Builder = {
            value.fold(self){ v => self.localTarget(v) }
            } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def localGatewayIdAsScala(value: Option[String]): ReplaceRouteRequest.Builder = {
...
final class ReplaceRouteRequestOps(val self: ReplaceRouteRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def localTargetAsScala: Option[Boolean] = Option(self.localTarget) 
...
implicit def toReplaceRouteRequestBuilderOps(v: ReplaceRouteRequest.Builder): ReplaceRouteRequestBuilderOps = new ReplaceRouteRequestBuilderOps(v)
