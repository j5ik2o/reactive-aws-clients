...
final class CreateInstanceExportTaskRequestBuilderOps(val self: CreateInstanceExportTaskRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def exportToS3TaskAsScala(value: Option[ExportToS3TaskSpecification]): CreateInstanceExportTaskRequest.Builder = {
...
implicit def toCreateInstanceExportTaskRequestBuilderOps(v: CreateInstanceExportTaskRequest.Builder): CreateInstanceExportTaskRequestBuilderOps = new CreateInstanceExportTaskRequestBuilderOps(v)

implicit def toCreateInstanceExportTaskRequestOps(v: CreateInstanceExportTaskRequest): CreateInstanceExportTaskRequestOps = new CreateInstanceExportTaskRequestOps(v)
