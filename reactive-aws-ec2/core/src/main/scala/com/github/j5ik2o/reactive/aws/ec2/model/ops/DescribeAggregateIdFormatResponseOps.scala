...
final class DescribeAggregateIdFormatResponseBuilderOps(val self: DescribeAggregateIdFormatResponse.Builder) extends AnyVal {

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def useLongIdsAggregatedAsScala(value: Option[Boolean]): DescribeAggregateIdFormatResponse.Builder = {
            value.fold(self){ v => self.useLongIdsAggregated(v) }
            } 
...
implicit def toDescribeAggregateIdFormatResponseBuilderOps(v: DescribeAggregateIdFormatResponse.Builder): DescribeAggregateIdFormatResponseBuilderOps = new DescribeAggregateIdFormatResponseBuilderOps(v)

implicit def toDescribeAggregateIdFormatResponseOps(v: DescribeAggregateIdFormatResponse): DescribeAggregateIdFormatResponseOps = new DescribeAggregateIdFormatResponseOps(v)
