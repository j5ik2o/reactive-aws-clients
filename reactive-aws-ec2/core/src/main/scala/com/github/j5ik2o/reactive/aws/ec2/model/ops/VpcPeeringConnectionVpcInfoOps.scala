...
final class VpcPeeringConnectionVpcInfoBuilderOps(val self: VpcPeeringConnectionVpcInfo.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def ipv6CidrBlockSetAsScala(value: Option[Seq[Ipv6CidrBlock]]): VpcPeeringConnectionVpcInfo.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.ipv6CidrBlockSet(v.asJava) } 
            }

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def cidrBlockSetAsScala(value: Option[Seq[CidrBlock]]): VpcPeeringConnectionVpcInfo.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.cidrBlockSet(v.asJava) } 
            }
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def peeringOptionsAsScala(value: Option[VpcPeeringConnectionOptionsDescription]): VpcPeeringConnectionVpcInfo.Builder = {
            value.fold(self){ v => self.peeringOptions(v) }
            } 
...
final class VpcPeeringConnectionVpcInfoOps(val self: VpcPeeringConnectionVpcInfo) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def ipv6CidrBlockSetAsScala: Option[Seq[Ipv6CidrBlock]] = Option(self.ipv6CidrBlockSet).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def cidrBlockSetAsScala: Option[Seq[CidrBlock]] = Option(self.cidrBlockSet).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toVpcPeeringConnectionVpcInfoBuilderOps(v: VpcPeeringConnectionVpcInfo.Builder): VpcPeeringConnectionVpcInfoBuilderOps = new VpcPeeringConnectionVpcInfoBuilderOps(v)

implicit def toVpcPeeringConnectionVpcInfoOps(v: VpcPeeringConnectionVpcInfo): VpcPeeringConnectionVpcInfoOps = new VpcPeeringConnectionVpcInfoOps(v)
