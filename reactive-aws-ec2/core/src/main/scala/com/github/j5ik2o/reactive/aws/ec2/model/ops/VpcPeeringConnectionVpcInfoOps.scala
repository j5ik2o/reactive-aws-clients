...
final class VpcPeeringConnectionVpcInfoOps(val self: VpcPeeringConnectionVpcInfo) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def ipv6CidrBlockSetAsScala: Option[Seq[Ipv6CidrBlock]] =
    Option(self.ipv6CidrBlockSet).map { v =>
      import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala
    }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def cidrBlockSetAsScala: Option[Seq[CidrBlock]] =
    Option(self.cidrBlockSet).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
