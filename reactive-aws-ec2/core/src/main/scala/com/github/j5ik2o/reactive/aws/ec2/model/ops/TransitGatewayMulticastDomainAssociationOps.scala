...
final class TransitGatewayMulticastDomainAssociationBuilderOps(
    val self: TransitGatewayMulticastDomainAssociation.Builder
) extends AnyVal {
...
final class TransitGatewayMulticastDomainAssociationOps(val self: TransitGatewayMulticastDomainAssociation)
    extends AnyVal {
...
trait ToTransitGatewayMulticastDomainAssociationOps {
  ...
  implicit def toTransitGatewayMulticastDomainAssociationBuilderOps(
      v: TransitGatewayMulticastDomainAssociation.Builder
  ): TransitGatewayMulticastDomainAssociationBuilderOps = new TransitGatewayMulticastDomainAssociationBuilderOps(v)

  implicit def toTransitGatewayMulticastDomainAssociationOps(
      v: TransitGatewayMulticastDomainAssociation
  ): TransitGatewayMulticastDomainAssociationOps = new TransitGatewayMulticastDomainAssociationOps(v)
