...
final class ModifyNetworkInterfaceAttributeRequestBuilderOps(val self: ModifyNetworkInterfaceAttributeRequest.Builder) extends AnyVal {

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def attachmentAsScala(value: Option[NetworkInterfaceAttachmentChanges]): ModifyNetworkInterfaceAttributeRequest.Builder = {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def sourceDestCheckAsScala(value: Option[AttributeBooleanValue]): ModifyNetworkInterfaceAttributeRequest.Builder = {
...
implicit def toModifyNetworkInterfaceAttributeRequestBuilderOps(v: ModifyNetworkInterfaceAttributeRequest.Builder): ModifyNetworkInterfaceAttributeRequestBuilderOps = new ModifyNetworkInterfaceAttributeRequestBuilderOps(v)

implicit def toModifyNetworkInterfaceAttributeRequestOps(v: ModifyNetworkInterfaceAttributeRequest): ModifyNetworkInterfaceAttributeRequestOps = new ModifyNetworkInterfaceAttributeRequestOps(v)
