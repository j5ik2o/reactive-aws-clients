...
final class DescribeVpnGatewaysResponseOps(val self: DescribeVpnGatewaysResponse) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def vpnGatewaysAsScala: Option[Seq[VpnGateway]] =
    Option(self.vpnGateways).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
