...
implicit def toWithdrawByoipCidrRequestBuilderOps(v: WithdrawByoipCidrRequest.Builder): WithdrawByoipCidrRequestBuilderOps = new WithdrawByoipCidrRequestBuilderOps(v)

implicit def toWithdrawByoipCidrRequestOps(v: WithdrawByoipCidrRequest): WithdrawByoipCidrRequestOps = new WithdrawByoipCidrRequestOps(v)
