...
final class ReservedInstancesBuilderOps(val self: ReservedInstances.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.start(v) }
            } 
...
implicit def toReservedInstancesBuilderOps(v: ReservedInstances.Builder): ReservedInstancesBuilderOps = new ReservedInstancesBuilderOps(v)
