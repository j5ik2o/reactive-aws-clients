...
implicit def toCreateVpnGatewayRequestBuilderOps(v: CreateVpnGatewayRequest.Builder): CreateVpnGatewayRequestBuilderOps = new CreateVpnGatewayRequestBuilderOps(v)

implicit def toCreateVpnGatewayRequestOps(v: CreateVpnGatewayRequest): CreateVpnGatewayRequestOps = new CreateVpnGatewayRequestOps(v)
