...
implicit def toDeleteNatGatewayRequestBuilderOps(v: DeleteNatGatewayRequest.Builder): DeleteNatGatewayRequestBuilderOps = new DeleteNatGatewayRequestBuilderOps(v)

implicit def toDeleteNatGatewayRequestOps(v: DeleteNatGatewayRequest): DeleteNatGatewayRequestOps = new DeleteNatGatewayRequestOps(v)
