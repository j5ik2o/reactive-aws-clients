...
final class CancelSpotFleetRequestsErrorItemBuilderOps(val self: CancelSpotFleetRequestsErrorItem.Builder) extends AnyVal {
...
implicit def toCancelSpotFleetRequestsErrorItemBuilderOps(v: CancelSpotFleetRequestsErrorItem.Builder): CancelSpotFleetRequestsErrorItemBuilderOps = new CancelSpotFleetRequestsErrorItemBuilderOps(v)

implicit def toCancelSpotFleetRequestsErrorItemOps(v: CancelSpotFleetRequestsErrorItem): CancelSpotFleetRequestsErrorItemOps = new CancelSpotFleetRequestsErrorItemOps(v)
