...
final class DescribeFleetsInstancesBuilderOps(val self: DescribeFleetsInstances.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def launchTemplateAndOverridesAsScala(value: Option[LaunchTemplateAndOverridesResponse]): DescribeFleetsInstances.Builder = {
...
implicit def toDescribeFleetsInstancesBuilderOps(v: DescribeFleetsInstances.Builder): DescribeFleetsInstancesBuilderOps = new DescribeFleetsInstancesBuilderOps(v)

implicit def toDescribeFleetsInstancesOps(v: DescribeFleetsInstances): DescribeFleetsInstancesOps = new DescribeFleetsInstancesOps(v)
