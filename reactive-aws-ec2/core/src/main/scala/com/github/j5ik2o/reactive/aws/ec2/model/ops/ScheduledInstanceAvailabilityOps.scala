...
final class ScheduledInstanceAvailabilityBuilderOps(val self: ScheduledInstanceAvailability.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.firstSlotStartTime(v) }
            } 
...
implicit def toScheduledInstanceAvailabilityBuilderOps(v: ScheduledInstanceAvailability.Builder): ScheduledInstanceAvailabilityBuilderOps = new ScheduledInstanceAvailabilityBuilderOps(v)

implicit def toScheduledInstanceAvailabilityOps(v: ScheduledInstanceAvailability): ScheduledInstanceAvailabilityOps = new ScheduledInstanceAvailabilityOps(v)
