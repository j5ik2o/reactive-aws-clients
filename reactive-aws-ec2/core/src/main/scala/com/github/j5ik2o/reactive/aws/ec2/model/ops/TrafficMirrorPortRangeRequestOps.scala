...
implicit def toTrafficMirrorPortRangeRequestBuilderOps(v: TrafficMirrorPortRangeRequest.Builder): TrafficMirrorPortRangeRequestBuilderOps = new TrafficMirrorPortRangeRequestBuilderOps(v)

implicit def toTrafficMirrorPortRangeRequestOps(v: TrafficMirrorPortRangeRequest): TrafficMirrorPortRangeRequestOps = new TrafficMirrorPortRangeRequestOps(v)
