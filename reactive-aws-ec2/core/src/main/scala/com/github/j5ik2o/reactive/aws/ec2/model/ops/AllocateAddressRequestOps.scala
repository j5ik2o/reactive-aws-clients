...
implicit def toAllocateAddressRequestBuilderOps(v: AllocateAddressRequest.Builder): AllocateAddressRequestBuilderOps = new AllocateAddressRequestBuilderOps(v)

implicit def toAllocateAddressRequestOps(v: AllocateAddressRequest): AllocateAddressRequestOps = new AllocateAddressRequestOps(v)
