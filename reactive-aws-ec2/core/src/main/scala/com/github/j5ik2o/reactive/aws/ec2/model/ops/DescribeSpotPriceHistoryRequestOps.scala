...
final class DescribeSpotPriceHistoryRequestBuilderOps(val self: DescribeSpotPriceHistoryRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def productDescriptionsAsScala(value: Option[Seq[String]]): DescribeSpotPriceHistoryRequest.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.productDescriptions(v.asJava) } 
            }
...
final class DescribeSpotPriceHistoryRequestOps(val self: DescribeSpotPriceHistoryRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def instanceTypesAsScala: Option[Seq[InstanceType]] = Option(self.instanceTypes).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def productDescriptionsAsScala: Option[Seq[String]] = Option(self.productDescriptions).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toDescribeSpotPriceHistoryRequestBuilderOps(v: DescribeSpotPriceHistoryRequest.Builder): DescribeSpotPriceHistoryRequestBuilderOps = new DescribeSpotPriceHistoryRequestBuilderOps(v)

implicit def toDescribeSpotPriceHistoryRequestOps(v: DescribeSpotPriceHistoryRequest): DescribeSpotPriceHistoryRequestOps = new DescribeSpotPriceHistoryRequestOps(v)
