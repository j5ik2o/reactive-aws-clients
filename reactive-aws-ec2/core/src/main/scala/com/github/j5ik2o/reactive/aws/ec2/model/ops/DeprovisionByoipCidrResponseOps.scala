...
implicit def toDeprovisionByoipCidrResponseBuilderOps(v: DeprovisionByoipCidrResponse.Builder): DeprovisionByoipCidrResponseBuilderOps = new DeprovisionByoipCidrResponseBuilderOps(v)

implicit def toDeprovisionByoipCidrResponseOps(v: DeprovisionByoipCidrResponse): DeprovisionByoipCidrResponseOps = new DeprovisionByoipCidrResponseOps(v)
