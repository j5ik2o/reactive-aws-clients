...
implicit def toCreatePlacementGroupRequestBuilderOps(v: CreatePlacementGroupRequest.Builder): CreatePlacementGroupRequestBuilderOps = new CreatePlacementGroupRequestBuilderOps(v)

implicit def toCreatePlacementGroupRequestOps(v: CreatePlacementGroupRequest): CreatePlacementGroupRequestOps = new CreatePlacementGroupRequestOps(v)
