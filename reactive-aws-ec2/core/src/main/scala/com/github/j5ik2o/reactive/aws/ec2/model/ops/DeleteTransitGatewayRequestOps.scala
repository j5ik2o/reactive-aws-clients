...
trait ToDeleteTransitGatewayRequestOps {
  ...
  implicit def toDeleteTransitGatewayRequestBuilderOps(
      v: DeleteTransitGatewayRequest.Builder
  ): DeleteTransitGatewayRequestBuilderOps = new DeleteTransitGatewayRequestBuilderOps(v)

  implicit def toDeleteTransitGatewayRequestOps(v: DeleteTransitGatewayRequest): DeleteTransitGatewayRequestOps =
    new DeleteTransitGatewayRequestOps(v)
