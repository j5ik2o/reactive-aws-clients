...
implicit def toSlotDateTimeRangeRequestBuilderOps(v: SlotDateTimeRangeRequest.Builder): SlotDateTimeRangeRequestBuilderOps = new SlotDateTimeRangeRequestBuilderOps(v)

implicit def toSlotDateTimeRangeRequestOps(v: SlotDateTimeRangeRequest): SlotDateTimeRangeRequestOps = new SlotDateTimeRangeRequestOps(v)
