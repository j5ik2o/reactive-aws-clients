...
final class CreateClientVpnEndpointRequestBuilderOps(val self: CreateClientVpnEndpointRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def authenticationOptionsAsScala(value: Option[Seq[ClientVpnAuthenticationRequest]]): CreateClientVpnEndpointRequest.Builder = {
...
final class CreateClientVpnEndpointRequestOps(val self: CreateClientVpnEndpointRequest) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def authenticationOptionsAsScala: Option[Seq[ClientVpnAuthenticationRequest]] = Option(self.authenticationOptions).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toCreateClientVpnEndpointRequestBuilderOps(v: CreateClientVpnEndpointRequest.Builder): CreateClientVpnEndpointRequestBuilderOps = new CreateClientVpnEndpointRequestBuilderOps(v)

implicit def toCreateClientVpnEndpointRequestOps(v: CreateClientVpnEndpointRequest): CreateClientVpnEndpointRequestOps = new CreateClientVpnEndpointRequestOps(v)
