...
implicit def toCreateVolumePermissionBuilderOps(v: CreateVolumePermission.Builder): CreateVolumePermissionBuilderOps = new CreateVolumePermissionBuilderOps(v)

implicit def toCreateVolumePermissionOps(v: CreateVolumePermission): CreateVolumePermissionOps = new CreateVolumePermissionOps(v)
