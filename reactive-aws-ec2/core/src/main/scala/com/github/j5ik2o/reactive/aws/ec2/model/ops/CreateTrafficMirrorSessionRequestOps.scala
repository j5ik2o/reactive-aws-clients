...
final class CreateTrafficMirrorSessionRequestBuilderOps(val self: CreateTrafficMirrorSessionRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def tagSpecificationsAsScala(value: Option[Seq[TagSpecification]]): CreateTrafficMirrorSessionRequest.Builder = {
...
implicit def toCreateTrafficMirrorSessionRequestBuilderOps(v: CreateTrafficMirrorSessionRequest.Builder): CreateTrafficMirrorSessionRequestBuilderOps = new CreateTrafficMirrorSessionRequestBuilderOps(v)

implicit def toCreateTrafficMirrorSessionRequestOps(v: CreateTrafficMirrorSessionRequest): CreateTrafficMirrorSessionRequestOps = new CreateTrafficMirrorSessionRequestOps(v)
