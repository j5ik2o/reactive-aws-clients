...
implicit def toClientVpnRouteStatusBuilderOps(v: ClientVpnRouteStatus.Builder): ClientVpnRouteStatusBuilderOps = new ClientVpnRouteStatusBuilderOps(v)

implicit def toClientVpnRouteStatusOps(v: ClientVpnRouteStatus): ClientVpnRouteStatusOps = new ClientVpnRouteStatusOps(v)
