...
final class DisableFastSnapshotRestoresResponseOps(val self: DisableFastSnapshotRestoresResponse) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def successfulAsScala: Option[Seq[DisableFastSnapshotRestoreSuccessItem]] = Option(self.successful).map { v =>
    import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala
  }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def unsuccessfulAsScala: Option[Seq[DisableFastSnapshotRestoreErrorItem]] = Option(self.unsuccessful).map { v =>
    import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala
  }
