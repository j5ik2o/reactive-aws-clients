...
final class ClientVpnRouteBuilderOps(val self: ClientVpnRoute.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            ...
            value.fold(self){ v => self.targetSubnet(v) }
            } 
...
implicit def toClientVpnRouteBuilderOps(v: ClientVpnRoute.Builder): ClientVpnRouteBuilderOps = new ClientVpnRouteBuilderOps(v)
