...
final class GetCapacityReservationUsageResponseBuilderOps(val self: GetCapacityReservationUsageResponse.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def instanceUsagesAsScala(value: Option[Seq[InstanceUsage]]): GetCapacityReservationUsageResponse.Builder = {
                value.filter(_.nonEmpty).fold(self){ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; self.instanceUsages(v.asJava) } 
            }
...
final class GetCapacityReservationUsageResponseOps(val self: GetCapacityReservationUsageResponse) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
                final def instanceUsagesAsScala: Option[Seq[InstanceUsage]] = Option(self.instanceUsages).map{ v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala } 
...
implicit def toGetCapacityReservationUsageResponseBuilderOps(v: GetCapacityReservationUsageResponse.Builder): GetCapacityReservationUsageResponseBuilderOps = new GetCapacityReservationUsageResponseBuilderOps(v)

implicit def toGetCapacityReservationUsageResponseOps(v: GetCapacityReservationUsageResponse): GetCapacityReservationUsageResponseOps = new GetCapacityReservationUsageResponseOps(v)
