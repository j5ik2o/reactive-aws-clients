...
final class RevokeSecurityGroupIngressRequestBuilderOps(val self: RevokeSecurityGroupIngressRequest.Builder) extends AnyVal {
...
implicit def toRevokeSecurityGroupIngressRequestBuilderOps(v: RevokeSecurityGroupIngressRequest.Builder): RevokeSecurityGroupIngressRequestBuilderOps = new RevokeSecurityGroupIngressRequestBuilderOps(v)

implicit def toRevokeSecurityGroupIngressRequestOps(v: RevokeSecurityGroupIngressRequest): RevokeSecurityGroupIngressRequestOps = new RevokeSecurityGroupIngressRequestOps(v)
