...
final class DescribeImportImageTasksRequestBuilderOps(val self: DescribeImportImageTasksRequest.Builder) extends AnyVal {
...
implicit def toDescribeImportImageTasksRequestBuilderOps(v: DescribeImportImageTasksRequest.Builder): DescribeImportImageTasksRequestBuilderOps = new DescribeImportImageTasksRequestBuilderOps(v)

implicit def toDescribeImportImageTasksRequestOps(v: DescribeImportImageTasksRequest): DescribeImportImageTasksRequestOps = new DescribeImportImageTasksRequestOps(v)
