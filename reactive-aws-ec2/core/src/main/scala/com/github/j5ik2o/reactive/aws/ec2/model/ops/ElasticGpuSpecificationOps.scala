...
implicit def toElasticGpuSpecificationBuilderOps(v: ElasticGpuSpecification.Builder): ElasticGpuSpecificationBuilderOps = new ElasticGpuSpecificationBuilderOps(v)

implicit def toElasticGpuSpecificationOps(v: ElasticGpuSpecification): ElasticGpuSpecificationOps = new ElasticGpuSpecificationOps(v)
