...
final class InferenceAcceleratorInfoOps(val self: InferenceAcceleratorInfo) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def acceleratorsAsScala: Option[Seq[InferenceDeviceInfo]] =
    Option(self.accelerators).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
