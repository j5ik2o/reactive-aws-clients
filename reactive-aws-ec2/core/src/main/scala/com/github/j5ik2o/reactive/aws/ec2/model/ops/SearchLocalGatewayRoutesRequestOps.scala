...
final class SearchLocalGatewayRoutesRequestBuilderOps(val self: SearchLocalGatewayRoutesRequest.Builder) extends AnyVal {
...
implicit def toSearchLocalGatewayRoutesRequestBuilderOps(v: SearchLocalGatewayRoutesRequest.Builder): SearchLocalGatewayRoutesRequestBuilderOps = new SearchLocalGatewayRoutesRequestBuilderOps(v)

implicit def toSearchLocalGatewayRoutesRequestOps(v: SearchLocalGatewayRoutesRequest): SearchLocalGatewayRoutesRequestOps = new SearchLocalGatewayRoutesRequestOps(v)
