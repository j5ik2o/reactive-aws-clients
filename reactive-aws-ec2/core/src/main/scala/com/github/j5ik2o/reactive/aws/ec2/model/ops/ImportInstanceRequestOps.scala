...
final class ImportInstanceRequestOps(val self: ImportInstanceRequest) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def diskImagesAsScala: Option[Seq[DiskImage]] =
    Option(self.diskImages).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
