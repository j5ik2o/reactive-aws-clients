...
implicit def toDetachClassicLinkVpcRequestBuilderOps(v: DetachClassicLinkVpcRequest.Builder): DetachClassicLinkVpcRequestBuilderOps = new DetachClassicLinkVpcRequestBuilderOps(v)

implicit def toDetachClassicLinkVpcRequestOps(v: DetachClassicLinkVpcRequest): DetachClassicLinkVpcRequestOps = new DetachClassicLinkVpcRequestOps(v)
