...
final class LaunchTemplateTagSpecificationRequestBuilderOps(val self: LaunchTemplateTagSpecificationRequest.Builder) extends AnyVal {
...
implicit def toLaunchTemplateTagSpecificationRequestBuilderOps(v: LaunchTemplateTagSpecificationRequest.Builder): LaunchTemplateTagSpecificationRequestBuilderOps = new LaunchTemplateTagSpecificationRequestBuilderOps(v)

implicit def toLaunchTemplateTagSpecificationRequestOps(v: LaunchTemplateTagSpecificationRequest): LaunchTemplateTagSpecificationRequestOps = new LaunchTemplateTagSpecificationRequestOps(v)
