...
implicit def toLaunchTemplateCpuOptionsBuilderOps(v: LaunchTemplateCpuOptions.Builder): LaunchTemplateCpuOptionsBuilderOps = new LaunchTemplateCpuOptionsBuilderOps(v)

implicit def toLaunchTemplateCpuOptionsOps(v: LaunchTemplateCpuOptions): LaunchTemplateCpuOptionsOps = new LaunchTemplateCpuOptionsOps(v)
