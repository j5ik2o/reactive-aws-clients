...
final class DescribeSnapshotsRequestOps(val self: DescribeSnapshotsRequest) extends AnyVal {
  ...
  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def ownerIdsAsScala: Option[Seq[String]] =
    Option(self.ownerIds).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def restorableByUserIdsAsScala: Option[Seq[String]] =
    Option(self.restorableByUserIds).map { v =>
      import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala
    }

  @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
  final def snapshotIdsAsScala: Option[Seq[String]] =
    Option(self.snapshotIds).map { v => import com.github.j5ik2o.reactive.aws.utils.JavaCollectionHelper._; v.asScala }
