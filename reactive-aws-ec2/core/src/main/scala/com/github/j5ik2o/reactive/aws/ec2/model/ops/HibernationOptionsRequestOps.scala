...
implicit def toHibernationOptionsRequestBuilderOps(v: HibernationOptionsRequest.Builder): HibernationOptionsRequestBuilderOps = new HibernationOptionsRequestBuilderOps(v)

implicit def toHibernationOptionsRequestOps(v: HibernationOptionsRequest): HibernationOptionsRequestOps = new HibernationOptionsRequestOps(v)
