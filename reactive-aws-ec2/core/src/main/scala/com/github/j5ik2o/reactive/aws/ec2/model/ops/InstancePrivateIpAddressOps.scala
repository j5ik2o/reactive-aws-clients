...
implicit def toInstancePrivateIpAddressBuilderOps(v: InstancePrivateIpAddress.Builder): InstancePrivateIpAddressBuilderOps = new InstancePrivateIpAddressBuilderOps(v)

implicit def toInstancePrivateIpAddressOps(v: InstancePrivateIpAddress): InstancePrivateIpAddressOps = new InstancePrivateIpAddressOps(v)
