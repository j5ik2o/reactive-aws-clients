...
final class ReplaceNetworkAclAssociationRequestBuilderOps(val self: ReplaceNetworkAclAssociationRequest.Builder) extends AnyVal {
...
implicit def toReplaceNetworkAclAssociationRequestBuilderOps(v: ReplaceNetworkAclAssociationRequest.Builder): ReplaceNetworkAclAssociationRequestBuilderOps = new ReplaceNetworkAclAssociationRequestBuilderOps(v)

implicit def toReplaceNetworkAclAssociationRequestOps(v: ReplaceNetworkAclAssociationRequest): ReplaceNetworkAclAssociationRequestOps = new ReplaceNetworkAclAssociationRequestOps(v)
