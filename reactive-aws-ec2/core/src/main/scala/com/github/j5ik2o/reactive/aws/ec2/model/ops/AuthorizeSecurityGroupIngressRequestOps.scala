...
final class AuthorizeSecurityGroupIngressRequestBuilderOps(val self: AuthorizeSecurityGroupIngressRequest.Builder) extends AnyVal {
...
implicit def toAuthorizeSecurityGroupIngressRequestBuilderOps(v: AuthorizeSecurityGroupIngressRequest.Builder): AuthorizeSecurityGroupIngressRequestBuilderOps = new AuthorizeSecurityGroupIngressRequestBuilderOps(v)

implicit def toAuthorizeSecurityGroupIngressRequestOps(v: AuthorizeSecurityGroupIngressRequest): AuthorizeSecurityGroupIngressRequestOps = new AuthorizeSecurityGroupIngressRequestOps(v)
