...
final class LoadBalancersConfigBuilderOps(val self: LoadBalancersConfig.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def classicLoadBalancersConfigAsScala(value: Option[ClassicLoadBalancersConfig]): LoadBalancersConfig.Builder = {
            value.fold(self){ v => self.classicLoadBalancersConfig(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def targetGroupsConfigAsScala(value: Option[TargetGroupsConfig]): LoadBalancersConfig.Builder = {
            value.fold(self){ v => self.targetGroupsConfig(v) }
            } 
...
final class LoadBalancersConfigOps(val self: LoadBalancersConfig) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def classicLoadBalancersConfigAsScala: Option[ClassicLoadBalancersConfig] = Option(self.classicLoadBalancersConfig) 
...
implicit def toLoadBalancersConfigBuilderOps(v: LoadBalancersConfig.Builder): LoadBalancersConfigBuilderOps = new LoadBalancersConfigBuilderOps(v)
