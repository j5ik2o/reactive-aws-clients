...
final class CreateVpcEndpointConnectionNotificationRequestBuilderOps(val self: CreateVpcEndpointConnectionNotificationRequest.Builder) extends AnyVal {
    ...
    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def connectionNotificationArnAsScala(value: Option[String]): CreateVpcEndpointConnectionNotificationRequest.Builder = {
            value.fold(self){ v => self.connectionNotificationArn(v) }
            } 

    @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
            final def connectionEventsAsScala(value: Option[Seq[String]]): CreateVpcEndpointConnectionNotificationRequest.Builder = {
...
final class CreateVpcEndpointConnectionNotificationRequestOps(val self: CreateVpcEndpointConnectionNotificationRequest) extends AnyVal {
...
implicit def toCreateVpcEndpointConnectionNotificationRequestBuilderOps(v: CreateVpcEndpointConnectionNotificationRequest.Builder): CreateVpcEndpointConnectionNotificationRequestBuilderOps = new CreateVpcEndpointConnectionNotificationRequestBuilderOps(v)

implicit def toCreateVpcEndpointConnectionNotificationRequestOps(v: CreateVpcEndpointConnectionNotificationRequest): CreateVpcEndpointConnectionNotificationRequestOps = new CreateVpcEndpointConnectionNotificationRequestOps(v)
