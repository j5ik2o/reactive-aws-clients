...
final class CreateTrafficMirrorFilterRequestBuilderOps(val self: CreateTrafficMirrorFilterRequest.Builder) extends AnyVal {
...
implicit def toCreateTrafficMirrorFilterRequestBuilderOps(v: CreateTrafficMirrorFilterRequest.Builder): CreateTrafficMirrorFilterRequestBuilderOps = new CreateTrafficMirrorFilterRequestBuilderOps(v)

implicit def toCreateTrafficMirrorFilterRequestOps(v: CreateTrafficMirrorFilterRequest): CreateTrafficMirrorFilterRequestOps = new CreateTrafficMirrorFilterRequestOps(v)
