...
implicit def toFailedQueuedPurchaseDeletionBuilderOps(v: FailedQueuedPurchaseDeletion.Builder): FailedQueuedPurchaseDeletionBuilderOps = new FailedQueuedPurchaseDeletionBuilderOps(v)

implicit def toFailedQueuedPurchaseDeletionOps(v: FailedQueuedPurchaseDeletion): FailedQueuedPurchaseDeletionOps = new FailedQueuedPurchaseDeletionOps(v)
